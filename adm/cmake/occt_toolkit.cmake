...
# Check if we're building a private static library for internal DE implementation
# This option is only valid if globally we're building shared libraries
set (IS_PRIVATE_STATIC_LIB FALSE)
if (DEFINED OCCT_PRIVATE_STATIC_LIB AND OCCT_PRIVATE_STATIC_LIB AND BUILD_SHARED_LIBS)
  set (IS_PRIVATE_STATIC_LIB TRUE)
endif()
...
if (NOT BUILD_SHARED_LIBS OR IS_PRIVATE_STATIC_LIB)
...
if (EXECUTABLE_PROJECT)
  ...
  # For private static libs, we build static libraries even when BUILD_SHARED_LIBS is ON
  if (IS_PRIVATE_STATIC_LIB)
    add_library (${PROJECT_NAME} STATIC ${USED_SRCFILES} ${USED_INCFILES} ${USED_RCFILE} ${RESOURCE_FILES} ${${PROJECT_NAME}_MOC_FILES})
    # Add definition to indicate this is a private static library for DE internal implementation
    target_compile_definitions(${PROJECT_NAME} PRIVATE -DOCCT_PRIVATE_STATIC_LIB)
  else()
    add_library (${PROJECT_NAME} ${USED_SRCFILES} ${USED_INCFILES} ${USED_RCFILE} ${RESOURCE_FILES} ${${PROJECT_NAME}_MOC_FILES})
  endif()

  if (MSVC AND BUILD_SHARED_LIBS AND NOT IS_PRIVATE_STATIC_LIB)
  ...
  # Skip installation for private static libraries
  #if (NOT IS_PRIVATE_STATIC_LIB)
  if (TRUE)
    install (TARGETS ${PROJECT_NAME}
    ...
    if (NOT WIN32 AND NOT IS_PRIVATE_STATIC_LIB)
      if (BUILD_SHARED_LIBS AND NOT "${BUILD_SHARED_LIBRARY_NAME_POSTFIX}" STREQUAL "")
