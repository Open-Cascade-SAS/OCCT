...
function (JEMALLOC_LIB_SEARCH MMGR_LIB PREFIX)
  ...
  if (WIN32 AND NOT JEMALLOC_IS_STATIC_LIB AND 3RDPARTY_JEMALLOC_LIBRARY_DIR_${MMGR_LIB})
    set(JEMALLOC_DLL_DIRS ${3RDPARTY_DLL_DIRS})
    list(APPEND JEMALLOC_DLL_DIRS "${3RDPARTY_JEMALLOC_LIBRARY_DIR_${MMGR_LIB}}")
    list(REMOVE_DUPLICATES JEMALLOC_DLL_DIRS)
    set(3RDPARTY_DLL_DIRS "${JEMALLOC_DLL_DIRS}" PARENT_SCOPE)
  endif()
