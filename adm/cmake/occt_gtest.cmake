...
function(OCCT_INIT_GTEST)
  ...
  if (INSTALL_GTEST)
    ...
    if (EMSCRIPTEN)
      install(FILES ${OCCT_BINARY_DIR}/${OS_WITH_BIT}/${COMPILER}/bin\${OCCT_INSTALL_BIN_LETTER}/${TEST_PROJECT_NAME}.wasm DESTINATION "${INSTALL_DIR_BIN}/${OCCT_INSTALL_BIN_LETTER}")
    endif()
  endif()
endfunction()
...
function(OCCT_COLLECT_TOOLKIT_TESTS TOOLKIT_NAME)
  ...
  if(EXISTS "${FILES_CMAKE_PATH}")
    ...
    gtest_add_tests(
      ...
      SKIP_DEPENDENCY
      WORKING_DIRECTORY "${OCCT_BINARY_DIR}"
    )
...
function(OCCT_SET_GTEST_ENVIRONMENT)
  ...
  if (OCCT_GTEST_TESTS_LIST)
    ...
    set(TEST_ENVIRONMENT
      ...
      "CSF_OCCTIncludePath=${OCCT_BINARY_DIR}/${INSTALL_DIR_INCLUDE}"
