...
function(OCCT_SET_TEST_TARGET_OUTPUT_DIRECTORIES TARGET_NAME)
  ...
  foreach (OCCT_CONFIGURATION ${CMAKE_CONFIGURATION_TYPES})
    ...
    set_target_properties(${TARGET_NAME} PROPERTIES
      ARCHIVE_OUTPUT_DIRECTORY_${OCCT_CONFIGURATION_UPPER} "${CMAKE_ARCHIVE_OUTPUT_DIRECTORY_${OCCT_CONFIGURATION_UPPER}}"
      RUNTIME_OUTPUT_DIRECTORY_${OCCT_CONFIGURATION_UPPER} "${CMAKE_RUNTIME_OUTPUT_DIRECTORY_${OCCT_CONFIGURATION_UPPER}}"
      LIBRARY_OUTPUT_DIRECTORY_${OCCT_CONFIGURATION_UPPER} "${CMAKE_LIBRARY_OUTPUT_DIRECTORY_${OCCT_CONFIGURATION_UPPER}}")
  endforeach()
endfunction()

function(OCCT_GTEST_GET_OUTPUT_DIRECTORY OUTPUT_DIRECTORY BASE_DIRECTORY_NAME)
  if (SINGLE_GENERATOR)
    set(${OUTPUT_DIRECTORY} "${${BASE_DIRECTORY_NAME}}" PARENT_SCOPE)
    return()
  endif()

  set(${OUTPUT_DIRECTORY}
      "$<IF:$<CONFIG:Debug>,${${BASE_DIRECTORY_NAME}_DEBUG},$<IF:$<CONFIG:RelWithDebInfo>,${${BASE_DIRECTORY_NAME}_RELWITHDEBINFO},${${BASE_DIRECTORY_NAME}_RELEASE}>>"
      PARENT_SCOPE)
endfunction()
...
function(OCCT_INIT_GTEST)
  ...
  OCCT_SET_TEST_TARGET_OUTPUT_DIRECTORIES(${TEST_PROJECT_NAME})
  OCCT_SET_TEST_TARGET_OUTPUT_DIRECTORIES(gtest)
  OCCT_SET_TEST_TARGET_OUTPUT_DIRECTORIES(gtest_main)
...
function(OCCT_SET_GTEST_ENVIRONMENT)
  ...
  if (OCCT_GTEST_TESTS_LIST)
    set(TEST_RUNTIME_OUTPUT_DIRECTORY "$<TARGET_FILE_DIR:${TEST_PROJECT_NAME}>")
    OCCT_GTEST_GET_OUTPUT_DIRECTORY(TEST_ARCHIVE_OUTPUT_DIRECTORY CMAKE_ARCHIVE_OUTPUT_DIRECTORY)
    ...
    set(TEST_ENVIRONMENT
      ...
      "CSF_OCCTBinPath=${TEST_RUNTIME_OUTPUT_DIRECTORY}"
      "CSF_OCCTLibPath=${TEST_ARCHIVE_OUTPUT_DIRECTORY}"
