...
elseif (CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX OR (CMAKE_CXX_COMPILER_ID MATCHES "[Cc][Ll][Aa][Nn][Gg]"))
  ...
  set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -Wextra -fvisibility=hidden -fvisibility-ms-compat")
  set (CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -Wall -Wextra -fvisibility=hidden -fvisibility-ms-compat")
