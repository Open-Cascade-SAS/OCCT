...
rem Auxiliary script for semi-automated building of OCCT for Windows platform.
...
set "anArchName=occt-%anOcctVersion%%anOcctVerSuffix%%aRevision%-msvc%aBuildTypePrefix%"
...
set "aTimeZERO=%TIME%"
if ["%toCMake%"] == ["1"] (
  echo Configuring OCCT for Windows...
  cmake -G "%aCmakeGen%" ^
