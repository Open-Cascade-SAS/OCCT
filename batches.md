...
- **Data Files**: `OCC16119-c1.draw, OCC16119-c2.draw, OCC16119-c31.draw, OCC16119-c32.draw, OCC16119-c41.draw, OCC16119-c42.draw, OCC16119-cv.draw` (Needs `BRepTools::Read` or path resolution)
...
- **Data Files**: `OCC16833-c1.draw, OCC16833-c2.draw, OCC16833-c3.draw, OCC16833-c4.draw` (Needs `BRepTools::Read` or path resolution)
...
- **Data Files**: `bug23343_initFace.brep, bug23343_edge_constraint.brep` (Needs `BRepTools::Read` or path resolution)
```tcl
...
### Test: bugs/filling/bug27873
- **Target Suite**: OCCT_Bugs_filling
- **Target Case**: bug27873
- **Data Files**: `bug27873_filling.brep` (Needs `BRepTools::Read` or path resolution)
- **Suggested C++**: BRepOffsetAPI_MakeFilling
```tcl
