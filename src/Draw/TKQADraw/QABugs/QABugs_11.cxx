...
static int OCC7372(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  occ::handle<TColgp_HArray1OfPnt2d> ap = new TColgp_HArray1OfPnt2d(1, 5);
...
static int OCC10138(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  //! 4. Change array
  doc->OpenCommand();
  occ::handle<TColStd_HArray1OfReal> arr = new TColStd_HArray1OfReal(LOWER + 5, UPPER + 5);
...
int TestCopyPaste(const occ::handle<TDocStd_Document>& doc)
{
  ...
  occ::handle<TColStd_HArray1OfInteger> ints_arr = new TColStd_HArray1OfInteger(4, 5);
  ...
  if (!nd->HasArrayOfIntegers("Integers1"))
    return 4;
  const occ::handle<TColStd_HArray1OfInteger>& ints_arr_out = nd->GetArrayOfIntegers("Integers1");
