...
public:
  ...
  void GetFreeNodeNum(const int theIndex,
                      int&      theFaceNum,
  ...
  //! this face.
  void GetSmallTriangle(const int theIndex,
                        int&      theFaceNum,
                        int&      theNodeNum) const
  {
...
private:
  ...
  NCollection_IndexedDataMap<int, occ::handle<TColStd_HSequenceOfInteger>> myMapFaceLinks;
