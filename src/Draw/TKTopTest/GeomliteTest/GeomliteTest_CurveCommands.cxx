...
static Standard_Integer anacurve(Draw_Interpretor&, Standard_Integer n, const char** a)
{
  ...
  else if (!strcmp(a[0], "circle"))
  {
    if (n == 5)
      result2d =
        new Geom2d_Circle(gp_Ax22d(gp_Pnt2d(Draw::Atof(a[2]), Draw::Atof(a[3])), gp_Dir2d(gp_Dir2d::D::X)),
                          Draw::Atof(a[4]));
    else if (n == 6)
  ...
  else if (!strcmp(a[0], "parabola"))
  {
    if (n == 5)
      result2d =
        new Geom2d_Parabola(gp_Ax22d(gp_Pnt2d(Draw::Atof(a[2]), Draw::Atof(a[3])), gp_Dir2d(gp_Dir2d::D::X)),
                            Draw::Atof(a[4]));
    else if (n == 6)
  ...
  else if (!strcmp(a[0], "ellipse"))
  {
    if (n == 6)
      result2d =
        new Geom2d_Ellipse(gp_Ax22d(gp_Pnt2d(Draw::Atof(a[2]), Draw::Atof(a[3])), gp_Dir2d(gp_Dir2d::D::X)),
                           Draw::Atof(a[4]),
                           Draw::Atof(a[5]));
    else if (n == 7)
  ...
  else if (!strcmp(a[0], "hyperbola"))
  {
    if (n == 6)
      result2d =
        new Geom2d_Hyperbola(gp_Ax22d(gp_Pnt2d(Draw::Atof(a[2]), Draw::Atof(a[3])), gp_Dir2d(gp_Dir2d::D::X)),
                             Draw::Atof(a[4]),
                             Draw::Atof(a[5]));
    else if (n == 7)
