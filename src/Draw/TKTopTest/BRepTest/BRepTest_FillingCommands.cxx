...
static int plate(Draw_Interpretor& di, int n, const char** a)
{
  ...
  occ::handle<GeomPlate_HArray1OfHCurve> Fronts     = new GeomPlate_HArray1OfHCurve(1, NbCurFront);
  occ::handle<TColStd_HArray1OfInteger>  Tang       = new TColStd_HArray1OfInteger(1, NbCurFront);
  occ::handle<TColStd_HArray1OfInteger>  NbPtsCur   = new TColStd_HArray1OfInteger(1, NbCurFront);
  BRep_Builder                      B;
