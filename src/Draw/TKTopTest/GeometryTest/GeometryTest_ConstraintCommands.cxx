...
//==================================================================================
{
  ...
  if (n == 2)
  {
    ...
    if (dout.Is3D(id))
    {
      ...
      occ::handle<TColgp_HArray1OfPnt> Points = new TColgp_HArray1OfPnt(1, 1);
      P.SetCoord((double)XX / zoom, (double)YY / zoom, 0.0);
      Points->SetValue(1, P);
      occ::handle<TColgp_HArray1OfPnt> ThePoints = new TColgp_HArray1OfPnt(1, 2);
    ...
    else
    {
      ...
      occ::handle<TColgp_HArray1OfPnt2d> Points = new TColgp_HArray1OfPnt2d(1, 1);
      P2d.SetCoord((double)XX / zoom, (double)YY / zoom);
      Points->SetValue(1, P2d);
      occ::handle<TColgp_HArray1OfPnt2d> ThePoints = new TColgp_HArray1OfPnt2d(1, 2);
  ...
  else if (n == 3)
  {
    ...
    if (!strcmp(dimen, "3d"))
    {
      occ::handle<TColgp_HArray1OfPnt> Point = new TColgp_HArray1OfPnt(1, nbp);
      for (i = 1; i <= nbp; i++)
      {
        iFile >> x >> y >> z;
    ...
    {
      occ::handle<TColgp_HArray1OfPnt2d> PointPtr = new TColgp_HArray1OfPnt2d(1, nbp);
      for (i = 1; i <= nbp; i++)
      {
        iFile >> x >> y;
...
static int tanginterpol(Draw_Interpretor& di, int n, const char** a)
{
  ...
  occ::handle<TColgp_HArray1OfPnt> PointsArrayPtr = new TColgp_HArray1OfPnt(1, num_parameters);
  ...
  if (num_tangents > 0)
  {
    ...
    occ::handle<TColStd_HArray1OfBoolean> TangentFlagsPtr =
