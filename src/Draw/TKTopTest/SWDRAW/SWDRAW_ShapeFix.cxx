...
static int connectedges(Draw_Interpretor& di, int n, const char** a)
{
  ...
  occ::handle<TopTools_HSequenceOfShape> aSeqEdges = new TopTools_HSequenceOfShape;
  occ::handle<TopTools_HSequenceOfShape> aSeqWires = new TopTools_HSequenceOfShape;
