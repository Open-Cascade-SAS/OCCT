...
static int tolerance(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  else
  {
    ...
    occ::handle<TopTools_HSequenceOfShape> list = sat.InTolerance(Shape, tol1, tol2, type);
...
static int XSHAPE_statshape(Draw_Interpretor& di,
                                         int  argc,
                                         const char**      argv)
{
  if (argc < 2)
  ...
  occ::handle<TopTools_HSequenceOfShape> sec;
...
static int XSHAPE_comptoledge(Draw_Interpretor& di,
                                           int  argc,
                                           const char**      argv)
{
  if (argc < 2)
...
static int checkselfintersection(Draw_Interpretor& di,
                                              int  argc,
                                              const char**      argv)
{
  if (argc < 2)
