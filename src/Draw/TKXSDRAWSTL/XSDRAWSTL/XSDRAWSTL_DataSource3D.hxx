...
public:
  ...
  Standard_EXPORT virtual bool Get3DGeom(
    const int                     theID,
    int&                          theNbNodes,
    occ::handle<MeshVS_HArray1OfSequenceOfInteger>& theData) const override;
  ...
  Standard_EXPORT void*
    GetAddr(const int theID,
            const bool theIsElement) const override;
...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger> myElemNbNodes;
