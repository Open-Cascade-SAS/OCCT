                                       ...
                                       const char**      theArgv)
{
       ...
       aNamedDataIter.Next())
  {
    ...
    {
      const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>& anArrayIntegerProperties =
        aNamedData->GetArraysOfIntegersContainer();
      for (NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>::Iterator anIter(anArrayIntegerProperties);
           anIter.More();
           anIter.Next())
      {
    ...
    {
      const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>& anArrayRealsProperties =
        aNamedData->GetArraysOfRealsContainer();
      for (NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>::Iterator anIter(anArrayRealsProperties);
           anIter.More();
           anIter.Next())
      {
        TCollection_AsciiString aMessage(anIter.Key() + " : ");
