...
public:
  ...
  Standard_EXPORT virtual void SetPoint(const char* name,
                                        const gp_Pnt&          val) override;

  Standard_EXPORT virtual void SetPoint2d(const char* name,
  ...
  Standard_EXPORT virtual void SetShape(const char* name,
