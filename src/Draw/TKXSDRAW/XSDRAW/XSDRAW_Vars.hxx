...
public:
  ...
  Standard_EXPORT virtual void SetPoint(const char* const name,
                                        const gp_Pnt&          val) override;

  Standard_EXPORT virtual void SetPoint2d(const char* const name,
                                          const gp_Pnt2d&        val) override;

  Standard_EXPORT virtual bool GetPoint(const char*& name,
                                                    gp_Pnt&           pnt) const override;

  Standard_EXPORT virtual bool GetPoint2d(const char*& name,
                                                      gp_Pnt2d& pnt) const override;

  Standard_EXPORT virtual void SetShape(const char* const name,
                                        const TopoDS_Shape&    val) override;
