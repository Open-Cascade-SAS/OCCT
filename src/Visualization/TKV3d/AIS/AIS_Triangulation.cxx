...
//=======================================================================
void AIS_Triangulation::SetColors(const occ::handle<TColStd_HArray1OfInteger>& aColor)
{
  myFlagColor = 1;
  myColor     = aColor;
}
...
occ::handle<TColStd_HArray1OfInteger> AIS_Triangulation::GetColors() const
{
  return myColor;
}
