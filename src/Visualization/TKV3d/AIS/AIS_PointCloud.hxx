...
public:
  ...
  Standard_EXPORT virtual void SetPoints(const occ::handle<TColgp_HArray1OfPnt>&     theCoords,
                                         const occ::handle<Quantity_HArray1OfColor>& theColors  = NULL,
                                         const occ::handle<TColgp_HArray1OfDir>&     theNormals = NULL);
