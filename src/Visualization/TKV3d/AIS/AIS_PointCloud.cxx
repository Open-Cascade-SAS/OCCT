...
void AIS_PointCloud::SetPoints(const occ::handle<TColgp_HArray1OfPnt>&     theCoords,
                               const occ::handle<Quantity_HArray1OfColor>& theColors,
                               const occ::handle<TColgp_HArray1OfDir>&     theNormals)
{
  myPoints.Nullify();
  myBndBox.SetVoid();
  if (theCoords.IsNull())
