...
NCOLLECTION_HSEQUENCE(AIS_ManipulatorObjectSequence, occ::handle<AIS_InteractiveObject>)
...
public:
  ...
  //! It is placed in the center of object bounding box, and its size is adjusted to the object
  //! bounding box.
  Standard_EXPORT void Attach(const occ::handle<AIS_ManipulatorObjectSequence>& theObject,
                              const OptionsForAttach& theOptions = OptionsForAttach());
...
public:
  ...
  Standard_EXPORT occ::handle<AIS_ManipulatorObjectSequence> Objects() const;
