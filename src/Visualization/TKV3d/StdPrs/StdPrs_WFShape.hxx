...
private:
  ...
  Standard_EXPORT static void addEdges(const TopoDS_Shape&         theShape,
                                       ...
                                       NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* theWire,
                                       NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* theFree,
                                       NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* theUnFree);
