...
{
public:
  StdPrs_WFShape_IsoFunctor(NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&     thePolylinesU,
                            NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&     thePolylinesV,
  ...
  {
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>> aPolylinesU, aPolylinesV;
...
private:
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&     myPolylinesU;
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&     myPolylinesV;
                         ...
                         bool                  theIsParallel)
{
  ...
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>      aCommonPolylines;
  ...
  // Draw isolines
  {
    ...
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* aUPolylinesPtr = &aUPolylines;
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* aVPolylinesPtr = &aVPolylines;
  ...
  {
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>  anUnfree, aFree;
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* anUnfreePtr = &anUnfree;
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* aFreePtr    = &aFree;
  ...
  const occ::handle<Prs3d_Drawer>& theDrawer)
{
  const double aShapeDeflection =
    StdPrs_ToolTriangulatedShape::GetDeflection(theShape, theDrawer);
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>> aPolylines;
                              ...
                              NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>* theUnFree)
{
  ...
  NCollection_IndexedDataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher> anEdgeMap;
  TopExp::MapShapesAndAncestors(theShape, TopAbs_EDGE, TopAbs_FACE, anEdgeMap);
  for (NCollection_IndexedDataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>::Iterator anEdgeIter(anEdgeMap); anEdgeIter.More();
       anEdgeIter.Next())
  {
...
void StdPrs_WFShape::addEdges(const NCollection_List<TopoDS_Shape>& theEdges,
                              const occ::handle<Prs3d_Drawer>& theDrawer,
                                             ...
                                             const bool theToExcludeGeometric)
{
  ...
  for (TopExp_Explorer aFaceIter(theShape, TopAbs_FACE); aFaceIter.More(); aFaceIter.Next())
  {
    ...
    if (const occ::handle<Poly_Triangulation>& aPolyTri = BRep_Tool::Triangulation(aFace, aLocation))
    {
                                                            ...
                                                            Prs3d_VertexDrawMode theVertexMode)
{
  ...
  else
  {
    ...
    {
      for (TopoDS_Iterator aVertIter(anEdgeIter.Current(), false, true);
           aVertIter.More();
           aVertIter.Next())
      {
