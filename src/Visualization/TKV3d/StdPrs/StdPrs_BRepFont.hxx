...
public:
  ...
  Standard_EXPORT TopoDS_Shape RenderGlyph(char32_t theChar);

  //! Render one glyph with explicit contour options.
  //! @param[in] theChar Unicode character
  //! @param[in] theOptions rendering options
  //! @return generated shape, or a null shape when the glyph is unavailable
  Standard_EXPORT TopoDS_Shape RenderGlyph(char32_t theChar, const GlyphOptions& theOptions);
  ...
  Standard_EXPORT void SetSingleStrokeFont(bool theIsSingleStroke);
  ...
  Standard_EXPORT double AdvanceX(char32_t theUCharNext);

  //! Return horizontal advance between two characters, including kerning.
  //! @param[in] theUChar current Unicode character
  //! @param[in] theUCharNext next Unicode character
  Standard_EXPORT double AdvanceX(char32_t theUChar, char32_t theUCharNext);

  //! Return vertical advance to the next character.
  //! @param[in] theUCharNext next Unicode character
  Standard_EXPORT double AdvanceY(char32_t theUCharNext);

  //! Return vertical advance between two characters, including kerning.
  //! @param[in] theUChar current Unicode character
  //! @param[in] theUCharNext next Unicode character
  Standard_EXPORT double AdvanceY(char32_t theUChar, char32_t theUCharNext);
