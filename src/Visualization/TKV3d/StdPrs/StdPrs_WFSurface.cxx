                           ...
                           const occ::handle<Prs3d_Drawer>&       aDrawer)
{
  ...
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>> freeCurves;
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>> UIsoCurves;
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>> VIsoCurves;
  ...
  if (!(UClosed && VClosed))
  {
    ...
    if (!UClosed)
    {
      ...
      occ::handle<TColgp_HSequenceOfPnt> aPntsU1 = new TColgp_HSequenceOfPnt;
      ...
      occ::handle<TColgp_HSequenceOfPnt> aPntsU2 = new TColgp_HSequenceOfPnt;
    ...
    if (!VClosed)
    {
      ...
      occ::handle<TColgp_HSequenceOfPnt> aPntsV1 = new TColgp_HSequenceOfPnt;
      ...
      occ::handle<TColgp_HSequenceOfPnt> aPntsV2 = new TColgp_HSequenceOfPnt;
  ...
  if (fin != 0)
  {
    ...
    for (int i = 1; i <= fin; i++)
    {
      ...
      occ::handle<TColgp_HSequenceOfPnt> Pnts = new TColgp_HSequenceOfPnt;
  ...
  if (UIsoCurves.Size() > 0)
  {
    ...
    NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>::Iterator It;
    ...
    for (It.Init(UIsoCurves); It.More(); It.Next())
    {
      const occ::handle<TColgp_HSequenceOfPnt>& Pnts = It.Value();
