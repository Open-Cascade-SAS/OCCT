...
public:
  ...
  const occ::handle<SelectMgr_BaseIntersector>& ActiveVolume() const { return myActiveSelectingVolume; }

  // Returns active selection type (point, box, polyline)
  Standard_EXPORT virtual int GetActiveSelectionType() const override;
  ...
  Standard_EXPORT virtual SelectMgr_SelectingVolumeManager ScaleAndTransform (const int theScaleFactor,
  ...
  Standard_EXPORT virtual SelectMgr_SelectingVolumeManager CopyWithBuilder (const occ::handle<SelectMgr_FrustumBuilder>& theBuilder) const;
...
public:
  ...
  Standard_EXPORT virtual bool OverlapsBox (const SelectMgr_Vec3& theBoxMin,
  ...
  Standard_EXPORT virtual bool OverlapsPolygon (const TColgp_Array1OfPnt& theArrayOfPts,
                                                            int theSensType,
                                                            SelectBasics_PickResult& thePickResult) const override;

  //! Checks if line segment overlaps selecting frustum
  Standard_EXPORT virtual bool OverlapsSegment (const gp_Pnt& thePnt1,
  ...
  Standard_EXPORT  virtual bool OverlapsTriangle (const gp_Pnt& thePnt1,
                                                              const gp_Pnt& thePnt2,
  ...
  Standard_EXPORT virtual bool IsOverlapAllowed() const override;

  //! Return view clipping planes.
  const occ::handle<Graphic3d_SequenceOfHClipPlane>& ViewClipping() const { return myViewClipPlanes; }

  //! Return object clipping planes.
  const occ::handle<Graphic3d_SequenceOfHClipPlane>& ObjectClipping() const { return myObjectClipPlanes; }
  ...
  Standard_EXPORT void SetViewClipping (const occ::handle<Graphic3d_SequenceOfHClipPlane>& theViewPlanes,
  ...
  Standard_EXPORT virtual bool IsScalableActiveVolume() const override;
  ...
  Standard_EXPORT virtual void GetPlanes (NCollection_Vector<SelectMgr_Vec4>& thePlaneEquations) const override;

  //! Dumps the content of me into the stream
  Standard_EXPORT virtual void DumpJson (Standard_OStream& theOStream, int theDepth = -1) const override;
