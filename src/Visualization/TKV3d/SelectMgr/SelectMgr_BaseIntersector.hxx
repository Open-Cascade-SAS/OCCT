...
public:
  ...
  virtual occ::handle<SelectMgr_BaseIntersector> ScaleAndTransform (const int theScaleFactor,
...
public:
  ...
  virtual bool OverlapsBox (const SelectMgr_Vec3& theBoxMin,
  ...
  virtual bool OverlapsPolygon (const TColgp_Array1OfPnt& theArrayOfPnts,
