...
// purpose  :
// =======================================================================
bool SelectMgr_AxisIntersector::hasIntersection (const SelectMgr_Vec3& theBoxMin,
                                                             ...
                                                             double& theTimeLeave) const
{
  ...
  BVH_Ray<double, 3> aRay(SelectMgr_Vec3(anAxisLoc.X(), anAxisLoc.Y(), anAxisLoc.Z()),
                                 SelectMgr_Vec3(anAxisDir.X(), anAxisDir.Y(), anAxisDir.Z()));
  if (!BVH_Tools<double, 3>::RayBoxIntersection (aRay, theBoxMin, theBoxMax, theTimeEnter, theTimeLeave))
  {
    return false;
  }
  return true;
...
// purpose  :
// =======================================================================
bool SelectMgr_AxisIntersector::OverlapsBox (const SelectMgr_Vec3& theBoxMin,
                                                         const SelectMgr_Vec3& theBoxMax,
...
// purpose  :
// =======================================================================
bool SelectMgr_AxisIntersector::OverlapsPolygon (const TColgp_Array1OfPnt& theArrayOfPnts,
