...
static occ::handle<TColgp_HSequenceOfPnt> shrunkTriangle(const gp_Pnt* thePnts, const gp_XYZ& theCenter)
{
...
static void addTriangulation(NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&                    theSeqLines,
                             NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&                    theSeqFree,
...
static void addBoundingBox(NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&          theSeqLines,
...
static void addCircle(NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>& theSeqLines,
...
static void addCylinder(NCollection_List<occ::handle<TColgp_HSequenceOfPnt>>&               theSeqLines,
                                    ...
                                    const occ::handle<Graphic3d_TransformPers>& theTrsfPers)
{
  ...
  NCollection_List<occ::handle<TColgp_HSequenceOfPnt>> aSeqLines, aSeqFree;
