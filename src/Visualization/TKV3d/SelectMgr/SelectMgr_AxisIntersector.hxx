...
public:
  ...
  Standard_EXPORT virtual occ::handle<SelectMgr_BaseIntersector> ScaleAndTransform (const int theScaleFactor,
...
protected:
  ...
  Standard_EXPORT bool hasIntersection (const SelectMgr_Vec3& theBoxMin,
                                                    const SelectMgr_Vec3& theBoxMax,
                                                    double& theTimeEnter,
  ...
  Standard_EXPORT bool hasIntersection (const gp_Pnt& thePnt,
