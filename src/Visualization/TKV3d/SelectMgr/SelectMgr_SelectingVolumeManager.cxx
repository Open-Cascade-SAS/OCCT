...
//=======================================================================
SelectMgr_SelectingVolumeManager SelectMgr_SelectingVolumeManager::ScaleAndTransform (const int theScaleFactor,
...
//=======================================================================
SelectMgr_SelectingVolumeManager SelectMgr_SelectingVolumeManager::CopyWithBuilder (const occ::handle<SelectMgr_FrustumBuilder>& theBuilder) const
{
  SelectMgr_SelectingVolumeManager aMgr;
  aMgr.myToAllowOverlap = myToAllowOverlap;
  aMgr.myViewClipPlanes = myViewClipPlanes;
...
{
  occ::handle<SelectMgr_RectangularFrustum> aPntVolume = occ::down_cast<SelectMgr_RectangularFrustum>(myActiveSelectingVolume);
...
{
  occ::handle<SelectMgr_RectangularFrustum> aBoxVolume = occ::down_cast<SelectMgr_RectangularFrustum>(myActiveSelectingVolume);
...
{
  occ::handle<SelectMgr_TriangularFrustumSet> aPolylineVolume = occ::down_cast<SelectMgr_TriangularFrustumSet>(myActiveSelectingVolume);
...
{
  occ::handle<SelectMgr_AxisIntersector> anAxisVolume = occ::down_cast<SelectMgr_AxisIntersector>(myActiveSelectingVolume);
...
//=======================================================================
bool SelectMgr_SelectingVolumeManager::OverlapsBox (const SelectMgr_Vec3& theBoxMin,
...
//=======================================================================
bool SelectMgr_SelectingVolumeManager::OverlapsPolygon (const TColgp_Array1OfPnt& theArrayOfPnts,
                                                                    int theSensType,
                                                                    SelectBasics_PickResult& thePickResult) const
{
  if (myActiveSelectingVolume.IsNull())
...
//=======================================================================
bool SelectMgr_SelectingVolumeManager::OverlapsTriangle (const gp_Pnt& thePt1,
                                                                     const gp_Pnt& thePt2,
                                                                     const gp_Pnt& thePt3,
                                                                     int theSensType,
                                                                     SelectBasics_PickResult& thePickResult) const
