                                                           ...
                                                           SelectBasics_PickResult& thePickResult) const
{
  ...
  const double aSegPntShift = Min(aFigureVecMod, Max(0.0, aCosOfAngle * aPickedVecMod));
...
void SelectMgr_RectangularFrustum::cacheVertexProjections (SelectMgr_RectangularFrustum* theFrustum) const
{
  if (theFrustum->Camera()->IsOrthographic())
  {
    ...
    int aVertIdxs[6] = { LeftTopNear, LeftBottomNear,       // opposite planes in height direction
    ...
    {
      double aProj1 = theFrustum->myPlanes[aPlaneIdx].XYZ().Dot (theFrustum->myVertices[aVertIdxs[aPlaneIdx]].XYZ());
      double aProj2 = theFrustum->myPlanes[aPlaneIdx].XYZ().Dot (theFrustum->myVertices[aVertIdxs[aPlaneIdx + 1]].XYZ());
...
// =======================================================================
occ::handle<SelectMgr_BaseIntersector> SelectMgr_RectangularFrustum::ScaleAndTransform (const int theScaleFactor,
...
// =======================================================================
occ::handle<SelectMgr_BaseIntersector> SelectMgr_RectangularFrustum::CopyWithBuilder (const occ::handle<SelectMgr_FrustumBuilder>& theBuilder) const
{
  Standard_ASSERT_RAISE (mySelectionType == SelectMgr_SelectionType_Point || mySelectionType == SelectMgr_SelectionType_Box,
...
// =======================================================================
bool SelectMgr_RectangularFrustum::OverlapsBox (const SelectMgr_Vec3& theBoxMin,
                                                            ...
                                                            SelectBasics_PickResult& thePickResult) const
{
  ...
  double aDepth = 0.0;
  BVH_Ray<double, 3> aRay(SelectMgr_Vec3(myNearPickedPnt.X(), myNearPickedPnt.Y(), myNearPickedPnt.Z()),
...
// =======================================================================
bool SelectMgr_RectangularFrustum::OverlapsPolygon (const TColgp_Array1OfPnt& theArrayOfPnts,
...
// purpose  :
//=======================================================================
bool SelectMgr_RectangularFrustum::isIntersectCircle (const double theRadius,
                                                                  ...
                                                                  const TColgp_Array1OfPnt& theVertices) const
{
  ...
  for (int anIdx = theVertices.Lower(); anIdx <= theVertices.Upper(); anIdx++)
  {
    ...
    if (aDiscr >= 0.0)
    {
      const double aT1 = (-aK + Sqrt (aDiscr)) / anA;
      const double aT2 = (-aK - Sqrt (aDiscr)) / anA;
