...
public:
  ...
  {
    occ::handle<TColgp_HArray1OfPnt2d> Points;
  };
...
public:
  ...
  Standard_EXPORT virtual occ::handle<SelectMgr_BaseIntersector> ScaleAndTransform (const int theScale,
  ...
  Standard_EXPORT virtual occ::handle<SelectMgr_BaseIntersector> CopyWithBuilder (const occ::handle<SelectMgr_FrustumBuilder>& theBuilder) const override;

public:

  Standard_EXPORT virtual bool OverlapsBox (const SelectMgr_Vec3& theMinPnt,
  ...
  Standard_EXPORT virtual bool OverlapsPolygon (const TColgp_Array1OfPnt& theArrayOfPnts,
...
private:
  ...
  Standard_EXPORT static bool segmentTriangleIntersection (const gp_Pnt &theOrig, const gp_Vec& theDir,
