...
public:
  ...
  Standard_EXPORT const occ::handle<SelectMgr_SensitiveEntity>& GetSensitiveById (const int theIndex) const;
...
private:
  ...
  int                 myNbEntityWithFlipping;    //!< number of sensitive entities that have own flipping options
};
