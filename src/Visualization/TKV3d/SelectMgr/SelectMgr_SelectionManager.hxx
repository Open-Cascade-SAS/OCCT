...
public:
  ...
  Standard_EXPORT SelectMgr_SelectionManager(const occ::handle<SelectMgr_ViewerSelector>& theSelector);
  ...
  Standard_EXPORT void ClearSelectionStructures(const occ::handle<SelectMgr_SelectableObject>& theObj,
                                                const int theMode = -1);
  ...
  Standard_EXPORT void RestoreSelectionStructures(const occ::handle<SelectMgr_SelectableObject>& theObj,
                                                  const int theMode = -1);
  ...
  Standard_EXPORT void SetSelectionSensitivity(const occ::handle<SelectMgr_SelectableObject>& theObject,
                                               const int                    theMode,
...
protected:
  ...
  Standard_EXPORT void recomputeSelectionMode(const occ::handle<SelectMgr_SelectableObject>& theObject,
