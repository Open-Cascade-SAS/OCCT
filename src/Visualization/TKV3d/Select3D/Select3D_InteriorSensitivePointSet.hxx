...
public:
  ...
  //! whole point set
  Standard_EXPORT virtual void GetPoints(occ::handle<TColgp_HArray1OfPnt>& theHArrayOfPnt);
...
protected:
  NCollection_Vector<occ::handle<Select3D_SensitivePoly>>           myPlanarPolygons; //!< Vector of planar polygons
  occ::handle<TColStd_HArray1OfInteger> myPolygonsIdxs;   //!< Indexes array for BVH calculation
