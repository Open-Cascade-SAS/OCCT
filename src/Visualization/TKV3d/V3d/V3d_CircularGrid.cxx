...
public:
  //! Main constructor.
  CircularGridStructure (const occ::handle<Graphic3d_StructureManager>& theManager, V3d_CircularGrid* theGrid)
...
void V3d_CircularGrid::DefineLines ()
{
  ...
  const int Division = (int )( (aDivision >= DIVISION ? aDivision : DIVISION));
  ...
  if (aSeqTenth.Length())
  {
    ...
    occ::handle<Graphic3d_ArrayOfPolylines> aPrims2 = new Graphic3d_ArrayOfPolylines(aSeqTenth.Length(),nbl);
  ...
  if (aSeqLines.Length())
  {
    ...
    occ::handle<Graphic3d_ArrayOfPolylines> aPrims3 = new Graphic3d_ArrayOfPolylines(aSeqLines.Length(),nbl);
    for (np = 1, n=0; n<nbl; n++) {
