...
public:
  ...
  Standard_EXPORT V3d_View (const occ::handle<V3d_Viewer>& theViewer, const V3d_TypeOfView theType = V3d_ORTHOGRAPHIC);

  //! Initializes the view by copying.
  Standard_EXPORT V3d_View (const occ::handle<V3d_Viewer>& theViewer, const occ::handle<V3d_View>& theView);
  ...
  Standard_EXPORT void SetWindow (const occ::handle<V3d_View>& theParentView,
...
public:
  ...
  Standard_EXPORT void SetImageBasedLighting (bool theToEnableIBL,
                                              bool theToUpdate = false);

  //! Activates IBL from background cubemap.
  void GeneratePBREnvironment (bool theToUpdate = false) { SetImageBasedLighting (true, theToUpdate); }
  ...
  Standard_EXPORT void SetAxis (const double X, const double Y, const double Z,
...
public:
  ...
  //! aligned or confused.
  Standard_EXPORT void Rotate (const double Ax, const double Ay, const double Az, const bool Start = true);
  ...
  //! If the eye, the view point, or the high point are
  //! aligned or confused.
  Standard_EXPORT void Rotate (const double Ax, const double Ay, const double Az,
  ...
  Standard_EXPORT void Move (const double Dx, const double Dy, const double Dz, const bool Start = true);
  ...
  //! Start = true
  Standard_EXPORT void Translate (const double Dx, const double Dy, const double Dz, const bool Start = true);

  //! Movement of the eye and the view point parallel to one
  //! of the axes of the fame of reference of the view a
  //! distance relative to the initial position
  //! expressed by Start = true
  Standard_EXPORT void Translate (const V3d_TypeOfAxe Axe, const double Length, const bool Start = true);
  ...
  //! Start = true
  Standard_EXPORT void Turn (const double Ax, const double Ay, const double Az, const bool Start = true);
  ...
  Standard_EXPORT void Panning (const double theDXv, const double theDYv, const double theZoomFactor = 1, const bool theToStart = true);
  ...
  //! @param theMargin [in] the margin coefficient for view borders.
  //! @param theToUpdate [in] flag to perform view update.
  Standard_EXPORT void FitAll (const Bnd_Box& theBox, const double theMargin = 0.01, const bool theToUpdate = true);
  ...
  Standard_EXPORT void FitAll (const double theMinXv, const double theMinYv, const double theMaxXv, const double theMaxYv);
  ...
  Standard_EXPORT void WindowFit (const int theMinXp, const int theMinYp, const int theMaxXp, const int theMaxYp);
  ...
  Standard_EXPORT void Convert (const int Xp, const int Yp,
                                double& Xv, double& Yv) const;
  ...
  Standard_EXPORT void Convert (const double Xv, const double Yv,
                                int& Xp, int& Yp) const;
  ...
  Standard_EXPORT void ConvertWithProj (const int Xp, const int Yp,
  ...
  Standard_EXPORT void ConvertToGrid (const int Xp, const int Yp,
                                      double& Xg, double& Yg, double& Zg) const;

  //! Converts the point into the nearest grid point
  //! and display the grid marker.
  Standard_EXPORT void ConvertToGrid (const double X, const double Y, const double Z,
                                      double& Xg, double& Yg, double& Zg) const;

  //! Projects the point defined in the reference frame of
  //! the view into the projected point in the associated window.
  Standard_EXPORT void Convert (const double X, const double Y, const double Z,
                                int& Xp, int& Yp) const;
  ...
  Standard_EXPORT void BackgroundColor (const Quantity_TypeOfColor Type, double& V1, double& V2, double& V3) const;
  ...
  Standard_EXPORT void ProjReferenceAxe (const int Xpix, const int Ypix,
  ...
  //! Performs update of view.
  Standard_EXPORT void Pan (const int theDXp, const int theDYp, const double theZoomFactor = 1, const bool theToStart = true);
  ...
  Standard_EXPORT void ZoomAtPoint (const int theMouseStartX, const int theMouseStartY, const int theMouseEndX, const int theMouseEndY);
  ...
  //! outside this area.
  Standard_EXPORT void StartRotation (const int X, const int Y, const double zRotationThreshold = 0.0);
  ...
  Standard_EXPORT bool Dump (const char* const theFile, const Graphic3d_BufferType& theBufferType = Graphic3d_BT_RGB);
  ...
  bool IsCullingEnabled() const { return RenderingParams().FrustumCullingState == Graphic3d_RenderingParams::FrustumCulling_On; }

  //! Turn on/off automatic culling of objects outside frustum (ON by default)
  void SetFrustumCulling (bool theMode) { ChangeRenderingParams().FrustumCullingState = theMode ? Graphic3d_RenderingParams::FrustumCulling_On : Graphic3d_RenderingParams::FrustumCulling_Off; }
...
public: //! @name subvew management
  ...
  Standard_EXPORT occ::handle<V3d_View> PickSubview (const Graphic3d_Vec2i& thePnt) const;
...
protected:
  ...
  Standard_EXPORT void Scale (const occ::handle<Graphic3d_Camera>& theCamera, const double theSizeXv, const double theSizeYv) const;

  Standard_EXPORT void Translate (const occ::handle<Graphic3d_Camera>& theCamera, const double theDXv, const double theDYv) const;
...
private:
  ...
  Standard_EXPORT static bool screenAxis (const gp_Dir& theVpn, const gp_Dir& theVup,
  ...
  Standard_EXPORT int MinMax (double& Xmin, double& Ymin, double& Zmin, double& Xmax, double& Ymax, double& Zmax) const;
