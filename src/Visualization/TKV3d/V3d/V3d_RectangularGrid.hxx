...
public:
  ...
  Standard_EXPORT virtual void SetColors (const Quantity_Color& aColor, const Quantity_Color& aTenthColor) override;
  ...
  Standard_EXPORT void SetGraphicValues (const double XSize, const double YSize, const double OffSet);
