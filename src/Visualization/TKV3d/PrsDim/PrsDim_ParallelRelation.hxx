...
private:
  ...
  Standard_EXPORT void ComputeTwoFacesParallel(const occ::handle<Prs3d_Presentation>& aPresentation);

  Standard_EXPORT void ComputeTwoEdgesParallel(const occ::handle<Prs3d_Presentation>& aPresentation);
