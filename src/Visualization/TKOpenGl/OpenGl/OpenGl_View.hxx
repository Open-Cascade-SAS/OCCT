...
public:
  ...
  Standard_EXPORT virtual const NCollection_List<occ::handle<Graphic3d_Layer>>& Layers() const override;

  //! Returns layer with given ID or NULL if undefined.
  Standard_EXPORT virtual occ::handle<Graphic3d_Layer> Layer (const Graphic3d_ZLayerId theLayerId) const override;
...
public:
  ...
  Standard_EXPORT virtual void SetGradientBackground (const Aspect_GradientBackground& theBackground) override;
  ...
  Standard_EXPORT virtual void SetBackgroundImage (const occ::handle<Graphic3d_TextureMap>& theTextureMap,
                                                   bool theToUpdatePBREnv = true) override;

  //! Sets environment texture for the view.
  Standard_EXPORT virtual void SetTextureEnv (const occ::handle<Graphic3d_TextureEnv>& theTextureEnv) override;

  //! Returns background image fill style.
  Standard_EXPORT virtual Aspect_FillMethod BackgroundImageStyle() const override;

  //! Sets background image fill style.
  Standard_EXPORT virtual void SetBackgroundImageStyle (const Aspect_FillMethod theFillStyle) override;
  ...
  virtual const occ::handle<Graphic3d_SequenceOfHClipPlane>& ClipPlanes() const override { return myClipPlanes; }

  //! Sets list of clip planes for the view.
  virtual void SetClipPlanes (const occ::handle<Graphic3d_SequenceOfHClipPlane>& thePlanes) override { myClipPlanes = thePlanes; }
  ...
  Standard_EXPORT virtual void StatisticInformation (TColStd_IndexedDataMapOfStringString& theDict) const override;
...
public: //! @name obsolete Graduated Trihedron functionality
  ...
  Standard_EXPORT virtual void GraduatedTrihedronDisplay (const Graphic3d_GraduatedTrihedron& theTrihedronData) override;

  //! Erases Graduated Trihedron.
  Standard_EXPORT virtual void GraduatedTrihedronErase() override;

  //! Displays Grid.
  Standard_EXPORT virtual void GridDisplay (const Aspect_GridParams& theGridParams) override;

  //! Erases Grid.
  Standard_EXPORT virtual void GridErase() override;

  //! Sets minimum and maximum points of scene bounding box for Graduated Trihedron stored in graphic view object.
  //! @param theMin [in] the minimum point of scene.
  //! @param theMax [in] the maximum point of scene.
  Standard_EXPORT virtual void GraduatedTrihedronMinMaxValues (const Graphic3d_Vec3 theMin, const Graphic3d_Vec3 theMax) override;
...
private:
  ...
  Standard_EXPORT virtual void displayStructure (const occ::handle<Graphic3d_CStructure>& theStructure,
                                                 const Graphic3d_DisplayPriority thePriority) override;

  //! Erases the structure from display lists of the view.
  Standard_EXPORT virtual void eraseStructure (const occ::handle<Graphic3d_CStructure>& theStructure) override;
  ...
  Standard_EXPORT virtual void changePriority (const occ::handle<Graphic3d_CStructure>& theCStructure,
...
protected: //! @name data types related to ray-tracing
  ...
  public:
    ...
    bool LoadFromFiles (const TCollection_AsciiString* theFileNames, const TCollection_AsciiString& thePrefix = EMPTY_PREFIX);

    //! Loads shader source from specified strings.
    bool LoadFromStrings (const TCollection_AsciiString* theStrings, const TCollection_AsciiString& thePrefix = EMPTY_PREFIX);
  ...
  static const int THE_DEFAULT_NB_BOUNCES = 3;

  //! Default size of traversal stack.
  static const int THE_DEFAULT_STACK_SIZE = 10;
  ...
  struct StructState
  {
    ...
    StructState (const size_t theStructureState = 0,
                 const size_t theInstancedState = 0)
...
protected: //! @name methods related to ray-tracing
  ...
  bool updateRaytraceLightSources (const OpenGl_Mat4& theInvModelView, const occ::handle<OpenGl_Context>& theGlContext);
  ...
  occ::handle<OpenGl_TriangleSet> addRaytracePrimitiveArray (const OpenGl_PrimitiveArray* theArray,
                                                        const int       theMatID,
  ...
  occ::handle<OpenGl_ShaderProgram> initProgram (const occ::handle<OpenGl_Context>&      theGlContext,
  ...
  void bindRaytraceTextures (const occ::handle<OpenGl_Context>& theGlContext,
                             int theStereoView);
