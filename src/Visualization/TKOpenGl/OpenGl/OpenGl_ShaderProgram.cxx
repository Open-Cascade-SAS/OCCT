                                                   ...
                                                   const Graphic3d_ShaderObjectList& theShaders)
{
  ...
  const int aNbUnitsMax = Max (theCtx->MaxCombinedTextureUnits(), Graphic3d_TextureUnit_NB);
...
// =======================================================================
OpenGl_ShaderUniformLocation OpenGl_ShaderProgram::GetUniformLocation (const occ::handle<OpenGl_Context>& theCtx,
