      ...
      myTopo(theTopo)
{
  ...
  for (int aPlaneIdx = aPlaneLowIdx; aPlaneIdx <= aPlaneUpIdx; ++aPlaneIdx)
  {
    ...
    occ::handle<TColgp_HArray1OfPnt> aVertArray = new TColgp_HArray1OfPnt(0, aVertNb - 1);
                                                     ...
                                                     SelectBasics_PickResult& thePickResult)
{
  ...
  for (NCollection_List<occ::handle<TColgp_HArray1OfPnt>>::Iterator aIter(myTopology); aIter.More(); aIter.Next())
  {
