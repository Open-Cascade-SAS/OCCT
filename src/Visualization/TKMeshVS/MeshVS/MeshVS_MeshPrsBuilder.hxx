...
public:
  ...
  Standard_EXPORT static void AddVolumePrs(const occ::handle<MeshVS_HArray1OfSequenceOfInteger>& Topo,
  ...
  Standard_EXPORT static void HowManyPrimitives(
    const occ::handle<MeshVS_HArray1OfSequenceOfInteger>& Topo,
