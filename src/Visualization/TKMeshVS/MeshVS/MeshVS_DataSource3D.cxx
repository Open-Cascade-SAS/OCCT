...
occ::handle<MeshVS_HArray1OfSequenceOfInteger> MeshVS_DataSource3D::GetPrismTopology(
  const int BasePoints) const
{
  ...
  {
    occ::handle<MeshVS_HArray1OfSequenceOfInteger> result = CreatePrismTopology(BasePoints);
    if (!result.IsNull())
...
occ::handle<MeshVS_HArray1OfSequenceOfInteger> MeshVS_DataSource3D::GetPyramidTopology(
  const int BasePoints) const
{
  ...
  {
    occ::handle<MeshVS_HArray1OfSequenceOfInteger> result = CreatePyramidTopology(BasePoints);
    if (!result.IsNull())
...
occ::handle<MeshVS_HArray1OfSequenceOfInteger> MeshVS_DataSource3D::CreatePrismTopology(
  const int BasePoints)
{
  occ::handle<MeshVS_HArray1OfSequenceOfInteger> result;
...
occ::handle<MeshVS_HArray1OfSequenceOfInteger> MeshVS_DataSource3D::CreatePyramidTopology(
  const int BasePoints)
{
  occ::handle<MeshVS_HArray1OfSequenceOfInteger> result;
