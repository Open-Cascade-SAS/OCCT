...
public:
  ...
  operator double&()
  {
    return *(myDynData ? static_cast<double*>(myDynData) : reinterpret_cast<double*>(myAutoData));
  }

  //! Interpret the buffer as a reference to int
  operator int&()
  {
    return *(myDynData ? static_cast<int*>(myDynData) : reinterpret_cast<int*>(myAutoData));
  }

  //! Interpret the buffer as a reference to gp_Pnt
  operator gp_Pnt&()
  {
    return *(myDynData ? static_cast<gp_Pnt*>(myDynData) : reinterpret_cast<gp_Pnt*>(myAutoData));
  }
