...
void Aspect_RectangularGrid::Compute(const double X,
    ...
    int n1 = int ( Abs(D1)/myXStep + 0.5);
    int n2 = int ( Abs(D2)/myYStep + 0.5);
    double offset1 = c1 + double(n1) * Sign (myXStep , D1);
    double offset2 = c2 + double(n2) * Sign (myYStep , D2);
