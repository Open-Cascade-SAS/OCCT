...
Bnd_Box Graphic3d_Structure::MinMaxValues (const bool theToIgnoreInfiniteFlag) const
{
  ...
  double aLimMin = ShortRealFirst() + 1.0;
  double aLimMax = ShortRealLast()  - 1.0;
                                  ...
                                  const bool theToIgnoreInfiniteFlag) const
{
  ...
  if (aBoxF.IsValid())
  {
    theBox = Graphic3d_BndBox3d (Graphic3d_Vec3d ((double )aBoxF.CornerMin().x(),
                                                  (double )aBoxF.CornerMin().y(),
                                                  (double )aBoxF.CornerMin().z()),
                                 Graphic3d_Vec3d ((double )aBoxF.CornerMax().x(),
...
void Graphic3d_Structure::Transforms (const gp_Trsf& theTrsf,
                                      ...
                                      double&      theNewX, double&      theNewY, double&      theNewZ)
{
  const double aRL = RealLast();
  const double aRF = RealFirst();
  theNewX = theX;
  theNewY = theY;
  theNewZ = theZ;
