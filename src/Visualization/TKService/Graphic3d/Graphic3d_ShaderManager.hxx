...
public:
  ...
  bool IsGapiGreaterEqual (int theVerMajor,
  ...
  //! Return GAPI version major number.
  void SetGapiVersion (int theVerMajor,
                       int theVerMinor)
  {
...
protected:
  ...
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramUnlit (int theBits,
                                                                      bool theIsOutline = false) const;

  //! Prepare standard GLSL program with per-vertex lighting.
  //! @param theLights [in] list of light sources
  //! @param theBits   [in] program bits
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramGouraud (const occ::handle<Graphic3d_LightSet>& theLights,
                                                                        int theBits) const;
  ...
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramPhong (const occ::handle<Graphic3d_LightSet>& theLights,
                                                                      const int theBits,
  ...
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramFboBlit (int theNbSamples,
                                                                        bool theIsFallback_sRGB) const;

  //! Prepare standard GLSL program for stereoscopic image.
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramStereo (Graphic3d_StereoMode theStereoMode) const;

  //! Prepare standard GLSL programs for OIT compositing operation.
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramOitCompositing (bool theMsaa) const;

  //! Prepare standard GLSL programs for OIT Depth Peeling blend operation.
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramOitDepthPeelingBlend (bool theMsaa) const;

  //! Prepare standard GLSL programs for OIT Depth Peeling flush operation.
  Standard_EXPORT occ::handle<Graphic3d_ShaderProgram> getStdProgramOitDepthPeelingFlush (bool theMsaa) const;
...
protected:
  ...
  Standard_EXPORT TCollection_AsciiString stdComputeLighting (int& theNbLights,
