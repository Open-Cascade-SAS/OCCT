...
// purpose  :
// =======================================================================
occ::handle<Graphic3d_ShaderProgram> Graphic3d_ShaderManager::getStdProgramOitCompositing (const bool theMsaa) const
{
  occ::handle<Graphic3d_ShaderProgram> aProgramSrc = new Graphic3d_ShaderProgram();
                                                                             ...
                                                                             const int theNbShadowMaps) const
{
  ...
  else
  {
    if ((theBits & Graphic3d_ShaderFlags_TextureRGB) != 0)
    {
      ...
      int aTextureBits = Graphic3d_TextureSetBits_BaseColor | Graphic3d_TextureSetBits_Occlusion | Graphic3d_TextureSetBits_Emissive;
      if (theIsPBR)
      {
