...
public:
  ...
  static occ::handle<Graphic3d_ArrayOfPrimitives> CreateArray (Graphic3d_TypeOfPrimitiveArray theType,
                                                          int theMaxVertexs,
                                                          int theMaxEdges,
  ...
  //! Create an array of specified type.
  static Standard_EXPORT occ::handle<Graphic3d_ArrayOfPrimitives> CreateArray (Graphic3d_TypeOfPrimitiveArray theType,
                                                                          int theMaxVertexs,
                                                                          int theMaxBounds,
                                                                          int theMaxEdges,
                                                                          Graphic3d_ArrayFlags theArrayFlags);
public:
  ...
  int AddVertex (const gp_Pnt& theVertex) { return AddVertex (theVertex.X(), theVertex.Y(), theVertex.Z()); }

  //! Adds a vertice in the array.
  //! @return the actual vertex number
  int AddVertex (const Graphic3d_Vec3& theVertex) { return AddVertex (theVertex.x(), theVertex.y(), theVertex.z()); }
  ...
  //! @return the actual vertex number
  int AddVertex (const double theX,  const double theY,  const double theZ,
                              const double theNX, const double theNY, const double theNZ)
  {
    return AddVertex (RealToShortReal (theX),  RealToShortReal (theY),  RealToShortReal (theZ),
  ...
  //! @return the actual vertex number
  int AddVertex (const float theX,  const float theY,  const float theZ,
                              const float theNX, const float theNY, const float theNZ)
  {
    const int anIndex = myAttribs->NbElements + 1;
    SetVertice      (anIndex, theX,  theY,  theZ);
  ...
  //! @return the actual vertex number
  int AddVertex (const double theX, const double theY, const double theZ,
                              const double theTX, const double theTY)
  {
    return AddVertex (RealToShortReal (theX),  RealToShortReal (theY),  RealToShortReal (theZ),
                      float (theTX), float (theTY));
  }
  ...
  //! @return the actual vertex number
  int AddVertex (const float theX, const float theY, const float theZ,
                              const float theTX, const float theTY)
  {
    const int anIndex = myAttribs->NbElements + 1;
    SetVertice     (anIndex, theX, theY, theZ);
  ...
  void SetVertice (const int theIndex, const float theX, const float theY, const float theZ)
  {
    ...
    Graphic3d_Vec3& aVec = *reinterpret_cast<Graphic3d_Vec3*> (myAttribs->ChangeData() + myPosStride * ((size_t)theIndex - 1));
    aVec.x() = theX;
    aVec.y() = theY;
    aVec.z() = theZ;
  ...
  void SetVertexColor (const int theIndex, const double theR, const double theG, const double theB)
  {
    ...
    if (myColData != NULL)
    {
      Graphic3d_Vec4ub* aColorPtr = reinterpret_cast<Graphic3d_Vec4ub* >(myColData + myColStride * ((size_t)theIndex - 1));
      aColorPtr->SetValues (static_cast<uint8_t>(theR * 255.0),
                            static_cast<uint8_t>(theG * 255.0),
                            static_cast<uint8_t>(theB * 255.0), 255);
    }
  ...
  void SetVertexColor (const int  theIndex,
                       const Graphic3d_Vec4ub& theColor)
  {
    Standard_OutOfRange_Raise_if (theIndex < 1 || theIndex > myAttribs->NbMaxElements(), "BAD VERTEX index");
    if (myColData != NULL)
  ...
  //! @param[in] theG green color value within [0, 1] range
  //! @param[in] theB blue  color value within [0, 1] range
  void SetVertexColorBack (const int theIndex, const double theR, const double theG, const double theB)
  {
    Standard_OutOfRange_Raise_if(theIndex < 1 || theIndex > myAttribs->NbMaxElements(), "BAD VERTEX index");
    if (myColDataBack != NULL)
    {
      Graphic3d_Vec4ub* aColorPtr = reinterpret_cast<Graphic3d_Vec4ub* >(myColDataBack + myColStrideBack * ((size_t)theIndex - 1));
      aColorPtr->SetValues (static_cast<uint8_t>(theR * 255.0),
                            static_cast<uint8_t>(theG * 255.0),
                            static_cast<uint8_t>(theB * 255.0), 255);
    }
  ...
  void SetVertexColorBack (const int theIndex, const int theColor32)
  {
    ...
    if (myColDataBack != NULL)
    {
      *reinterpret_cast<int* >(myColDataBack + myColStrideBack * ((size_t)theIndex - 1)) = theColor32;
    }
  }
  ...
  void SetVertexNormal (const int theIndex, const double theNX, const double theNY, const double theNZ)
  {
    ...
    if (myNormData != NULL)
    {
      Graphic3d_Vec3& aVec = *reinterpret_cast<Graphic3d_Vec3* >(myNormData + myNormStride * ((size_t)theIndex - 1));
      aVec.x() = float (theNX);
      aVec.y() = float (theNY);
      aVec.z() = float (theNZ);
    }
  ...
  void SetVertexTexel (const int theIndex, const double theTX, const double theTY)
  {
    ...
    if (myTexData != NULL)
    {
      Graphic3d_Vec2& aVec = *reinterpret_cast<Graphic3d_Vec2* >(myTexData + myTexStride * ((size_t)theIndex - 1));
      aVec.x() = float (theTX);
      aVec.y() = float (theTY);
    }
    myAttribs->NbElements = Max (theIndex, myAttribs->NbElements);
  ...
  void Vertice (const int theRank, double& theX, double& theY, double& theZ) const
  {
    ...
    const Graphic3d_Vec3& aVec = *reinterpret_cast<const Graphic3d_Vec3*> (myAttribs->Data() + myPosStride * ((size_t)theRank - 1));
    theX = double(aVec.x());
    theY = double(aVec.y());
    theZ = double(aVec.z());
  }
  ...
  void VertexColor (const int theIndex,
                    Graphic3d_Vec4ub&      theColor) const
  {
    ...
    theColor = *reinterpret_cast<const Graphic3d_Vec4ub* >(myColData + myColStride * ((size_t)theIndex - 1));
  }
  ...
  void VertexColor (const int theRank, double& theR, double& theG, double& theB) const
  {
    ...
    const Graphic3d_Vec4ub& aColor = *reinterpret_cast<const Graphic3d_Vec4ub* >(myColData + myColStride * ((size_t)theRank - 1));
  ...
  void VertexNormal (const int theRank, double& theNX, double& theNY, double& theNZ) const
  {
    ...
    if (myNormData != NULL)
    {
      const Graphic3d_Vec3& aVec = *reinterpret_cast<const Graphic3d_Vec3* >(myNormData + myNormStride * ((size_t)theRank - 1));
      theNX = double(aVec.x());
      theNY = double(aVec.y());
      theNZ = double(aVec.z());
    }
  ...
  void VertexTexel (const int theRank, double& theTX, double& theTY) const
  {
    ...
    if (myTexData != NULL)
    {
      const Graphic3d_Vec2& aVec = *reinterpret_cast<const Graphic3d_Vec2* >(myTexData + myTexStride * ((size_t)theRank - 1));
      theTX = double(aVec.x());
      theTY = double(aVec.y());
    }
  }
...
public: //! @name optional array of Indices/Edges for using shared Vertex data
  ...
  //! @return the actual edges number
  int AddEdges (int theVertexIndex1,
                             int theVertexIndex2)
  {
  ...
  //! @return the actual edges number
  int AddSegmentEdges (int theVertexIndex1,
                                    int theVertexIndex2)
  {
  ...
  //! @return the actual edges number
  int AddTriangleEdges (int theVertexIndex1,
                                     int theVertexIndex2,
                                     int theVertexIndex3)
  {
  ...
  //! Raises exception if array is not of type Graphic3d_TOPA_TRIANGLES.
  //! @return the actual edges number
  int AddTriangleEdges (const Graphic3d_Vec3i& theIndexes)
  {
    Standard_TypeMismatch_Raise_if (myType != Graphic3d_TOPA_TRIANGLES, "Not array of triangles");
  ...
  //! Raises exception if array is not of type Graphic3d_TOPA_TRIANGLES.
  //! @return the actual edges number
  int AddTriangleEdges (const Graphic3d_Vec4i& theIndexes)
  {
    Standard_TypeMismatch_Raise_if (myType != Graphic3d_TOPA_TRIANGLES, "Not array of triangles");
    return AddEdges (theIndexes[0], theIndexes[1], theIndexes[2]);
  }
  ...
  //! Raises exception if array is not of type Graphic3d_TOPA_TRIANGLES.
  //! @return the actual edges number
  int AddQuadTriangleEdges (const Graphic3d_Vec4i& theIndexes)
  {
  ...
  Standard_EXPORT void AddTriangleStripEdges (int theVertexLower,
                                              int theVertexUpper);
  ...
  Standard_EXPORT void AddTriangleFanEdges (int theVertexLower,
                                            int theVertexUpper,
                                            bool theToClose);
  ...
  //! @param theVertexUpper [in] index of last  node defining triangle fun
  //! @param theToClose [in] close triangle fan (connect first and last points)
  Standard_EXPORT void AddPolylineEdges (int theVertexLower,
                                         int theVertexUpper,
                                         bool theToClose);
...
public: //! @name optional array of Bounds/Subgroups within primitive array (e.g. restarting primitives / assigning colors)
  ...
  //! @return the actual bounds number
  Standard_EXPORT int AddBound (const int theEdgeNumber, const double theR, const double theG, const double theB);
