...
public:
  ...
  Standard_EXPORT void Internals(int&                 nbrefs,
                                 occ::handle<TColStd_HArray1OfInteger>& ents,
                                 occ::handle<TColStd_HArray1OfInteger>& refs) const;
...
private:
  ...
  int                 thecount;
  int                 therank;
  occ::handle<TColStd_HArray1OfInteger> theents;
  occ::handle<TColStd_HArray1OfInteger> therefs;
};
