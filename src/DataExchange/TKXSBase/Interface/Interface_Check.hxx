...
public:
  ...
  //! Can be empty
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> Fails(
    const bool final = true) const;
  ...
  //! Final forms by default, Original forms if <final> is False
  //! Can be empty
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> Warnings(
    const bool final = true) const;
  ...
  //! Final forms by default, Original forms if <final> is False
  //! Can be empty
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> InfoMsgs(
    const bool final = true) const;
...
private:
  occ::handle<TColStd_HSequenceOfHAsciiString> thefails;
  occ::handle<TColStd_HSequenceOfHAsciiString> thefailo;
  occ::handle<TColStd_HSequenceOfHAsciiString> thewarns;
  occ::handle<TColStd_HSequenceOfHAsciiString> thewarno;
  occ::handle<TColStd_HSequenceOfHAsciiString> theinfos;
  occ::handle<TColStd_HSequenceOfHAsciiString> theinfoo;
