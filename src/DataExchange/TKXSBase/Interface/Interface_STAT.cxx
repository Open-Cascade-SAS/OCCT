...
void Interface_STAT::Internals(occ::handle<TCollection_HAsciiString>&       tit,
                               double&                          total,
                               occ::handle<TColStd_HSequenceOfAsciiString>& phn,
                               occ::handle<TColStd_HSequenceOfReal>&        phw,
                               occ::handle<TColStd_HSequenceOfInteger>&     phdeb,
                               occ::handle<TColStd_HSequenceOfInteger>&     phfin,
                               occ::handle<TColStd_HSequenceOfReal>&        stw) const
{
  tit   = thetitle;
  total = thetotal;
  phn   = thephnam;
