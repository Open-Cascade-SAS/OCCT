...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Checkeds(
...
private:
  occ::handle<Interface_HSequenceOfCheck> thelist;
  occ::handle<TColStd_HSequenceOfInteger> thenums;
