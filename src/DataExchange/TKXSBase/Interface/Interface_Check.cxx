...
occ::handle<TColStd_HSequenceOfHAsciiString> Interface_Check::Fails(const bool final) const
{
  if (thefails.IsNull())
...
occ::handle<TColStd_HSequenceOfHAsciiString> Interface_Check::Warnings(
  const bool final) const
{
  if (thewarns.IsNull())
    return new TColStd_HSequenceOfHAsciiString();
...
occ::handle<TColStd_HSequenceOfHAsciiString> Interface_Check::InfoMsgs(
  const bool final) const
{
  if (theinfos.IsNull())
    return new TColStd_HSequenceOfHAsciiString();
