...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GetShareds(
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GetSharings(
    const occ::handle<Standard_Transient>& ent) const;
  ...
  Standard_EXPORT const occ::handle<TColStd_HArray1OfListOfInteger>& SharingTable() const;
...
protected:
  ...
  occ::handle<TColStd_HArray1OfInteger>       thestats;
  occ::handle<TColStd_HArray1OfListOfInteger> thesharings;
