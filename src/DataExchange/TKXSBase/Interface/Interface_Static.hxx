...
public:
  ...
  Standard_EXPORT static const char* CDef(const char* const name,
  ...
  Standard_EXPORT static int IDef(const char* const name,
                                               const char* const part);
  ...
  Standard_EXPORT static bool IsSet(const char* const name,
  ...
  Standard_EXPORT static bool SetCVal(const char* const name,
  ...
  Standard_EXPORT static bool SetIVal(const char* const name,
                                                  const int val);
  ...
  Standard_EXPORT static bool SetRVal(const char* const name,
                                                  const double    val);
