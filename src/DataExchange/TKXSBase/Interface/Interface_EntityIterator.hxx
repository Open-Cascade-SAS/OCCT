...
public:
  ...
  Standard_EXPORT Interface_EntityIterator(const occ::handle<TColStd_HSequenceOfTransient>& list);

  //! Gets a list of entities and adds its to the iteration list
  Standard_EXPORT void AddList(const occ::handle<TColStd_HSequenceOfTransient>& list);
  ...
  //! Calls Start if not yet done
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Content() const;
...
private:
  ...
  occ::handle<TColStd_HSequenceOfTransient> thelist;
};
