...
private:
  ...
  double                          thetotal;
  occ::handle<TColStd_HSequenceOfAsciiString> thephnam;
  occ::handle<TColStd_HSequenceOfReal>        thephw;
  occ::handle<TColStd_HSequenceOfInteger>     thephdeb;
  occ::handle<TColStd_HSequenceOfInteger>     thephfin;
  occ::handle<TColStd_HSequenceOfReal>        thestw;
};
