...
bool IFSelect::SaveSession(const occ::handle<IFSelect_WorkSession>& WS, const char* const file)
{
  IFSelect_SessionFile sesfile(WS, file);
  return sesfile.IsDone();
}

bool IFSelect::RestoreSession(const occ::handle<IFSelect_WorkSession>& WS, const char* const file)
{
