...
Interface_CheckIterator IFSelect_ModelCopier::SendAll(const char*              filename,
...
occ::handle<TColStd_HSequenceOfHAsciiString> IFSelect_ModelCopier::SentFiles() const
{
  return thesentfiles;
}
