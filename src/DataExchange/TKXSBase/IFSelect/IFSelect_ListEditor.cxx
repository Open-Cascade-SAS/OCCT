...
void IFSelect_ListEditor::LoadValues(const occ::handle<TColStd_HSequenceOfHAsciiString>& vals)
{
  theorig = vals;
  ClearEdit();
}
...
occ::handle<TColStd_HSequenceOfHAsciiString> IFSelect_ListEditor::OriginalValues() const
{
  return theorig;
}

occ::handle<TColStd_HSequenceOfHAsciiString> IFSelect_ListEditor::EditedValues() const
{
  return theedit;
}
