...
void IFSelect_SignCounter::AddList(const occ::handle<TColStd_HSequenceOfTransient>& list,
                                   const occ::handle<Interface_InterfaceModel>&     model)
{
  if (list.IsNull())
    return;
...
void IFSelect_SignCounter::AddWithGraph(const occ::handle<TColStd_HSequenceOfTransient>& list,
