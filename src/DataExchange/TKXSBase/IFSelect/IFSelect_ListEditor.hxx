...
public:
  ...
  Standard_EXPORT void LoadValues(const occ::handle<TColStd_HSequenceOfHAsciiString>& vals);
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> OriginalValues() const;

  //! Returns the result of the edition
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> EditedValues() const;
...
private:
  ...
  int                        thetouc;
  occ::handle<TColStd_HSequenceOfHAsciiString> theorig;
  occ::handle<TColStd_HSequenceOfHAsciiString> theedit;
  occ::handle<TColStd_HSequenceOfInteger>      thestat;
