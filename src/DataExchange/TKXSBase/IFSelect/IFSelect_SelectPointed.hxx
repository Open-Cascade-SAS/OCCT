...
public:
  ...
  Standard_EXPORT void SetList(const occ::handle<TColStd_HSequenceOfTransient>& list);
  ...
  Standard_EXPORT bool AddList(const occ::handle<TColStd_HSequenceOfTransient>& list);

  //! Removes all the items defined in a list. Returns True if at
  //! least one item has been removed, False else
  Standard_EXPORT bool RemoveList(const occ::handle<TColStd_HSequenceOfTransient>& list);

  //! Toggles status of all the items defined in a list : adds it if
  //! not pointed or removes it if already pointed.
  Standard_EXPORT bool ToggleList(const occ::handle<TColStd_HSequenceOfTransient>& list);
