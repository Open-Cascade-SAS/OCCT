...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> OriginalList(
    const int num) const;
  ...
  //! defined or has been removed
  //! For a single parameter, gives a Null Handle
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> EditedList(
    const int num) const;
  ...
  Standard_EXPORT bool
    TouchList(const int num, const occ::handle<TColStd_HSequenceOfHAsciiString>& newlist);
