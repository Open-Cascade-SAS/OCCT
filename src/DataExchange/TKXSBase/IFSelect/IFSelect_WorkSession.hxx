...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Shareds(
    const occ::handle<Standard_Transient>& ent);

  //! Returns the list of entities sharing <ent> (can be empty)
  //! Returns a null Handle if <ent> is unknown
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Sharings(
    const occ::handle<Standard_Transient>& ent);
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfInteger> ItemIdents(
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> ItemNames(
    const occ::handle<Standard_Type>& type) const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> ItemNamesForLabel(
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> SelectionResult(
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> SelectionResultFromList(
    const occ::handle<IFSelect_Selection>&           sel,
    const occ::handle<TColStd_HSequenceOfTransient>& list) const;
  ...
  Standard_EXPORT bool
    ComputeCounterFromList(const occ::handle<IFSelect_SignCounter>&         counter,
                           const occ::handle<TColStd_HSequenceOfTransient>& list,
                           const bool                      clear = true);

  //! Returns the ordered list of dispatches stored by the ShareOut
  Standard_EXPORT occ::handle<TColStd_HSequenceOfInteger> AppliedDispatches() const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfInteger> FinalModifierIdents(
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> SentFiles() const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GiveList(
  ...
  //! GiveList
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GiveListFromList(
    const char*            selname,
    const occ::handle<Standard_Transient>& ent) const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GiveListCombined(
    const occ::handle<TColStd_HSequenceOfTransient>& l1,
    const occ::handle<TColStd_HSequenceOfTransient>& l2,
    const int                      mode) const;
