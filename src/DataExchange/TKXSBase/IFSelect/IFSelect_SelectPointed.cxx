...
void IFSelect_SelectPointed::SetList(const occ::handle<TColStd_HSequenceOfTransient>& list)
{
  theitems.Clear();
  theset = true;
  if (list.IsNull())
...
bool IFSelect_SelectPointed::AddList(const occ::handle<TColStd_HSequenceOfTransient>& list)
{
