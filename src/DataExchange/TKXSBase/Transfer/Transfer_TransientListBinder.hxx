...
public:
  ...
  Standard_EXPORT Transfer_TransientListBinder(const occ::handle<TColStd_HSequenceOfTransient>& list);
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Result() const;
...
private:
  occ::handle<TColStd_HSequenceOfTransient> theres;
};
