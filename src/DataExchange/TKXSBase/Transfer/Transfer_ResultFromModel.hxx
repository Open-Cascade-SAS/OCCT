...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Results(const int level) const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> TransferredList(
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> CheckedList(
