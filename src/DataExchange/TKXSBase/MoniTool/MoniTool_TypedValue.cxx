                                  ...
                                  const char* v10)
{
  ...
  {
    occ::handle<TColStd_HArray1OfAsciiString> enums =
...
occ::handle<TColStd_HSequenceOfAsciiString> MoniTool_TypedValue::LibList()
{
  occ::handle<TColStd_HSequenceOfAsciiString> list = new TColStd_HSequenceOfAsciiString();
  if (libtv().IsEmpty())
    return list;
