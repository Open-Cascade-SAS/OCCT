...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> RecordedList() const;
  ...
  //! but is optimised
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> EntitiesFromShapeList(
    const occ::handle<TopTools_HSequenceOfShape>& theRes,
    const int                   theMode = 0) const;
  ...
  Standard_EXPORT int
    TransferList(const occ::handle<TColStd_HSequenceOfTransient>& theList,
                 const bool                      theRec      = true,
                 const Message_ProgressRange&                theProgress = Message_ProgressRange());
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> LastTransferList(
  ...
  Standard_EXPORT const occ::handle<TopTools_HSequenceOfShape>& ShapeResultList(
    const bool theRec);
  ...
  Standard_EXPORT static void PrintStatsOnList(const occ::handle<Transfer_TransientProcess>&    theTP,
                                               const occ::handle<TColStd_HSequenceOfTransient>& theList,
                                               const int                      theWhat,
                                               const int theMode = 0);
...
private:
  ...
  occ::handle<TopTools_HSequenceOfShape>                                        myShapeResult;
};
