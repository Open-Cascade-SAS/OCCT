                                                    ...
                                                    Interface_EntityIterator& explored) const
{
  ...
  if (Shape.IsNull())
    return false;
  occ::handle<TColStd_HSequenceOfTransient> li = AdjacentEntities(Shape, TP, TopAbs_FACE);
  explored.AddList(li);
  return true;
}
...
occ::handle<TColStd_HSequenceOfTransient> XSControl_ConnectedShapes::AdjacentEntities(
