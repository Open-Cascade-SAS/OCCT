...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> NewSeqTra() const;

  Standard_EXPORT void AppendTra(const occ::handle<TColStd_HSequenceOfTransient>& seqval,
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> NewSeqCStr() const;

  Standard_EXPORT void AppendCStr(const occ::handle<TColStd_HSequenceOfHAsciiString>& seqval,
                                  const char*                         strval) const;

  Standard_EXPORT occ::handle<TColStd_HSequenceOfHExtendedString> NewSeqEStr() const;

  Standard_EXPORT void AppendEStr(const occ::handle<TColStd_HSequenceOfHExtendedString>& seqval,
  ...
  Standard_EXPORT TopoDS_Shape ShapeValue(const occ::handle<TopTools_HSequenceOfShape>& seqv,
                                          const int                   num) const;

  Standard_EXPORT occ::handle<TopTools_HSequenceOfShape> NewSeqShape() const;

  Standard_EXPORT void AppendShape(const occ::handle<TopTools_HSequenceOfShape>& seqv,
  ...
  Standard_EXPORT int SeqIntValue(const occ::handle<TColStd_HSequenceOfInteger>& list,
                                               const int                    num) const;
