...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GiveList(const char* first  = "",
                                                                const char* second = "");
  ...
  Standard_EXPORT int
    TransferList(const occ::handle<TColStd_HSequenceOfTransient>& list,
                 const Message_ProgressRange&                theProgress = Message_ProgressRange());
  ...
  Standard_EXPORT void GetStatsTransfer(const occ::handle<TColStd_HSequenceOfTransient>& list,
                                        int&                           nbMapped,
                                        int&                           nbWithResult,
