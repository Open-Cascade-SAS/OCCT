...
public:
  ...
  Standard_EXPORT occ::handle<TopTools_HSequenceOfShape> Shapes() const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> Transients() const;
...
private:
  ...
  int                         theFilest;
  bool                         theNewpr;
  occ::handle<TopTools_HSequenceOfShape>        theShapes;
  occ::handle<TColStd_HSequenceOfTransient>     theTransi;
};
