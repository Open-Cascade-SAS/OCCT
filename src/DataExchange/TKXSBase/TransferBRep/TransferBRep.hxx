...
public:
  ...
  Standard_EXPORT static occ::handle<TopTools_HSequenceOfShape> Shapes(
  ...
  Standard_EXPORT static void TransferResultInfo(
    const occ::handle<Transfer_TransientProcess>&            TP,
    const occ::handle<TColStd_HSequenceOfTransient>&         EntityTypes,
    occ::handle<TransferBRep_HSequenceOfTransferResultInfo>& InfoSeq);
  ...
  Standard_EXPORT static void TransferResultInfo(
    const occ::handle<Transfer_FinderProcess>&               FP,
    const occ::handle<TColStd_HSequenceOfInteger>&           ShapeTypes,
    occ::handle<TransferBRep_HSequenceOfTransferResultInfo>& InfoSeq);
  ...
  Standard_EXPORT static occ::handle<TColStd_HSequenceOfTransient> Checked(
    const Interface_CheckIterator& chl,
    const bool         alsoshapes = false);

  //! Returns the list of shapes to which a non-empty Check is bound
  //! in a check-list
  Standard_EXPORT static occ::handle<TopTools_HSequenceOfShape> CheckedShapes(
    const Interface_CheckIterator& chl);
