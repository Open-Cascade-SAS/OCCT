...
public:
  ...
  Standard_EXPORT TransferBRep_ShapeListBinder(const occ::handle<TopTools_HSequenceOfShape>& list);
  ...
  Standard_EXPORT occ::handle<TopTools_HSequenceOfShape> Result() const;
...
private:
  occ::handle<TopTools_HSequenceOfShape> theres;
};
