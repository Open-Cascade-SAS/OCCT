...
Standard_Boolean DEGLTF_Provider::Read(const ReadStreamMap&            theStreams,
                                        const Handle(TDocStd_Document)& theDocument,
                                        Handle(XSControl_WorkSession)&  theWS,
                                        const Message_ProgressRange&    theProgress)
{
  ...
  (void)theDocument;
  (void)theProgress;
  Message::SendFail() << "Error: DEGLTF_Provider doesn't support document read operations with streams";
                                         ...
                                         const Message_ProgressRange&    theProgress)
{
  ...
  (void)theDocument;
  (void)theProgress;
  Message::SendFail() << "Error: DEGLTF_Provider doesn't support document write operations with streams";
  return Standard_False;
}
                                        ...
                                        const Message_ProgressRange&   theProgress)
{
  ...
  (void)theShape;
  (void)theProgress;
  Message::SendFail() << "Error: DEGLTF_Provider doesn't support shape read operations with streams";
  return Standard_False;
}
                                         ...
                                         const Message_ProgressRange&   theProgress)
{
  ...
  (void)theShape;
  (void)theProgress;
  Message::SendFail() << "Error: DEGLTF_Provider doesn't support shape write operations with streams";
  return Standard_False;
}
