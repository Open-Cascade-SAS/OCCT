                                     ...
                                     const std::string&      theValueName)
{
  ...
  if (theValue[0].IsInt())
  {
    ...
    {
      anArray->SetValue(static_cast<Standard_Integer>(anIndex), theValue[(int)anIndex].GetInt());
    }
  ...
  else if (theValue[0].IsDouble())
  {
    ...
    for (size_t anIndex = 0; anIndex < theValue.Size(); ++anIndex)
    {
      anArray->SetValue(static_cast<Standard_Integer>(anIndex), theValue[(int)anIndex].GetDouble());
    }
  ...
  else if (theValue[0].IsString())
  {
    ...
    {
      anArrayString = anArrayString + aSeparator + theValue[(int)i].GetString();
    }
