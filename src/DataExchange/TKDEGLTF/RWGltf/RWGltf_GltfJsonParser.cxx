                                     ...
                                     const std::string&      theValueName)
{
  ...
  if (theValue[0].IsInt())
  {
    ...
    occ::handle<TColStd_HArray1OfInteger> anArray = new TColStd_HArray1OfInteger(0, theValue.Size());
  ...
  else if (theValue[0].IsDouble())
  {
    ...
    occ::handle<TColStd_HArray1OfReal> anArray = new TColStd_HArray1OfReal(0, theValue.Size());
    for (size_t anIndex = 0; anIndex < theValue.Size(); ++anIndex)
    {
      anArray->SetValue(static_cast<int>(anIndex),
