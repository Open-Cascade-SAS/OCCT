...
static void PrintPoints(occ::handle<TColgp_HArray1OfVec>&        aHAV1,
                        occ::handle<TColStd_HArray1OfInteger>&   aHAI1,
...
void VrmlConverter_DeflectionCurve::Add(Standard_OStream&                    anOStream,
                                        ...
                                        const occ::handle<VrmlConverter_Drawer>&  aDrawer)
{
  occ::handle<TColgp_HArray1OfVec>      aHAV1 = new TColgp_HArray1OfVec(1, aNbNodes);
  occ::handle<TColStd_HArray1OfInteger> aHAI1 = new TColStd_HArray1OfInteger(1, aNbNodes + 1);
