                                    ...
                                    const occ::handle<VrmlConverter_Drawer>& aDrawer)
{
  ...
  if (nbVertices > 2 && nbTriangles > 0)
  {
    ...
    occ::handle<TColgp_HArray1OfVec> HAV1 = new TColgp_HArray1OfVec(1, nbVertices);
    occ::handle<TColgp_HArray1OfVec> HAV2 = new TColgp_HArray1OfVec(1, nbVertices);

    gp_Vec V, VV;

    occ::handle<TColStd_HArray1OfInteger> HAI1 = new TColStd_HArray1OfInteger(1, 4 * nbTriangles);
    occ::handle<TColStd_HArray1OfInteger> HAI3 =
      new TColStd_HArray1OfInteger(1, (nbVertices / 3 * 4 + nbVertices % 3));
    occ::handle<TColStd_HArray1OfInteger> HAI2 = new TColStd_HArray1OfInteger(1, 1);
    occ::handle<TColStd_HArray1OfInteger> HAI4 = new TColStd_HArray1OfInteger(1, 1);
