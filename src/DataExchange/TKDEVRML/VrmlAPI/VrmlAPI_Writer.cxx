...
VrmlAPI_Writer::VrmlAPI_Writer()
{
  ...
  myDeflection                         = -1;
  occ::handle<Quantity_HArray1OfColor> Col1 = new Quantity_HArray1OfColor(1, 1, Quantity_NOC_BLACK);
  occ::handle<TColStd_HArray1OfReal>   kik1 = new TColStd_HArray1OfReal(1, 1, 0.0);
  occ::handle<TColStd_HArray1OfReal>   kik2 = new TColStd_HArray1OfReal(1, 1, 0.1);
...
void VrmlAPI_Writer::ResetToDefaults()
{
  myTransparency                       = 0.0;
  myShininess                          = 0.1;
  occ::handle<TColStd_HArray1OfReal>   kik1 = new TColStd_HArray1OfReal(1, 1, myTransparency);
  occ::handle<TColStd_HArray1OfReal>   kik2 = new TColStd_HArray1OfReal(1, 1, myShininess);
  occ::handle<Quantity_HArray1OfColor> Col  = new Quantity_HArray1OfColor(1, 1, Quantity_NOC_BLACK);
  //
  ...
  //
  //  occ::handle<Quantity_HArray1OfColor> Col3 = new Quantity_HArray1OfColor(1,1);
  ...
  //
  //  occ::handle<Quantity_HArray1OfColor> Col4 = new Quantity_HArray1OfColor(1,1);
  //  color.SetValues(Quantity_NOC_GOLD);
...
{
  occ::handle<TColStd_HArray1OfReal> t = new TColStd_HArray1OfReal(1, 1, aTransparency);
...
{
  occ::handle<TColStd_HArray1OfReal> s = new TColStd_HArray1OfReal(1, 1, aShininess);
  aMaterial->SetShininess(s);
}

void VrmlAPI_Writer::SetAmbientColorToMaterial(occ::handle<Vrml_Material>&                 aMaterial,
                                               const occ::handle<Quantity_HArray1OfColor>& Color)
{
