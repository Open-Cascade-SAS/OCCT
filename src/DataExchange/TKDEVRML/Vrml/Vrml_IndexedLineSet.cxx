...
Vrml_IndexedLineSet::Vrml_IndexedLineSet(const occ::handle<TColStd_HArray1OfInteger>& aCoordIndex,
...
void Vrml_IndexedLineSet::SetCoordIndex(const occ::handle<TColStd_HArray1OfInteger>& aCoordIndex)
{
  myCoordIndex = aCoordIndex;
}

occ::handle<TColStd_HArray1OfInteger> Vrml_IndexedLineSet::CoordIndex() const
{
  return myCoordIndex;
}

void Vrml_IndexedLineSet::SetMaterialIndex(const occ::handle<TColStd_HArray1OfInteger>& aMaterialIndex)
{
  myMaterialIndex = aMaterialIndex;
}

occ::handle<TColStd_HArray1OfInteger> Vrml_IndexedLineSet::MaterialIndex() const
{
  return myMaterialIndex;
}

void Vrml_IndexedLineSet::SetNormalIndex(const occ::handle<TColStd_HArray1OfInteger>& aNormalIndex)
{
  myNormalIndex = aNormalIndex;
}

occ::handle<TColStd_HArray1OfInteger> Vrml_IndexedLineSet::NormalIndex() const
{
...
occ::handle<TColStd_HArray1OfInteger> Vrml_IndexedLineSet::TextureCoordIndex() const
{
