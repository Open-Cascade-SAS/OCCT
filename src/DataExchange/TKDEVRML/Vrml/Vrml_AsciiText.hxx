...
public:
  ...
  Standard_EXPORT Vrml_AsciiText(const occ::handle<TColStd_HArray1OfAsciiString>& aString,
                                 const double                         aSpacing,
                                 const Vrml_AsciiTextJustification           aJustification,
                                 const double                         aWidth);

  Standard_EXPORT void SetString(const occ::handle<TColStd_HArray1OfAsciiString>& aString);

  Standard_EXPORT occ::handle<TColStd_HArray1OfAsciiString> String() const;
...
private:
  occ::handle<TColStd_HArray1OfAsciiString> myString;
  double                        mySpacing;
