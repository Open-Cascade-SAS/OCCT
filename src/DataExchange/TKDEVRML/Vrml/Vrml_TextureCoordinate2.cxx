...
Vrml_TextureCoordinate2::Vrml_TextureCoordinate2(const occ::handle<TColgp_HArray1OfVec2d>& aPoint)
{
  myPoint = aPoint;
}

void Vrml_TextureCoordinate2::SetPoint(const occ::handle<TColgp_HArray1OfVec2d>& aPoint)
{
  myPoint = aPoint;
}

occ::handle<TColgp_HArray1OfVec2d> Vrml_TextureCoordinate2::Point() const
{
  return myPoint;
}
