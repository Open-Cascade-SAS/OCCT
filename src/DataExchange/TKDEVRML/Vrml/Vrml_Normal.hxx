...
public:
  Standard_EXPORT Vrml_Normal(const occ::handle<TColgp_HArray1OfVec>& aVector);

  Standard_EXPORT Vrml_Normal();

  Standard_EXPORT void SetVector(const occ::handle<TColgp_HArray1OfVec>& aVector);

  Standard_EXPORT occ::handle<TColgp_HArray1OfVec> Vector() const;
...
private:
  occ::handle<TColgp_HArray1OfVec> myVector;
};
