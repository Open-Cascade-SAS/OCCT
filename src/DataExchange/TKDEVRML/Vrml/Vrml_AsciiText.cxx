...
Vrml_AsciiText::Vrml_AsciiText(const occ::handle<TColStd_HArray1OfAsciiString>& aString,
...
void Vrml_AsciiText::SetString(const occ::handle<TColStd_HArray1OfAsciiString>& aString)
{
  myString = aString;
}

occ::handle<TColStd_HArray1OfAsciiString> Vrml_AsciiText::String() const
{
  return myString;
}
