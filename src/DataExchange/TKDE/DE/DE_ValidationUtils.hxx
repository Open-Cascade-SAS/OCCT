...
public:
  ...
  Standard_EXPORT static bool ValidateFileForReading(
  ...
  Standard_EXPORT static bool ValidateFileForWriting(
    const TCollection_AsciiString& thePath,
    const TCollection_AsciiString& theContext,
    const bool         theIsVerbose = true);
  ...
  Standard_EXPORT static bool ValidateReadStreamList(
  ...
  //! @param[in] theIsVerbose if true, sends detailed error/warning messages
  //! @return true if stream list is valid, false otherwise
  Standard_EXPORT static bool ValidateWriteStreamList(
  ...
  Standard_EXPORT static bool ValidateDocument(
  ...
  Standard_EXPORT static bool WarnLengthUnitNotSupported(
  ...
  Standard_EXPORT static bool CreateContentBuffer(
    const TCollection_AsciiString& thePath,
