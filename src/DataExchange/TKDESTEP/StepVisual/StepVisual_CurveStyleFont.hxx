...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&                  aName,
                            const occ::handle<StepVisual_HArray1OfCurveStyleFontPattern>& aPatternList);
  ...
  Standard_EXPORT occ::handle<StepVisual_HArray1OfCurveStyleFontPattern> PatternList() const;
...
private:
  ...
  occ::handle<StepVisual_HArray1OfCurveStyleFontPattern> patternList;
};
