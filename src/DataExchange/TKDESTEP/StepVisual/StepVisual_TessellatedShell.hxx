...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>& theRepresentationItem_Name,
                            const occ::handle<StepVisual_HArray1OfTessellatedStructuredItem>& theItems,
                            const bool                    theHasTopologicalLink,
                            const occ::handle<StepShape_ConnectedFaceSet>& theTopologicalLink);

  //! Returns field Items
  Standard_EXPORT occ::handle<StepVisual_HArray1OfTessellatedStructuredItem> Items() const;
...
private:
  occ::handle<StepVisual_HArray1OfTessellatedStructuredItem> myItems;
