...
public:
  ...
  const occ::handle<StepVisual_HArray1OfPresentationStyleAssignment>& Styles() const { return myStyles; }
...
private:
  occ::handle<StepVisual_HArray1OfPresentationStyleAssignment> myStyles;
