...
occ::handle<TColStd_HArray2OfReal> StepVisual_TessellatedFace::Normals() const
{
  return myNormals;
}
...
void StepVisual_TessellatedFace::SetNormals(const occ::handle<TColStd_HArray2OfReal>& theNormals)
{
  myNormals = theNormals;
}
