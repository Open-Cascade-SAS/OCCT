...
void StepVisual_CompositeText::Init(
  ...
  const occ::handle<StepVisual_HArray1OfTextOrCharacter>& aCollectedText)
{
  // --- classe own fields ---
...
occ::handle<StepVisual_HArray1OfTextOrCharacter> StepVisual_CompositeText::CollectedText() const
{
