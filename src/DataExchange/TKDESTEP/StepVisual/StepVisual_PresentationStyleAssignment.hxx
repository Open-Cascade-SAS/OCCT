...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<StepVisual_HArray1OfPresentationStyleSelect>& aStyles);

  Standard_EXPORT void SetStyles(
    const occ::handle<StepVisual_HArray1OfPresentationStyleSelect>& aStyles);

  Standard_EXPORT occ::handle<StepVisual_HArray1OfPresentationStyleSelect> Styles() const;
...
private:
  occ::handle<StepVisual_HArray1OfPresentationStyleSelect> styles;
};
