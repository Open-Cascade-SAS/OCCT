...
void StepVisual_Invisibility::Init(const occ::handle<StepVisual_HArray1OfInvisibleItem>& aInvisibleItems)
{
  // --- classe own fields ---
...
occ::handle<StepVisual_HArray1OfInvisibleItem> StepVisual_Invisibility::InvisibleItems() const
{
