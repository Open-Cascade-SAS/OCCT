...
occ::handle<TColStd_HArray1OfInteger> StepVisual_TriangulatedFace::Pnindex() const
{
  return myPnindex;
}
...
void StepVisual_TriangulatedFace::SetPnindex(const occ::handle<TColStd_HArray1OfInteger>& thePnindex)
{
  myPnindex = thePnindex;
}
...
occ::handle<TColStd_HArray2OfInteger> StepVisual_TriangulatedFace::Triangles() const
{
  return myTriangles;
}
...
void StepVisual_TriangulatedFace::SetTriangles(const occ::handle<TColStd_HArray2OfInteger>& theTriangles)
{
  myTriangles = theTriangles;
}
