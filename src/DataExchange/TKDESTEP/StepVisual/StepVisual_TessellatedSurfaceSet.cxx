...
occ::handle<TColStd_HArray2OfReal> StepVisual_TessellatedSurfaceSet::Normals() const
{
  return myNormals;
}
...
void StepVisual_TessellatedSurfaceSet::SetNormals(const occ::handle<TColStd_HArray2OfReal>& theNormals)
{
  myNormals = theNormals;
}
