...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> LineStripFace1() const;

  //! Sets field LineStripFace1
  Standard_EXPORT void SetLineStripFace1(const occ::handle<TColStd_HArray1OfInteger>& theLineStripFace1);
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> LineStripFace2() const;

  //! Sets field LineStripFace2
  Standard_EXPORT void SetLineStripFace2(const occ::handle<TColStd_HArray1OfInteger>& theLineStripFace2);
...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger>   myLineStripFace1;
  occ::handle<TColStd_HArray1OfInteger>   myLineStripFace2;
};
