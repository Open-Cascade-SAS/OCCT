...
public:
  ...
  const occ::handle<StepVisual_HArray1OfCameraModelD3MultiClippingUnionSelect> ShapeClipping()
  {
...
private:
  occ::handle<StepVisual_HArray1OfCameraModelD3MultiClippingUnionSelect> myShapeClipping;
};
