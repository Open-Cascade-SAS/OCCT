...
occ::handle<TColStd_HArray1OfInteger> StepVisual_TessellatedEdge::LineStrip() const
{
  return myLineStrip;
}
...
void StepVisual_TessellatedEdge::SetLineStrip(const occ::handle<TColStd_HArray1OfInteger>& theLineStrip)
{
  myLineStrip = theLineStrip;
}
