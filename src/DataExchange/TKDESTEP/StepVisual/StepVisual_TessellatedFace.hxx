...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&   theRepresentationItem_Name,
                            ...
                            const int                    thePnmax,
                            const occ::handle<TColStd_HArray2OfReal>&      theNormals,
  ...
  Standard_EXPORT occ::handle<TColStd_HArray2OfReal> Normals() const;

  //! Sets field Normals
  Standard_EXPORT void SetNormals(const occ::handle<TColStd_HArray2OfReal>& theNormals);
...
private:
  ...
  int                   myPnmax;
  occ::handle<TColStd_HArray2OfReal>      myNormals;
