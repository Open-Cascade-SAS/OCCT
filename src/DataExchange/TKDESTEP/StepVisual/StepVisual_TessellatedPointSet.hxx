...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&   theRepresentationItem_Name,
                            ...
                            const occ::handle<TColStd_HArray1OfInteger>&   thePointList);
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> PointList() const;

  //! Sets field PointList
  Standard_EXPORT void SetPointList(const occ::handle<TColStd_HArray1OfInteger>& thePointList);
...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger>   myPointList;
};
