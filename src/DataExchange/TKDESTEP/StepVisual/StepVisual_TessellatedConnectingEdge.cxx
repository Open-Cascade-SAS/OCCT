...
void StepVisual_TessellatedConnectingEdge::Init(
  ...
  const occ::handle<TColStd_HArray1OfInteger>&   theTessellatedEdge_LineStrip,
  ...
  const occ::handle<TColStd_HArray1OfInteger>&   theLineStripFace1,
  const occ::handle<TColStd_HArray1OfInteger>&   theLineStripFace2)
{
...
occ::handle<TColStd_HArray1OfInteger> StepVisual_TessellatedConnectingEdge::LineStripFace1() const
{
...
occ::handle<TColStd_HArray1OfInteger> StepVisual_TessellatedConnectingEdge::LineStripFace2() const
{
