...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&   theRepresentationItem_Name,
                            ...
                            const occ::handle<TColStd_HArray1OfInteger>&   theLineStrip);
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> LineStrip() const;

  //! Sets field LineStrip
  Standard_EXPORT void SetLineStrip(const occ::handle<TColStd_HArray1OfInteger>& theLineStrip);
...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger>   myLineStrip;
