...
occ::handle<TColStd_HArray1OfInteger> StepVisual_ComplexTriangulatedSurfaceSet::Pnindex() const
{
  return myPnindex;
}
...
int StepVisual_ComplexTriangulatedSurfaceSet::PnindexValue(
...
occ::handle<TColStd_HArray1OfTransient> StepVisual_ComplexTriangulatedSurfaceSet::TriangleStrips() const
{
...
occ::handle<TColStd_HArray1OfTransient> StepVisual_ComplexTriangulatedSurfaceSet::TriangleFans() const
{
