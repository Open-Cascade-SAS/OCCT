...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray2OfInteger> Triangles() const;

  //! Sets field Triangles
  Standard_EXPORT void SetTriangles(const occ::handle<TColStd_HArray2OfInteger>& theTriangles);
