...
bool RWStepAP214_GeneralModule::NewVoid
  (const int CN, occ::handle<Standard_Transient>& ent) const
{
...
int  RWStepAP214_GeneralModule::CategoryNumber
  (const int CN, const occ::handle<Standard_Transient>& /*ent*/, const Interface_ShareTool& /*shares*/) const
{
  switch (CN) {
...
occ::handle<TCollection_HAsciiString>  RWStepAP214_GeneralModule::Name
       (const int /*CN*/, const occ::handle<Standard_Transient>& /*ent*/,
