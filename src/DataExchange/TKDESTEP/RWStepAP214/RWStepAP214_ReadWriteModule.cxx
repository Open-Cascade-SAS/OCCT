...
static NCollection_DataMap<TCollection_AsciiString, int> typenums;
static NCollection_DataMap<TCollection_AsciiString, int> typeshor;

RWStepAP214_ReadWriteModule::RWStepAP214_ReadWriteModule ()
{
//  occ::handle<StepAP214_Protocol> protocol = new StepAP214_Protocol;
//  StepData_WriterLib::SetGlobal(occ::down_cast<RWStepAP214_ReadWriteModule>(This()),protocol);
//  Interface_ReaderLib::SetGlobal(occ::down_cast<RWStepAP214_ReadWriteModule>(This()),protocol);
...
bool RWStepAP214_ReadWriteModule::IsComplex
  (const int CN) const
{
  switch(CN)
    {
...
bool RWStepAP214_ReadWriteModule::ComplexType(const int CN,
