  ...
  const occ::handle<StepVisual_ComplexTriangulatedFace>& theEnt) const
{
  ...
  if (theData->ReadSubList(theNum, 7, "triangle_strips", theCheck, sub7))
  {
    ...
    for (int i0 = 1; i0 <= nb0; i0++)
    {
      ...
      occ::handle<TColStd_HArray1OfInteger> aSingleTriangleStrip = new TColStd_HArray1OfInteger(1, nbj0);
      int                 subj7                = 0;
  ...
  occ::handle<TColStd_HArray1OfTransient> aTriangleFans;
  int                   sub8 = 0;
  if (theData->ReadSubList(theNum, 8, "triangle_fans", theCheck, sub8))
  {
    ...
    for (int i0 = 1; i0 <= nb0; i0++)
    {
      ...
      occ::handle<TColStd_HArray1OfInteger> aSingleTriangleFan = new TColStd_HArray1OfInteger(1, nbj0);
      int                 subj8              = 0;
  ...
  const occ::handle<StepVisual_ComplexTriangulatedFace>& theEnt) const
{
  ...
  for (int i6 = 1; i6 <= theEnt->NbTriangleStrips(); i6++)
  {
    ...
    occ::handle<TColStd_HArray1OfInteger> aTriangleStrip =
      occ::down_cast<TColStd_HArray1OfInteger>(theEnt->TriangleStrips()->Value(i6));
  ...
  for (int i7 = 1; i7 <= theEnt->NbTriangleFans(); i7++)
  {
    ...
    occ::handle<TColStd_HArray1OfInteger> aTriangleFan =
      occ::down_cast<TColStd_HArray1OfInteger>(theEnt->TriangleFans()->Value(i7));
