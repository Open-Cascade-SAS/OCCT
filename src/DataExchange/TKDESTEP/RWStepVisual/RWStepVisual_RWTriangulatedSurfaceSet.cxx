  ...
  const occ::handle<StepVisual_TriangulatedSurfaceSet>& theEnt) const
{
  ...
  occ::handle<TColStd_HArray2OfReal> aTessellatedSurfaceSet_Normals;
  int              aNormSub4 = 0;
  ...
  occ::handle<TColStd_HArray1OfInteger> aPnindex;
  int                 aPnSub5 = 0;
  ...
  occ::handle<TColStd_HArray2OfInteger> aTriangles;
  int                 aTrSub6 = 0;
