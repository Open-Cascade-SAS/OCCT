...
// purpose  :
//=======================================================================
STEPCAFControl_Provider::STEPCAFControl_Provider(const occ::handle<DE_ConfigurationNode>& theNode)
  :DE_Provider(theNode)
{}
                                   ...
                                   const Message_ProgressRange& theProgress)
{
  ...
  occ::handle<STEPCAFControl_ConfigurationNode> aNode = occ::down_cast<STEPCAFControl_ConfigurationNode>(GetNode());
  personizeWS(theWS);
                                    ...
                                    const Message_ProgressRange& theProgress)
{
  ...
  aWriter.Init(theWS);
  occ::handle<StepData_StepModel> aModel = occ::down_cast<StepData_StepModel>(aWriter.Writer().WS()->Model());
...
// purpose  :
//=======================================================================
void STEPCAFControl_Provider::personizeWS(occ::handle<XSControl_WorkSession>& theWS)
{
  if (theWS.IsNull())
  {
  ...
  occ::handle<STEPCAFControl_Controller> aCntrl = occ::down_cast<STEPCAFControl_Controller>(theWS->NormAdaptor());
  if (aCntrl.IsNull())
  {
