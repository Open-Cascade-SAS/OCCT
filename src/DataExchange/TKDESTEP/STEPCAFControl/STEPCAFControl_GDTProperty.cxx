...
{
  occ::handle<TColgp_HArray1OfXYZ> thePoints = new TColgp_HArray1OfXYZ(1, theTriangulation->NbNodes());
...
//           no normals.
//=======================================================================
occ::handle<TColStd_HArray2OfReal> GenerateNormalsArray(
  const occ::handle<Poly_Triangulation>& theTriangulation,
  const gp_Trsf&                    theTransformation)
{
  ...
  {
    occ::handle<TColStd_HArray2OfReal> aNormals = new TColStd_HArray2OfReal(1, 1, 1, 3);
...
//=======================================================================
occ::handle<TColStd_HArray1OfTransient> GenerateTriangleStrips(
  const occ::handle<Poly_Triangulation>& theTriangulation)
{
  occ::handle<TColStd_HArray1OfTransient> aTriangleStrips =
       ...
       ++aTriangleIndex)
  {
    ...
    occ::handle<TColStd_HArray1OfInteger> aTriangleStrip   = new TColStd_HArray1OfInteger(1, 3);
  ...
  const TopoDS_Face& theFace)
{
  ...
  // normals
  occ::handle<TColStd_HArray2OfReal> aNormals = GenerateNormalsArray(aTriangulation, aFaceTransform);
  // pnindex
  ...
  occ::handle<TColStd_HArray1OfInteger> aPnindex = new TColStd_HArray1OfInteger;
  // triangle_strips
  occ::handle<TColStd_HArray1OfTransient> aTriangleStrips = GenerateTriangleStrips(aTriangulation);
  // triangle_fans
  // All triangles were already written as triangle strips.
  occ::handle<TColStd_HArray1OfTransient> aTriangleFans = new TColStd_HArray1OfTransient;
...
{
  NCollection_Handle<NCollection_Vector<occ::handle<TColStd_HSequenceOfInteger>>> aLineStrips =
    new NCollection_Vector<occ::handle<TColStd_HSequenceOfInteger>>;
  ...
  for (TopExp_Explorer aCurveIt(theShape, TopAbs_EDGE); aCurveIt.More(); aCurveIt.Next())
  {
    ...
    occ::handle<TColStd_HSequenceOfInteger> aCurrentCurve = new TColStd_HSequenceOfInteger;
  ...
  occ::handle<TColgp_HArray1OfXYZ> aPoints = new TColgp_HArray1OfXYZ(1, aTmpPointsContainer.Size());
...
//=======================================================================
occ::handle<StepDimTol_HArray1OfDatumReferenceModifier> STEPCAFControl_GDTProperty::GetDatumRefModifiers(
