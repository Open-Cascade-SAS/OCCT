...
public:
  ...
  Standard_EXPORT GeomToStep_MakeBSplineCurveWithKnotsAndRationalBSplineCurve(const occ::handle<Geom_BSplineCurve>& Bsplin,
                                                                              const StepData_Factors& theLocalFactors = StepData_Factors());
  
  Standard_EXPORT GeomToStep_MakeBSplineCurveWithKnotsAndRationalBSplineCurve(const occ::handle<Geom2d_BSplineCurve>& Bsplin,
                                                                              const StepData_Factors& theLocalFactors = StepData_Factors());
  
  Standard_EXPORT const occ::handle<StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve>& Value() const;

private:

  occ::handle<StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve> theBSplineCurveWithKnotsAndRationalBSplineCurve;
