  ...
  const occ::handle<StepFEA_Curve3dElementProperty>& ent) const
{
  ...
  occ::handle<StepFEA_HArray1OfCurveElementInterval> aIntervalDefinitions;
  int                              sub3 = 0;
  ...
  occ::handle<StepFEA_HArray1OfCurveElementEndOffset> aEndOffsets;
  int                               sub4 = 0;
  ...
  occ::handle<StepFEA_HArray1OfCurveElementEndRelease> aEndReleases;
  int                                sub5 = 0;
...
void RWStepFEA_RWCurve3dElementProperty::Share(const occ::handle<StepFEA_Curve3dElementProperty>& ent,
