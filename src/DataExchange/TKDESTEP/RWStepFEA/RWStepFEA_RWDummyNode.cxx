...
void RWStepFEA_RWDummyNode::ReadStep(const occ::handle<StepData_StepReaderData>& data,
                                     const int                 num,
...
void RWStepFEA_RWDummyNode::Share(const occ::handle<StepFEA_DummyNode>& ent,
