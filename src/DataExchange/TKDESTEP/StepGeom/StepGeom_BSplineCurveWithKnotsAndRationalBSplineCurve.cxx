...
occ::handle<TColStd_HArray1OfInteger> StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::
...
occ::handle<TColStd_HArray1OfReal> StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::Knots() const
{
  return bSplineCurveWithKnots->Knots();
}

double StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::KnotsValue(
  const int num) const
{
...
occ::handle<TColStd_HArray1OfReal> StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::WeightsData()
  const
{
  return rationalBSplineCurve->WeightsData();
}

double StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::WeightsDataValue(
  const int num) const
{
