...
void StepGeom_TrimmedCurve::SetTrim1(const occ::handle<NCollection_HArray1<StepGeom_TrimmingSelect>>& aTrim1)
{
  trim1 = aTrim1;
}
...
void StepGeom_TrimmedCurve::SetTrim2(const occ::handle<NCollection_HArray1<StepGeom_TrimmingSelect>>& aTrim2)
{
  trim2 = aTrim2;
}
