...
void StepGeom_TrimmedCurve::Init(const occ::handle<TCollection_HAsciiString>&         aName,
                                 const occ::handle<StepGeom_Curve>&                   aBasisCurve,
                                 const occ::handle<StepGeom_HArray1OfTrimmingSelect>& aTrim1,
                                 const occ::handle<StepGeom_HArray1OfTrimmingSelect>& aTrim2,
...
void StepGeom_TrimmedCurve::SetTrim1(const occ::handle<StepGeom_HArray1OfTrimmingSelect>& aTrim1)
{
  trim1 = aTrim1;
}

occ::handle<StepGeom_HArray1OfTrimmingSelect> StepGeom_TrimmedCurve::Trim1() const
{
  return trim1;
}
...
void StepGeom_TrimmedCurve::SetTrim2(const occ::handle<StepGeom_HArray1OfTrimmingSelect>& aTrim2)
{
  trim2 = aTrim2;
}

occ::handle<StepGeom_HArray1OfTrimmingSelect> StepGeom_TrimmedCurve::Trim2() const
{
  return trim2;
}
