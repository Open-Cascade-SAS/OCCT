...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepBasic_HArray1OfNamedUnit>&                  aUnits,
    const occ::handle<StepBasic_HArray1OfUncertaintyMeasureWithUnit>& anUncertainty);
  ...
  Standard_EXPORT void SetUnits(const occ::handle<StepBasic_HArray1OfNamedUnit>& aUnits);

  Standard_EXPORT occ::handle<StepBasic_HArray1OfNamedUnit> Units() const;
  ...
  Standard_EXPORT void SetUncertainty(
    const occ::handle<StepBasic_HArray1OfUncertaintyMeasureWithUnit>& aUncertainty);

  Standard_EXPORT occ::handle<StepBasic_HArray1OfUncertaintyMeasureWithUnit> Uncertainty() const;
