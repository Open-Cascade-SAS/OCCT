...
void StepGeom_Polyline::Init(const occ::handle<TCollection_HAsciiString>&         aName,
                             const occ::handle<StepGeom_HArray1OfCartesianPoint>& aPoints)
{
  // --- classe own fields ---
  points = aPoints;
...
void StepGeom_Polyline::SetPoints(const occ::handle<StepGeom_HArray1OfCartesianPoint>& aPoints)
{
  points = aPoints;
}

occ::handle<StepGeom_HArray1OfCartesianPoint> StepGeom_Polyline::Points() const
{
  return points;
}
