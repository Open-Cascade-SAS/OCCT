...
void StepGeom_Direction::Init(const occ::handle<TCollection_HAsciiString>& theName,
                              const occ::handle<TColStd_HArray1OfReal>&    theDirectionRatios)
{
  // --- classe own fields ---
...
void StepGeom_Direction::SetDirectionRatios(const occ::handle<TColStd_HArray1OfReal>& theDirectionRatios)
{
