...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>& aRepresentationItem_Name,
                            ...
                            const occ::handle<StepGeom_HArray1OfSurfaceBoundary>& aBoundaries,
  ...
  Standard_EXPORT occ::handle<StepGeom_HArray1OfSurfaceBoundary> Boundaries() const;

  //! Set field Boundaries
  Standard_EXPORT void SetBoundaries(const occ::handle<StepGeom_HArray1OfSurfaceBoundary>& Boundaries);
...
private:
  ...
  occ::handle<StepGeom_HArray1OfSurfaceBoundary> theBoundaries;
