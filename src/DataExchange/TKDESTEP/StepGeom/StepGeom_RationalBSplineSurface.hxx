...
public:
  ...
  Standard_EXPORT void SetWeightsData(const occ::handle<TColStd_HArray2OfReal>& aWeightsData);

  Standard_EXPORT occ::handle<TColStd_HArray2OfReal> WeightsData() const;
...
private:
  occ::handle<TColStd_HArray2OfReal> weightsData;
};
