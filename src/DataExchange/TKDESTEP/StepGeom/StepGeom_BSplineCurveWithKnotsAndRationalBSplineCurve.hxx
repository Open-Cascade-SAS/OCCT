...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&         aName,
                            ...
                            const occ::handle<TColStd_HArray1OfReal>&            aKnots,
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> KnotMultiplicities() const;

  Standard_EXPORT int KnotMultiplicitiesValue(const int num) const;

  Standard_EXPORT int NbKnotMultiplicities() const;

  Standard_EXPORT void SetKnots(const occ::handle<TColStd_HArray1OfReal>& aKnots);

  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> Knots() const;
  ...
  Standard_EXPORT void SetWeightsData(const occ::handle<TColStd_HArray1OfReal>& aWeightsData);

  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> WeightsData() const;
