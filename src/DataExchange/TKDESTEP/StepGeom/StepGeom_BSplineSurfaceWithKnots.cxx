...
occ::handle<TColStd_HArray1OfInteger> StepGeom_BSplineSurfaceWithKnots::UMultiplicities() const
{
  return uMultiplicities;
}

int StepGeom_BSplineSurfaceWithKnots::UMultiplicitiesValue(
  const int num) const
{
...
occ::handle<TColStd_HArray1OfInteger> StepGeom_BSplineSurfaceWithKnots::VMultiplicities() const
{
  return vMultiplicities;
}

int StepGeom_BSplineSurfaceWithKnots::VMultiplicitiesValue(
  const int num) const
{
...
void StepGeom_BSplineSurfaceWithKnots::SetUKnots(const occ::handle<TColStd_HArray1OfReal>& aUKnots)
{
  uKnots = aUKnots;
}

occ::handle<TColStd_HArray1OfReal> StepGeom_BSplineSurfaceWithKnots::UKnots() const
{
  return uKnots;
}
...
void StepGeom_BSplineSurfaceWithKnots::SetVKnots(const occ::handle<TColStd_HArray1OfReal>& aVKnots)
{
  vKnots = aVKnots;
}

occ::handle<TColStd_HArray1OfReal> StepGeom_BSplineSurfaceWithKnots::VKnots() const
{
  return vKnots;
}
