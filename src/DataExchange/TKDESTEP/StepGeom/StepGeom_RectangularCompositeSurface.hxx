...
public:
  ...
  Standard_EXPORT void SetSegments(const occ::handle<StepGeom_HArray2OfSurfacePatch>& aSegments);

  Standard_EXPORT occ::handle<StepGeom_HArray2OfSurfacePatch> Segments() const;
...
private:
  occ::handle<StepGeom_HArray2OfSurfacePatch> segments;
};
