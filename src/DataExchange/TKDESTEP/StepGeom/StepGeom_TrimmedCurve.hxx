...
public:
  ...
  Standard_EXPORT void SetTrim1(const occ::handle<StepGeom_HArray1OfTrimmingSelect>& aTrim1);

  Standard_EXPORT occ::handle<StepGeom_HArray1OfTrimmingSelect> Trim1() const;

  Standard_EXPORT StepGeom_TrimmingSelect Trim1Value(const int num) const;

  Standard_EXPORT int NbTrim1() const;

  Standard_EXPORT void SetTrim2(const occ::handle<StepGeom_HArray1OfTrimmingSelect>& aTrim2);

  Standard_EXPORT occ::handle<StepGeom_HArray1OfTrimmingSelect> Trim2() const;
...
private:
  ...
  occ::handle<StepGeom_HArray1OfTrimmingSelect> trim1;
  occ::handle<StepGeom_HArray1OfTrimmingSelect> trim2;
  bool                         senseAgreement;
