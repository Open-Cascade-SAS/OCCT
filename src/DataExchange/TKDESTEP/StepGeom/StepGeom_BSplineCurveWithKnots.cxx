...
occ::handle<TColStd_HArray1OfInteger> StepGeom_BSplineCurveWithKnots::KnotMultiplicities() const
{
...
void StepGeom_BSplineCurveWithKnots::SetKnots(const occ::handle<TColStd_HArray1OfReal>& aKnots)
{
  knots = aKnots;
}

occ::handle<TColStd_HArray1OfReal> StepGeom_BSplineCurveWithKnots::Knots() const
{
  return knots;
}
