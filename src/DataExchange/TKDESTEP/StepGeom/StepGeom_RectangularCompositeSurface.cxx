...
void StepGeom_RectangularCompositeSurface::Init(
  ...
  const occ::handle<StepGeom_HArray2OfSurfacePatch>& aSegments)
{
  // --- classe own fields ---
  segments = aSegments;
...
occ::handle<StepGeom_HArray2OfSurfacePatch> StepGeom_RectangularCompositeSurface::Segments() const
{
  return segments;
}
