...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> ArrReal() const;

  Standard_EXPORT void SetArrReal(const occ::handle<TColStd_HArray1OfReal>& arr);

  DEFINE_STANDARD_RTTIEXT(StepData_SelectArrReal, StepData_SelectNamed)

private:
  occ::handle<TColStd_HArray1OfReal> theArr;
};
