...
public:
  ...
  Standard_EXPORT void SendArrReal(const occ::handle<TColStd_HArray1OfReal>& anArr);
...
private:
  ...
  occ::handle<TColStd_HSequenceOfHAsciiString> thefile;
  ...
  int                        thenum;
  int                        thelabmode;
  occ::handle<TColStd_HArray1OfInteger>        thescopebeg;
  occ::handle<TColStd_HArray1OfInteger>        thescopeend;
  occ::handle<TColStd_HArray1OfInteger>        thescopenext;
};
