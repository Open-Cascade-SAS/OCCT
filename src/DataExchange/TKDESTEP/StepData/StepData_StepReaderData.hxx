...
public:
  ...
  Standard_EXPORT int SubListNumber(const int num,
                                                 const int nump,
  ...
  Standard_EXPORT int
    FindNextRecord(const int num) const override;
...
private:
  ...
  Standard_EXPORT int FindEntityNumber(const int num,
                                                    const int id) const;
