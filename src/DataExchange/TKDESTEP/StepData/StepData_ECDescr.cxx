...
occ::handle<TColStd_HSequenceOfAsciiString> StepData_ECDescr::TypeList() const
{
  occ::handle<TColStd_HSequenceOfAsciiString> tl = new TColStd_HSequenceOfAsciiString();
  int                       i, nb = NbMembers();
  for (i = 1; i <= nb; i++)
  {
