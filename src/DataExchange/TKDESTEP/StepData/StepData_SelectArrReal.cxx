...
occ::handle<TColStd_HArray1OfReal> StepData_SelectArrReal::ArrReal() const
{
  return theArr;
}
...
void StepData_SelectArrReal::SetArrReal(const occ::handle<TColStd_HArray1OfReal>& arr)
{
  theArr = arr;
}
