...
occ::handle<TColStd_HSequenceOfAsciiString> StepData_FreeFormEntity::TypeList() const
{
  occ::handle<TColStd_HSequenceOfAsciiString> li = new TColStd_HSequenceOfAsciiString();
  li->Append(thetype);
