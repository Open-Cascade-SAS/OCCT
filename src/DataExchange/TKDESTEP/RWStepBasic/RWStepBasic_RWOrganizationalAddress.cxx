  ...
  const occ::handle<StepBasic_OrganizationalAddress>& ent) const
{
  ...
  occ::handle<StepBasic_HArray1OfOrganization> aOrganizations;
...
void RWStepBasic_RWOrganizationalAddress::Share(const occ::handle<StepBasic_OrganizationalAddress>& ent,
