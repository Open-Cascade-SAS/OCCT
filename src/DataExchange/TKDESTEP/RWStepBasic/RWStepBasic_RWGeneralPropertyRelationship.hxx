...
public:
  ...
  Standard_EXPORT void ReadStep (const occ::handle<StepData_StepReaderData>& theData,
                                 const int theNum,
  ...
  Standard_EXPORT void Share (const occ::handle<StepBasic_GeneralPropertyRelationship>& theEnt,
