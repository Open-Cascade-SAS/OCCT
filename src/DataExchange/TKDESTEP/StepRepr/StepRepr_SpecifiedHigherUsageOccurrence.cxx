...
occ::handle<StepRepr_AssemblyComponentUsage> StepRepr_SpecifiedHigherUsageOccurrence::UpperUsage() const
{
...
occ::handle<StepRepr_NextAssemblyUsageOccurrence> StepRepr_SpecifiedHigherUsageOccurrence::NextUsage()
  const
{
  return theNextUsage;
}
