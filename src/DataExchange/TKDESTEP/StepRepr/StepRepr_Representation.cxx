...
void StepRepr_Representation::SetItems(const occ::handle<StepRepr_HArray1OfRepresentationItem>& aItems)
{
  items = aItems;
}

occ::handle<StepRepr_HArray1OfRepresentationItem> StepRepr_Representation::Items() const
{
  return items;
}
