...
void StepRepr_Representation::Init(const occ::handle<TCollection_HAsciiString>&             aName,
...
void StepRepr_Representation::SetItems(const occ::handle<NCollection_HArray1<occ::handle<StepRepr_RepresentationItem>>>& aItems)
{
  items = aItems;
}

occ::handle<NCollection_HArray1<occ::handle<StepRepr_RepresentationItem>>> StepRepr_Representation::Items() const
{
  return items;
}

occ::handle<StepRepr_RepresentationItem> StepRepr_Representation::ItemsValue(
  const int num) const
{
