  ...
  occ::handle<Standard_Transient>             theSharing)
{
  ...
  bool                                     isReplaced     = false;
  occ::handle<StepGeom_HArray1OfCartesianPoint> aControlPoints = aSharing->ControlPointsList();
  ...
  occ::handle<Standard_Transient>             theSharing)
{
  ...
  bool                                     isReplaced     = false;
  occ::handle<StepGeom_HArray2OfCartesianPoint> aControlPoints = aSharing->ControlPointsList();
  ...
  occ::handle<Standard_Transient>             theSharing)
{
  ...
  bool                            isReplaced           = false;
  occ::handle<StepRepr_HArray1OfRepresentationItem> anItems = aSharing->Items();
