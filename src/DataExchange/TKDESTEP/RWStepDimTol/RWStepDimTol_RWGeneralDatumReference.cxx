  ...
  const occ::handle<StepDimTol_GeneralDatumReference>& ent) const
{
  ...
  {
    occ::handle<StepDimTol_HArray1OfDatumReferenceElement> anItems;
  ...
  occ::handle<StepDimTol_HArray1OfDatumReferenceModifier> aModifiers;
  if (hasModifiers)
  {
  ...
  const occ::handle<StepDimTol_GeneralDatumReference>& ent) const
{
  ...
  {
    occ::handle<StepDimTol_HArray1OfDatumReferenceElement> anArray = ent->Base().CommonDatumList();
