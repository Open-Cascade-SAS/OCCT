...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepDimTol_HArray1OfToleranceZoneTarget>& theDefiningTolerance,
    const occ::handle<StepDimTol_ToleranceZoneForm>&            theForm);

  //! Returns field DefiningTolerance
  inline occ::handle<StepDimTol_HArray1OfToleranceZoneTarget> DefiningTolerance() const
  {
...
private:
  occ::handle<StepDimTol_HArray1OfToleranceZoneTarget> myDefiningTolerance;
