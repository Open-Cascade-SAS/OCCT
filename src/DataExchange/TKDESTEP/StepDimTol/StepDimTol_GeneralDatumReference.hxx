...
public:
  ...
  inline occ::handle<StepDimTol_HArray1OfDatumReferenceModifier> Modifiers() { return myModifiers; }

  //! Set field Modifiers
  inline void SetModifiers(const occ::handle<StepDimTol_HArray1OfDatumReferenceModifier>& theModifiers)
  {
  ...
  inline void ModifiersValue(const int                   theNum,
...
private:
  ...
  occ::handle<StepDimTol_HArray1OfDatumReferenceModifier> myModifiers;
};
