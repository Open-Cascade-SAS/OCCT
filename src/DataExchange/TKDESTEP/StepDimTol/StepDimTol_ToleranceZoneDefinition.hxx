...
public:
  ...
  inline occ::handle<StepRepr_HArray1OfShapeAspect> Boundaries() const { return myBoundaries; }

  //! Set field Boundaries
  inline void SetBoundaries(const occ::handle<StepRepr_HArray1OfShapeAspect>& theBoundaries)
  {
...
private:
  occ::handle<StepRepr_HArray1OfShapeAspect> myBoundaries;
