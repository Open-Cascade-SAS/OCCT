...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepDimTol_HArray1OfDatumReferenceCompartment>& theConstituents);

  //! Returns field Constituents
  inline occ::handle<StepDimTol_HArray1OfDatumReferenceCompartment> Constituents()
  {
...
private:
  occ::handle<StepDimTol_HArray1OfDatumReferenceCompartment> myConstituents;
};
