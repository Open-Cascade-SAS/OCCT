...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<Interface_HArray1OfHAsciiString>& aSchemaIdentifiers);

  Standard_EXPORT void SetSchemaIdentifiers(
    const occ::handle<Interface_HArray1OfHAsciiString>& aSchemaIdentifiers);

  Standard_EXPORT occ::handle<Interface_HArray1OfHAsciiString> SchemaIdentifiers() const;
...
private:
  occ::handle<Interface_HArray1OfHAsciiString> schemaIdentifiers;
};
