...
void HeaderSection_FileName::Init(const occ::handle<TCollection_HAsciiString>&        aName,
                                  ...
                                  const occ::handle<Interface_HArray1OfHAsciiString>& aAuthor,
...
void HeaderSection_FileName::SetAuthor(const occ::handle<Interface_HArray1OfHAsciiString>& aAuthor)
{
  author = aAuthor;
}

occ::handle<Interface_HArray1OfHAsciiString> HeaderSection_FileName::Author() const
{
  return author;
}
...
occ::handle<Interface_HArray1OfHAsciiString> HeaderSection_FileName::Organization() const
{
  return organization;
}
