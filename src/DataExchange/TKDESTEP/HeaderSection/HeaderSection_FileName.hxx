...
public:
  ...
  Standard_EXPORT void SetAuthor(const occ::handle<Interface_HArray1OfHAsciiString>& aAuthor);

  Standard_EXPORT occ::handle<Interface_HArray1OfHAsciiString> Author() const;
  ...
  Standard_EXPORT occ::handle<Interface_HArray1OfHAsciiString> Organization() const;
...
private:
  ...
  occ::handle<Interface_HArray1OfHAsciiString> author;
  occ::handle<Interface_HArray1OfHAsciiString> organization;
