...
void RWStepShape_RWGeometricallyBoundedSurfaceShapeRepresentation::ReadStep(
  ...
  const occ::handle<StepShape_GeometricallyBoundedSurfaceShapeRepresentation>& ent) const
{
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem> aItems;
...
void RWStepShape_RWGeometricallyBoundedSurfaceShapeRepresentation::Share(
  const occ::handle<StepShape_GeometricallyBoundedSurfaceShapeRepresentation>& ent,
