...
void RWStepShape_RWGeometricallyBoundedWireframeShapeRepresentation::ReadStep(
  ...
  const occ::handle<StepShape_GeometricallyBoundedWireframeShapeRepresentation>& ent) const
{
...
void RWStepShape_RWGeometricallyBoundedWireframeShapeRepresentation::Share(
  const occ::handle<StepShape_GeometricallyBoundedWireframeShapeRepresentation>& ent,
