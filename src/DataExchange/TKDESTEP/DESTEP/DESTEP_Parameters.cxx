...
{
  ReadBSplineContinuity = static_cast<DESTEP_Parameters::ReadMode_BSplineContinuity>(
    Interface_Static::IVal("read.iges.bspline.continuity"));
  ReadPrecisionMode = static_cast<DESTEP_Parameters::ReadMode_Precision>(
    Interface_Static::IVal("read.precision.mode"));
  ReadPrecisionVal     = Interface_Static::RVal("read.precision.val");
  ReadMaxPrecisionMode = static_cast<DESTEP_Parameters::ReadMode_MaxPrecision>(
  ...
  ReadSurfaceCurveMode = static_cast<DESTEP_Parameters::ReadMode_SurfaceCurve>(
    Interface_Static::IVal("read.surfacecurve.mode"));
  EncodeRegAngle = Interface_Static::RVal("read.encoderegularity.angle") * 180.0 / M_PI;
  AngleUnit =
    static_cast<DESTEP_Parameters::AngleUnitMode>(Interface_Static::IVal("step.angleunit.mode"));

  ReadProductMode    = Interface_Static::IVal("read.step.product.mode") == 1;
  ReadProductContext = static_cast<DESTEP_Parameters::ReadMode_ProductContext>(
    Interface_Static::IVal("read.step.product.context"));
  ReadShapeRepr = static_cast<DESTEP_Parameters::ReadMode_ShapeRepr>(
    Interface_Static::IVal("read.step.shape.repr"));
  ReadTessellated = static_cast<DESTEP_Parameters::RWMode_Tessellated>(
    Interface_Static::IVal("read.step.tessellated"));
  ReadAssemblyLevel = static_cast<DESTEP_Parameters::ReadMode_AssemblyLevel>(
  ...
  WritePrecisionMode = static_cast<DESTEP_Parameters::WriteMode_PrecisionMode>(
    Interface_Static::IVal("write.precision.mode"));
  WritePrecisionVal = Interface_Static::RVal("write.precision.val");
  WriteAssembly     = static_cast<DESTEP_Parameters::WriteMode_Assembly>(
    Interface_Static::IVal("write.step.assembly"));
  WriteSchema = static_cast<DESTEP_Parameters::WriteMode_StepSchema>(
    Interface_Static::IVal("write.step.schema"));
  WriteTessellated = static_cast<DESTEP_Parameters::RWMode_Tessellated>(
  ...
  WriteVertexMode = static_cast<DESTEP_Parameters::WriteMode_VertexMode>(
  ...
  WriteModelType =
    static_cast<STEPControl_StepModelType>(Interface_Static::IVal("write.model.type"));
}
