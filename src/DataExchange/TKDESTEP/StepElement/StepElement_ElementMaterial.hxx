...
public:
  ...
  Standard_EXPORT occ::handle<StepRepr_HArray1OfMaterialPropertyRepresentation> Properties() const;

  //! Set field Properties
  Standard_EXPORT void SetProperties(
    const occ::handle<StepRepr_HArray1OfMaterialPropertyRepresentation>& Properties);
...
private:
  ...
  occ::handle<StepRepr_HArray1OfMaterialPropertyRepresentation> theProperties;
};
