...
void StepElement_SurfaceSectionFieldVarying::Init(
  const occ::handle<StepElement_HArray1OfSurfaceSection>& aDefinitions,
...
occ::handle<StepElement_HArray1OfSurfaceSection> StepElement_SurfaceSectionFieldVarying::Definitions()
  const
{
