...
void StepElement_ElementMaterial::Init(
  ...
  const occ::handle<StepRepr_HArray1OfMaterialPropertyRepresentation>& aProperties)
{
...
occ::handle<StepRepr_HArray1OfMaterialPropertyRepresentation> StepElement_ElementMaterial::Properties()
  const
{
