...
public:
  ...
  Standard_EXPORT void Init(const bool                   hasAinternalLocation,
                            ...
                            const occ::handle<StepBasic_HArray1OfPerson>& aPeople,
                            const occ::handle<TCollection_HAsciiString>&  aDescription);

  Standard_EXPORT void SetPeople(const occ::handle<StepBasic_HArray1OfPerson>& aPeople);

  Standard_EXPORT occ::handle<StepBasic_HArray1OfPerson> People() const;
...
private:
  occ::handle<StepBasic_HArray1OfPerson> people;
