...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&             aId,
                            ...
                            const occ::handle<StepBasic_HArray1OfDocument>&          aDocIds);

  Standard_EXPORT occ::handle<StepBasic_HArray1OfDocument> DocIds() const;

  Standard_EXPORT void SetDocIds(const occ::handle<StepBasic_HArray1OfDocument>& DocIds);

  Standard_EXPORT int NbDocIds() const;

  Standard_EXPORT occ::handle<StepBasic_Document> DocIdsValue(const int num) const;

  Standard_EXPORT void SetDocIdsValue(const int            num,
...
private:
  occ::handle<StepBasic_HArray1OfDocument> theDocIds;
};
