...
void StepBasic_PersonalAddress::SetPeople(const occ::handle<StepBasic_HArray1OfPerson>& aPeople)
{
  people = aPeople;
}

occ::handle<StepBasic_HArray1OfPerson> StepBasic_PersonalAddress::People() const
{
  return people;
}
