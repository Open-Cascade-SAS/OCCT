...
void StepBasic_DerivedUnit::Init(const occ::handle<StepBasic_HArray1OfDerivedUnitElement>& elements)
{
  theElements = elements;
}

void StepBasic_DerivedUnit::SetElements(
  const occ::handle<StepBasic_HArray1OfDerivedUnitElement>& elements)
{
  theElements = elements;
}

occ::handle<StepBasic_HArray1OfDerivedUnitElement> StepBasic_DerivedUnit::Elements() const
{
  return theElements;
}
