...
public:
  ...
  Standard_EXPORT void Init(const bool                  hasAinternalLocation,
                            ...
                            const occ::handle<StepBasic_HArray1OfOrganization>& aOrganizations,
                            const occ::handle<TCollection_HAsciiString>&        aDescription);

  Standard_EXPORT void SetOrganizations(
    const occ::handle<StepBasic_HArray1OfOrganization>& aOrganizations);

  Standard_EXPORT occ::handle<StepBasic_HArray1OfOrganization> Organizations() const;
...
private:
  occ::handle<StepBasic_HArray1OfOrganization> organizations;
