...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&          aId,
                            ...
                            const occ::handle<StepBasic_HArray1OfProductContext>& aFrameOfReference);
  ...
  Standard_EXPORT occ::handle<StepBasic_HArray1OfProductContext> FrameOfReference() const;
...
private:
  ...
  occ::handle<StepBasic_HArray1OfProductContext> frameOfReference;
};
