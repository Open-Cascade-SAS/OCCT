...
void StepBasic_ProductDefinitionRelationship::SetId(const occ::handle<TCollection_HAsciiString>& aId)
{
  theId = aId;
}
...
void StepBasic_ProductDefinitionRelationship::SetName(const occ::handle<TCollection_HAsciiString>& aName)
{
  theName = aName;
}
