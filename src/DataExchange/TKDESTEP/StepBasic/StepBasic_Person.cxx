...
void StepBasic_Person::SetMiddleNames(const occ::handle<Interface_HArray1OfHAsciiString>& aMiddleNames)
{
  middleNames    = aMiddleNames;
  hasMiddleNames = true;
}
...
occ::handle<Interface_HArray1OfHAsciiString> StepBasic_Person::MiddleNames() const
{
  return middleNames;
}
...
void StepBasic_Person::SetPrefixTitles(const occ::handle<Interface_HArray1OfHAsciiString>& aPrefixTitles)
{
  prefixTitles    = aPrefixTitles;
...
occ::handle<Interface_HArray1OfHAsciiString> StepBasic_Person::PrefixTitles() const
{
  return prefixTitles;
}
...
void StepBasic_Person::SetSuffixTitles(const occ::handle<Interface_HArray1OfHAsciiString>& aSuffixTitles)
{
  suffixTitles    = aSuffixTitles;
...
occ::handle<Interface_HArray1OfHAsciiString> StepBasic_Person::SuffixTitles() const
{
  return suffixTitles;
}
