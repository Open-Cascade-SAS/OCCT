                                                       ...
                                                       const StepData_Factors& theLocalFactors)
{
  ...
  if (SC->IsKind(STANDARD_TYPE(StepGeom_BezierCurve)))
  {
    ...
    const occ::handle<TColStd_HArray1OfInteger> Kmult = new TColStd_HArray1OfInteger(1, 2);
    const occ::handle<TColStd_HArray1OfReal>    Knots = new TColStd_HArray1OfReal(1, 2);
  ...
  if (SC->IsKind(STANDARD_TYPE(StepGeom_UniformCurve)))
  {
    ...
    const occ::handle<TColStd_HArray1OfInteger> Kmult = new TColStd_HArray1OfInteger(1, nbK);
    const occ::handle<TColStd_HArray1OfReal>    Knots = new TColStd_HArray1OfReal(1, nbK);
  ...
  const StepData_Factors&                theLocalFactors)
{
  ...
  if (SS->IsKind(STANDARD_TYPE(StepGeom_BezierSurface)))
  {
    ...
    // Compute Knots and KnotsMultiplicity
    const occ::handle<TColStd_HArray1OfInteger> UKmult = new TColStd_HArray1OfInteger(1, 2);
    const occ::handle<TColStd_HArray1OfInteger> VKmult = new TColStd_HArray1OfInteger(1, 2);
    const occ::handle<TColStd_HArray1OfReal>    UKnots = new TColStd_HArray1OfReal(1, 2);
    const occ::handle<TColStd_HArray1OfReal>    VKnots = new TColStd_HArray1OfReal(1, 2);
  ...
  if (SS->IsKind(STANDARD_TYPE(StepGeom_UniformSurface)))
  {
    ...
    const occ::handle<TColStd_HArray1OfInteger> UKmult = new TColStd_HArray1OfInteger(1, nbKU);
    const occ::handle<TColStd_HArray1OfReal>    UKnots = new TColStd_HArray1OfReal(1, nbKU);
    ...
    const occ::handle<TColStd_HArray1OfInteger> VKmult = new TColStd_HArray1OfInteger(1, nbKV);
    const occ::handle<TColStd_HArray1OfReal>    VKnots = new TColStd_HArray1OfReal(1, nbKV);
                                                   ...
                                                   const StepData_Factors&))
{
  ...
  const occ::handle<TColStd_HArray1OfInteger>& aKnotMultiplicities =
    aBSplineCurveWithKnots->KnotMultiplicities();
  const occ::handle<TColStd_HArray1OfReal>& aKnots = aBSplineCurveWithKnots->Knots();
  ...
  if (theStepGeom_BSplineCurve->IsKind(
        STANDARD_TYPE(StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve)))
  {
    const occ::handle<TColStd_HArray1OfReal>& aWeights =
  ...
  const StepData_Factors&                theLocalFactors)
{
  ...
  const occ::handle<StepGeom_HArray2OfCartesianPoint>& aControlPointsList = BS->ControlPointsList();
  ...
  const occ::handle<TColStd_HArray1OfInteger>& aUMultiplicities = BS->UMultiplicities();
  const occ::handle<TColStd_HArray1OfReal>&    aUKnots          = BS->UKnots();
  ...
  const occ::handle<TColStd_HArray1OfInteger>& aVMultiplicities = BS->VMultiplicities();
  const occ::handle<TColStd_HArray1OfReal>&    aVKnots          = BS->VKnots();
  ...
  if (SS->IsKind(STANDARD_TYPE(StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface)))
  {
    const occ::handle<TColStd_HArray2OfReal>& aWeight = BSR->WeightsData();
...
static bool ExtractParameter(const occ::handle<Geom_Curve>&                       aGeomCurve,
                                         const occ::handle<StepGeom_HArray1OfTrimmingSelect>& TS,
                                         const int                          nbSel,
                                         const int                          MasterRep,
                                         const double                             Factor,
                                         const double                             Shift,
                                                       ...
                                                       const StepData_Factors& theLocalFactors)
{
  ...
  const occ::handle<StepGeom_HArray1OfTrimmingSelect>& theTrimSel1 = SC->Trim1();
  const occ::handle<StepGeom_HArray1OfTrimmingSelect>& theTrimSel2 = SC->Trim2();
...
occ::handle<TColStd_HArray1OfReal> StepToGeom::MakeYprRotation(
  ...
  const occ::handle<StepRepr_GlobalUnitAssignedContext>& theCntxt)
{
  ...
  occ::handle<TColStd_HArray1OfReal> anYPRRotation;
