                                             ...
                                             Interface_CopyTool&               TC) const
{
  ...
  switch (CN)
  {
    ...
    case 1: {
      ...
      occ::handle<Interface_HArray1OfHAsciiString> auth = new Interface_HArray1OfHAsciiString(1, nba);
      for (i = 1; i <= nba; i++)
        auth->SetValue(i, new TCollection_HAsciiString(enfr->AuthorValue(i)));
      int                        nbo  = enfr->NbOrganization();
      occ::handle<Interface_HArray1OfHAsciiString> orga = new Interface_HArray1OfHAsciiString(1, nbo);
      for (i = 1; i <= nbo; i++)
    ...
    case 2: {
      ...
      occ::handle<Interface_HArray1OfHAsciiString> desc = new Interface_HArray1OfHAsciiString(1, nbd);
      for (i = 1; i <= nbd; i++)
    ...
    case 3: {
      ...
      occ::handle<Interface_HArray1OfHAsciiString> sche = new Interface_HArray1OfHAsciiString(1, nbs);
      for (i = 1; i <= nbs; i++)
