...
static occ::handle<Interface_HArray1OfHAsciiString> nularr;
...
void APIHeaderSection_MakeHeader::Init(const char* nameval)
{
  ...
  fn->SetTimeStamp(tst);
  occ::handle<Interface_HArray1OfHAsciiString> authors = new Interface_HArray1OfHAsciiString(1, 1);
  occ::handle<TCollection_HAsciiString>        a1      = new TCollection_HAsciiString("Author");
  authors->SetValue(1, a1);
  fn->SetAuthor(authors);
  occ::handle<Interface_HArray1OfHAsciiString> org  = new Interface_HArray1OfHAsciiString(1, 1);
  ...
  occ::handle<Interface_HArray1OfHAsciiString> descr = new Interface_HArray1OfHAsciiString(1, 1);
  ...
  occ::handle<Interface_HArray1OfHAsciiString> schid  = new Interface_HArray1OfHAsciiString(1, 1);
...
void APIHeaderSection_MakeHeader::Apply(const occ::handle<StepData_StepModel>& model) const
{
  ...
  if (HasFs() && !model->HasHeaderEntity(STANDARD_TYPE(HeaderSection_FileSchema)))
  {
    ...
    occ::handle<Interface_HArray1OfHAsciiString> schid = fs->SchemaIdentifiers();
    if (!schid.IsNull())
      sch = schid->Value(1);
    else
    {
...
void APIHeaderSection_MakeHeader::SetAuthor(const occ::handle<Interface_HArray1OfHAsciiString>& aAuthor)
{
  if (!fn.IsNull())
                                                 ...
                                                 const occ::handle<TCollection_HAsciiString>& aAuthor)
{
  if (fn.IsNull())
    return;
  occ::handle<Interface_HArray1OfHAsciiString> li = fn->Author();
  if (num >= li->Lower() && num <= li->Upper())
    li->SetValue(num, aAuthor);
}

occ::handle<Interface_HArray1OfHAsciiString> APIHeaderSection_MakeHeader::Author() const
{
...
void APIHeaderSection_MakeHeader::SetOrganization(
  const occ::handle<Interface_HArray1OfHAsciiString>& aOrganization)
{
  if (!fn.IsNull())
  ...
  const occ::handle<TCollection_HAsciiString>& aOrgan)
{
  if (fn.IsNull())
    return;
  occ::handle<Interface_HArray1OfHAsciiString> li = fn->Organization();
  if (num >= li->Lower() && num <= li->Upper())
    li->SetValue(num, aOrgan);
}

occ::handle<Interface_HArray1OfHAsciiString> APIHeaderSection_MakeHeader::Organization() const
{
...
void APIHeaderSection_MakeHeader::SetSchemaIdentifiers(
  const occ::handle<Interface_HArray1OfHAsciiString>& aSchemaIdentifiers)
{
  if (!fs.IsNull())
  ...
  const occ::handle<TCollection_HAsciiString>& aSchem)
{
  if (fs.IsNull())
    return;
  occ::handle<Interface_HArray1OfHAsciiString> li = fs->SchemaIdentifiers();
  if (num >= li->Lower() && num <= li->Upper())
    li->SetValue(num, aSchem);
}

occ::handle<Interface_HArray1OfHAsciiString> APIHeaderSection_MakeHeader::SchemaIdentifiers() const
{
  ...
  const occ::handle<TCollection_HAsciiString>& aSchem)
{
  if (fs.IsNull())
    fs = new HeaderSection_FileSchema;
  occ::handle<Interface_HArray1OfHAsciiString> idents = fs->SchemaIdentifiers();
  ...
  // add a subshema
  occ::handle<Interface_HArray1OfHAsciiString> ids =
...
void APIHeaderSection_MakeHeader::SetDescription(
  const occ::handle<Interface_HArray1OfHAsciiString>& aDescription)
{
  if (!fs.IsNull())
  ...
  const occ::handle<TCollection_HAsciiString>& aDescr)
{
  if (fd.IsNull())
    return;
  occ::handle<Interface_HArray1OfHAsciiString> li = fd->Description();
  if (num >= li->Lower() && num <= li->Upper())
    li->SetValue(num, aDescr);
}

occ::handle<Interface_HArray1OfHAsciiString> APIHeaderSection_MakeHeader::Description() const
{
