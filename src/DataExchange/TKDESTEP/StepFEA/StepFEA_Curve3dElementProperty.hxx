...
public:
  ...
  Standard_EXPORT occ::handle<StepFEA_HArray1OfCurveElementInterval> IntervalDefinitions() const;

  //! Set field IntervalDefinitions
  Standard_EXPORT void SetIntervalDefinitions(
    const occ::handle<StepFEA_HArray1OfCurveElementInterval>& IntervalDefinitions);

  //! Returns field EndOffsets
  Standard_EXPORT occ::handle<StepFEA_HArray1OfCurveElementEndOffset> EndOffsets() const;

  //! Set field EndOffsets
  Standard_EXPORT void SetEndOffsets(
    const occ::handle<StepFEA_HArray1OfCurveElementEndOffset>& EndOffsets);

  //! Returns field EndReleases
  Standard_EXPORT occ::handle<StepFEA_HArray1OfCurveElementEndRelease> EndReleases() const;

  //! Set field EndReleases
  Standard_EXPORT void SetEndReleases(
    const occ::handle<StepFEA_HArray1OfCurveElementEndRelease>& EndReleases);
...
private:
  ...
  occ::handle<StepFEA_HArray1OfCurveElementInterval>   theIntervalDefinitions;
  occ::handle<StepFEA_HArray1OfCurveElementEndOffset>  theEndOffsets;
  occ::handle<StepFEA_HArray1OfCurveElementEndRelease> theEndReleases;
};
