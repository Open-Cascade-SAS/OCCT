...
public:
  ...
  Standard_EXPORT occ::handle<NCollection_HArray1<occ::handle<StepFEA_ElementRepresentation>>> Elements() const;

  //! Set field Elements
  Standard_EXPORT void SetElements(const occ::handle<NCollection_HArray1<occ::handle<StepFEA_ElementRepresentation>>>& Elements);
