...
occ::handle<StepFEA_HArray1OfNodeRepresentation> StepFEA_NodeSet::Nodes() const
{
  return theNodes;
}
...
void StepFEA_NodeSet::SetNodes(const occ::handle<StepFEA_HArray1OfNodeRepresentation>& aNodes)
{
  theNodes = aNodes;
}
