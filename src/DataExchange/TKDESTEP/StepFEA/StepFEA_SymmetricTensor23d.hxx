...
public:
  ...
  Standard_EXPORT void SetOrthotropicSymmetricTensor23d(const occ::handle<TColStd_HArray1OfReal>& aVal);

  //! Returns Value as OrthotropicSymmetricTensor23d (or Null if another type)
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> OrthotropicSymmetricTensor23d() const;

  //! Set Value for AnisotropicSymmetricTensor23d
  Standard_EXPORT void SetAnisotropicSymmetricTensor23d(const occ::handle<TColStd_HArray1OfReal>& aVal);

  //! Returns Value as AnisotropicSymmetricTensor23d (or Null if another type)
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> AnisotropicSymmetricTensor23d() const;
