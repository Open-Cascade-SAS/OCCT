...
public:
  ...
  Standard_EXPORT void SetOrthotropicSymmetricTensor23d(const occ::handle<NCollection_HArray1<double>>& aVal);
  ...
  Standard_EXPORT void SetAnisotropicSymmetricTensor23d(const occ::handle<NCollection_HArray1<double>>& aVal);
