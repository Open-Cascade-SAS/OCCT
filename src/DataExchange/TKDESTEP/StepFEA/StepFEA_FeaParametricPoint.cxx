...
occ::handle<TColStd_HArray1OfReal> StepFEA_FeaParametricPoint::Coordinates() const
{
...
void StepFEA_FeaParametricPoint::SetCoordinates(const occ::handle<TColStd_HArray1OfReal>& aCoordinates)
{
  theCoordinates = aCoordinates;
}
