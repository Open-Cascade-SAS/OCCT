...
void StepFEA_Curve3dElementProperty::Init(
  ...
  const occ::handle<StepFEA_HArray1OfCurveElementInterval>&   aIntervalDefinitions,
  const occ::handle<StepFEA_HArray1OfCurveElementEndOffset>&  aEndOffsets,
  const occ::handle<StepFEA_HArray1OfCurveElementEndRelease>& aEndReleases)
{
...
occ::handle<StepFEA_HArray1OfCurveElementInterval> StepFEA_Curve3dElementProperty::IntervalDefinitions()
  const
{
...
occ::handle<StepFEA_HArray1OfCurveElementEndOffset> StepFEA_Curve3dElementProperty::EndOffsets() const
{
...
occ::handle<StepFEA_HArray1OfCurveElementEndRelease> StepFEA_Curve3dElementProperty::EndReleases() const
{
