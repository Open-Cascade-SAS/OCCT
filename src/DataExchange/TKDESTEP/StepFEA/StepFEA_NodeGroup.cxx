...
occ::handle<StepFEA_HArray1OfNodeRepresentation> StepFEA_NodeGroup::Nodes() const
{
  return theNodes;
}
...
void StepFEA_NodeGroup::SetNodes(const occ::handle<StepFEA_HArray1OfNodeRepresentation>& aNodes)
{
  theNodes = aNodes;
}
