...
void StepFEA_NodeGroup::Init(const occ::handle<TCollection_HAsciiString>&            aGroup_Name,
...
occ::handle<NCollection_HArray1<occ::handle<StepFEA_NodeRepresentation>>> StepFEA_NodeGroup::Nodes() const
{
  return theNodes;
}
...
void StepFEA_NodeGroup::SetNodes(const occ::handle<NCollection_HArray1<occ::handle<StepFEA_NodeRepresentation>>>& aNodes)
{
  theNodes = aNodes;
}
