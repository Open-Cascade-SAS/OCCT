...
void StepFEA_ElementGroup::Init(const occ::handle<TCollection_HAsciiString>& aGroup_Name,
...
occ::handle<StepFEA_HArray1OfElementRepresentation> StepFEA_ElementGroup::Elements() const
{
  return theElements;
}
