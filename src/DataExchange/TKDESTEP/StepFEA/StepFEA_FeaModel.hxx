...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<TColStd_HArray1OfAsciiString>&         aIntendedAnalysisCode,
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfAsciiString> IntendedAnalysisCode() const;

  //! Set field IntendedAnalysisCode
  Standard_EXPORT void SetIntendedAnalysisCode(
    const occ::handle<TColStd_HArray1OfAsciiString>& IntendedAnalysisCode);
...
private:
  ...
  occ::handle<TColStd_HArray1OfAsciiString> theIntendedAnalysisCode;
