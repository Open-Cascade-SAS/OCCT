...
static void InitTriangulation(const occ::handle<Poly_Triangulation>&       theMesh,
                              ...
                              occ::handle<TColgp_HArray1OfXYZ>&            thePoints,
                              occ::handle<TColStd_HArray2OfReal>&          theNormals,
                              occ::handle<TColStd_HArray1OfInteger>&       theIndices,
                              occ::handle<TColStd_HArray2OfInteger>&       theTrias,
                                            ...
                                            const Message_ProgressRange& theProgress)
{
  ...
  occ::handle<TColgp_HArray1OfXYZ>        aPoints      = new TColgp_HArray1OfXYZ(1, aMesh->NbNodes());
  occ::handle<TColStd_HArray2OfReal>    aNormals  = new TColStd_HArray2OfReal(1, aMesh->NbNodes(), 1, 3);
  occ::handle<TColStd_HArray1OfInteger> anIndices = new TColStd_HArray1OfInteger(1, aMesh->NbNodes());
  occ::handle<TColStd_HArray2OfInteger> aTrias =
                                            ...
                                            const Message_ProgressRange&          theProgress)
{
  ...
  occ::handle<StepVisual_HArray1OfTessellatedStructuredItem> anItems =
