...
void TopoDSToStep_WireframeBuilder::Init(const TopoDS_Shape& aShape,
                                         ...
                                         const StepData_Factors& theLocalFactors)
{
  occ::handle<TColStd_HSequenceOfTransient> itemList = new TColStd_HSequenceOfTransient();
  NCollection_DataMap<TopoDS_Shape, occ::handle<Standard_Transient>, TopTools_ShapeMapHasher>     aPmsMap;
...
const occ::handle<TColStd_HSequenceOfTransient>& TopoDSToStep_WireframeBuilder::Value() const
{
...
static occ::handle<StepGeom_TrimmedCurve> MakeTrimmedCurve(const occ::handle<StepGeom_Curve>&          C,
                                                      ...
                                                      bool                       sense)
{
  occ::handle<StepGeom_HArray1OfTrimmingSelect> aSTS1 = new StepGeom_HArray1OfTrimmingSelect(1, 2);
  ...
  occ::handle<StepGeom_HArray1OfTrimmingSelect> aSTS2 = new StepGeom_HArray1OfTrimmingSelect(1, 2);
  tSel.SetValue(P2);
...
bool TopoDSToStep_WireframeBuilder::GetTrimmedCurveFromEdge(
  ...
  NCollection_DataMap<TopoDS_Shape, occ::handle<Standard_Transient>, TopTools_ShapeMapHasher>&     theMap,
  occ::handle<TColStd_HSequenceOfTransient>& theCurveList,
...
bool TopoDSToStep_WireframeBuilder::GetTrimmedCurveFromFace(
  ...
  occ::handle<TColStd_HSequenceOfTransient>& aCurveList,
  const StepData_Factors&               theLocalFactors) const
{
