  ...
  const Message_ProgressRange&          theProgress)
{
  ...
  if (StepB.IsDone())
  {
    ...
    if (!aFS.IsNull())
    {
      ...
      occ::handle<StepShape_HArray1OfFace> aCfsFaces  = new StepShape_HArray1OfFace(1, 1);
      ...
      occ::handle<StepShape_HArray1OfShell> aSbsmFaces = new StepShape_HArray1OfShell(1, 1);
  ...
  const Message_ProgressRange&          theProgress)
{
  ...
  StepShape_Shell                  aShellSelect;
  occ::handle<StepShape_HArray1OfShell> aSbsmBoundary;
