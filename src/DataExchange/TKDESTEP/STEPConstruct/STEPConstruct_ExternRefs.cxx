  ...
  const char*                     format)
{
  ...
  if (!(np > 0))
  {
    ...
    Item.SetValue(DF);
    occ::handle<StepAP214_HArray1OfExternalIdentificationItem> Items =
    ...
    if (format && format[0])
    {
      ...
      occ::handle<StepRepr_HArray1OfRepresentationItem> fItems =
  ...
  { // format=="AP203"
    ...
    occ::handle<StepBasic_HArray1OfDocument> aDocIds = new StepBasic_HArray1OfDocument(1, 1);
    ...
    for (subs2.Start(); subs2.More(); subs2.Next())
    {
      ...
      if (sub2->IsKind(STANDARD_TYPE(StepAP203_CcDesignPersonAndOrganizationAssignment)))
      {
        ...
        occ::handle<StepAP203_HArray1OfPersonOrganizationItem> HAPOI = CDPAOA->Items();
      ...
      if (sub2->IsKind(STANDARD_TYPE(StepAP203_CcDesignDateAndTimeAssignment)))
      {
        ...
        occ::handle<StepAP203_HArray1OfDateTimeItem> HADTI = CDDATA->Items();
      ...
      if (sub2->IsKind(STANDARD_TYPE(StepAP203_CcDesignApproval)))
      {
        ...
        occ::handle<StepAP203_HArray1OfApprovedItem> HAAI = CDA->Items();
...
bool STEPConstruct_ExternRefs::addAP214ExterRef(
  ...
  const char*                            filename)
{
  occ::handle<StepAP214_HArray1OfDocumentReferenceItem> DRIs =
  ...
  occ::handle<StepBasic_HArray1OfProduct> HProducts  = mySharedPRPC->Products();
  int                   nbProducts = 0;
  if (!HProducts.IsNull())
  ...
  occ::handle<StepBasic_HArray1OfProductContext> aHProdContext =
  ...
  occ::handle<StepBasic_HArray1OfProduct> newHProducts =
