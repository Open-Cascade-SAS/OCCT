...
occ::handle<StepBasic_PersonAndOrganization> STEPConstruct_AP203Context::DefaultPersonAndOrganization()
{
  if (defPersonAndOrganization.IsNull())
  {
    ...
    occ::handle<Interface_HArray1OfHAsciiString> mname;
    ...
    occ::handle<Interface_HArray1OfHAsciiString> suffix, prefix;
    aPerson->Init(uid,
                  true,
                  lname,
                  true,
...
void STEPConstruct_AP203Context::InitPart(const STEPConstruct_Part& SDRTool)
{
  if (myCreator.IsNull())
  {
    ...
    occ::handle<StepAP203_HArray1OfPersonOrganizationItem> items =
  ...
  if (myCreationDate.IsNull())
  {
    ...
    occ::handle<StepAP203_HArray1OfDateTimeItem> items = new StepAP203_HArray1OfDateTimeItem(1, 1);
  ...
  if (mySecurity.IsNull())
  {
    ...
    occ::handle<StepAP203_HArray1OfClassifiedItem> items = new StepAP203_HArray1OfClassifiedItem(1, 1);
    items->ChangeValue(1).SetValue(SDRTool.PDF());
  ...
  if (myApproval.IsNull())
  {
    ...
    occ::handle<StepAP203_HArray1OfApprovedItem> items = new StepAP203_HArray1OfApprovedItem(1, 3);
    items->ChangeValue(1).SetValue(SDRTool.PDF());
    items->ChangeValue(2).SetValue(SDRTool.PD());
  ...
  const occ::handle<StepRepr_NextAssemblyUsageOccurrence>& NAUO)
{
  ...
  {
    myApproval                                    = new StepAP203_CcDesignApproval;
    occ::handle<StepAP203_HArray1OfApprovedItem> items = new StepAP203_HArray1OfApprovedItem(1, 1);
