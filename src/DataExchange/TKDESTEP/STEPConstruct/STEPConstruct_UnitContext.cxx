                                     ...
                                     const StepData_Factors&           theLocalFactors)
{
  ...
  occ::handle<StepBasic_HArray1OfNamedUnit> units = new StepBasic_HArray1OfNamedUnit(1, 3);
  ...
  occ::handle<StepBasic_HArray1OfUncertaintyMeasureWithUnit> Tols =
  ...
  const StepData_Factors&                           theLocalFactors)
{
  ...
  // Start Computation
  occ::handle<StepBasic_HArray1OfNamedUnit> theUnits = aContext->Units();
