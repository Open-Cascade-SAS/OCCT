...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GetRootsForPart(
    const STEPConstruct_Part& SDRTool);

  //! Produces and returns a full list of root entities required
  //! for assembly link identified by assembly (including NAUO and CDSR)
  Standard_EXPORT occ::handle<TColStd_HSequenceOfTransient> GetRootsForAssemblyLink(
