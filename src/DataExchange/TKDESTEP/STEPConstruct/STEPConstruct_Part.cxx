                                 ...
                                 occ::handle<StepData_StepModel>&                  theStepModel)
{
  ...
  occ::handle<StepBasic_HArray1OfProductContext> PCs = new StepBasic_HArray1OfProductContext(1, 1);
  PCs->SetValue(1, PC);
  ...
  occ::handle<StepBasic_HArray1OfProduct> PRPCproducts = new StepBasic_HArray1OfProduct(1, 1);
