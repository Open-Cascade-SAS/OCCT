...
void StepAP214_AppliedOrganizationAssignment::Init(
  ...
  const occ::handle<StepAP214_HArray1OfOrganizationItem>& aItems)
{
  // --- classe own fields ---
  items = aItems;
...
occ::handle<StepAP214_HArray1OfOrganizationItem> StepAP214_AppliedOrganizationAssignment::Items() const
{
  return items;
}
