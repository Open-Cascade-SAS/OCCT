...
static const char* schemaAP242DIS = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF. {1 0 10303 442 1 1 4 }";
...
int StepAP214_Protocol::TypeNumber(const 
occ::handle<Standard_Type>& atype) const
{
...
const char* StepAP214_Protocol::SchemaName() const
{	
...
occ::handle<Interface_Protocol> StepAP214_Protocol::Resource
  (const int /*num*/) const
{
