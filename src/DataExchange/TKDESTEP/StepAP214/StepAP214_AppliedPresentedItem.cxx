...
void StepAP214_AppliedPresentedItem::Init(
  const occ::handle<StepAP214_HArray1OfPresentedItemSelect>& aItems)
{
  // --- classe own fields ---
  items = aItems;
}
...
occ::handle<StepAP214_HArray1OfPresentedItemSelect> StepAP214_AppliedPresentedItem::Items() const
{
  return items;
}
