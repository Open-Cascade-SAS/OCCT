...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<StepBasic_DateAndTime>&              aAssignedDateAndTime,
                            ...
                            const occ::handle<StepAP214_HArray1OfDateAndTimeItem>& aItems);

  Standard_EXPORT void SetItems(const occ::handle<StepAP214_HArray1OfDateAndTimeItem>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfDateAndTimeItem> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfDateAndTimeItem> items;
};
