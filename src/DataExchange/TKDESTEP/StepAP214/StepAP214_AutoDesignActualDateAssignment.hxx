...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<StepBasic_Date>&                         aAssignedDate,
                            ...
                            const occ::handle<StepAP214_HArray1OfAutoDesignDatedItem>& aItems);

  Standard_EXPORT void SetItems(const occ::handle<StepAP214_HArray1OfAutoDesignDatedItem>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfAutoDesignDatedItem> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfAutoDesignDatedItem> items;
};
