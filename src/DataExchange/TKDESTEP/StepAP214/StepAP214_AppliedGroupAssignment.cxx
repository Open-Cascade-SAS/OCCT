...
occ::handle<StepAP214_HArray1OfGroupItem> StepAP214_AppliedGroupAssignment::Items() const
{
  return theItems;
}
...
void StepAP214_AppliedGroupAssignment::SetItems(const occ::handle<StepAP214_HArray1OfGroupItem>& aItems)
{
  theItems = aItems;
}
