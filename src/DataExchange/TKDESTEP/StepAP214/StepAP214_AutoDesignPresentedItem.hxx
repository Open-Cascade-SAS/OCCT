...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<StepAP214_HArray1OfAutoDesignPresentedItemSelect>& aItems);

  Standard_EXPORT void SetItems(
    const occ::handle<StepAP214_HArray1OfAutoDesignPresentedItemSelect>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfAutoDesignPresentedItemSelect> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfAutoDesignPresentedItemSelect> items;
};
