...
public:
  ...
  Standard_EXPORT void SetItems(const occ::handle<StepAP214_HArray1OfOrganizationItem>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfOrganizationItem> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfOrganizationItem> items;
};
