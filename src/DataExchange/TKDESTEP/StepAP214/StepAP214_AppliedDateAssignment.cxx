...
void StepAP214_AppliedDateAssignment::SetItems(const occ::handle<StepAP214_HArray1OfDateItem>& aItems)
{
  items = aItems;
}

occ::handle<StepAP214_HArray1OfDateItem> StepAP214_AppliedDateAssignment::Items() const
{
  return items;
}
