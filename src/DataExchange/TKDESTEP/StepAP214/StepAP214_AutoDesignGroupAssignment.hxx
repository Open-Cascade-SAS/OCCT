...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<StepBasic_Group>&                          aAssignedGroup,
                            const occ::handle<StepAP214_HArray1OfAutoDesignGroupedItem>& aItems);

  Standard_EXPORT void SetItems(const occ::handle<StepAP214_HArray1OfAutoDesignGroupedItem>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfAutoDesignGroupedItem> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfAutoDesignGroupedItem> items;
};
