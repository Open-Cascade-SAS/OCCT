...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<StepBasic_Approval>&              aAssignedApproval,
                            const occ::handle<StepAP214_HArray1OfApprovalItem>& aItems);

  Standard_EXPORT void SetItems(const occ::handle<StepAP214_HArray1OfApprovalItem>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfApprovalItem> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfApprovalItem> items;
};
