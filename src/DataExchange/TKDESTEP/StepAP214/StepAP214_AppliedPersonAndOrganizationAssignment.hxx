...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem>& aItems);

  Standard_EXPORT void SetItems(const occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem>& aItems);

  Standard_EXPORT occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem> Items() const;
...
private:
  occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem> items;
};
