  ...
  const occ::handle<StepElement_CurveElementSectionDerivedDefinitions>& ent) const
{
  ...
  occ::handle<StepElement_HArray1OfMeasureOrUnspecifiedValue> aShearArea;
  int                                       sub4 = 0;
  ...
  occ::handle<TColStd_HArray1OfReal> aSecondMomentOfArea;
  int              sub5 = 0;
  ...
  occ::handle<StepElement_HArray1OfMeasureOrUnspecifiedValue> aLocationOfCentroid;
  int                                       sub8 = 0;
  ...
  occ::handle<StepElement_HArray1OfMeasureOrUnspecifiedValue> aLocationOfShearCentre;
  int                                       sub9 = 0;
  ...
  occ::handle<StepElement_HArray1OfMeasureOrUnspecifiedValue> aLocationOfNonStructuralMass;
  int                                       sub10 = 0;
