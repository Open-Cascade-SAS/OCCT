...
TEST_F(StepTidy_CartesianPointReducerTest, DifferentNames)
{
  ...
  // Creating direction.
  occ::handle<TColStd_HArray1OfReal> aDirCoords = new TColStd_HArray1OfReal(1, 3);
...
TEST_F(StepTidy_CartesianPointReducerTest, StepShape_GeometricCurveSet)
{
  ...
  occ::handle<StepShape_HArray1OfGeometricSetSelect> aFirstElements =
  ...
  occ::handle<StepShape_HArray1OfGeometricSetSelect> aSecondElements =
    new StepShape_HArray1OfGeometricSetSelect(1, 1);
...
TEST_F(StepTidy_CartesianPointReducerTest, StepVisual_PresentationLayerAssignment)
{
  ...
  occ::handle<StepVisual_HArray1OfLayeredItem> aFirstAssignedItems =
  ...
  occ::handle<StepVisual_HArray1OfLayeredItem> aSecondAssignedItems =
    new StepVisual_HArray1OfLayeredItem(1, 1);
...
TEST_F(StepTidy_CartesianPointReducerTest, StepVisual_StyledItem)
{
  ...
  occ::handle<StepVisual_HArray1OfPresentationStyleAssignment> aFirstAssignedItems =
  ...
  occ::handle<StepVisual_HArray1OfPresentationStyleAssignment> aSecondAssignedItems =
    new StepVisual_HArray1OfPresentationStyleAssignment(1, 1);
...
TEST_F(StepTidy_CartesianPointReducerTest, StepGeom_BSplineCurveWithKnots)
{
  ...
  occ::handle<StepGeom_HArray1OfCartesianPoint> aFirstControlPoints =
  ...
  occ::handle<StepGeom_HArray1OfCartesianPoint> aSecondControlPoints =
    new StepGeom_HArray1OfCartesianPoint(1, 1);
...
TEST_F(StepTidy_CartesianPointReducerTest, StepGeom_BSplineSurfaceWithKnots)
{
  ...
  occ::handle<StepGeom_HArray2OfCartesianPoint> aFirstControlPoints =
  ...
  occ::handle<StepGeom_HArray2OfCartesianPoint> aSecondControlPoints =
    new StepGeom_HArray2OfCartesianPoint(1, 1, 1, 1);
...
TEST_F(StepTidy_CartesianPointReducerTest, StepRepr_Representation)
{
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem> aFirstItems =
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem> aSecondItems =
    new StepRepr_HArray1OfRepresentationItem(1, 1);
