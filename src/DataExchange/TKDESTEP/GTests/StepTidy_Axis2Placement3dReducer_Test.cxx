...
TEST_F(StepTidy_Axis2Placement3dReducerTest, StepShape_ShapeRepresentation)
{
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem> aItems1 =
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem> aItems2 =
    new StepRepr_HArray1OfRepresentationItem(1, 1);
...
TEST_F(StepTidy_Axis2Placement3dReducerTest, StepVisual_PresentationLayerAssignment)
{
  ...
  occ::handle<StepVisual_HArray1OfLayeredItem> aAssignedItems1 =
  ...
  occ::handle<StepVisual_HArray1OfLayeredItem> aAssignedItems2 =
    new StepVisual_HArray1OfLayeredItem(1, 1);
