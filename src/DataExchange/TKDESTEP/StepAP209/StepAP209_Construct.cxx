...
occ::handle<StepElement_HSequenceOfElementMaterial> StepAP209_Construct::GetElementMaterial() const
{
  occ::handle<StepElement_HSequenceOfElementMaterial> aSequence =
...
occ::handle<StepFEA_HSequenceOfElementGeometricRelationship> StepAP209_Construct::GetElemGeomRelat()
  const
{
  occ::handle<StepFEA_HSequenceOfElementGeometricRelationship> aSequence =
...
occ::handle<StepFEA_HSequenceOfElementRepresentation> StepAP209_Construct::GetElements1D(
  const occ::handle<StepFEA_FeaModel>& theFeaModel) const
{
...
occ::handle<StepFEA_HSequenceOfElementRepresentation> StepAP209_Construct::GetElements2D(
  const occ::handle<StepFEA_FeaModel>& theFeaModel) const
{
...
occ::handle<StepFEA_HSequenceOfElementRepresentation> StepAP209_Construct::GetElements3D(
  const occ::handle<StepFEA_FeaModel>& theFeaModel) const
{
...
occ::handle<StepFEA_HSequenceOfElementRepresentation> StepAP209_Construct::GetFeaElements(
  const occ::handle<StepFEA_FeaModel>& theFeaModel,
  const occ::handle<Standard_Type>&    theType) const
{
  occ::handle<StepFEA_HSequenceOfElementRepresentation> aSequence;
...
occ::handle<StepElement_HSequenceOfCurveElementSectionDefinition> StepAP209_Construct::GetCurElemSection(
  const occ::handle<StepFEA_Curve3dElementRepresentation>& ElemRepr) const
{
  occ::handle<StepElement_HSequenceOfCurveElementSectionDefinition> aSequence =
  ...
  occ::handle<StepFEA_HArray1OfCurveElementInterval> ACEI = C3dEP->IntervalDefinitions();
  if (ACEI.IsNull())
    return aSequence;
  ...
  const occ::handle<StepBasic_Product>& Prod) const
{
  ...
  if (!OldProdCtx.IsNull())
  {
    ...
    occ::handle<StepBasic_HArray1OfProductContext> HAPC = Prod->FrameOfReference();
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem> ARI = new StepRepr_HArray1OfRepresentationItem(1, 1);
  ARI->SetValue(1, RI);
  ...
  const occ::handle<StepBasic_Product>& Prod) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> ArrTmp = new TColStd_HArray1OfReal(1, 3);
  ArrTmp->SetValue(1, 0.);
  ArrTmp->SetValue(2, 0.);
  ArrTmp->SetValue(3, 1.);
  ...
  occ::handle<StepBasic_HArray1OfNamedUnit>            OldHANU;
  ...
  occ::handle<StepBasic_HArray1OfNamedUnit> NewHANU =
  ...
  occ::handle<TColStd_HArray1OfAsciiString> HAAS = new TColStd_HArray1OfAsciiString(1, 1);
...
bool StepAP209_Construct::ReplaceCcDesingToApplied() const
{
  ...
  for (int i = 1; i <= nb; i++)
  {
    ...
    if (anEntity->IsKind(STANDARD_TYPE(StepAP203_CcDesignApproval)))
    {
      ...
      occ::handle<StepAP203_HArray1OfApprovedItem>     HAAI203 = ent->Items();
      occ::handle<StepAP214_HArray1OfApprovalItem>     HAAI214 =
    ...
    else if (anEntity->IsKind(STANDARD_TYPE(StepAP203_CcDesignPersonAndOrganizationAssignment)))
    {
      ...
      occ::handle<StepAP203_HArray1OfPersonOrganizationItem>    HAPOI203 = ent->Items();
      occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem> HAPOI214 =
    ...
    else if (anEntity->IsKind(STANDARD_TYPE(StepAP203_CcDesignDateAndTimeAssignment)))
    {
      ...
      occ::handle<StepAP203_HArray1OfDateTimeItem>    HADTI203 = ent->Items();
      occ::handle<StepAP214_HArray1OfDateAndTimeItem> HADTI214 =
    ...
    else if (anEntity->IsKind(STANDARD_TYPE(StepAP203_CcDesignSecurityClassification)))
    {
      ...
      occ::handle<StepAP203_HArray1OfClassifiedItem>             HACI203 = ent->Items();
      occ::handle<StepAP214_HArray1OfSecurityClassificationItem> HASCI214 =
  ...
  const occ::handle<StepBasic_ProductDefinition>& AnaPD) const
{
  ...
  occ::handle<StepAP214_HArray1OfApprovalItem>     HAAI = new StepAP214_HArray1OfApprovalItem(1, 3);
  ...
  occ::handle<StepAP214_AppliedSecurityClassificationAssignment> ASCA =
    new StepAP214_AppliedSecurityClassificationAssignment;
  occ::handle<StepAP214_HArray1OfSecurityClassificationItem> HASCI =
  ...
  occ::handle<StepAP214_HArray1OfDateAndTimeItem> HADTI = new StepAP214_HArray1OfDateAndTimeItem(1, 1);
  ...
  occ::handle<Interface_HArray1OfHAsciiString> HAHAS = new Interface_HArray1OfHAsciiString(1, 1);
  ...
  occ::handle<StepAP214_AppliedPersonAndOrganizationAssignment> APOA =
    new StepAP214_AppliedPersonAndOrganizationAssignment;
  occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem> HAPOI =
...
occ::handle<StepData_StepModel> StepAP209_Construct::CreateAP203Structure() const
{
  ...
  // adding categories:
  occ::handle<StepBasic_HArray1OfProduct> HAProd = new StepBasic_HArray1OfProduct(1, 1);
  ...
  if (!ProdCtx.IsNull())
  {
    ...
    occ::handle<StepBasic_HArray1OfProductContext> HAPC = new StepBasic_HArray1OfProductContext(1, 1);
  ...
  if (!FD.IsNull())
  {
    occ::handle<Interface_HArray1OfHAsciiString> HAAS = new Interface_HArray1OfHAsciiString(1, 1);
  ...
  occ::handle<StepData_StepModel>&                aModel) const
{
  ...
  occ::handle<StepAP203_HArray1OfClassifiedItem> HACI = new StepAP203_HArray1OfClassifiedItem(1, 1);
  ...
  for (subs.Start(); subs.More(); subs.Next())
  {
    ...
    if (!AAA.IsNull())
    {
      occ::handle<StepAP214_HArray1OfApprovalItem> HAAI214 = AAA->Items();
      occ::handle<StepAP203_HArray1OfApprovedItem> HAAI =
  ...
  if (aModel->Number(DT) > 0)
  {
    ...
    for (subs.Start(); subs.More(); subs.Next())
    {
      ...
      if (ADTA.IsNull())
        continue;
      occ::handle<StepAP214_HArray1OfDateAndTimeItem> HADTI214 = ADTA->Items();
      occ::handle<StepAP203_HArray1OfDateTimeItem>    HADTI =
  ...
  for (subs.Start(); subs.More(); subs.Next())
  {
    ...
    if (APOA.IsNull())
      continue;
    occ::handle<StepAP214_HArray1OfPersonAndOrganizationItem> HAPOI214 = APOA->Items();
    occ::handle<StepAP203_HArray1OfPersonOrganizationItem>    HAPOI =
