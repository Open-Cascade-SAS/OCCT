...
public:
  ...
  Standard_EXPORT occ::handle<StepElement_HSequenceOfElementMaterial> GetElementMaterial() const;

  Standard_EXPORT occ::handle<StepFEA_HSequenceOfElementGeometricRelationship> GetElemGeomRelat() const;

  Standard_EXPORT occ::handle<StepFEA_HSequenceOfElementRepresentation> GetElements1D(
    const occ::handle<StepFEA_FeaModel>& theFeaModel) const;

  Standard_EXPORT occ::handle<StepFEA_HSequenceOfElementRepresentation> GetElements2D(
    const occ::handle<StepFEA_FeaModel>& theFEAModel) const;

  Standard_EXPORT occ::handle<StepFEA_HSequenceOfElementRepresentation> GetElements3D(
    const occ::handle<StepFEA_FeaModel>& theFEAModel) const;

  //! Getting list of curve_element_section_definitions
  //! for given element_representation
  Standard_EXPORT occ::handle<StepElement_HSequenceOfCurveElementSectionDefinition> GetCurElemSection(
...
protected:
  Standard_EXPORT occ::handle<StepFEA_HSequenceOfElementRepresentation> GetFeaElements(
