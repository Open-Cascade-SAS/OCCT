...
public:
  ...
  Standard_EXPORT bool Compute (const occ::handle<StepGeom_CartesianTransformationOperator3d>& Operator,
                                            const StepData_Factors& theLocalFactors = StepData_Factors());
  ...
  Standard_EXPORT TopoDS_Shape TranslateMappedItem (const occ::handle<StepRepr_MappedItem>& mapit,
