...
public:
  ...
  Standard_EXPORT StepToTopoDS_TranslateEdge(const occ::handle<StepShape_Edge>& E,
                                             StepToTopoDS_Tool& T,
  ...
  Standard_EXPORT void MakeFromCurve3D (const occ::handle<StepGeom_Curve>& C3D,
  ...
  Standard_EXPORT occ::handle<Geom2d_Curve> MakePCurve (const occ::handle<StepGeom_Pcurve>& PCU,
