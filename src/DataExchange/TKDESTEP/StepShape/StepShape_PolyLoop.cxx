...
void StepShape_PolyLoop::SetPolygon(const occ::handle<StepGeom_HArray1OfCartesianPoint>& aPolygon)
{
  polygon = aPolygon;
}

occ::handle<StepGeom_HArray1OfCartesianPoint> StepShape_PolyLoop::Polygon() const
{
  return polygon;
}
