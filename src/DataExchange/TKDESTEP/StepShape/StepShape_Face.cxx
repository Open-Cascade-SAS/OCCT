...
void StepShape_Face::SetBounds(const occ::handle<StepShape_HArray1OfFaceBound>& aBounds)
{
  bounds = aBounds;
}

occ::handle<StepShape_HArray1OfFaceBound> StepShape_Face::Bounds() const
{
  return bounds;
}
