...
void StepShape_OrientedOpenShell::SetCfsFaces(const occ::handle<StepShape_HArray1OfFace>& /*aCfsFaces*/)
{
...
occ::handle<StepShape_HArray1OfFace> StepShape_OrientedOpenShell::CfsFaces() const
{
  // WARNING : the field is redefined.
