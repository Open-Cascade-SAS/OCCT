...
void StepShape_EdgeLoop::SetEdgeList(const occ::handle<StepShape_HArray1OfOrientedEdge>& aEdgeList)
{
  edgeList = aEdgeList;
}

occ::handle<StepShape_HArray1OfOrientedEdge> StepShape_EdgeLoop::EdgeList() const
{
  return edgeList;
}
