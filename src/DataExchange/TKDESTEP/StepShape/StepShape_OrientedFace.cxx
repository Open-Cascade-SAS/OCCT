                                  ...
                                  const bool                  aOrientation)
{
  ...
  occ::handle<StepShape_HArray1OfFaceBound> aBounds;
  aBounds.Nullify();
...
void StepShape_OrientedFace::SetBounds(const occ::handle<StepShape_HArray1OfFaceBound>& /*aBounds*/)
{
...
occ::handle<StepShape_HArray1OfFaceBound> StepShape_OrientedFace::Bounds() const
{
  // WARNING : the field is redefined.
