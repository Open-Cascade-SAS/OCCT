...
occ::handle<StepShape_HArray1OfEdge> StepShape_ConnectedEdgeSet::CesEdges() const
{
  return theCesEdges;
}
...
void StepShape_ConnectedEdgeSet::SetCesEdges(const occ::handle<StepShape_HArray1OfEdge>& aCesEdges)
{
  theCesEdges = aCesEdges;
}
