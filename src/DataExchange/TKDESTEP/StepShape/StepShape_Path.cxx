...
void StepShape_Path::SetEdgeList(const occ::handle<StepShape_HArray1OfOrientedEdge>& aEdgeList)
{
  edgeList = aEdgeList;
}

occ::handle<StepShape_HArray1OfOrientedEdge> StepShape_Path::EdgeList() const
{
  return edgeList;
}
