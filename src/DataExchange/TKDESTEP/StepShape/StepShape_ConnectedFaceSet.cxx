...
void StepShape_ConnectedFaceSet::Init(const occ::handle<TCollection_HAsciiString>& aName,
                                      const occ::handle<StepShape_HArray1OfFace>&  aCfsFaces)
{
  // --- classe own fields ---
  cfsFaces = aCfsFaces;
...
void StepShape_ConnectedFaceSet::SetCfsFaces(const occ::handle<StepShape_HArray1OfFace>& aCfsFaces)
{
  cfsFaces = aCfsFaces;
}

occ::handle<StepShape_HArray1OfFace> StepShape_ConnectedFaceSet::CfsFaces() const
{
  return cfsFaces;
}
