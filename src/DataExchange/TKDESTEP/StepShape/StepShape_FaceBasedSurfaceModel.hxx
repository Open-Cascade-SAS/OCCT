...
public:
  ...
  Standard_EXPORT occ::handle<NCollection_HArray1<occ::handle<StepShape_ConnectedFaceSet>>> FbsmFaces() const;

  //! Set field FbsmFaces
  Standard_EXPORT void SetFbsmFaces(const occ::handle<NCollection_HArray1<occ::handle<StepShape_ConnectedFaceSet>>>& FbsmFaces);
