...
void StepShape_LoopAndPath::SetEdgeList(const occ::handle<StepShape_HArray1OfOrientedEdge>& aEdgeList)
{
  path->SetEdgeList(aEdgeList);
}

occ::handle<StepShape_HArray1OfOrientedEdge> StepShape_LoopAndPath::EdgeList() const
{
