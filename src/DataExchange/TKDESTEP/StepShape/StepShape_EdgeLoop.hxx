...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TCollection_HAsciiString>&        aName,
                            const occ::handle<StepShape_HArray1OfOrientedEdge>& aEdgeList);

  Standard_EXPORT void SetEdgeList(const occ::handle<StepShape_HArray1OfOrientedEdge>& aEdgeList);

  Standard_EXPORT occ::handle<StepShape_HArray1OfOrientedEdge> EdgeList() const;
...
private:
  occ::handle<StepShape_HArray1OfOrientedEdge> edgeList;
};
