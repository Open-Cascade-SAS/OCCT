...
occ::handle<StepAP203_HArray1OfChangeRequestItem> StepAP203_ChangeRequest::Items() const
{
  return theItems;
}
...
void StepAP203_ChangeRequest::SetItems(const occ::handle<StepAP203_HArray1OfChangeRequestItem>& aItems)
{
  theItems = aItems;
}
