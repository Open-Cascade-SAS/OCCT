...
void StepAP203_CcDesignApproval::Init(
  ...
  const occ::handle<StepAP203_HArray1OfApprovedItem>& aItems)
{
...
occ::handle<StepAP203_HArray1OfApprovedItem> StepAP203_CcDesignApproval::Items() const
{
  return theItems;
}
...
void StepAP203_CcDesignApproval::SetItems(const occ::handle<StepAP203_HArray1OfApprovedItem>& aItems)
{
  theItems = aItems;
}
