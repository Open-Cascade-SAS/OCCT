...
occ::handle<StepAP203_HArray1OfContractedItem> StepAP203_CcDesignContract::Items() const
{
  return theItems;
}
...
void StepAP203_CcDesignContract::SetItems(const occ::handle<StepAP203_HArray1OfContractedItem>& aItems)
{
  theItems = aItems;
}
