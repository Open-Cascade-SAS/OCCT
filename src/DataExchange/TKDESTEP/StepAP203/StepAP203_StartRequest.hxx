...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepAP203_HArray1OfStartRequestItem>& aItems);

  //! Returns field Items
  Standard_EXPORT occ::handle<StepAP203_HArray1OfStartRequestItem> Items() const;

  //! Set field Items
  Standard_EXPORT void SetItems(const occ::handle<StepAP203_HArray1OfStartRequestItem>& Items);

  DEFINE_STANDARD_RTTIEXT(StepAP203_StartRequest, StepBasic_ActionRequestAssignment)

private:
  occ::handle<StepAP203_HArray1OfStartRequestItem> theItems;
};
