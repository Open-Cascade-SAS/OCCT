...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepAP203_HArray1OfDateTimeItem>& aItems);

  //! Returns field Items
  Standard_EXPORT occ::handle<StepAP203_HArray1OfDateTimeItem> Items() const;

  //! Set field Items
  Standard_EXPORT void SetItems(const occ::handle<StepAP203_HArray1OfDateTimeItem>& Items);

  DEFINE_STANDARD_RTTIEXT(StepAP203_CcDesignDateAndTimeAssignment, StepBasic_DateAndTimeAssignment)

private:
  occ::handle<StepAP203_HArray1OfDateTimeItem> theItems;
};
