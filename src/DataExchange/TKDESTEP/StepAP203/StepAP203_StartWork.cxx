...
occ::handle<StepAP203_HArray1OfWorkItem> StepAP203_StartWork::Items() const
{
  return theItems;
}
...
void StepAP203_StartWork::SetItems(const occ::handle<StepAP203_HArray1OfWorkItem>& aItems)
{
  theItems = aItems;
}
