...
occ::handle<StepAP203_HArray1OfStartRequestItem> StepAP203_StartRequest::Items() const
{
  return theItems;
}
...
void StepAP203_StartRequest::SetItems(const occ::handle<StepAP203_HArray1OfStartRequestItem>& aItems)
{
  theItems = aItems;
}
