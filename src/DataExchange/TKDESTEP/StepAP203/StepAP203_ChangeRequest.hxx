...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepAP203_HArray1OfChangeRequestItem>& aItems);

  //! Returns field Items
  Standard_EXPORT occ::handle<StepAP203_HArray1OfChangeRequestItem> Items() const;

  //! Set field Items
  Standard_EXPORT void SetItems(const occ::handle<StepAP203_HArray1OfChangeRequestItem>& Items);

  DEFINE_STANDARD_RTTIEXT(StepAP203_ChangeRequest, StepBasic_ActionRequestAssignment)

private:
  occ::handle<StepAP203_HArray1OfChangeRequestItem> theItems;
};
