...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<StepRepr_HArray1OfRepresentationItem>&          theIdentifiedItem);
  ...
  inline occ::handle<StepRepr_HArray1OfRepresentationItem> IdentifiedItem() const
  {
...
private:
  ...
  occ::handle<StepRepr_HArray1OfRepresentationItem>          identifiedItem;
};
