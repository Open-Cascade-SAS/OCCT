  ...
  const occ::handle<StepGeom_BSplineSurfaceWithKnots>& ent) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger> aUMultiplicities;
  ...
  occ::handle<TColStd_HArray1OfInteger> aVMultiplicities;
  ...
  occ::handle<TColStd_HArray1OfReal> aUKnots;
  double                 aUKnotsItem;
  int              nsub11;
  ...
  occ::handle<TColStd_HArray1OfReal> aVKnots;
  double                 aVKnotsItem;
  int              nsub12;
