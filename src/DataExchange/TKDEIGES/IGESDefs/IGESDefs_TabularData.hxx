...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> DependentValues(const int num) const;
...
private:
  ...
  int                         thePropertyType;
  occ::handle<TColStd_HArray1OfInteger>         theTypeOfIndependentVariables;
  occ::handle<TColStd_HArray1OfInteger>         theNbValues;
