...
void IGESDefs_TabularData::Init(const int nbProps,
                                ...
                                /*     const int nbDeps, */
                                /*     const int nbIndeps, */
                                const occ::handle<TColStd_HArray1OfInteger>&         typesInd,
                                const occ::handle<TColStd_HArray1OfInteger>&         nbValuesInd,
...
occ::handle<TColStd_HArray1OfReal> IGESDefs_TabularData::DependentValues(
  const int num) const
{
