...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const int                                        aListType,
    const occ::handle<TColStd_HArray1OfInteger>&                       attrTypes,
    const occ::handle<TColStd_HArray1OfInteger>&                       attrValueDataTypes,
    const occ::handle<TColStd_HArray1OfInteger>&                       attrValueCounts,
    const occ::handle<TColStd_HArray1OfTransient>&                     attrValues,
...
private:
  ...
  int                                       theListType;
  occ::handle<TColStd_HArray1OfInteger>                       theAttrTypes;
  occ::handle<TColStd_HArray1OfInteger>                       theAttrValueDataTypes;
  occ::handle<TColStd_HArray1OfInteger>                       theAttrValueCounts;
  occ::handle<TColStd_HArray1OfTransient>                     theAttrValues;
