                                                  ...
                                                  IGESData_ParamReader& PR) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>            requirements;
  occ::handle<TColStd_HArray1OfInteger>            orders;
  occ::handle<TColStd_HArray1OfInteger>            numItems;
  ...
  if (!requirements.IsNull())
    for (int i = 1; i <= nbval; i++)
    {
      ...
      int                 order;
      int                 numItem;
      occ::handle<TColStd_HArray1OfInteger> item;
