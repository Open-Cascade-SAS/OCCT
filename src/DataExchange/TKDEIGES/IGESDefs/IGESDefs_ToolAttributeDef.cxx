                                              ...
                                              IGESData_ParamReader&                  PR) const
{
  ...
  int                                       aListType;
  occ::handle<TColStd_HArray1OfInteger>                       attrTypes;
  occ::handle<TColStd_HArray1OfInteger>                       attrValueDataTypes;
  occ::handle<TColStd_HArray1OfInteger>                       attrValueCounts;
  occ::handle<TColStd_HArray1OfTransient>                     attrValues;
  ...
  if (!attrTypes.IsNull())
    for (int i = 1; i <= nbval; i++)
    {
      ...
      occ::handle<IGESGraph_HArray1OfTextDisplayTemplate> attrValuePointer;
      ...
      if (!attrValues.IsNull())
        if (fn > 0)
        {
          occ::handle<TColStd_HArray1OfInteger>        attrInt;
          occ::handle<TColStd_HArray1OfReal>           attrReal;
          occ::handle<Interface_HArray1OfHAsciiString> attrStr;
          occ::handle<IGESData_HArray1OfIGESEntity>    attrEnt;
