                                             ...
                                             IGESData_ParamReader& PR) const
{
  ...
  int                         nbDeps;
  int                         nbIndeps;
  occ::handle<TColStd_HArray1OfInteger>         typesInd;
  occ::handle<TColStd_HArray1OfInteger>         nbValuesInd;
  ...
  {
    occ::handle<TColStd_HArray1OfReal> tarr;
  ...
  occ::handle<TColStd_HArray1OfReal> somedeps;
  if (nbd > 0)
                                              ...
                                              IGESData_IGESWriter&                IW) const
{
  ...
  if (nbDeps == 0)
    return;
  occ::handle<TColStd_HArray1OfReal> deps = ent->DependentValues(1);
                                       ...
                                       Interface_CopyTool& /* TC */) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>         typesInd    = new TColStd_HArray1OfInteger(1, nbIndeps);
  occ::handle<TColStd_HArray1OfInteger>         nbValuesInd = new TColStd_HArray1OfInteger(1, nbIndeps);
  occ::handle<IGESBasic_HArray1OfHArray1OfReal> valuesInd =
  ...
  for (i = 1; i <= nbIndeps; i++)
  {
    ...
    occ::handle<TColStd_HArray1OfReal> tmparr = new TColStd_HArray1OfReal(1, nval);
    for (j = 1; j <= nval; j++)
