...
void IGESDefs_HArray1OfHArray1OfTextDisplayTemplate::SetValue(
  const int                                num,
  const occ::handle<IGESGraph_HArray1OfTextDisplayTemplate>& val)
{
  thelist.SetValue(num, val);
}

occ::handle<IGESGraph_HArray1OfTextDisplayTemplate> IGESDefs_HArray1OfHArray1OfTextDisplayTemplate::
  Value(const int num) const
{
  return occ::down_cast<IGESGraph_HArray1OfTextDisplayTemplate>(thelist.Value(num));
}
