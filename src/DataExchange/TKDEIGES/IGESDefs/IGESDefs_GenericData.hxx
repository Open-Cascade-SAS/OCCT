...
public:
  ...
  Standard_EXPORT void Init(const int                    nbPropVal,
                            ...
                            const occ::handle<TColStd_HArray1OfInteger>&   allTypes,
                            const occ::handle<TColStd_HArray1OfTransient>& allValues);
...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger>   theTypes;
  occ::handle<TColStd_HArray1OfTransient> theValues;
};
