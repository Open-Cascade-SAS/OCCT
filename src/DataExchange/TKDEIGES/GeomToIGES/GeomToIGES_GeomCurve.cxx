  ...
  const double              Ufin)
{
  ...
  int              itampon = -Deg;
  occ::handle<TColStd_HArray1OfReal> Knots   = new TColStd_HArray1OfReal(-Deg, Index + 1);
  ...
  mycurve->Weights(W);
  itampon                               = 0;
  occ::handle<TColStd_HArray1OfReal> Weights = new TColStd_HArray1OfReal(0, Index);
  ...
  itampon = 0;
  double               Xpt, Ypt, Zpt;
  occ::handle<TColgp_HArray1OfXYZ> Poles = new TColgp_HArray1OfXYZ(0, Index);
