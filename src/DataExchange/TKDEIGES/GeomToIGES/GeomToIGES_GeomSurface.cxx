  ...
  const double                Vfin)
{
  ...
  itampon                              = -DegU;
  occ::handle<TColStd_HArray1OfReal> KnotsU = new TColStd_HArray1OfReal(-DegU, IndexU + 1);
  ...
  itampon                              = -DegV;
  occ::handle<TColStd_HArray1OfReal> KnotsV = new TColStd_HArray1OfReal(-DegV, IndexV + 1);
  ...
  // ----------------------------------------------
  occ::handle<TColStd_HArray2OfReal> Weights   = new TColStd_HArray2OfReal(0, IndexU, 0, IndexV);
  ...
  // ---------------------------------------------
  occ::handle<TColgp_HArray2OfXYZ> Poles  = new TColgp_HArray2OfXYZ(0, IndexU, 0, IndexV);
                                                                    ...
                                                                    const double       Vfin)
{
  ...
  else
  {
    ...
    occ::handle<TColgp_HArray2OfXYZ> Poles = new TColgp_HArray2OfXYZ(0, 1, 0, 1);
    double               X, Y, Z;
    P1.Coord(X, Y, Z);
    ...
    occ::handle<TColStd_HArray1OfReal> KnotsU = new TColStd_HArray1OfReal(-1, 2);
    KnotsU->SetValue(-1, Udeb);
    KnotsU->SetValue(0, Udeb);
    KnotsU->SetValue(1, Ufin);
    KnotsU->SetValue(2, Ufin);

    occ::handle<TColStd_HArray1OfReal> KnotsV = new TColStd_HArray1OfReal(-1, 2);
    KnotsV->SetValue(-1, Vdeb);
    KnotsV->SetValue(0, Vdeb);
    KnotsV->SetValue(1, Vfin);
    KnotsV->SetValue(2, Vfin);

    occ::handle<TColStd_HArray2OfReal> Weights = new TColStd_HArray2OfReal(0, 1, 0, 1, 1.);
  ...
  const double                          Vfin)
{
  ...
  // occ::handle<IGESData_IGESEntity> Directrix = GC.TransferCurve( CopyCurve, V1, V2);
  occ::handle<IGESData_IGESEntity> Directrix = GC.TransferCurve(CopyCurve, U1, U2);
  // occ::handle<IGESData_IGESEntity> Directrix = GC.TransferCurve( TheCurve, U1, U2);
