  ...
  IGESData_ParamReader&                         PR) const
{
  ...
  occ::handle<TColStd_HArray1OfReal>             breakpointParameters;
  occ::handle<TColStd_HArray1OfInteger>          displayFlags;
  occ::handle<TColStd_HArray1OfInteger>          colorValues;
  occ::handle<IGESGraph_HArray1OfColor>          colorDefinitions;
  occ::handle<TColStd_HArray1OfInteger>          lineFontValues;
  occ::handle<IGESBasic_HArray1OfLineFontEntity> lineFontDefinitions;
  occ::handle<TColStd_HArray1OfInteger>          lineWeights;
