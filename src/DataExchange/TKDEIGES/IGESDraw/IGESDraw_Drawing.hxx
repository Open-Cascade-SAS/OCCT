...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<IGESDraw_HArray1OfViewKindEntity>& allViews,
                            const occ::handle<TColgp_HArray1OfXY>&               allViewOrigins,
                            const occ::handle<IGESData_HArray1OfIGESEntity>&     allAnnotations);
...
private:
  ...
  occ::handle<TColgp_HArray1OfXY>               theViewOrigins;
  occ::handle<IGESData_HArray1OfIGESEntity>     theAnnotations;
};
