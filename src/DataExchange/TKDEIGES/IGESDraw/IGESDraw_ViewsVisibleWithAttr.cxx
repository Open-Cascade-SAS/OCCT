...
void IGESDraw_ViewsVisibleWithAttr::Init(
  const occ::handle<IGESDraw_HArray1OfViewKindEntity>&  allViewEntities,
  const occ::handle<TColStd_HArray1OfInteger>&          allLineFonts,
  const occ::handle<IGESBasic_HArray1OfLineFontEntity>& allLineDefinitions,
  ...
  const occ::handle<IGESData_HArray1OfIGESEntity>&      allDisplayEntities)
{
...
void IGESDraw_ViewsVisibleWithAttr::InitImplied(
  const occ::handle<IGESData_HArray1OfIGESEntity>& allDisplayEntity)
{
