...
public:
  ...
  Standard_EXPORT IGESData_DirChecker
    DirChecker(const occ::handle<IGESDraw_ViewsVisibleWithAttr>& ent) const;
  ...
  Standard_EXPORT void OwnWhenDelete(const occ::handle<IGESDraw_ViewsVisibleWithAttr>& ent) const;
