...
void IGESDraw_DrawingWithRotation::Init(const occ::handle<IGESDraw_HArray1OfViewKindEntity>& allViews,
                                        const occ::handle<TColgp_HArray1OfXY>&    allViewOrigins,
                                        const occ::handle<TColStd_HArray1OfReal>& allOrientationAngles,
