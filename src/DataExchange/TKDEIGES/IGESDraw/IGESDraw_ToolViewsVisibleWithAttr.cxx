  ...
  IGESData_ParamReader&                        PR) const
{
  ...
  occ::handle<IGESGraph_HArray1OfColor>          tempColorDefinitions;
  occ::handle<TColStd_HArray1OfInteger>          tempLineFonts;
  occ::handle<TColStd_HArray1OfInteger>          tempColorValues;
  occ::handle<TColStd_HArray1OfInteger>          tempLineWeights;
  occ::handle<IGESData_HArray1OfIGESEntity>      tempDisplayEntities;
  occ::handle<IGESBasic_HArray1OfLineFontEntity> tempLineDefinitions;
  ...
  Interface_CopyTool&                          TC) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>          tempLineFonts = new TColStd_HArray1OfInteger(1, up);
  occ::handle<IGESBasic_HArray1OfLineFontEntity> tempLineDefinitions =
    new IGESBasic_HArray1OfLineFontEntity(1, up);
  occ::handle<TColStd_HArray1OfInteger> tempColorValues      = new TColStd_HArray1OfInteger(1, up);
  occ::handle<IGESGraph_HArray1OfColor> tempColorDefinitions = new IGESGraph_HArray1OfColor(1, up);
  occ::handle<TColStd_HArray1OfInteger> tempLineWeights      = new TColStd_HArray1OfInteger(1, up);
