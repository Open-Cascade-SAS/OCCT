...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<IGESDraw_HArray1OfViewKindEntity>&  allViewEntities,
  ...
  Standard_EXPORT void InitImplied(const occ::handle<IGESData_HArray1OfIGESEntity>& allDisplayEntity);
...
private:
  occ::handle<IGESDraw_HArray1OfViewKindEntity>  theViewEntities;
  occ::handle<TColStd_HArray1OfInteger>          theLineFonts;
  occ::handle<IGESBasic_HArray1OfLineFontEntity> theLineDefinitions;
  ...
  occ::handle<IGESData_HArray1OfIGESEntity>      theDisplayEntities;
};
