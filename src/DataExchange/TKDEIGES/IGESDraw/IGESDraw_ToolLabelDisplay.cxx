                                              ...
                                              IGESData_ParamReader&                  PR) const
{
  ...
  occ::handle<IGESDraw_HArray1OfViewKindEntity> views;
  occ::handle<TColgp_HArray1OfXYZ>              textLocations;
  occ::handle<IGESDimen_HArray1OfLeaderArrow>   leaderEntities;
  occ::handle<TColStd_HArray1OfInteger>         labelLevels;
  occ::handle<IGESData_HArray1OfIGESEntity>     displayedEntities;
