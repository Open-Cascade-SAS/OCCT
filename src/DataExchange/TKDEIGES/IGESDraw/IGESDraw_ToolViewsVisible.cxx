                                              ...
                                              IGESData_ParamReader&                  PR) const
{
  ...
  occ::handle<IGESDraw_HArray1OfViewKindEntity> tempViewEntities;
  occ::handle<IGESData_HArray1OfIGESEntity>     tempDisplayEntity;
                                        ...
                                        Interface_CopyTool&                  TC) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> tempDisplayEntities;
  ...
  const occ::handle<IGESDraw_ViewsVisible>& ent) const
{
  ...
  if (!res)
    return res;
  occ::handle<IGESData_HArray1OfIGESEntity> nulDisplayEntities;
