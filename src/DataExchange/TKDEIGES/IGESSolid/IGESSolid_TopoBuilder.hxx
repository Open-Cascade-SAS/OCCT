...
private:
  ...
  bool                     themflag;
  occ::handle<TColStd_HSequenceOfTransient> thevoids;
  occ::handle<TColStd_HSequenceOfInteger>   thevflag;
  occ::handle<IGESSolid_Shell>              theshell;
  occ::handle<TColStd_HSequenceOfTransient> thefaces;
  occ::handle<TColStd_HSequenceOfInteger>   thefflag;
  occ::handle<IGESSolid_Face>               theface;
  occ::handle<IGESData_IGESEntity>          thesurf;
  bool                     theouter;
  occ::handle<TColStd_HSequenceOfTransient> theinner;
  occ::handle<IGESSolid_Loop>               theloop;
  occ::handle<TColStd_HSequenceOfInteger>   theetype;
  occ::handle<TColStd_HSequenceOfInteger>   thee3d;
  occ::handle<TColStd_HSequenceOfInteger>   theeflag;
  occ::handle<TColStd_HSequenceOfTransient> theeuv;
  occ::handle<TColStd_HSequenceOfInteger>   theisol;
  occ::handle<TColStd_HSequenceOfTransient> thecuruv;
  occ::handle<TColStd_HSequenceOfTransient> theiso;
  occ::handle<IGESSolid_EdgeList>           theedgel;
  occ::handle<TColStd_HSequenceOfTransient> thecur3d;
  occ::handle<TColStd_HSequenceOfInteger>   thevstar;
  occ::handle<TColStd_HSequenceOfInteger>   thevend;
  occ::handle<IGESSolid_VertexList>         thevertl;
  occ::handle<TColgp_HSequenceOfXYZ>        thepoint;
};
