                                              ...
                                              IGESData_ParamReader&                  PR) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>     tempOperations;
  occ::handle<IGESData_HArray1OfIGESEntity> tempOperands;
                                        ...
                                        Interface_CopyTool&                  TC) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>     tempOperations = new TColStd_HArray1OfInteger(1, length);
  occ::handle<IGESData_HArray1OfIGESEntity> tempOperands   = new IGESData_HArray1OfIGESEntity(1, length);
