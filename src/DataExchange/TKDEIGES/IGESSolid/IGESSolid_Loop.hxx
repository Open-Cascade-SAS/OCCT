...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<TColStd_HArray1OfInteger>&            types,
                            const occ::handle<IGESData_HArray1OfIGESEntity>&        edges,
                            const occ::handle<TColStd_HArray1OfInteger>&            index,
                            const occ::handle<TColStd_HArray1OfInteger>&            orient,
                            const occ::handle<TColStd_HArray1OfInteger>&            nbParameterCurves,
...
private:
  ...
  occ::handle<IGESData_HArray1OfIGESEntity>           theEdges;
  occ::handle<TColStd_HArray1OfInteger>               theIndex;
  occ::handle<TColStd_HArray1OfInteger>               theOrientationFlags;
  occ::handle<TColStd_HArray1OfInteger>               theNbParameterCurves;
