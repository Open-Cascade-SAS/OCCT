...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<IGESSolid_Shell>&          aShell,
                            ...
                            const occ::handle<IGESSolid_HArray1OfShell>& voidShells,
                            const occ::handle<TColStd_HArray1OfInteger>& voidShellFlags);
...
private:
  ...
  occ::handle<IGESSolid_HArray1OfShell> theVoidShells;
  occ::handle<TColStd_HArray1OfInteger> theOrientFlags;
};
