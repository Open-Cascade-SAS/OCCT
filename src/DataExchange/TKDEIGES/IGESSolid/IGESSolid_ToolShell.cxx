                                        ...
                                        IGESData_ParamReader&                  PR) const
{
  ...
  occ::handle<IGESSolid_HArray1OfFace>  tempFaces;
  occ::handle<TColStd_HArray1OfInteger> tempOrientation;
                                  ...
                                  Interface_CopyTool&            TC) const
{
  ...
  occ::handle<IGESSolid_HArray1OfFace>  tempFaces       = new IGESSolid_HArray1OfFace(1, nbfaces);
  occ::handle<TColStd_HArray1OfInteger> tempOrientation = new TColStd_HArray1OfInteger(1, nbfaces);
  for (int i = 1; i <= nbfaces; i++)
  {
