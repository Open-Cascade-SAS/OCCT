                                                ...
                                                IGESData_ParamReader&                  PR) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity>           tempItems;
  occ::handle<IGESGeom_HArray1OfTransformationMatrix> tempMatrices;
                                          ...
                                          Interface_CopyTool&                    TC) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> tempItems = new IGESData_HArray1OfIGESEntity(1, nbitems);
  occ::handle<IGESGeom_HArray1OfTransformationMatrix> tempMatrices =
