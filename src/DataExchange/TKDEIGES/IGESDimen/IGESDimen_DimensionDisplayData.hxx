...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger> theSupplementaryNotes;
  occ::handle<TColStd_HArray1OfInteger> theStartIndex;
  occ::handle<TColStd_HArray1OfInteger> theEndIndex;
};
