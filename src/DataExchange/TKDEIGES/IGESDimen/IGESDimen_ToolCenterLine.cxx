                                             ...
                                             IGESData_ParamReader& PR) const
{
  ...
  int           nbval;
  occ::handle<TColgp_HArray1OfXY> dataPoints;
                                       ...
                                       Interface_CopyTool& /* TC */) const
{
  ...
  occ::handle<TColgp_HArray1OfXY> dataPoints = new TColgp_HArray1OfXY(1, nbval);
...
bool IGESDimen_ToolCenterLine::OwnCorrect(const occ::handle<IGESDimen_CenterLine>& ent) const
{
  ...
  occ::handle<TColgp_HArray1OfXY> pts = new TColgp_HArray1OfXY(1, nb);
  for (int i = 1; i <= nb; i++)
