  ...
  IGESData_ParamReader& PR) const
{
  ...
  double                    tempInitVal;
  int                 tempNbProps;
  occ::handle<TColStd_HArray1OfInteger> tempSuppleNotes;
  occ::handle<TColStd_HArray1OfInteger> tempStartInd;
  occ::handle<TColStd_HArray1OfInteger> tempEndInd;
...
{
  occ::handle<TColStd_HArray1OfInteger> EndList;
  occ::handle<TColStd_HArray1OfInteger> StartList;
  occ::handle<TColStd_HArray1OfInteger> NotesList;
