...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger>        theCharDisplays;
  occ::handle<TColStd_HArray1OfReal>           theCharWidths;
  occ::handle<TColStd_HArray1OfReal>           theCharHeights;
  occ::handle<TColStd_HArray1OfReal>           theInterCharSpaces;
  occ::handle<TColStd_HArray1OfReal>           theInterlineSpaces;
  occ::handle<TColStd_HArray1OfInteger>        theFontStyles;
  occ::handle<TColStd_HArray1OfReal>           theCharAngles;
  occ::handle<Interface_HArray1OfHAsciiString> theControlCodeStrings;
  ...
  occ::handle<TColStd_HArray1OfInteger>        theCharSetCodes;
  occ::handle<IGESData_HArray1OfIGESEntity>    theCharSetEntities;
