...
public:
  ...
  Standard_EXPORT void Init(
    ...
    const occ::handle<IGESData_HArray1OfIGESEntity>&           allModelCurves,
    const occ::handle<TColStd_HArray1OfInteger>&               allSenses,
  ...
  //! raises exception if Index <= 0 or Index > NbModelSpaceCurves()
  Standard_EXPORT occ::handle<IGESData_HArray1OfIGESEntity> ParameterCurves(
...
private:
  ...
  occ::handle<IGESData_HArray1OfIGESEntity>           theModelCurves;
  occ::handle<TColStd_HArray1OfInteger>               theSenses;
