...
public:
  ...
  Standard_EXPORT void Init(const int               anIndex,
                            ...
                            const occ::handle<TColStd_HArray1OfReal>& allKnots,
                            const occ::handle<TColStd_HArray1OfReal>& allWeights,
                            const occ::handle<TColgp_HArray1OfXYZ>&   allPoles,
                            const double                  aUmin,
                            const double                  aUmax,
                            const gp_XYZ&                        aNorm);
...
private:
  ...
  bool              isPolynomial;
  bool              isPeriodic;
  occ::handle<TColStd_HArray1OfReal> theKnots;
  occ::handle<TColStd_HArray1OfReal> theWeights;
  occ::handle<TColgp_HArray1OfXYZ>   thePoles;
  double                 theUmin;
  double                 theUmax;
  gp_XYZ                        theNorm;
};
