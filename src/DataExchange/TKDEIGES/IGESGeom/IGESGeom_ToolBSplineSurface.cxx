                                                ...
                                                IGESData_ParamReader& PR) const
{
  ...
  double                 tempVal;
  gp_XYZ                        tempXYZ;
  occ::handle<TColStd_HArray1OfReal> allKnotsU;
  occ::handle<TColStd_HArray1OfReal> allKnotsV;
  occ::handle<TColStd_HArray2OfReal> allWeights;
  occ::handle<TColgp_HArray2OfXYZ>   allPoles;
                                          ...
                                          Interface_CopyTool& /* TC */) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> allKnotsU = new TColStd_HArray1OfReal(-aDegU, anIndexU + 1);
  occ::handle<TColStd_HArray1OfReal> allKnotsV = new TColStd_HArray1OfReal(-aDegV, anIndexV + 1);
  ...
  occ::handle<TColStd_HArray2OfReal> allWeights = new TColStd_HArray2OfReal(0, anIndexU, 0, anIndexV);
  occ::handle<TColgp_HArray2OfXYZ>   allPoles   = new TColgp_HArray2OfXYZ(0, anIndexU, 0, anIndexV);
