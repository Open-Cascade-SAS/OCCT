                                              ...
                                              IGESData_ParamReader& PR) const
{
  ...
  gp_XYZ                        aNorm(0., 0., 0.);
  occ::handle<TColStd_HArray1OfReal> allKnots;
  occ::handle<TColStd_HArray1OfReal> allWeights;
  occ::handle<TColgp_HArray1OfXYZ>   allPoles;
                                        ...
                                        Interface_CopyTool& /* TC */) const
{
  ...
  int              anIndex, aDegree;
  bool              aPlanar, aClosed, aPolynomial, aPeriodic;
  occ::handle<TColStd_HArray1OfReal> allKnots, allWeights;
  occ::handle<TColgp_HArray1OfXYZ>   allPoles;
  double                 aUmin, aUmax;
  gp_XYZ                        aNorm;
