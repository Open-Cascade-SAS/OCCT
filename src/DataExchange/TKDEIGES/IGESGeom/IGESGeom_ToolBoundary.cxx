                                          ...
                                          IGESData_ParamReader&                  PR) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger> tempSenses;
  occ::handle<IGESData_HArray1OfIGESEntity>           tempModelCurves;
  ...
  if (!tempSenses.IsNull() && !tempModelCurves.IsNull() && !tempParameterCurves.IsNull())
  {
    ...
    // clang-format on
    {
      ...
      /*
              if (st && tempCount >= 0)
            {
              occ::handle<IGESData_HArray1OfIGESEntity> tempParCurves;
              if (tempCount > 0)
                                           ...
                                           IGESData_IGESWriter&             IW) const
{
  ...
  for (num1 = ent->NbModelSpaceCurves(), i = 1; i <= num1; i++)
  {
    ...
    IW.Send(ent->Sense(i));
    occ::handle<IGESData_HArray1OfIGESEntity> curves = ent->ParameterCurves(i);
                                    ...
                                    Interface_CopyTool&              TC) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>     tempSenses      = new TColStd_HArray1OfInteger(1, num1);
  occ::handle<IGESData_HArray1OfIGESEntity> tempModelCurves = new IGESData_HArray1OfIGESEntity(1, num1);
  occ::handle<IGESBasic_HArray1OfHArray1OfIGESEntity> tempParameterCurves =
  ...
  for (i = 1; i <= num1; i++)
  {
    ...
    occ::handle<IGESData_HArray1OfIGESEntity> ParCurves = another->ParameterCurves(i);
    occ::handle<IGESData_HArray1OfIGESEntity> tempParCurves;
    if (num2 > 0)
...
bool IGESGeom_ToolBoundary::OwnCorrect(const occ::handle<IGESGeom_Boundary>& ent) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> modcv  = new IGESData_HArray1OfIGESEntity(1, nb);
  occ::handle<TColStd_HArray1OfInteger>     senses = new TColStd_HArray1OfInteger(1, nb);
  for (i = 1; i <= nb; i++)
  {
