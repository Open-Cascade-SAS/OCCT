                                               ...
                                               IGESData_ParamReader& PR) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> allUBreakPoints;
  occ::handle<TColStd_HArray1OfReal> allVBreakPoints;
  occ::handle<IGESBasic_HArray2OfHArray1OfReal> allXCoeffs;
  occ::handle<IGESBasic_HArray2OfHArray1OfReal> allYCoeffs;
  occ::handle<IGESBasic_HArray2OfHArray1OfReal> allZCoeffs;
  ...
  occ::handle<TColStd_HArray1OfReal> Temp; // = new TColStd_HArray1OfReal(1, 16);
                                         ...
                                         Interface_CopyTool& /* TC */) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> allUBreakPoints = new TColStd_HArray1OfReal(1, allNbUSegments + 1);

  occ::handle<TColStd_HArray1OfReal> allVBreakPoints = new TColStd_HArray1OfReal(1, allNbVSegments + 1);
