                                  ...
                                  const occ::handle<IGESBasic_HArray2OfHArray1OfReal>& allZCoeffs)
{
  ...
  occ::handle<TColStd_HArray1OfReal> temp1;
  occ::handle<TColStd_HArray1OfReal> temp2;
  occ::handle<TColStd_HArray1OfReal> temp3;
  for (i = 1; i <= nbUSegs; i++)
    for (j = 1; j <= nbVSegs; j++)
    {
...
occ::handle<TColStd_HArray1OfReal> IGESGeom_SplineSurface::XPolynomial(
  const int Index1,
...
occ::handle<TColStd_HArray1OfReal> IGESGeom_SplineSurface::YPolynomial(
  const int Index1,
  const int Index2) const
{
...
occ::handle<TColStd_HArray1OfReal> IGESGeom_SplineSurface::ZPolynomial(
  const int Index1,
  const int Index2) const
{
...
void IGESGeom_SplineSurface::Polynomials(occ::handle<IGESBasic_HArray2OfHArray1OfReal>& allXCoeffs,
                                         occ::handle<IGESBasic_HArray2OfHArray1OfReal>& allYCoeffs,
                                         occ::handle<IGESBasic_HArray2OfHArray1OfReal>& allZCoeffs) const
{
