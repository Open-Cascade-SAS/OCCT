...
public:
  ...
  Standard_EXPORT void Init(const int               anIndexU,
                            ...
                            const bool               aPeriodU,
                            const bool               aPeriodV,
                            const occ::handle<TColStd_HArray1OfReal>& allKnotsU,
                            const occ::handle<TColStd_HArray1OfReal>& allKnotsV,
                            const occ::handle<TColStd_HArray2OfReal>& allWeights,
                            const occ::handle<TColgp_HArray2OfXYZ>&   allPoles,
                            const double                  aUmin,
                            const double                  aUmax,
                            const double                  aVmin,
                            const double                  aVmax);
...
private:
  ...
  bool              isPeriodicU;
  bool              isPeriodicV;
  occ::handle<TColStd_HArray1OfReal> theKnotsU;
  occ::handle<TColStd_HArray1OfReal> theKnotsV;
  occ::handle<TColStd_HArray2OfReal> theWeights;
  occ::handle<TColgp_HArray2OfXYZ>   thePoles;
  double                 theUmin;
  double                 theUmax;
  double                 theVmin;
  double                 theVmax;
