...
public:
  ...
  Standard_EXPORT void Init(const int               aType,
                            ...
                            const occ::handle<TColStd_HArray1OfReal>& allBreakPoints,
                            const occ::handle<TColStd_HArray2OfReal>& allXPolynomials,
                            const occ::handle<TColStd_HArray2OfReal>& allYPolynomials,
                            const occ::handle<TColStd_HArray2OfReal>& allZPolynomials,
                            const occ::handle<TColStd_HArray1OfReal>& allXvalues,
                            const occ::handle<TColStd_HArray1OfReal>& allYvalues,
                            const occ::handle<TColStd_HArray1OfReal>& allZvalues);
...
private:
  ...
  int              theDegree;
  int              theNbDimensions;
  occ::handle<TColStd_HArray1OfReal> theBreakPoints;
  occ::handle<TColStd_HArray2OfReal> theXCoordsPolynomial;
  occ::handle<TColStd_HArray2OfReal> theYCoordsPolynomial;
  occ::handle<TColStd_HArray2OfReal> theZCoordsPolynomial;
  occ::handle<TColStd_HArray1OfReal> theXvalues;
  occ::handle<TColStd_HArray1OfReal> theYvalues;
  occ::handle<TColStd_HArray1OfReal> theZvalues;
};
