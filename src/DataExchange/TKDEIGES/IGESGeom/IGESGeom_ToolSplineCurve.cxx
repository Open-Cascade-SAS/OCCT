                                             ...
                                             IGESData_ParamReader& PR) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> allBreakPoints;
  occ::handle<TColStd_HArray2OfReal> allXPolynomials;
  occ::handle<TColStd_HArray2OfReal> allYPolynomials;
  occ::handle<TColStd_HArray2OfReal> allZPolynomials;
  occ::handle<TColStd_HArray1OfReal> allXvalues = new TColStd_HArray1OfReal(1, 4);
  occ::handle<TColStd_HArray1OfReal> allYvalues = new TColStd_HArray1OfReal(1, 4);
  occ::handle<TColStd_HArray1OfReal> allZvalues = new TColStd_HArray1OfReal(1, 4);
  ...
  */
  ...
  occ::handle<TColStd_HArray1OfReal> temp;
                                       ...
                                       Interface_CopyTool& /* TC */) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> allBreakPoints = new TColStd_HArray1OfReal(1, nbSegments + 1);
  for (I = 1; I <= (nbSegments + 1); I++)
    allBreakPoints->SetValue(I, another->BreakPoint(I));

  occ::handle<TColStd_HArray2OfReal> allXPolynomials = new TColStd_HArray2OfReal(1, nbSegments, 1, 4);
  occ::handle<TColStd_HArray2OfReal> allYPolynomials = new TColStd_HArray2OfReal(1, nbSegments, 1, 4);
  occ::handle<TColStd_HArray2OfReal> allZPolynomials = new TColStd_HArray2OfReal(1, nbSegments, 1, 4);
