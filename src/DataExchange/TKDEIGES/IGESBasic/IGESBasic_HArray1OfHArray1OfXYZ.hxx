...
public:
  ...
  Standard_EXPORT void SetValue(const int num, const occ::handle<TColgp_HArray1OfXYZ>& val);

  Standard_EXPORT occ::handle<TColgp_HArray1OfXYZ> Value(const int num) const;
