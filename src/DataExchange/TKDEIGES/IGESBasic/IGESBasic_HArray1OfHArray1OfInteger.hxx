...
public:
  Standard_EXPORT IGESBasic_HArray1OfHArray1OfInteger(const int low,
                                                      const int up);
  ...
  Standard_EXPORT void SetValue(const int                  num,
                                const occ::handle<TColStd_HArray1OfInteger>& val);

  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> Value(const int num) const;
