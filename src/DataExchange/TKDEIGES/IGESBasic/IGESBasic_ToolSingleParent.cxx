                                               ...
                                               IGESData_ParamReader&                  PR) const
{
  ...
  int                     nbval = 0;
  occ::handle<IGESData_HArray1OfIGESEntity> tempChildren;
                                         ...
                                         Interface_CopyTool&                   TC) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> EntArray = new IGESData_HArray1OfIGESEntity(1, upper);
  for (int i = 1; i <= upper; i++)
  {
  ...
  const occ::handle<IGESBasic_SingleParent>& ent) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> EntArray = new IGESData_HArray1OfIGESEntity(1, nb);
  for (int i = 1; i <= nb; i++)
