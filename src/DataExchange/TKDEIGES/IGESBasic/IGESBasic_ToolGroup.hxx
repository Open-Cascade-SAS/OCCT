...
public:
  ...
  Standard_EXPORT bool OwnCorrect(const occ::handle<IGESBasic_Group>& ent) const;

  //! Returns specific DirChecker
  Standard_EXPORT IGESData_DirChecker DirChecker(const occ::handle<IGESBasic_Group>& ent) const;
