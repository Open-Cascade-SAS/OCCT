...
public:
  Standard_EXPORT IGESBasic_HArray1OfHArray1OfXY(const int low,
                                                 const int up);
  ...
  Standard_EXPORT void SetValue(const int num, const occ::handle<TColgp_HArray1OfXY>& val);

  Standard_EXPORT occ::handle<TColgp_HArray1OfXY> Value(const int num) const;
