...
IGESBasic_HArray1OfHArray1OfXYZ::IGESBasic_HArray1OfHArray1OfXYZ(const int low,
                                                                 const int up)
    : thelist(low, up)
{
...
void IGESBasic_HArray1OfHArray1OfXYZ::SetValue(const int             num,
                                               const occ::handle<TColgp_HArray1OfXYZ>& val)
{
  thelist.SetValue(num, val);
}

occ::handle<TColgp_HArray1OfXYZ> IGESBasic_HArray1OfHArray1OfXYZ::Value(const int num) const
{
  return occ::down_cast<TColgp_HArray1OfXYZ>(thelist.Value(num));
}
