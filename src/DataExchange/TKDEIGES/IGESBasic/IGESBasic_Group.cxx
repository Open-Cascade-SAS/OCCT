...
void IGESBasic_Group::Init(const occ::handle<IGESData_HArray1OfIGESEntity>& allEntities)
{
...
void IGESBasic_Group::SetNb(const int nb)
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> newents = new IGESData_HArray1OfIGESEntity(1, nb);
  if (oldnb > nb)
    oldnb = nb;
  for (i = 1; i <= oldnb; i++)
