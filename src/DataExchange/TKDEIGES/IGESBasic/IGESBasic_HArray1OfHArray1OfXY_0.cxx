...
IGESBasic_HArray1OfHArray1OfXY::IGESBasic_HArray1OfHArray1OfXY(const int low,
                                                               const int up)
    : thelist(low, up)
{
...
void IGESBasic_HArray1OfHArray1OfXY::SetValue(const int            num,
                                              const occ::handle<TColgp_HArray1OfXY>& val)
{
  thelist.SetValue(num, val);
}

occ::handle<TColgp_HArray1OfXY> IGESBasic_HArray1OfHArray1OfXY::Value(const int num) const
{
  return occ::down_cast<TColgp_HArray1OfXY>(thelist.Value(num));
}
