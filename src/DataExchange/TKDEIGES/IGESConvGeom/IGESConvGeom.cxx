                                                     ...
                                                     occ::handle<Geom_BSplineSurface>& res)
{
  ...
  occ::handle<TColStd_HArray1OfReal> XPoly = st->XPolynomial(USeg, VSeg);
  occ::handle<TColStd_HArray1OfReal> YPoly = st->YPolynomial(USeg, VSeg);
  occ::handle<TColStd_HArray1OfReal> ZPoly = st->ZPolynomial(USeg, VSeg);
