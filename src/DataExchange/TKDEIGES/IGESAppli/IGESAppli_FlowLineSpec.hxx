...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<Interface_HArray1OfHAsciiString>& allProperties);
...
private:
  occ::handle<Interface_HArray1OfHAsciiString> theNameAndModifiers;
};
