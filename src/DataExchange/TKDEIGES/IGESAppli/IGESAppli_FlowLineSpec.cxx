...
void IGESAppli_FlowLineSpec::Init(const occ::handle<NCollection_HArray1<occ::handle<TCollection_HAsciiString>>>& allProperties)
{
...
occ::handle<TCollection_HAsciiString> IGESAppli_FlowLineSpec::Modifier(
