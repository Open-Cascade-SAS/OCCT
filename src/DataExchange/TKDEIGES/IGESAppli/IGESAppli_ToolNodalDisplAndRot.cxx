                                                   ...
                                                   IGESData_ParamReader& PR) const
{
  ...
  int                        nbcases = 0;
  int                        nbnodes = 0;
  occ::handle<IGESDimen_HArray1OfGeneralNote>  tempNotes;
  occ::handle<TColStd_HArray1OfInteger>        tempNodeIdentifiers;
  occ::handle<IGESAppli_HArray1OfNode>         tempNodes;
  ...
  if (PR.ReadInteger(PR.Current(), "No. of nodes", nbnodes))
  {
    ...
    for (int j = 1; j <= nbnodes; j++)
    {
      ...
      occ::handle<TColgp_HArray1OfXYZ> tempArray1;
      occ::handle<TColgp_HArray1OfXYZ> tempArray;
      if (tempFlag)
      {
                                             ...
                                             Interface_CopyTool&                       TC) const
{
  ...
  occ::handle<IGESDimen_HArray1OfGeneralNote> aNotes  = new IGESDimen_HArray1OfGeneralNote(1, nbcases);
  occ::handle<TColStd_HArray1OfInteger> aNodeIdentifiers = new TColStd_HArray1OfInteger(1, nbnodes);
  occ::handle<IGESAppli_HArray1OfNode>  aNodes           = new IGESAppli_HArray1OfNode(1, nbnodes);
  ...
  {
    occ::handle<TColgp_HArray1OfXYZ> tempArray1 = new TColgp_HArray1OfXYZ(1, nbcases);
    occ::handle<TColgp_HArray1OfXYZ> tempArray2 = new TColgp_HArray1OfXYZ(1, nbcases);
    for (int k = 1; k <= nbcases; k++)
    {
