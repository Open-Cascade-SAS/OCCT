                                                 ...
                                                 IGESData_ParamReader&                   PR) const
{
  ...
  occ::handle<TColStd_HArray1OfInteger>            allElementIdentifiers;
  occ::handle<IGESAppli_HArray1OfFiniteElement>    allElements;
  occ::handle<TColStd_HArray1OfInteger>            allElementTopologyType;
  occ::handle<TColStd_HArray1OfInteger>            allNbLayers;
  occ::handle<TColStd_HArray1OfInteger>            allDataLayerFlag;
  occ::handle<TColStd_HArray1OfInteger>            allNbResultDataLocs;
  ...
  for (int nume = 1; nume <= num; nume++)
  {
    ...
    occ::handle<TColStd_HArray1OfInteger> rdrl;
    occ::handle<TColStd_HArray1OfReal>    vres;
                                           ...
                                           Interface_CopyTool&                     TC) const
{
  ...
  for (i = 1; i <= num; i++)
  {
    ...
    occ::handle<TColStd_HArray1OfInteger> rdrl = new TColStd_HArray1OfInteger(1, nrl);
    allResultDataLoc->SetValue(i, rdrl);
    for (j = 1; j <= nrl; j++)
      rdrl->SetValue(j, another->ResultDataLoc(i, j));
    numv                               = another->NbResults(i);
    occ::handle<TColStd_HArray1OfReal> vres = new TColStd_HArray1OfReal(1, numv);
    for (j = 1; j <= numv; j++)
