                                       ...
                                       Interface_CopyTool&                 TC) const
{
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> tempFlowAssocs = new IGESData_HArray1OfIGESEntity(1, num);
  for (i = 1; i <= num; i++)
  {
  ...
  num                                            = another->NbJoins();
  occ::handle<IGESData_HArray1OfIGESEntity> tempJoins = new IGESData_HArray1OfIGESEntity(1, num);
  for (i = 1; i <= num; i++)
  {
