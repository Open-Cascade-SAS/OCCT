...
public:
  ...
  Standard_EXPORT void Init(const occ::handle<IGESDimen_GeneralNote>&               aNote,
                            ...
                            const occ::handle<TColStd_HArray1OfInteger>&            allElementIdents,
                            const occ::handle<IGESAppli_HArray1OfFiniteElement>&    allFiniteElems,
                            const occ::handle<TColStd_HArray1OfInteger>&            allTopTypes,
                            const occ::handle<TColStd_HArray1OfInteger>&            nbLayers,
                            const occ::handle<TColStd_HArray1OfInteger>&            allDataLayerFlags,
                            const occ::handle<TColStd_HArray1OfInteger>&            allnbResDataLocs,
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> ResultList(const int NElem) const;
...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger>            theElementIdentifiers;
  occ::handle<IGESAppli_HArray1OfFiniteElement>    theElements;
  occ::handle<TColStd_HArray1OfInteger>            theElementTopologyTypes;
  occ::handle<TColStd_HArray1OfInteger>            theNbLayers;
  occ::handle<TColStd_HArray1OfInteger>            theDataLayerFlags;
  occ::handle<TColStd_HArray1OfInteger>            theNbResultDataLocs;
