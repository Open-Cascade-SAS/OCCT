...
bool IGESAppli_ToolPartNumber::OwnCorrect(const occ::handle<IGESAppli_PartNumber>& ent) const
{
...
void IGESAppli_ToolPartNumber::OwnCheck(const occ::handle<IGESAppli_PartNumber>& ent,
