...
void IGESAppli_NodalDisplAndRot::Init(const occ::handle<IGESDimen_HArray1OfGeneralNote>&  allNotes,
                                      const occ::handle<TColStd_HArray1OfInteger>&        allIdentifiers,
                                      ...
                                      const occ::handle<IGESBasic_HArray1OfHArray1OfXYZ>& allTransParams)
{
  ...
  {
    occ::handle<TColgp_HArray1OfXYZ> temp1 = allTransParams->Value(i);
    occ::handle<TColgp_HArray1OfXYZ> temp2 = allRotParams->Value(i);
