...
occ::handle<IGESData_IGESEntity> BRepToIGES_BRWire ::TransferWire(const TopoDS_Wire& mywire)
{
  ...
  occ::handle<TColStd_HSequenceOfTransient> Seq = new TColStd_HSequenceOfTransient();
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> Tab;
  if (nbedges == 1)
  {
  ...
  const double                 theLength)
{
  ...
  occ::handle<TColStd_HSequenceOfTransient> Seq3d = new TColStd_HSequenceOfTransient();
  occ::handle<TColStd_HSequenceOfTransient> Seq2d = new TColStd_HSequenceOfTransient();
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> Tab3d;
  if (nb3d == 1)
  {
    res = ent3d;
  }
  ...
  occ::handle<IGESData_HArray1OfIGESEntity> Tab2d;
  if (nb2d == 1)
  {
    theCurve2d = ent2d;
  }
