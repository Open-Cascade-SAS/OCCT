...
void IGESSelect_AddFileComment::AddLines(const occ::handle<TColStd_HSequenceOfHAsciiString>& lines)
{
...
occ::handle<TColStd_HSequenceOfHAsciiString> IGESSelect_AddFileComment::Lines() const
{
  return thelist;
}
