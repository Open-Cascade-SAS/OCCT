                                               ...
                                               const int            level)
{
  ...
  if (level > upper)
  {
    occ::handle<TColStd_HArray1OfInteger> levels = new TColStd_HArray1OfInteger(0, level + 100);
    levels->Init(0);
...
occ::handle<TColStd_HSequenceOfInteger> IGESSelect_CounterOfLevelNumber::Levels() const
{
  occ::handle<TColStd_HSequenceOfInteger> list = new TColStd_HSequenceOfInteger();
