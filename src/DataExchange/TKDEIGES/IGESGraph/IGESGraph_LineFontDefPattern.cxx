...
Handle(TCollection_HAsciiString) IGESGraph_LineFontDefPattern::DisplayPattern() const
{
...
Standard_Boolean IGESGraph_LineFontDefPattern::IsVisible(const Standard_Integer Index) const
{
  ...
  tempStr[1]               = 0;
  Standard_Integer tempVal = (Standard_Integer)strtol(tempStr, (char**)NULL, 16);
