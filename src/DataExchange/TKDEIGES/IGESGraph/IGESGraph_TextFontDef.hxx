...
public:
  ...
  Standard_EXPORT void Init(const int                             aFontCode,
                            ...
                            const int                             aScale,
                            const occ::handle<TColStd_HArray1OfInteger>&            allASCIICodes,
                            const occ::handle<TColStd_HArray1OfInteger>&            allNextCharX,
                            const occ::handle<TColStd_HArray1OfInteger>&            allNextCharY,
                            const occ::handle<TColStd_HArray1OfInteger>&            allPenMotions,
  ...
  //! Exception OutOfRange is raised if Chnum <= 0 or Chnum > NbCharacters
  Standard_EXPORT void NextCharOrigin(const int Chnum,
                                      int&      NX,
                                      int&      NY) const;
  ...
  Standard_EXPORT bool IsPenUp(const int Chnum,
...
private:
  ...
  int                            theScale;
  occ::handle<TColStd_HArray1OfInteger>            theASCIICodes;
  occ::handle<TColStd_HArray1OfInteger>            theNextCharOriginX;
  occ::handle<TColStd_HArray1OfInteger>            theNextCharOriginY;
  occ::handle<TColStd_HArray1OfInteger>            theNbPenMotions;
