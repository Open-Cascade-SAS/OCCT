...
occ::handle<TColStd_HSequenceOfHAsciiString> IGESData_IGESModel::StartSection() const
{
  return thestart;
}
...
void IGESData_IGESModel::SetStartSection(const occ::handle<TColStd_HSequenceOfHAsciiString>& list,
                                         const bool                         copy)
{
  if (copy)
  {
