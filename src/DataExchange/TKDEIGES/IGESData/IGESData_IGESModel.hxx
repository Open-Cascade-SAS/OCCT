...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> StartSection() const;
  ...
  Standard_EXPORT void SetStartSection(const occ::handle<TColStd_HSequenceOfHAsciiString>& list,
...
private:
  occ::handle<TColStd_HSequenceOfHAsciiString> thestart;
