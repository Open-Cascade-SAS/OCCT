...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHAsciiString> SectionStrings(
...
private:
  ...
  occ::handle<TColStd_HSequenceOfHAsciiString> thestar;
  occ::handle<TColStd_HSequenceOfHAsciiString> thehead;
  char                      thesep;
  char                      theendm;
  NCollection_Array1<IGESData_DirPart>                thedirs;
  NCollection_Array1<int>                 thepnum;
  occ::handle<TColStd_HSequenceOfHAsciiString> thepars;
  int                        thesect;
