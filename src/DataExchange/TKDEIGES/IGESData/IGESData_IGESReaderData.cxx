...
IGESData_IGESReaderData::IGESData_IGESReaderData(const int nbe,
                                                 const int nbp)
...
occ::handle<NCollection_HSequence<occ::handle<TCollection_HAsciiString>>> IGESData_IGESReaderData::StartSection() const
{
  return thestar;
}
