...
void BRepToIGESBRep_Entity::TransferVertexList()
{
  ...
  if (!nbvertices)
    return;
  occ::handle<TColgp_HArray1OfXYZ> vertices = new TColgp_HArray1OfXYZ(1, nbvertices);
  double               Unit     = GetUnit();
  double               X, Y, Z;
...
void BRepToIGESBRep_Entity::TransferEdgeList()
{
  ...
  if (!nbedges)
    return;
  occ::handle<IGESData_HArray1OfIGESEntity>  Curves = new IGESData_HArray1OfIGESEntity(1, nbedges);
  occ::handle<IGESSolid_HArray1OfVertexList> startVertexList =
    new IGESSolid_HArray1OfVertexList(1, nbedges);
  occ::handle<TColStd_HArray1OfInteger>      startVertexIndex = new TColStd_HArray1OfInteger(1, nbedges);
  occ::handle<IGESSolid_HArray1OfVertexList> endVertexList =
    new IGESSolid_HArray1OfVertexList(1, nbedges);
  occ::handle<TColStd_HArray1OfInteger> endVertexIndex = new TColStd_HArray1OfInteger(1, nbedges);
                                                           ...
                                                           const double Length)
{
  ...
  occ::handle<TColStd_HArray1OfInteger>            types   = new TColStd_HArray1OfInteger(1, nbedges);
  int                            mytype;
  occ::handle<IGESData_HArray1OfIGESEntity>        edges = new IGESData_HArray1OfIGESEntity(1, nbedges);
  occ::handle<IGESData_IGESEntity>                 myedge;
  occ::handle<TColStd_HArray1OfInteger>            index = new TColStd_HArray1OfInteger(1, nbedges);
  int                            myindex;
  occ::handle<TColStd_HArray1OfInteger>            orient = new TColStd_HArray1OfInteger(1, nbedges);
  int                            myorient;
  occ::handle<TColStd_HArray1OfInteger>            nbcurves = new TColStd_HArray1OfInteger(1, nbedges);
  int                            mynbcurve;
  occ::handle<TColStd_HArray1OfInteger>            flag;
  occ::handle<IGESBasic_HArray1OfHArray1OfInteger> isoflags =
    new IGESBasic_HArray1OfHArray1OfInteger(1, nbedges);
  int                               myisoflag;
  occ::handle<IGESData_HArray1OfIGESEntity>           curve;
...
occ::handle<IGESSolid_Face> BRepToIGESBRep_Entity ::TransferFace(const TopoDS_Face& start)
{
  ...
  occ::handle<IGESSolid_HArray1OfLoop> TabLoop;
  ...
  const Message_ProgressRange& theProgress)
{
  ...
  occ::handle<IGESSolid_HArray1OfFace>  TabFace = new IGESSolid_HArray1OfFace(1, nbfaces);
  occ::handle<TColStd_HArray1OfInteger> TabFlag = new TColStd_HArray1OfInteger(1, nbfaces);
  ...
  const Message_ProgressRange& theProgress)
{
  ...
  occ::handle<IGESSolid_HArray1OfShell> Tab;
  occ::handle<TColStd_HArray1OfInteger> TabFlag;
  if (nbshells > 1)
  {
  ...
  const Message_ProgressRange& theProgress)
{
  ...
  if (nbshapes > 0)
  {
    occ::handle<IGESData_HArray1OfIGESEntity> Tab = new IGESData_HArray1OfIGESEntity(1, nbshapes);
