                                           ...
                                           const IFSelect_PrintCount mode) const
{
  ...
  if (!model.IsNull())
  {
    ...
    NCollection_DataMap<TCollection_AsciiString, occ::handle<TColStd_HSequenceOfInteger>> aMapList;
    ...
    for (checkIterator.Start(); checkIterator.More(); checkIterator.Next())
    {
      ...
      for (i = 1; (failsonly == IFSelect_FailAndWarn) && (i <= nw); i++)
      {
        ...
        occ::handle<TColStd_HSequenceOfInteger> alist;
    ...
    switch (mode)
    {
      ...
      case IFSelect_ListByItem: {
        ...
        NCollection_DataMap<TCollection_AsciiString, int>::Iterator aMapCountIter(
          aMapCount);
        NCollection_DataMap<TCollection_AsciiString, occ::handle<TColStd_HSequenceOfInteger>>::Iterator
             ...
             aMapCountIter.Next(), aMapListIter.Next())
        {
          ...
          {
            const occ::handle<TColStd_HSequenceOfInteger>& entityList = aMapListIter.Value();
