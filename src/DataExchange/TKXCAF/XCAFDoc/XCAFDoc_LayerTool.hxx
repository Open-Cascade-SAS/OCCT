...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfExtendedString> GetLayers(const TDF_Label& L);
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfExtendedString> GetLayers(const TopoDS_Shape& Sh);
