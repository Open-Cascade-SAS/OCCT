...
bool XCAFDoc_LayerTool::GetLayers(const TDF_Label&                           L,
                                              occ::handle<TColStd_HSequenceOfExtendedString>& aLayerS)
{
  aLayerS = GetLayers(L);
...
occ::handle<TColStd_HSequenceOfExtendedString> XCAFDoc_LayerTool::GetLayers(const TDF_Label& L)
{
  occ::handle<TColStd_HSequenceOfExtendedString> aLayerS = new TColStd_HSequenceOfExtendedString;
...
void XCAFDoc_LayerTool::GetShapesOfLayer(const TDF_Label& theLayerL, NCollection_Sequence<TDF_Label>& theShLabels)
{
  theShLabels.Clear();
  occ::handle<XCAFDoc_GraphNode> aGNode;
...
occ::handle<TColStd_HSequenceOfExtendedString> XCAFDoc_LayerTool::GetLayers(const TopoDS_Shape& Sh)
{
  occ::handle<TColStd_HSequenceOfExtendedString> aLayerS = new TColStd_HSequenceOfExtendedString;
  TDF_Label                                 aLab;
  if (myShapeTool->Search(Sh, aLab))
