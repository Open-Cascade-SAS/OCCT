...
void XCAFDoc_Dimension::SetObject(const occ::handle<XCAFDimTolObjects_DimensionObject>& theObject)
{
  ...
  occ::handle<TColStd_HArray1OfInteger> anArrI;
  ...
  if (theObject->HasPoint())
  {
    ...
    if (!theObject->IsPointConnection())
    {
      ...
      occ::handle<TColStd_HArray1OfReal> aAxisArr = new TColStd_HArray1OfReal(1, 6);
      for (int i = 1; i <= 3; i++)
      {
  ...
  {
    occ::handle<TColStd_HArray1OfExtendedString> aDescrArr =
      new TColStd_HArray1OfExtendedString(1, theObject->NbDescriptions());
    occ::handle<TColStd_HArray1OfExtendedString> aDescrNameArr =
      new TColStd_HArray1OfExtendedString(1, theObject->NbDescriptions());
