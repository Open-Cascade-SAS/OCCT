...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> GetValues() const;
  ...
  Standard_EXPORT void SetValues(const occ::handle<TColStd_HArray1OfReal>& theValue);
...
private:
  ...
  occ::handle<TColStd_HArray1OfReal>                        myVal;
