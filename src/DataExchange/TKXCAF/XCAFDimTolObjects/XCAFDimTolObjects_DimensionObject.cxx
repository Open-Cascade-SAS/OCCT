...
occ::handle<TColStd_HArray1OfReal> XCAFDimTolObjects_DimensionObject::GetValues() const
{
  return myVal;
}
...
void XCAFDimTolObjects_DimensionObject::SetValues(const occ::handle<TColStd_HArray1OfReal>& theValue)
{
  myVal = theValue;
}
