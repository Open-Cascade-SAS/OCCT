...
occ::handle<TColStd_HSequenceOfAsciiString> StdStorage_TypeData::Types() const
{
  occ::handle<TColStd_HSequenceOfAsciiString> r = new TColStd_HSequenceOfAsciiString;
  int                       i;
