...
occ::handle<StdStorage_HSequenceOfRoots> StdStorage_RootData::Roots() const
{
  occ::handle<StdStorage_HSequenceOfRoots>    anObjectsSeq = new StdStorage_HSequenceOfRoots;
