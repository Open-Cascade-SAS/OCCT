...
public:
  ...
  Standard_EXPORT CDF_FWOSDriver(NCollection_DataMap<TCollection_ExtendedString, occ::handle<CDM_MetaData>>& theLookUpTable);
  ...
  Standard_EXPORT bool FindFolder(const TCollection_ExtendedString& aFolder)
    override;

  Standard_EXPORT TCollection_ExtendedString DefaultFolder() override;

  Standard_EXPORT TCollection_ExtendedString BuildFileName(const occ::handle<CDM_Document>& aDocument)
    override;
...
private:
  ...
  Standard_EXPORT occ::handle<CDM_MetaData> CreateMetaData(const occ::handle<CDM_Document>&       aDocument,
