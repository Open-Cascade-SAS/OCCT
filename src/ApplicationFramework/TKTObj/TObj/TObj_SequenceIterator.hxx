...
public:
  ...
  Standard_EXPORT TObj_SequenceIterator(const occ::handle<TObj_HSequenceOfObject>& theObjects,
...
protected:
  ...
  occ::handle<TObj_HSequenceOfObject> myObjects; //!< sequence of objects
