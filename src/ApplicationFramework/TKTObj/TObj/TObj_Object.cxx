...
static void addObjToOrderSequence(const occ::handle<TObj_Object>&      theObj,
                                  const int          theOrder,
                                  occ::handle<TObj_HSequenceOfObject>& theHSeqOfObj,
...
occ::handle<TObj_ObjectIterator> TObj_Object::GetChildren(const occ::handle<Standard_Type>& theType) const
{
  ...
  int               aLastIndex = 0;
  int               aLastOrder = 0;
  occ::handle<TObj_HSequenceOfObject> aHSeqOfObj = new TObj_HSequenceOfObject();
...
occ::handle<TColStd_HArray1OfReal> TObj_Object::getRealArray(const int theLength,
                                                        const int theRank1,
                                                        const int theRank2,
                                                        const double theInitialValue) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> anArr;
...
occ::handle<TColStd_HArray1OfInteger> TObj_Object::getIntegerArray(
  const int theLength,
  const int theRank1,
  const int theRank2,
...
occ::handle<TColStd_HArray1OfExtendedString> TObj_Object::getExtStringArray(
  const int theLength,
  const int theRank1,
  const int theRank2) const
{
  ...
  occ::handle<TColStd_HArray1OfExtendedString> anArr;
  if (!anArrAttribute.IsNull())
    anArr = anArrAttribute->Array();
  return anArr;
}
...
void TObj_Object::setArray(const occ::handle<TColStd_HArray1OfReal>& theArray,
                           const int               theRank1,
                           const int               theRank2)
{
  TDF_Label                  aLabel = getDataLabel(theRank1, theRank2);
...
void TObj_Object::setArray(const occ::handle<TColStd_HArray1OfInteger>& theArray,
                           const int                  theRank1,
                           const int                  theRank2)
{
  TDF_Label                     aLabel = getDataLabel(theRank1, theRank2);
...
void TObj_Object::setArray(const occ::handle<TColStd_HArray1OfExtendedString>& theArray,
                           const int                         theRank1,
                           const int                         theRank2)
{
  TDF_Label                       aLabel = getDataLabel(theRank1, theRank2);
