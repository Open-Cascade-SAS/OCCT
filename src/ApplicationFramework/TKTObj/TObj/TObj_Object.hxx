...
protected:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> getRealArray(
    const int theLength,
    const int theRank1,
    const int theRank2        = 0,
  ...
  //! WARNING: call setArray() after array contents modification
  //! in order to assure Undo work
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> getIntegerArray(
    const int theLength,
    const int theRank1,
    const int theRank2        = 0,
  ...
  //! WARNING: call setArray() after array contents modification
  //! in order to assure Undo work
  Standard_EXPORT occ::handle<TColStd_HArray1OfExtendedString> getExtStringArray(
    const int theLength,
    const int theRank1,
    const int theRank2 = 0) const;
  ...
  Standard_EXPORT void setArray(const occ::handle<TColStd_HArray1OfReal>& theArray,
                                const int               theRank1,
                                const int               theRank2 = 0);
  ...
  //! If theRank2 is 0 (default), label theRank1 is supposed (not its sublabel).
  //! If theArray is null then array attribute if any is removed.
  Standard_EXPORT void setArray(const occ::handle<TColStd_HArray1OfInteger>& theArray,
                                const int                  theRank1,
                                const int                  theRank2 = 0);
  ...
  //! If theRank2 is 0 (default), label theRank1 is supposed (not its sublabel).
  //! If theArray is null then array attribute if any is removed.
  Standard_EXPORT void setArray(const occ::handle<TColStd_HArray1OfExtendedString>& theArray,
                                const int                         theRank1,
                                const int                         theRank2 = 0);
...
private:
  ...
  occ::handle<TObj_HSequenceOfObject> myHSeqBackRef; //!< hsequence of back references.
