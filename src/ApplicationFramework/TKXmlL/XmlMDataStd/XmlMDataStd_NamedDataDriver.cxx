...
//=======================================================================
occ::handle<TColStd_HArray1OfInteger> BuildIntArray(const TCollection_AsciiString& ValString,
                                               const int         theLen)
{
...
//=======================================================================
occ::handle<TColStd_HArray1OfReal> BuildRealArray(const TCollection_AsciiString& ValString,
                                             const int         theLen)
{
  ...
  try
  {
    ...
    if ((aFirstInd | aLastInd) && aLastInd >= aFirstInd)
    {
      ...
      for (ind = aFirstInd; ind < aLastInd; ind++)
      {
        ...
        occ::handle<TColStd_HArray1OfInteger> aValue       = BuildIntArray(aValueString, aLen);
        if (aValue.IsNull())
        {
          TCollection_ExtendedString aMessageString =
            TCollection_ExtendedString("Cannot retrieve a value from item = ") + aKey;
    ...
    if ((aFirstInd | aLastInd) && aLastInd >= aFirstInd)
    {
      ...
      for (ind = aFirstInd; ind < aLastInd; ind++)
      {
        ...
        TCollection_AsciiString       aValueString = aCurElement->getAttribute(::Value());
        occ::handle<TColStd_HArray1OfReal> aValue       = BuildRealArray(aValueString, aLen);
        if (aValue.IsNull())
        {
          TCollection_ExtendedString aMessageString =
            TCollection_ExtendedString("Cannot retrieve a value from item = ") + aKey;
