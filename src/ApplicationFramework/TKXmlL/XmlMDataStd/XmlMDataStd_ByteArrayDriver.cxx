                                                    ...
                                                    XmlObjMgt_RRelocationTable& theRelocTable) const
{
  ...
  occ::handle<TColStd_HArray1OfByte> hArr = new TColStd_HArray1OfByte(aFirstInd, aLastInd);
                                        ...
                                        XmlObjMgt_SRelocationTable&) const
{
  ...
  const occ::handle<TColStd_HArray1OfByte>& hArr = aByteArray->InternalArray();
