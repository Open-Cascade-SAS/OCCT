...
void BinLDrivers_DocumentStorageDriver::UnsupportedAttrMsg(const occ::handle<Standard_Type>& theType)
{
#ifdef OCCT_DEBUG
...
//=======================================================================
bool BinLDrivers_DocumentStorageDriver::IsQuickPart(
  const int theVersion) const
{
