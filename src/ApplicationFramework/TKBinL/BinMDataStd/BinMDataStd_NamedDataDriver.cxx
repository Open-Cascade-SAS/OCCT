                                                    ...
                                                    BinObjMgt_RRelocationTable&) const
{
  ...
  if (anUpper | aLower)
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>> anIntArrays;
    for (i = aLower; i <= anUpper; i++)
    {
      TCollection_ExtendedString aKey;
      if (!(theSource >> aKey))
      ...
      if (up | low)
      {
        occ::handle<TColStd_HArray1OfInteger> aTargetArray = new TColStd_HArray1OfInteger(low, up);
  ...
  if (anUpper | aLower)
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>> aRealArrays;
    for (i = aLower; i <= anUpper; i++)
    {
      TCollection_ExtendedString aKey;
      if (!(theSource >> aKey))
      ...
      if (low | up)
      {
        occ::handle<TColStd_HArray1OfReal> aTargetArray = new TColStd_HArray1OfReal(low, up);
                                        ...
                                        NCollection_IndexedMap<occ::handle<Standard_Transient>>&) const
{
  ...
  if (S->HasArraysOfIntegers() && !S->GetArraysOfIntegersContainer().IsEmpty())
  {
    ...
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>::Iterator itr(
  ...
  if (S->HasArraysOfReals() && !S->GetArraysOfRealsContainer().IsEmpty())
  {
    ...
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>::Iterator itr(S->GetArraysOfRealsContainer());
    for (; itr.More(); itr.Next())
    {
      theTarget << itr.Key(); // key
