      ...
      myUp2(0)
{
  ...
  {
    occ::handle<TColStd_HArray1OfReal> Arr1, Arr2;
    Arr1 = OldAtt->Array();
    Arr2 = CurrAtt->Array();
#ifdef OCCT_DEBUG
    if (Arr1.IsNull())
...
void TDataStd_DeltaOnModificationOfRealArray::Apply()
{
  ...
  int              i;
  occ::handle<TColStd_HArray1OfReal> aRealArr = aCurAtt->Array();
  if (aRealArr.IsNull())
    return;
  if (aCase == 1)
  ...
  {
    occ::handle<TColStd_HArray1OfReal> realArr = new TColStd_HArray1OfReal(aRealArr->Lower(), myUp1);
  ...
  { // == 3
    ...
    occ::handle<TColStd_HArray1OfReal> realArr = new TColStd_HArray1OfReal(low, myUp1);
  ...
  occ::handle<TColStd_HArray1OfReal> aRArr = aCurAtt->Array();
