...
//=======================================================================
const occ::handle<TColStd_HArray1OfInteger>& TDataStd_NamedData::GetArrayOfIntegers(
  const TCollection_ExtendedString& theName)
{
  if (!HasArraysOfIntegers())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>> aMap;
...
void TDataStd_NamedData::setArrayOfIntegers(
  const TCollection_ExtendedString&       theName,
  const occ::handle<TColStd_HArray1OfInteger>& theArrayOfIntegers)
{
  if (!HasArraysOfIntegers())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>> aMap;
  ...
  occ::handle<TColStd_HArray1OfInteger> anArray;
...
//=======================================================================
const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>& TDataStd_NamedData::GetArraysOfIntegersContainer()
{
  if (!HasArraysOfIntegers())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>> aMap;
...
void TDataStd_NamedData::ChangeArraysOfIntegers(
  const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>& theIntegers)
{
  if (!HasArraysOfIntegers())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>> aMap;
...
//=======================================================================
const occ::handle<TColStd_HArray1OfReal>& TDataStd_NamedData::GetArrayOfReals(
  const TCollection_ExtendedString& theName)
{
  if (!HasArraysOfReals())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>> aMap;
...
void TDataStd_NamedData::setArrayOfReals(const TCollection_ExtendedString&    theName,
                                         const occ::handle<TColStd_HArray1OfReal>& theArrayOfReals)
{
  if (!HasArraysOfReals())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>> aMap;
  ...
  occ::handle<TColStd_HArray1OfReal> anArray;
...
//=======================================================================
const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>& TDataStd_NamedData::GetArraysOfRealsContainer()
{
  if (!HasArraysOfReals())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>> aMap;
...
// purpose  : Replace the container content by new content of the <theReals>.
//=======================================================================
void TDataStd_NamedData::ChangeArraysOfReals(const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>& theReals)
{
  if (!HasArraysOfReals())
  {
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>> aMap;
...
void TDataStd_NamedData::Restore(const occ::handle<TDF_Attribute>& With)
{
  ...
  if (!ND->GetArraysOfIntegersContainer().IsEmpty())
  {
    ...
    for (; itr.More(); itr.Next())
    {
      ...
      const occ::handle<TColStd_HArray1OfInteger>& ints = itr.Value();
      occ::handle<TColStd_HArray1OfInteger>        copied_ints;
      if (!ints.IsNull())
      {
  ...
  if (!ND->GetArraysOfRealsContainer().IsEmpty())
  {
    ...
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>::Iterator itr(ND->GetArraysOfRealsContainer());
    for (; itr.More(); itr.Next())
    {
      // Deep copy of the arrays
      const occ::handle<TColStd_HArray1OfReal>& dbls = itr.Value();
      occ::handle<TColStd_HArray1OfReal>        copied_dbls;
      if (!dbls.IsNull())
      {
                               ...
                               const occ::handle<TDF_RelocationTable>&) const
{
  ...
  if (HasArraysOfIntegers() && !myArraysOfIntegers->Map().IsEmpty())
  {
    ...
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>::Iterator itr(myArraysOfIntegers->Map());
    for (; itr.More(); itr.Next())
    {
      const occ::handle<TColStd_HArray1OfInteger>& ints = itr.Value();
      occ::handle<TColStd_HArray1OfInteger>        copied_ints;
  ...
  if (HasArraysOfReals() && !myArraysOfReals->Map().IsEmpty())
  {
    ...
    NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>::Iterator itr(myArraysOfReals->Map());
    for (; itr.More(); itr.Next())
    {
      const occ::handle<TColStd_HArray1OfReal>& dbls = itr.Value();
      occ::handle<TColStd_HArray1OfReal>        copied_dbls;
