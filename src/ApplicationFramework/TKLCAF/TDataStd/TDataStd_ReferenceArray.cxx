...
void TDataStd_ReferenceArray::SetInternalArray(const occ::handle<NCollection_HArray1<TDF_Label>>& values,
                                               const bool)
{
  //  myArray = values;
  ...
  if (myArray.IsNull() || !aDimEqual)
    myArray = new NCollection_HArray1<TDF_Label>(aLower, anUpper);
