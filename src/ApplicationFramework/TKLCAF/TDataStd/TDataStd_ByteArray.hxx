...
public:
  ...
  const occ::handle<TColStd_HArray1OfByte>& InternalArray() const { return myValue; }
  ...
  Standard_EXPORT void ChangeArray(const occ::handle<TColStd_HArray1OfByte>& newArray,
...
private:
  occ::handle<TColStd_HArray1OfByte> myValue;
  bool              myIsDelta;
  Standard_GUID                 myID;
};
