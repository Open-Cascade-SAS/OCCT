      ...
      myUp2(0)
{
  ...
  {
    {
      occ::handle<TColStd_HArray1OfByte> Arr1, Arr2;
...
void TDataStd_DeltaOnModificationOfByteArray::Apply()
{
  ...
  int              i;
  occ::handle<TColStd_HArray1OfByte> BArr = aCurAtt->InternalArray();
  if (BArr.IsNull())
    return;
  if (aCase == 1)
  ...
  {
    occ::handle<TColStd_HArray1OfByte> byteArr = new TColStd_HArray1OfByte(BArr->Lower(), myUp1);
  ...
  { // aCase == 3
    int              low     = BArr->Lower();
    occ::handle<TColStd_HArray1OfByte> byteArr = new TColStd_HArray1OfByte(low, myUp1);
  ...
  occ::handle<TColStd_HArray1OfByte> BArr2 = aCurAtt->InternalArray();
