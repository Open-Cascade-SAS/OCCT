...
public:
  ...
  Standard_EXPORT const occ::handle<TColStd_HArray1OfInteger>& GetArrayOfIntegers(
    const TCollection_ExtendedString& theName);
  ...
  Standard_EXPORT const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>& GetArraysOfIntegersContainer();

  //! Replace the container content by new content of the <theArraysOfIntegers>.
  Standard_EXPORT void ChangeArraysOfIntegers(
    const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfInteger>>& theArraysOfIntegers);
  ...
  //! (use HasArrayOfReals()).
  Standard_EXPORT const occ::handle<TColStd_HArray1OfReal>& GetArrayOfReals(
    const TCollection_ExtendedString& theName);
  ...
  Standard_EXPORT const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>& GetArraysOfRealsContainer();

  //! Replace the container content by new content of the <theArraysOfReals>.
  Standard_EXPORT void ChangeArraysOfReals(
    const NCollection_DataMap<TCollection_ExtendedString, occ::handle<TColStd_HArray1OfReal>>& theArraysOfReals);
