...
public:
  ...
  Standard_EXPORT void ChangeArray(const occ::handle<TColStd_HArray1OfReal>& newArray,
                                   const bool isCheckItems = true);

  //! Returns the handle of this array of reals.
  const occ::handle<TColStd_HArray1OfReal>& Array() const { return myValue; }
...
private:
  occ::handle<TColStd_HArray1OfReal> myValue;
  bool              myIsDelta;
  Standard_GUID                 myID;
};
