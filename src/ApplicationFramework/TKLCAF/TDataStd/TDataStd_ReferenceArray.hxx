...
public:
  ...
  Standard_EXPORT const occ::handle<TDataStd_HLabelArray1>& InternalArray() const;

  Standard_EXPORT void SetInternalArray(const occ::handle<TDataStd_HLabelArray1>& values,
...
private:
  occ::handle<TDataStd_HLabelArray1> myArray;
  Standard_GUID                 myID;
};
