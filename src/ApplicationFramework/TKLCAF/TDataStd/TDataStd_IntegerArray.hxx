...
public:
  ...
  Standard_EXPORT void ChangeArray(const occ::handle<TColStd_HArray1OfInteger>& newArray,
                                   const bool isCheckItems = true);

  //! Return the inner array of the IntegerArray attribute
  const occ::handle<TColStd_HArray1OfInteger>& Array() const { return myValue; }
...
private:
  occ::handle<TColStd_HArray1OfInteger> myValue;
  bool                 myIsDelta;
  Standard_GUID                    myID;
};
