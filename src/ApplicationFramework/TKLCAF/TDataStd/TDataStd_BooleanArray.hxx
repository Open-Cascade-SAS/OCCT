...
public:
  ...
  Standard_EXPORT const occ::handle<TColStd_HArray1OfByte>& InternalArray() const;

  Standard_EXPORT void SetInternalArray(const occ::handle<TColStd_HArray1OfByte>& values);
