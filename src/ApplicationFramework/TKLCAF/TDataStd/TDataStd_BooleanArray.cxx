...
const occ::handle<TColStd_HArray1OfByte>& TDataStd_BooleanArray::InternalArray() const
{
  return myValues;
}
...
void TDataStd_BooleanArray::SetInternalArray(const occ::handle<TColStd_HArray1OfByte>& values)
{
  myValues = values;
}
