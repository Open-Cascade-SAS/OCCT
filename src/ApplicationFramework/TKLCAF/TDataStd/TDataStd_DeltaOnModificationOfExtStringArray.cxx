      ...
      myUp2(0)
{
  ...
  {
    {
      occ::handle<TColStd_HArray1OfExtendedString> Arr1, Arr2;
      Arr1 = OldAtt->Array();
      Arr2 = CurrAtt->Array();
#ifdef OCCT_DEBUG
      if (Arr1.IsNull())
...
void TDataStd_DeltaOnModificationOfExtStringArray::Apply()
{
  ...
  int                        i;
  occ::handle<TColStd_HArray1OfExtendedString> aStrArr = aCurAtt->Array();
  if (aStrArr.IsNull())
    return;
  ...
  {
    occ::handle<TColStd_HArray1OfExtendedString> strArr =
  ...
  occ::handle<TColStd_HArray1OfExtendedString> aStrArr2 = aCurAtt->Array();
