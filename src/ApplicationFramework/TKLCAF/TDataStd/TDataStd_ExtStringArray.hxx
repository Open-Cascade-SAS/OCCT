...
public:
  ...
  Standard_EXPORT void ChangeArray(const occ::handle<TColStd_HArray1OfExtendedString>& newArray,
                                   const bool isCheckItems = true);

  //! Return the inner array of the ExtStringArray attribute
  const occ::handle<TColStd_HArray1OfExtendedString>& Array() const { return myValue; }
...
private:
  occ::handle<TColStd_HArray1OfExtendedString> myValue;
  bool                        myIsDelta;
  Standard_GUID                           myID;
};
