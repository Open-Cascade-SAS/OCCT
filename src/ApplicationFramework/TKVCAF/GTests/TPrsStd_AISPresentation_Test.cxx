...
// Migrated from tests/bugs/caf/buc60910.
// The DRAW case checks presentation mode state only; it does not create a
...
TEST(TPrsStd_AISPresentationTest, CafBug_60910_ModeState)
{
  ...
  EXPECT_FALSE(aPresentation->HasOwnMode());
  aPresentation->SetMode(3);
  EXPECT_EQ(aPresentation->Mode(), 3);
  EXPECT_TRUE(aPresentation->HasOwnMode());
