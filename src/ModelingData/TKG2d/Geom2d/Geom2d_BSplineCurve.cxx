...
void Geom2d_BSplineCurve::IncreaseDegree(const int Degree)
{
  ...
  occ::handle<TColgp_HArray1OfPnt2d> npoles =
  ...
  occ::handle<TColStd_HArray1OfReal> nknots = new TColStd_HArray1OfReal(1, nbknots);

  occ::handle<TColStd_HArray1OfInteger> nmults = new TColStd_HArray1OfInteger(1, nbknots);

  occ::handle<TColStd_HArray1OfReal> nweights;
...
void Geom2d_BSplineCurve::IncreaseMultiplicity(const int I1,
                                               ...
                                               const int M)
{
  occ::handle<TColStd_HArray1OfReal> tk = knots;
                                      ...
                                      const bool         Add)
{
  ...
  occ::handle<TColgp_HArray1OfPnt2d>    npoles = new TColgp_HArray1OfPnt2d(1, nbpoles);
  occ::handle<TColStd_HArray1OfReal>    nknots = knots;
  occ::handle<TColStd_HArray1OfInteger> nmults = mults;
                                                 ...
                                                 const double    Tolerance)
{
  ...
  occ::handle<TColgp_HArray1OfPnt2d> npoles = new TColgp_HArray1OfPnt2d(1, oldpoles.Length() - step);
                                          ...
                                          const double    Weight)
{
  ...
  const NCollection_Array1<double>& cknots  = knots->Array1();
  int            nbknots = cknots.Length();

  occ::handle<TColStd_HArray1OfReal> nknots = new TColStd_HArray1OfReal(1, nbknots + 1);
  ...
  occ::handle<TColStd_HArray1OfInteger> nmults = new TColStd_HArray1OfInteger(1, nbknots + 1);

  NCollection_Array1<int>&       newmults = nmults->ChangeArray1();
  const NCollection_Array1<int>& cmults   = mults->Array1();
  ...
  occ::handle<TColgp_HArray1OfPnt2d> npoles   = new TColgp_HArray1OfPnt2d(1, nbpoles + 1);
...
void Geom2d_BSplineCurve::RemovePole(const int Index)
{
  ...
  int              i;
  occ::handle<TColStd_HArray1OfReal> nknots   = new TColStd_HArray1OfReal(1, knots->Length() - 1);
  NCollection_Array1<double>&         newknots = nknots->ChangeArray1();

  occ::handle<TColStd_HArray1OfInteger> nmults   = new TColStd_HArray1OfInteger(1, mults->Length() - 1);
  NCollection_Array1<int>&         newmults = nmults->ChangeArray1();
  ...
  occ::handle<TColgp_HArray1OfPnt2d> npoles   = new TColgp_HArray1OfPnt2d(1, poles->Upper() - 1);
  NCollection_Array1<gp_Pnt2d>&         newpoles = npoles->ChangeArray1();
...
void Geom2d_BSplineCurve::Segment(const double aU1,
                                  const double aU2,
                                  const double theTolerance)
{
  ...
  occ::handle<TColStd_HArray1OfReal> nweights = new TColStd_HArray1OfReal(1, nbpoles);
  occ::handle<TColgp_HArray1OfPnt2d> npoles   = new TColgp_HArray1OfPnt2d(1, nbpoles);
...
void Geom2d_BSplineCurve::SetPeriodic()
{
  ...
  occ::handle<TColStd_HArray1OfInteger> tm = mults;
  ...
  occ::handle<TColgp_HArray1OfPnt2d> tp = poles;
  NCollection_Array1<gp_Pnt2d>          cpoles((poles->Array1())(1), 1, nbp);
  poles                 = new TColgp_HArray1OfPnt2d(1, nbp);
  poles->ChangeArray1() = cpoles;

  if (rational)
  {
    occ::handle<TColStd_HArray1OfReal> tw = weights;
                                    ...
                                    int&      LastmodifiedPole)
{
  ...
  NCollection_Array1<gp_Pnt2d> npoles(1, poles->Length());
  gp_Pnt2d             P0;
  D0(U, P0);
  gp_Vec2d Displ(P0, P);
                                              ...
                                              int&      ErrorStatus)
{
  ...
  NCollection_Array1<gp_Pnt2d> new_poles(1, poles->Length());
  gp_Pnt2d             P0;
