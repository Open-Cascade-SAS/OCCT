...
std::optional<Geom2d_CurveD1> Geom2d_Parabola::EvalD1(const double U) const
{
...
std::optional<Geom2d_CurveD2> Geom2d_Parabola::EvalD2(const double U) const
{
...
std::optional<Geom2d_CurveD3> Geom2d_Parabola::EvalD3(const double U) const
{
