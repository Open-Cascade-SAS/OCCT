...
#ifndef _Geom2dEval_TBezierCurve_HeaderFile
#define _Geom2dEval_TBezierCurve_HeaderFile
...
private:
  ...
  gp_Pnt2d evalNonRationalPoint(const NCollection_Array1<double>& theBasis) const;

  //! Evaluate derivative vector on a non-rational curve: sum(P_i * B_i'(t)).
  gp_Vec2d evalNonRationalDeriv(const NCollection_Array1<double>& theBasisDeriv) const;

  NCollection_Array1<gp_Pnt2d> myPoles;    //!< Control points
...
#endif // _Geom2dEval_TBezierCurve_HeaderFile
