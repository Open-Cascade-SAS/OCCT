  ...
  const NCollection_Array1<double>& theParams) const
{
  ...
  for (int i = theParams.Lower(); i <= theParams.Upper(); ++i)
  {
    ...
    aPoints.SetValue(i - theParams.Lower() + 1, aP);
  }
  ...
  const NCollection_Array1<double>& theParams) const
{
  ...
  for (int i = theParams.Lower(); i <= theParams.Upper(); ++i)
  {
    gp_Pnt aPoint;
    gp_Vec aD1;
    myGeom->D1(theParams.Value(i), aPoint, aD1);
    aResults.ChangeValue(i - theParams.Lower() + 1) = {aPoint, aD1};
  }
  ...
  const NCollection_Array1<double>& theParams) const
{
  ...
  for (int i = theParams.Lower(); i <= theParams.Upper(); ++i)
  {
    gp_Pnt aPoint;
    gp_Vec aD1, aD2;
    myGeom->D2(theParams.Value(i), aPoint, aD1, aD2);
    aResults.ChangeValue(i - theParams.Lower() + 1) = {aPoint, aD1, aD2};
  }
  ...
  const NCollection_Array1<double>& theParams) const
{
  ...
  for (int i = theParams.Lower(); i <= theParams.Upper(); ++i)
  {
    gp_Pnt aPoint;
    gp_Vec aD1, aD2, aD3;
    myGeom->D3(theParams.Value(i), aPoint, aD1, aD2, aD3);
    aResults.ChangeValue(i - theParams.Lower() + 1) = {aPoint, aD1, aD2, aD3};
  }
