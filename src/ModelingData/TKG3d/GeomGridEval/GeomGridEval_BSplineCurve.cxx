  ...
  const NCollection_Array1<double>& theParams) const
{
  ...
  const occ::handle<TColStd_HArray1OfReal>& aFlatKnotsHandle = myGeom->HArrayFlatKnots();
  ...
  const occ::handle<TColgp_HArray1OfPnt>& aPolesHandle = myGeom->HArrayPoles();
  ...
  const occ::handle<TColStd_HArray1OfReal>& aWeightsHandle = myGeom->HArrayWeights();
