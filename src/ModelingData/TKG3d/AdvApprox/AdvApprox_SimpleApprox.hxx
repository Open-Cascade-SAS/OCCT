...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> Coefficients() const;

  //! returns the constraints at First
  Standard_EXPORT occ::handle<TColStd_HArray2OfReal> FirstConstr() const;

  //! returns the constraints at Last
  Standard_EXPORT occ::handle<TColStd_HArray2OfReal> LastConstr() const;
...
private:
  ...
  occ::handle<TColStd_HArray2OfReal> myTabWeights;
  void*              myEvaluator;
  int              myDegree;
  occ::handle<TColStd_HArray1OfReal> myCoeff;
  occ::handle<TColStd_HArray2OfReal> myFirstConstr;
  occ::handle<TColStd_HArray2OfReal> myLastConstr;
  occ::handle<TColStd_HArray1OfReal> mySomTab;
  occ::handle<TColStd_HArray1OfReal> myDifTab;
  occ::handle<TColStd_HArray1OfReal> myMaxError;
  occ::handle<TColStd_HArray1OfReal> myAverageError;
  bool              done;
};
