  ...
  int&        ErrorCode)
{
  ...
  while ((NUPIL - NumCurves) != 0)
  {
    ...
    occ::handle<TColStd_HArray1OfReal> HJacCoeff = Approx.Coefficients();
                                        ...
                                        const AdvApprox_Cutting& CutTool)
{
  ...
  occ::handle<TColStd_HArray1OfInteger> NumCoeffPerCurvePtr =
    new TColStd_HArray1OfInteger(1, myMaxSegments);

  occ::handle<TColStd_HArray1OfReal> LocalCoefficientsPtr = new TColStd_HArray1OfReal(1, size);

  occ::handle<TColStd_HArray1OfReal> IntervalsPtr = new TColStd_HArray1OfReal(1, myMaxSegments + 1);
...
occ::handle<TColStd_HArray1OfReal> AdvApprox_ApproxAFunction::MaxError(const int D) const
...
{
  occ::handle<TColStd_HArray1OfReal> EPtr = MaxError(D);
...
occ::handle<TColStd_HArray1OfReal> AdvApprox_ApproxAFunction::AverageError(
  const int D) const
...
{
  occ::handle<TColStd_HArray1OfReal> EPtr = AverageError(D);
  return EPtr->Value(Index);
}
