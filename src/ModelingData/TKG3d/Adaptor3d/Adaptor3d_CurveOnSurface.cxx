...
static void AddIntervals(const occ::handle<TColStd_HSequenceOfReal>& theParameters,
...
int Adaptor3d_CurveOnSurface::NbIntervals(const GeomAbs_Shape S) const
{
  ...
  occ::handle<TColStd_HSequenceOfReal> aIntervals = new TColStd_HSequenceOfReal;
