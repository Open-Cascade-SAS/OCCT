...
public:
  ...
  static void Value(const occ::handle<Adaptor3d_Curve>& C, const double U, gp_Pnt& P) { P = C->Value(U); }
  ...
  static double FirstParameter(const occ::handle<Adaptor3d_Curve>& C) { return C->FirstParameter(); }
