...
Geom_BezierCurve::Geom_BezierCurve(const NCollection_Array1<gp_Pnt>& Poles)
{
  ...
  //  copy the poles
  occ::handle<TColgp_HArray1OfPnt> npoles = new TColgp_HArray1OfPnt(1, nbpoles);

  npoles->ChangeArray1() = Poles;

  // Init non rational
  Init(npoles, occ::handle<TColStd_HArray1OfReal>());
}
...
void Geom_BezierCurve::Increase(const int Deg)
{
  ...
  occ::handle<TColgp_HArray1OfPnt> npoles = new TColgp_HArray1OfPnt(1, Deg + 1);
                                       ...
                                       const double    Weight)
{
  ...
  // Insert the pole
  occ::handle<TColgp_HArray1OfPnt> npoles = new TColgp_HArray1OfPnt(1, nbpoles + 1);
...
void Geom_BezierCurve::D3(const double U,
                          gp_Pnt&             P,
                          gp_Vec&             V1,
                          gp_Vec&             V2,
                          gp_Vec&             V3) const
...
void Geom_BezierCurve::Init(const occ::handle<TColgp_HArray1OfPnt>&   Poles,
                            const occ::handle<TColStd_HArray1OfReal>& Weights)
{
  int nbpoles = Poles->Length();
  // closed ?
