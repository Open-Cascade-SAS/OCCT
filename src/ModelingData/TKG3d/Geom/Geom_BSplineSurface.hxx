...
public:
  ...
  Standard_EXPORT void IncreaseDegree(const int UDegree,
                                      const int VDegree);
  ...
  Standard_EXPORT bool RemoveUKnot(const int Index,
                                               const int M,
  ...
  //! Standard_OutOfRange if Index is outside the
  //! bounds of the knots table of this BSpline surface.
  Standard_EXPORT bool RemoveVKnot(const int Index,
                                               const int M,
                                               const double    Tolerance);
  ...
  Standard_EXPORT void IncreaseUMultiplicity(const int UIndex,
                                             const int M);
  ...
  Standard_EXPORT void IncreaseUMultiplicity(const int FromI1,
                                             const int ToI2,
                                             const int M);
  ...
  Standard_EXPORT void IncrementUMultiplicity(const int FromI1,
                                              const int ToI2,
                                              const int Step);
  ...
  Standard_EXPORT void IncreaseVMultiplicity(const int VIndex,
                                             const int M);
  ...
  Standard_EXPORT void IncreaseVMultiplicity(const int FromI1,
                                             const int ToI2,
                                             const int M);
  ...
  Standard_EXPORT void IncrementVMultiplicity(const int FromI1,
                                              const int ToI2,
                                              const int Step);
  ...
  Standard_EXPORT void SetUKnot(const int UIndex,
                                const double    K,
                                const int M);
  ...
  Standard_EXPORT void SetVKnot(const int VIndex,
                                const double    K,
                                const int M);
  ...
  //! package gp
  Standard_EXPORT void SetWeight(const int UIndex,
                                 const int VIndex,
                                 const double    Weight);
  ...
  //! Raised if UIndex < 1 or UIndex > NbUPoles or VIndex < 1 or
  //! VIndex > NbVPoles.
  Standard_EXPORT const gp_Pnt& Pole(const int UIndex,
  ...
  const occ::handle<TColgp_HArray2OfPnt>& HArrayPoles() const { return poles; }

  //! Returns handle to the weights array.
  //! Returns null handle for non-rational surfaces.
  const occ::handle<TColStd_HArray2OfReal>& HArrayWeights() const { return weights; }

  //! Returns handle to the U flat knots sequence.
  const occ::handle<TColStd_HArray1OfReal>& HArrayUFlatKnots() const { return ufknots; }

  //! Returns handle to the V flat knots sequence.
  const occ::handle<TColStd_HArray1OfReal>& HArrayVFlatKnots() const { return vfknots; }
  ...
  Standard_EXPORT void Resolution(const double Tolerance3D,
                                  double&      UTolerance,
                                  double&      VTolerance);
...
private:
  ...
  int                 udeg;
  int                 vdeg;
  occ::handle<TColgp_HArray2OfPnt>      poles;
  occ::handle<TColStd_HArray2OfReal>    weights;
  occ::handle<TColStd_HArray1OfReal>    ufknots;
  occ::handle<TColStd_HArray1OfReal>    vfknots;
  occ::handle<TColStd_HArray1OfReal>    uknots;
  occ::handle<TColStd_HArray1OfReal>    vknots;
  occ::handle<TColStd_HArray1OfInteger> umults;
  occ::handle<TColStd_HArray1OfInteger> vmults;
  double                    umaxderivinv;
  double                    vmaxderivinv;
  bool                 maxderivinvok;
};
