...
private:
  Geom_BezierSurface(const occ::handle<TColgp_HArray2OfPnt>&   SurfacePoles,
  ...
  void Init(const occ::handle<TColgp_HArray2OfPnt>& Poles, const occ::handle<TColStd_HArray2OfReal>& Weights);
