...
void Geom_BSplineSurface::IncreaseUMultiplicity(const int FromI1,
                                                ...
                                                const int M)
{
  occ::handle<TColStd_HArray1OfReal> tk = uknots;
...
void Geom_BSplineSurface::IncreaseVMultiplicity(const int FromI1,
                                                ...
                                                const int M)
{
  occ::handle<TColStd_HArray1OfReal> tk = vknots;
                                  ...
                                  const bool SegmentInV)
{
  ...
  occ::handle<TColStd_HArray1OfReal>    nuknots = new TColStd_HArray1OfReal(1, nbuknots);
  occ::handle<TColStd_HArray1OfInteger> numults = new TColStd_HArray1OfInteger(1, nbuknots);
  ...
  occ::handle<TColStd_HArray1OfReal>    nvknots = new TColStd_HArray1OfReal(1, nbvknots);
  occ::handle<TColStd_HArray1OfInteger> nvmults = new TColStd_HArray1OfInteger(1, nbvknots);
...
void Geom_BSplineSurface::PeriodicNormalization(double& Uparameter,
