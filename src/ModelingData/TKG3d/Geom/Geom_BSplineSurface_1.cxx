...
void Geom_BSplineSurface::SetUPeriodic()
{
  ...
  occ::handle<TColStd_HArray1OfInteger> tm = umults;
...
void Geom_BSplineSurface::SetVPeriodic()
{
  ...
  occ::handle<TColStd_HArray1OfInteger> tm = vmults;
...
void Geom_BSplineSurface::SetUOrigin(const int Index)
{
  ...
  occ::handle<TColgp_HArray2OfPnt>   npoles     = new TColgp_HArray2OfPnt(1, nbpoles, 1, nbvp);
  occ::handle<TColStd_HArray2OfReal> nweights   = new TColStd_HArray2OfReal(1, nbpoles, 1, nbvp);
...
void Geom_BSplineSurface::SetVOrigin(const int Index)
{
  ...
  occ::handle<TColgp_HArray2OfPnt>   npoles     = new TColgp_HArray2OfPnt(1, nbup, 1, nbpoles);
  occ::handle<TColStd_HArray2OfReal> nweights   = new TColStd_HArray2OfReal(1, nbup, 1, nbpoles);
  NCollection_Array2<gp_Pnt>&           newpoles   = npoles->ChangeArray2();
  NCollection_Array2<double>&         newweights = nweights->ChangeArray2();
...
void Geom_BSplineSurface::SetUNotPeriodic()
{
  if (uperiodic)
  {
    ...
    occ::handle<TColgp_HArray2OfPnt> npoles = new TColgp_HArray2OfPnt(1, NbPoles, 1, poles->RowLength());
...
void Geom_BSplineSurface::SetVNotPeriodic()
{
  if (vperiodic)
  {
    ...
    occ::handle<TColgp_HArray2OfPnt> npoles = new TColgp_HArray2OfPnt(1, poles->ColLength(), 1, NbPoles);
                                       ...
                                       const bool         Add)
{
  ...
  occ::handle<TColStd_HArray1OfReal>    nknots = uknots;
  occ::handle<TColStd_HArray1OfInteger> nmults = umults;
                                       ...
                                       const bool         Add)
{
  ...
  occ::handle<TColStd_HArray1OfReal>    nknots = vknots;
  occ::handle<TColStd_HArray1OfInteger> nmults = vmults;
