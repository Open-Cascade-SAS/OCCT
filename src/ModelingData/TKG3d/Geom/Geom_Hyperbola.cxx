...
std::optional<gp_Pnt> Geom_Hyperbola::EvalD0(const double U) const
{
...
std::optional<Geom_CurveD1> Geom_Hyperbola::EvalD1(const double U) const
{
...
std::optional<Geom_CurveD2> Geom_Hyperbola::EvalD2(const double U) const
{
...
std::optional<Geom_CurveD3> Geom_Hyperbola::EvalD3(const double U) const
{
  std::optional<Geom_CurveD3> aResult{std::in_place};
  ElCLib::HyperbolaD3(U, pos, majorRadius, minorRadius, aResult->Point, aResult->D1, aResult->D2, aResult->D3);
  return aResult;
}

//=================================================================================================

std::optional<gp_Vec> Geom_Hyperbola::EvalDN(const double U, const int N) const
{
