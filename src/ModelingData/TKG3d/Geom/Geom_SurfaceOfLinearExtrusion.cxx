...
Geom_Surface::ResD1 Geom_SurfaceOfLinearExtrusion::EvalD1(const double U,
...
Geom_Surface::ResD2 Geom_SurfaceOfLinearExtrusion::EvalD2(const double U,
                                                                         const double V) const
{
...
Geom_Surface::ResD3 Geom_SurfaceOfLinearExtrusion::EvalD3(const double U,
                                                                         const double V) const
{
