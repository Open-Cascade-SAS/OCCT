...
void Geom_BSplineCurve::IncreaseDegree(const int Degree)
{
  ...
  occ::handle<TColgp_HArray1OfPnt> npoles =
                                               ...
                                               const double    Tolerance)
{
  ...
  occ::handle<TColgp_HArray1OfPnt> npoles = new TColgp_HArray1OfPnt(1, oldpoles.Length() - step);
...
void Geom_BSplineCurve::SetPeriodic()
{
  ...
  occ::handle<TColgp_HArray1OfPnt> tp = poles;
