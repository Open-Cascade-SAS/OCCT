...
void printTBezierCurveBenchRow(const TBezierCurveBenchSummary& theResult, const int theCalls)
{
  ...
  std::cout << std::left << std::setw(34) << theResult.Name << std::right << std::setw(12)
...
{
  std::cout << "\n=== " << theTitle << " ===\n";
  std::cout << std::left << std::setw(34) << "Path" << std::right << std::setw(12) << "ms"
...
TEST(GeomEval_TBezierCurvePerfTest, DISABLED_D0ToD2_EquivalentCircleAndAdaptorPaths)
{
  ...
  const TBezierCurveBenchSummary aDirectTBezD0 =
    runTBezierCurveBench("Direct_TBezier_D0", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      aTBezierCurve->D0(theU, aP);
      return aP.X() + aP.Y() + aP.Z();
    });
  const TBezierCurveBenchSummary aDirectCircleD0 =
    runTBezierCurveBench("Direct_Circle_D0", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      aCircleCurve->D0(theU, aP);
      return aP.X() + aP.Y() + aP.Z();
    });
  const TBezierCurveBenchSummary aDirectBspD0 =
    runTBezierCurveBench("Direct_BSpline_D0", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      aBSplineCurve->D0(theU, aP);
      return aP.X() + aP.Y() + aP.Z();
    });
  const TBezierCurveBenchSummary anAdaptorCircleD0 =
    runTBezierCurveBench("Adaptor_Circle_D0", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      anAdaptorCircle.D0(theU, aP);
      return aP.X() + aP.Y() + aP.Z();
    });
  const TBezierCurveBenchSummary anAdaptorBspD0 =
    runTBezierCurveBench("Adaptor_BSpline_D0", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
  ...
  const TBezierCurveBenchSummary aDirectTBezD1 =
    runTBezierCurveBench("Direct_TBezier_D1", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV;
      aTBezierCurve->D1(theU, aP, aV);
      return aP.X() + aP.Y() + aP.Z() + aV.X() + aV.Y() + aV.Z();
    });
  const TBezierCurveBenchSummary aDirectCircleD1 =
    runTBezierCurveBench("Direct_Circle_D1", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV;
      aCircleCurve->D1(theU, aP, aV);
      return aP.X() + aP.Y() + aP.Z() + aV.X() + aV.Y() + aV.Z();
    });
  const TBezierCurveBenchSummary aDirectBspD1 =
    runTBezierCurveBench("Direct_BSpline_D1", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV;
      aBSplineCurve->D1(theU, aP, aV);
      return aP.X() + aP.Y() + aP.Z() + aV.X() + aV.Y() + aV.Z();
    });
  const TBezierCurveBenchSummary anAdaptorCircleD1 =
    runTBezierCurveBench("Adaptor_Circle_D1", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV;
      anAdaptorCircle.D1(theU, aP, aV);
      return aP.X() + aP.Y() + aP.Z() + aV.X() + aV.Y() + aV.Z();
    });
  const TBezierCurveBenchSummary anAdaptorBspD1 =
    runTBezierCurveBench("Adaptor_BSpline_D1", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV;
  ...
  const TBezierCurveBenchSummary aDirectTBezD2 =
    runTBezierCurveBench("Direct_TBezier_D2", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV1;
      gp_Vec aV2;
  ...
  const TBezierCurveBenchSummary aDirectCircleD2 =
    runTBezierCurveBench("Direct_Circle_D2", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV1;
      gp_Vec aV2;
  ...
  const TBezierCurveBenchSummary aDirectBspD2 =
    runTBezierCurveBench("Direct_BSpline_D2", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV1;
      gp_Vec aV2;
  ...
  const TBezierCurveBenchSummary anAdaptorCircleD2 =
    runTBezierCurveBench("Adaptor_Circle_D2", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV1;
      gp_Vec aV2;
  ...
  const TBezierCurveBenchSummary anAdaptorBspD2 =
    runTBezierCurveBench("Adaptor_BSpline_D2", aRepeats, aParams, [&](double theU) {
      gp_Pnt aP;
      gp_Vec aV1;
      gp_Vec aV2;
