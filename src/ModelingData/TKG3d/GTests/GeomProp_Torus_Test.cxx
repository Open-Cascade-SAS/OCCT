...
TEST(GeomProp_TorusTest, Normal_AtOuterEdge)
{
  ...
  occ::handle<Geom_ToroidalSurface> aTorus =
    new Geom_ToroidalSurface(gp_Ax3(), aMajorR, aMinorR);
...
{
  occ::handle<Geom_ToroidalSurface> aTorus =
    new Geom_ToroidalSurface(gp_Ax3(), 10.0, 3.0);
  GeomProp_Surface aProp(aTorus);
...
{
  occ::handle<Geom_ToroidalSurface> aTorus =
    new Geom_ToroidalSurface(gp_Ax3(), 100.0, 10.0);
...
{
  occ::handle<Geom_ToroidalSurface> aTorus =
    new Geom_ToroidalSurface(gp_Ax3(), 2.0, 0.5);
  compareAllSurface(aTorus, 0.0, 2.0 * M_PI, 0.0, 2.0 * M_PI);
}
...
TEST(GeomProp_TorusTest, VsSLProps_CriticalPoints)
{
  ...
  const double aParams[][2] = {{0.0, 0.0}, {0.0, M_PI}, {0.0, M_PI / 2.0}, {0.0, -M_PI / 2.0},
                                {M_PI / 2.0, 0.0}, {M_PI / 2.0, M_PI},
                                {1.0e-10, 0.0}, {0.0, 1.0e-10}, {0.0, M_PI + 1.0e-6},
                                {0.0, M_PI - 1.0e-6}, {2.0 * M_PI - 1.0e-10, M_PI / 4.0},
