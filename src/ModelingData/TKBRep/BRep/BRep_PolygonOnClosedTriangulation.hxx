...
public:
  Standard_EXPORT BRep_PolygonOnClosedTriangulation(const occ::handle<Poly_PolygonOnTriangulation>& P1,
  ...
  Standard_EXPORT virtual const occ::handle<Poly_PolygonOnTriangulation>& PolygonOnTriangulation2() const
    override;
