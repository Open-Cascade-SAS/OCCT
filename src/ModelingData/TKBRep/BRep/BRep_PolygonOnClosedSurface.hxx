...
public:
  ...
  //! returns True.
  Standard_EXPORT virtual Standard_Boolean IsPolygonOnClosedSurface() const override;

  Standard_EXPORT virtual const Handle(Poly_Polygon2D)& Polygon2() const override;

  Standard_EXPORT virtual void Polygon2(const Handle(Poly_Polygon2D)& P) override;
