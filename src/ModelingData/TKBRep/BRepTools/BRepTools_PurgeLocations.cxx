...
bool BRepTools_PurgeLocations::Perform(const TopoDS_Shape& theShape)
{
  ...
  NCollection_DataMap<TopoDS_Shape, TopoDS_Shape, TopTools_ShapeMapHasher>::Iterator anIter(myMapNewShapes);
...
bool BRepTools_PurgeLocations::PurgeLocation(const TopoDS_Shape& theS,
                                                         TopoDS_Shape&       theRes)
{
  bool isDone  = true;
