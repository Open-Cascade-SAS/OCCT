...
public:
  ...
  Standard_EXPORT bool
    NewTriangulation(const TopoDS_Face& F, occ::handle<Poly_Triangulation>& T) override;

  //! Returns true if the edge has been modified according to changed polygon.
  //! If the edge has been modified:
  //! - P is a new polygon
  Standard_EXPORT bool NewPolygon(const TopoDS_Edge&      E,
                                              occ::handle<Poly_Polygon3D>& P) override;
  ...
  Standard_EXPORT bool NewPolygonOnTriangulation(const TopoDS_Edge&                   E,
                                                             const TopoDS_Face&                   F,
