...
void BRepGraph_ChildIterator::advance()
{
  ...
  for (;;)
  {
    ...
    {
      case Kind::Compound: {
        const BRepGraphInc::CompoundDef& aComp = aDefs.Compound(BRepGraph_CompoundId(myParent.Index));
        int i = myChildIdx;
      ...
      case Kind::CompSolid: {
        const BRepGraphInc::CompSolidDef& aCompSolid =
          aDefs.CompSolid(BRepGraph_CompSolidId(myParent.Index));
        int i = myChildIdx;
      ...
      case Kind::Solid: {
        const BRepGraphInc::SolidDef& aSolid = aDefs.Solid(BRepGraph_SolidId(myParent.Index));
      ...
      case Kind::Shell: {
        const BRepGraphInc::ShellDef& aShell = aDefs.Shell(BRepGraph_ShellId(myParent.Index));
      ...
      case Kind::Face: {
        const BRepGraphInc::FaceDef& aFace = aDefs.Face(BRepGraph_FaceId(myParent.Index));
      ...
      case Kind::Wire: {
        const BRepGraphInc::WireDef& aWire = aDefs.Wire(BRepGraph_WireId(myParent.Index));
        int i = myChildIdx;
      ...
      case Kind::Edge: {
        const BRepGraphInc::EdgeDef& anEdge = aDefs.Edge(BRepGraph_EdgeId(myParent.Index));
      ...
      case Kind::Product: {
        const BRepGraphInc::ProductDef& aProduct = aDefs.Product(BRepGraph_ProductId(myParent.Index));
        int i = myChildIdx;
                                          ...
                                          TopAbs_Orientation& theOri) const
{
  ...
  for (;;)
  {
    ...
    {
      const BRepGraphInc::CoEdgeDef& aCoEdge = aDefs.CoEdge(BRepGraph_CoEdgeId(theNode.Index));
    ...
    {
      const BRepGraphInc::OccurrenceDef& anOcc = aDefs.Occurrence(BRepGraph_OccurrenceId(theNode.Index));
      if (anOcc.IsRemoved)
      {
        theNode = BRepGraph_NodeId();
        return;
    ...
    {
      const BRepGraphInc::ProductDef& aProd = aDefs.Product(BRepGraph_ProductId(theNode.Index));
      if (aProd.IsRemoved)
      {
        theNode = BRepGraph_NodeId();
        return;
