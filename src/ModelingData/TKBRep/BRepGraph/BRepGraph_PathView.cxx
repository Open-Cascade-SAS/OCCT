  ...
  const occ::handle<NCollection_BaseAllocator>& theAllocator) const
{
  ...
  ForEachPathTo(theNode,
                theAllocator,
                [&](const BRepGraph_TopologyPath& thePath)
                { aResult.Append(BRepGraph_TopologyPath(thePath, theAllocator)); });
  return aResult;
}
  ...
  const occ::handle<NCollection_BaseAllocator>& theAllocator) const
{
  ...
  ForEachNodeLocation(theNode,
                      theAllocator,
                      [&](const OccurrenceEntry& theEntry)
                      {
                        aResult.Append(OccurrenceEntry{BRepGraph_TopologyPath(theEntry.Path,
                                                                              theAllocator),
                                                       theEntry.Location,
