...
public:
  ...
  Standard_EXPORT int DepthOfKind(const BRepGraph_TopologyPath& thePath,
                                  BRepGraph_NodeId::Kind        theKind) const;
  ...
  Standard_EXPORT bool IsAncestorOf(const BRepGraph_TopologyPath& theAncestorPath,
  ...
  Standard_EXPORT NCollection_Vector<BRepGraph_NodeId> AllNodesOnPath(
