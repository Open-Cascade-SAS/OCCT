...
public:
  ...
  [[nodiscard]] Standard_EXPORT uint64_t Attach(BRepGraph_NodeId                        theOwner,
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToVertex(
    BRepGraph_VertexId theVertex,
    const TopoDS_Shape& theShape,
    BRepGraph_LayerTopoSupplement::AttachmentKind theKind =
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToEdge(
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToFace(
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToSolid(
    BRepGraph_SolidId theSolid,
    const TopoDS_Shape& theShape,
    BRepGraph_LayerTopoSupplement::AttachmentKind theKind =
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToCompSolid(
    BRepGraph_CompSolidId theCompSolid,
    const TopoDS_Shape& theShape,
    BRepGraph_LayerTopoSupplement::AttachmentKind theKind =
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToShell(
  ...
  //! @param[in] theKind semantic attachment kind
  //! @return non-zero attachment uid on success, `0` on rejection
  [[nodiscard]] Standard_EXPORT uint64_t AttachToCompound(
    BRepGraph_CompoundId theCompound,
    const TopoDS_Shape& theShape,
    BRepGraph_LayerTopoSupplement::AttachmentKind theKind =
