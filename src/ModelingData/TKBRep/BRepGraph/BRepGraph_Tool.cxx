...
gp_Pnt BRepGraph_Tool::Vertex::Pnt(const BRepGraph& theGraph, const BRepGraphInc::VertexUsage& theRef)
{
...
const BRepGraphInc::VertexRef& BRepGraph_Tool::Edge::StartVertex(
