...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes1 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes2 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes3 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes4 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes5 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes6 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes7 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, SingleFace_NoSurfaceRewrite)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes8 = BRepGraph_Builder::Add(aGraph, anExp.Current());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes9 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes11 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, EmptyCompound_NoRewrites)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes12 = BRepGraph_Builder::Add(aGraph, aCompound);
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, MultipleCopies_NWayDedup)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes13 = BRepGraph_Builder::Add(aGraph, makeNCopiedIdenticalFaces(aNbCopies));
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes14 = BRepGraph_Builder::Add(aGraph, makeMixedCompound());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, AfterDedup_AllCopiedFacesShareCanonicalSurface)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes15 = BRepGraph_Builder::Add(aGraph, makeNCopiedIdenticalFaces(aNbCopies));
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes16 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes17 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes18 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes19 = BRepGraph_Builder::Add(aGraph, makeNestedCompound());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes20 = BRepGraph_Builder::Add(aGraph, makeThreeDistinctPrimitives());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes21 = BRepGraph_Builder::Add(aGraph, makeTwoIdenticalBoxes());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes22 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes23 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, MultiplePCurveDups_AllEdgesDeduped)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes24 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, PCurveDup_AnalyzeOnly_CountsButNoRewrite)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes25 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, NoPCurveDuplicates_ZeroPCurveRewrites)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes26 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes27 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes28 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes29 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes30 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
  ...
  BRepGraph aGraph2;
  aGraph2.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes31 = BRepGraph_Builder::Add(aGraph2, makeTwoCopiedIdenticalFaces());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes32 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes33 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, AfterDedup_AllInlinePCurvesHaveCurve2d)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes34 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes35 = BRepGraph_Builder::Add(aGraph, makeNCopiedIdenticalFaces(4));
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes36 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, ParallelBuild_SameResultAsSequential)
{
  ...
  BRepGraph aGraphSeq;
  aGraphSeq.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes37 = BRepGraph_Builder::Add(aGraphSeq, aCompound, BRepGraph_Builder::Options{ {}, true, false, false });
  ASSERT_TRUE(aGraphSeq.IsDone());

  BRepGraph aGraphPar;
  aGraphPar.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes38 = BRepGraph_Builder::Add(aGraphPar, aCompound, BRepGraph_Builder::Options{ {}, true, false, true });
...
TEST(BRepGraph_DeduplicateTest, TenCopies_AllDeduplicatedToOneSurface)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes39 = BRepGraph_Builder::Add(aGraph, makeNCopiedIdenticalFaces(aNbCopies));
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes40 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes41 = BRepGraph_Builder::Add(aGraph, makeMixedCompound());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes42 = BRepGraph_Builder::Add(aGraph, makeTwoIdenticalBoxes());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, DISABLED_PCurveDedup_RewritesReduceUniquePCurveNodes)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes43 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes44 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes45 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes46 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes47 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, PCurveEntryCount_UnchangedAfterDedup)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes48 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, TwoCopiedSphereFaces_Deduped)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes49 = BRepGraph_Builder::Add(aGraph, aCompound);
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, TwoCopiedCylinderFaces_Deduped)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes50 = BRepGraph_Builder::Add(aGraph, aCompound);
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, DifferentSizedCylinders_NotDeduped)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes51 = BRepGraph_Builder::Add(aGraph, aCompound);
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes52 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes53 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes54 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes55 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes56 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, Nullify_OrphanedPCurve_HandleIsNull)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes57 = BRepGraph_Builder::Add(aGraph, aCopy.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes58 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, RoundTrip_TwoCopiedFaces_FewerSurfaces)
{
  ...
  BRepGraph aGraph1;
  aGraph1.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes59 = BRepGraph_Builder::Add(aGraph1, aCompound);
  ...
  BRepGraph aGraph2;
  aGraph2.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes60 = BRepGraph_Builder::Add(aGraph2, aReconstructed);
  ASSERT_TRUE(aGraph2.IsDone());
...
TEST(BRepGraph_DeduplicateTest, RoundTrip_TwoCopiedFaces_FewerCurves)
{
  ...
  BRepGraph aGraph1;
  aGraph1.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes61 = BRepGraph_Builder::Add(aGraph1, aCompound);
  ASSERT_TRUE(aGraph1.IsDone());
  ...
  BRepGraph aGraph2;
  aGraph2.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes62 = BRepGraph_Builder::Add(aGraph2, aReconstructed);
  ASSERT_TRUE(aGraph2.IsDone());
...
TEST(BRepGraph_DeduplicateTest, Build_SharedTFace_OneSurfaceNode)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes63 = BRepGraph_Builder::Add(aGraph, aCompound);
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, RoundTrip_TwoBoxes_GeomReduction)
{
  ...
  BRepGraph aGraph1;
  aGraph1.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes64 = BRepGraph_Builder::Add(aGraph1, aCompound);
  ASSERT_TRUE(aGraph1.IsDone());
  ...
  // Build second graph.
  BRepGraph aGraph2;
  aGraph2.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes65 = BRepGraph_Builder::Add(aGraph2, aReconstructed);
  ASSERT_TRUE(aGraph2.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes66 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes67 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes68 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes69 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes70 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes71 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes72 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes73 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, VertexMerge_UpdatesInternalEdgeVertexRefs)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes74 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, VertexMerge_UpdatesFaceDirectVertexRefs)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes75 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_DeduplicateTest, WireDedup_PreservesShellAuxChildRefs)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes76 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedIdenticalFaces());
  ASSERT_TRUE(aGraph.IsDone());
