...
TEST(BRepGraph_EdgeCasesTest, Build_NullShape_IsDoneFalse)
{
  ...
  aGraph.Clear(); (void)BRepGraph_Builder::Add(aGraph, aNullShape);
...
TEST(BRepGraph_EdgeCasesTest, ParallelBuild_Sphere_SameAsSequential)
{
  ...
  BRepGraph aSeqGraph;
  aSeqGraph.Clear(); (void)BRepGraph_Builder::Add(aSeqGraph, aSphere, BRepGraph_Builder::Options{ {}, true, false, false });
  ASSERT_TRUE(aSeqGraph.IsDone());

  BRepGraph aParGraph;
  aParGraph.Clear(); (void)BRepGraph_Builder::Add(aParGraph, aSphere, BRepGraph_Builder::Options{ {}, true, false, true });
...
TEST(BRepGraph_EdgeCasesTest, ParallelBuild_Compound_SameAsSequential)
{
  ...
  BRepGraph aSeqGraph;
  aSeqGraph.Clear(); (void)BRepGraph_Builder::Add(aSeqGraph, aCompound, BRepGraph_Builder::Options{ {}, true, false, false });
  ASSERT_TRUE(aSeqGraph.IsDone());

  BRepGraph aParGraph;
  aParGraph.Clear(); (void)BRepGraph_Builder::Add(aParGraph, aCompound, BRepGraph_Builder::Options{ {}, true, false, true });
  ASSERT_TRUE(aParGraph.IsDone());
