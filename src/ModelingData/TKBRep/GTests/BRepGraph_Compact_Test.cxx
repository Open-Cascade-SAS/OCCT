...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes5 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes8 = BRepGraph_Builder::Add(aGraph, makeBoxWithLooseEdge());
  ASSERT_TRUE(aGraph.IsDone());
...
{
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes10 = BRepGraph_Builder::Add(aGraph, makeBoxWithLooseEdge());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_CompactTest, OwnGen_SurvivesCompact)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes12 = BRepGraph_Builder::Add(aGraph, makeTwoCopiedFaces());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_CompactTest, CoEdgeUID_AfterCompaction)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes14 = BRepGraph_Builder::Add(aGraph, aBoxMaker.Shape());
  ASSERT_TRUE(aGraph.IsDone());
...
TEST(BRepGraph_CompactTest, UIDRoundTrip_RefUIDs_AfterCompaction)
{
  ...
  BRepGraph aGraph;
  aGraph.Clear(); [[maybe_unused]] const BRepGraph_Builder::Result aBuildRes15 = BRepGraph_Builder::Add(aGraph, aBoxMaker.Shape());
  ASSERT_TRUE(aGraph.IsDone());
