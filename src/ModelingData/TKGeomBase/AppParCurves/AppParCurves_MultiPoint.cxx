...
#define tabPoint occ::down_cast<TColgp_HArray1OfPnt>(ttabPoint)
#define tabPoint2d occ::down_cast<TColgp_HArray1OfPnt2d>(ttabPoint2d)
                                                 ...
                                                 const int NbPoles2d)
{
  ...
  if (nbP != 0)
  {
    occ::handle<TColgp_HArray1OfPnt> tab3d = new TColgp_HArray1OfPnt(1, NbPoles);
    ttabPoint                         = tab3d;
  }
  if (nbP2d != 0)
  {
    occ::handle<TColgp_HArray1OfPnt2d> tab2d = new TColgp_HArray1OfPnt2d(1, NbPoles2d);
    ttabPoint2d                         = tab2d;
  }
}
...
AppParCurves_MultiPoint::AppParCurves_MultiPoint(const NCollection_Array1<gp_Pnt>& tabP)
{
  nbP2d                             = 0;
  nbP                               = tabP.Length();
  occ::handle<TColgp_HArray1OfPnt> tab3d = new TColgp_HArray1OfPnt(1, nbP);
  ttabPoint                         = tab3d;
...
AppParCurves_MultiPoint::AppParCurves_MultiPoint(const NCollection_Array1<gp_Pnt2d>& tabP2d)
{
  nbP                                 = 0;
  nbP2d                               = tabP2d.Length();
  occ::handle<TColgp_HArray1OfPnt2d> tab2d = new TColgp_HArray1OfPnt2d(1, nbP2d);
  ttabPoint2d                         = tab2d;
                                                 ...
                                                 const NCollection_Array1<gp_Pnt2d>& tabP2d)
{
  nbP                             = tabP.Length();
  nbP2d                           = tabP2d.Length();
  occ::handle<TColgp_HArray1OfPnt> t3d = new TColgp_HArray1OfPnt(1, nbP);
  ttabPoint                       = t3d;

  occ::handle<TColgp_HArray1OfPnt2d> t2d = new TColgp_HArray1OfPnt2d(1, nbP2d);
  ttabPoint2d                       = t2d;
