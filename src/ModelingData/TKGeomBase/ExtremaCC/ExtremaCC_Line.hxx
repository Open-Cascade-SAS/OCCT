...
#ifndef _ExtremaCC_Line_HeaderFile
#define _ExtremaCC_Line_HeaderFile
...
public:
  ...
  ExtremaCC_Line(const gp_Lin& theLine, const ExtremaCC::Domain1D& theDomain)
      : myLine(theLine),
        myDomain(theDomain)
  {
  }
...
#endif // _ExtremaCC_Line_HeaderFile
