...
const ExtremaCC::Result& ExtremaCC_EllipseHyperbola::Perform(double                theTol,
                                                             ExtremaCC::SearchMode theMode) const
{
  ...
  ExtremaCC_GridEvaluator2D<ExtremaCC_Ellipse, ExtremaCC_Hyperbola> aGridEval(aEval1,
                                                                              aEval2,
                                                                              aDomain);
...
const ExtremaCC::Result& ExtremaCC_EllipseHyperbola::PerformWithEndpoints(
  double                theTol,
  ExtremaCC::SearchMode theMode) const
{
