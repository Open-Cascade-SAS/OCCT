...
const ExtremaCC::Result& ExtremaCC_HyperbolaParabola::Perform(double                theTol,
                                                              ExtremaCC::SearchMode theMode) const
{
  ...
  ExtremaCC_Hyperbola aEval1(myHyperbola, aDomain.Curve1);
  ExtremaCC_Parabola  aEval2(myParabola, aDomain.Curve2);

  ExtremaCC_GridEvaluator2D<ExtremaCC_Hyperbola, ExtremaCC_Parabola> aGridEval(aEval1,
                                                                               aEval2,
                                                                               aDomain);
...
const ExtremaCC::Result& ExtremaCC_HyperbolaParabola::PerformWithEndpoints(
  double                theTol,
  ExtremaCC::SearchMode theMode) const
{
  ...
  {
    ExtremaCC_Hyperbola aEval1(myHyperbola);
