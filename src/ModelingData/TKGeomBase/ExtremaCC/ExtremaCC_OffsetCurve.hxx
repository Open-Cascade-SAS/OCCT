...
#ifndef _ExtremaCC_OffsetCurve_HeaderFile
#define _ExtremaCC_OffsetCurve_HeaderFile
...
//! @brief Offset curve evaluator wrapper for curve-curve extrema.
//!
...
class ExtremaCC_OffsetCurve
{
public:
  DEFINE_STANDARD_ALLOC

  //! Constructor with offset curve (full domain).
  Standard_EXPORT explicit ExtremaCC_OffsetCurve(
    const occ::handle<Geom_OffsetCurve>& theCurve);

  //! Constructor with offset curve and parameter domain.
  Standard_EXPORT ExtremaCC_OffsetCurve(const occ::handle<Geom_OffsetCurve>& theCurve,
  ...
  const occ::handle<Geom_OffsetCurve>& Curve() const { return myCurve; }

private:
  occ::handle<Geom_OffsetCurve> myCurve;   //!< Offset curve
  ExtremaCC::Domain1D           myDomain;  //!< Parameter domain
};

#endif // _ExtremaCC_OffsetCurve_HeaderFile
