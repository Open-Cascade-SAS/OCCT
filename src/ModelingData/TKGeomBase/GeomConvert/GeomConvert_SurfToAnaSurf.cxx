...
//=======================================================================
static void GetLSGap(const occ::handle<TColgp_HArray1OfXYZ>& thePoints,
                     const gp_Ax3&                      thePos,
                     const double                theR,
                     double&                     theGap)
{
...
bool GeomConvert_SurfToAnaSurf::GetCylByLS(const occ::handle<TColgp_HArray1OfXYZ>& thePoints,
                                                       const double                theTol,
                                                       gp_Ax3&                            thePos,
                                                       double&                     theR,
                                                       double&                     theGap)
