                                            ...
                                            const int           thePrecisCode)
{
  ...
  occ::handle<TColStd_HArray1OfReal> nul1 = new TColStd_HArray1OfReal(1, 1);
  nul1->SetValue(1, 0.);
  occ::handle<TColStd_HArray2OfReal> nul2 = new TColStd_HArray2OfReal(1, 1, 1, 4);
  nul2->SetValue(1, 1, 0.);
  nul2->SetValue(1, 2, 0.);
  nul2->SetValue(1, 3, 0.);
  nul2->SetValue(1, 4, 0.);
  occ::handle<TColStd_HArray1OfReal> eps3D = new TColStd_HArray1OfReal(1, 1);
  eps3D->SetValue(1, theTol3d);
  occ::handle<TColStd_HArray2OfReal> epsfr = new TColStd_HArray2OfReal(1, 1, 1, 4);
