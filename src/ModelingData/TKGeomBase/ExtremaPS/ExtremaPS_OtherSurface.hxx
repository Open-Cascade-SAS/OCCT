...
//!
//! @note This class is intentionally separate from ExtremaPS_OffsetSurface despite
//! similar structure. They use different grid evaluators (GeomGridEval_OtherSurface
//! vs GeomGridEval_OffsetSurface) optimized for their respective surface types.
