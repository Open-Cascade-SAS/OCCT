...
public:
  ...
  Standard_EXPORT explicit ExtremaPS_OffsetSurface(const Handle(Geom_OffsetSurface)& theSurface);
  ...
  Standard_EXPORT ExtremaPS_OffsetSurface(const Handle(Geom_OffsetSurface)& theSurface,
...
private:
  Handle(Geom_OffsetSurface) mySurface;  //!< Offset surface geometry
