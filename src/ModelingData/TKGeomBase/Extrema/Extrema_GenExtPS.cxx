...
{
public:
  Bnd_SphereUBTreeSelector(const occ::handle<Bnd_HArray1OfSphere>& theSphereArray, Bnd_Sphere& theSol)
      : myXYZ(0, 0, 0),
...
protected:
  gp_Pnt                             myXYZ;
  const occ::handle<Bnd_HArray1OfSphere>& mySphereArray;
  Bnd_Sphere&                        mySol;
...
{
public:
  Bnd_SphereUBTreeSelectorMin(const occ::handle<Bnd_HArray1OfSphere>& theSphereArray, Bnd_Sphere& theSol)
...
{
public:
  Bnd_SphereUBTreeSelectorMax(const occ::handle<Bnd_HArray1OfSphere>& theSphereArray, Bnd_Sphere& theSol)
      : Bnd_SphereUBTreeSelector(theSphereArray, theSol),
        myMaxDist(0)
  {
  }
...
inline static void fillParams(const NCollection_Array1<double>&    theKnots,
                              ...
                              double                  theParMin,
                              double                  theParMax,
                              occ::handle<TColStd_HArray1OfReal>& theParams,
                              int               theSample)
{
...
void Extrema_GenExtPS::GetGridPoints(const Adaptor3d_Surface& theSurf)
{
  ...
  {
    occ::handle<TColStd_HArray1OfReal> anArrKnots;
    int              aDegree = 0;
