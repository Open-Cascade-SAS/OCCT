...
public:
  ...
  Standard_EXPORT static occ::handle<TColStd_HArray1OfReal> DeflCurvIntervals(
  ...
  static occ::handle<Geom_BSplineCurve> BSpline(const Adaptor3d_Curve& theC) { return theC.BSpline(); }
};
