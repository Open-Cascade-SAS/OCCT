...
Extrema_LocEPCOfLocateExtPC::Extrema_LocEPCOfLocateExtPC(const gp_Pnt&          P,
                                                         const Adaptor3d_Curve& C,
                                                         const Standard_Real    U0,
                                                         const Standard_Real    TolU)
{
  Initialize(C, Extrema_CurveTool::FirstParameter(C), Extrema_CurveTool::LastParameter(C), TolU);
  Perform(P, U0);
}
...
void Extrema_LocEPCOfLocateExtPC::Initialize(const Adaptor3d_Curve& C,
                                             const Standard_Real    Umin,
                                             const Standard_Real    Usup,
                                             const Standard_Real    TolU)
{
...
void Extrema_LocEPCOfLocateExtPC::Perform(const gp_Pnt& P, const Standard_Real U0)
{
  ...
  {
    Standard_Real        uu, ff;
    const Extrema_POnCurv& PP = Point();
    uu                      = PP.Parameter();
    if (myF.Value(uu, ff))
    {
