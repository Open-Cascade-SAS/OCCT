...
inline void Extrema_GGenExtCC_ChangeIntervals(occ::handle<TColStd_HArray1OfReal>& theInts,
                                              const int                      theNbInts)
{
  int                           aNbInts  = theInts->Length() - 1;
  int                           aNbAdd   = theNbInts - aNbInts;
  occ::handle<TColStd_HArray1OfReal> aNewInts = new TColStd_HArray1OfReal(1, theNbInts + 1);
                       ...
                       TheExtPC>::Perform()
{
  ...
  occ::handle<TColStd_HArray1OfReal> anIntervals1 = new TColStd_HArray1OfReal(1, aNbInter[0] + 1);
  occ::handle<TColStd_HArray1OfReal> anIntervals2 = new TColStd_HArray1OfReal(1, aNbInter[1] + 1);
