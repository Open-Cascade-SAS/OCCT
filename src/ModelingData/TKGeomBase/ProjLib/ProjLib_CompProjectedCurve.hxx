...
public:
  ...
  Standard_EXPORT const occ::handle<ProjLib_HSequenceOfHSequenceOfPnt>& GetSequence() const;
...
private:
  ...
  int                          myNbCurves;
  occ::handle<ProjLib_HSequenceOfHSequenceOfPnt> mySequence;
  occ::handle<TColStd_HArray1OfBoolean>          myUIso;
  occ::handle<TColStd_HArray1OfBoolean>          myVIso;
  occ::handle<TColStd_HArray1OfBoolean>          mySnglPnts;
  occ::handle<TColStd_HArray1OfReal>             myMaxDistance;
  occ::handle<TColStd_HArray1OfReal>             myTabInt;
  double                             myTol3d;
  ...
  occ::handle<TColStd_HArray1OfBoolean>  myResultIsPoint;
  occ::handle<TColStd_HArray1OfReal>     myResult2dUApproxError;
  occ::handle<TColStd_HArray1OfReal>     myResult2dVApproxError;
  occ::handle<TColStd_HArray1OfReal>     myResult3dApproxError;
  occ::handle<TColgp_HArray1OfPnt>       myResult3dPoint;
  occ::handle<TColgp_HArray1OfPnt2d>     myResult2dPoint;
  occ::handle<TColGeom_HArray1OfCurve>   myResult3dCurve;
  occ::handle<TColGeom2d_HArray1OfCurve> myResult2dCurve;
};
