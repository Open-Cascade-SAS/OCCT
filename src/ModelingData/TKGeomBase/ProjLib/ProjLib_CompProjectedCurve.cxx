...
ProjLib_CompProjectedCurve::ProjLib_CompProjectedCurve(const occ::handle<Adaptor3d_Surface>& theSurface,
...
ProjLib_CompProjectedCurve::ProjLib_CompProjectedCurve(const double              theTol3d,
                                                       const occ::handle<Adaptor3d_Surface>& theSurface,
                                                       const occ::handle<Adaptor3d_Curve>&   theCurve,
                                                       const double              theMaxDist)
    : mySurface(theSurface),
...
void ProjLib_CompProjectedCurve::Init()
{
  ...
  while (t <= LastU)
  {
    ...
    occ::handle<TColgp_HSequenceOfPnt> hSeq = new TColgp_HSequenceOfPnt();
...
void ProjLib_CompProjectedCurve::D2(const double t,
                                    gp_Pnt2d&           P,
                                    gp_Vec2d&           V1,
                                    gp_Vec2d&           V2) const
{
...
const occ::handle<ProjLib_HSequenceOfHSequenceOfPnt>& ProjLib_CompProjectedCurve::GetSequence() const
{
  return mySequence;
}
...
void ProjLib_CompProjectedCurve::BuildIntervals(const GeomAbs_Shape S) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> BArr = NULL, CArr = NULL, UArr = NULL, VArr = NULL;
