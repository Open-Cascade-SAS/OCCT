...
//!             Use GC_MakeSegment2d.hxx instead.
...
using GCE2d_MakeSegment Standard_DEPRECATED("GCE2d_MakeSegment is deprecated since OCCT 8.0.0. Use GC_MakeSegment2d instead.") = GC_MakeSegment2d;
