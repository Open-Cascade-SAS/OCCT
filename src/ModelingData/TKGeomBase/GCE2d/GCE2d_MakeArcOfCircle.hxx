...
//! A `GCE2d_MakeArcOfCircle` object provides a framework for:
...
public:
  ...
  Standard_EXPORT GCE2d_MakeArcOfCircle(const gp_Circ2d& theCircle,
  ...
  Standard_EXPORT GCE2d_MakeArcOfCircle(const gp_Pnt2d& theP1,
                                        const gp_Pnt2d& theP2,
