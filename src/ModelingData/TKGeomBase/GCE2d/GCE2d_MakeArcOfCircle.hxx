...
//!             Use GC_MakeArcOfCircle2d.hxx instead.
...
using GCE2d_MakeArcOfCircle Standard_DEPRECATED("GCE2d_MakeArcOfCircle is deprecated since OCCT 8.0.0. Use GC_MakeArcOfCircle2d instead.") = GC_MakeArcOfCircle2d;
