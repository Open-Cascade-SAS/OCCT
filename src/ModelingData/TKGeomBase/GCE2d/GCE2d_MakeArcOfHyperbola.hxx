...
using GCE2d_MakeArcOfHyperbola Standard_DEPRECATED("GCE2d_MakeArcOfHyperbola is deprecated since OCCT 8.0.0. Use GC_MakeArcOfHyperbola2d instead.") = GC_MakeArcOfHyperbola2d;
