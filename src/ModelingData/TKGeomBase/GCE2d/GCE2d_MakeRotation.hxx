...
//!             Use GC_MakeRotation2d.hxx instead.
...
using GCE2d_MakeRotation Standard_DEPRECATED("GCE2d_MakeRotation is deprecated since OCCT 8.0.0. Use GC_MakeRotation2d instead.") = GC_MakeRotation2d;
