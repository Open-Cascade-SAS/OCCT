...
using GCE2d_MakeTranslation Standard_DEPRECATED("GCE2d_MakeTranslation is deprecated since OCCT 8.0.0. Use GC_MakeTranslation2d instead.") = GC_MakeTranslation2d;
