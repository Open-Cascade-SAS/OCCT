...
using GCE2d_MakeArcOfEllipse Standard_DEPRECATED("GCE2d_MakeArcOfEllipse is deprecated since OCCT 8.0.0. Use GC_MakeArcOfEllipse2d instead.") = GC_MakeArcOfEllipse2d;
