...
//!             Use GC_MakeArcOfParabola2d.hxx instead.
...
using GCE2d_MakeArcOfParabola Standard_DEPRECATED("GCE2d_MakeArcOfParabola is deprecated since OCCT 8.0.0. Use GC_MakeArcOfParabola2d instead.") = GC_MakeArcOfParabola2d;
