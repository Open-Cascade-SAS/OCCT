...
public:
  ...
  [[nodiscard]] Bnd_Box2d Box(double theTol) const { return Box(myGeom->Circ2d(), theTol); }

  //! Compute bounding box for arc [theU1, theU2].
  [[nodiscard]] Bnd_Box2d Box(double theU1, double theU2, double theTol) const
  {
    return Box(myGeom->Circ2d(), theU1, theU2, theTol);
  }
  ...
  [[nodiscard]] Standard_EXPORT static Bnd_Box2d Box(const gp_Circ2d& theCirc, double theTol);

  //! Compute bounding box for a circle arc [theU1, theU2] defined by gp_Circ2d.
  [[nodiscard]] Standard_EXPORT static Bnd_Box2d Box(const gp_Circ2d& theCirc,
                                                     double           theU1,
                                                     double           theU2,
                                                     double           theTol);
