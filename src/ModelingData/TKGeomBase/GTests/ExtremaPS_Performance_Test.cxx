...
Handle(Geom_BSplineSurface) MakeDomeBSpline() {
    ...
    TColgp_Array2OfPnt poles(1, aNbPoles, 1, aNbPoles);
    ...
    TColStd_Array1OfReal uKnots(1, aNbKnots), vKnots(1, aNbKnots);
    TColStd_Array1OfInteger uMults(1, aNbKnots), vMults(1, aNbKnots);
