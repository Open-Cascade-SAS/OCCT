...
TEST_F(ExtremaPS_TorusTest, BasicProjection_PointOutsideTorusXAxis)
{
  ...
  ExtremaPS_Torus anEval(myTorus);
  ExtremaPS::Result aResult = anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(0.0, 2.0 * THE_PI, 0.0, 2.0 * THE_PI), THE_TOLERANCE);
...
TEST_F(ExtremaPS_TorusTest, SearchMode_MinOnly)
{
  ...
  ExtremaPS::Result aResult =
    anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(0.0, 2.0 * THE_PI, 0.0, 2.0 * THE_PI), THE_TOLERANCE, ExtremaPS::SearchMode::Min);
...
TEST_F(ExtremaPS_TorusTest, SearchMode_MaxOnly)
{
  ...
  ExtremaPS_Torus anEval(myTorus);
  ExtremaPS::Result aResult =
    anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(0.0, 2.0 * THE_PI, 0.0, 2.0 * THE_PI), THE_TOLERANCE, ExtremaPS::SearchMode::Max);
...
TEST_F(ExtremaPS_TorusTest, SearchMode_MinMax)
{
  ...
  ExtremaPS_Torus anEval(myTorus);
  ExtremaPS::Result aResult =
    anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(0.0, 2.0 * THE_PI, 0.0, 2.0 * THE_PI), THE_TOLERANCE, ExtremaPS::SearchMode::MinMax);
...
TEST_F(ExtremaPS_TorusTest, Boundary_PartialURange)
{
  ...
  gp_Pnt         aP(10.0, 0.0, 0.0);
  ExtremaPS_Torus anEval(myTorus);
  ExtremaPS::Result aResult = anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(0.0, THE_PI / 2.0, 0.0, 2.0 * THE_PI), THE_TOLERANCE);
...
TEST_F(ExtremaPS_TorusTest, Boundary_PartialVRange)
{
  ...
  gp_Pnt         aP(5.0, 0.0, 3.0);
  ExtremaPS_Torus anEval(myTorus);
  ExtremaPS::Result aResult = anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(0.0, 2.0 * THE_PI, 0.0, THE_PI), THE_TOLERANCE);
...
TEST_F(ExtremaPS_TorusTest, Boundary_SmallUVPatch)
{
  ...
  ExtremaPS_Torus anEval(myTorus);
  ExtremaPS::Result aResult = anEval.PerformWithBoundary(aP, ExtremaPS::Domain2D(-0.1, 0.1, -0.1, 0.1), THE_TOLERANCE);
