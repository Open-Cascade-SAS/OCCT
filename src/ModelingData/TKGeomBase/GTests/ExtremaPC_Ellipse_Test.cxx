...
TEST_F(ExtremaPC_EllipseTest, PartialArc_SecondHalf)
{
  ...
  ExtremaPC_Ellipse anEval(anEllipse);
  ExtremaPC::Result aResult = anEval.PerformWithEndpoints(aPoint, ExtremaPC::Domain1D{THE_PI, THE_2PI}, THE_TOL);
...
TEST_F(ExtremaPC_EllipseTest, NarrowRange_VerySmall)
{
  ...
  ExtremaPC_Ellipse anEval(anEllipse);
  ExtremaPC::Result aResult = anEval.PerformWithEndpoints(aPoint, ExtremaPC::Domain1D{aUMin, aUMax}, THE_TOL);
