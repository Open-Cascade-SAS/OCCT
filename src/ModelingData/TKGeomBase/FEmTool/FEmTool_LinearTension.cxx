...
occ::handle<TColStd_HArray2OfInteger> FEmTool_LinearTension::DependenceTable() const
{
  if (myCoeff.IsNull())
    throw Standard_DomainError("FEmTool_LinearTension::DependenceTable");

  occ::handle<TColStd_HArray2OfInteger> DepTab = new TColStd_HArray2OfInteger(myCoeff->LowerCol(),
                                                                         myCoeff->UpperCol(),
                                                                         myCoeff->LowerCol(),
                                                                         myCoeff->UpperCol(),
                                                                         0);
...
double FEmTool_LinearTension::Value()
{
  ...
  double coeff = (myLast - myFirst) / 2., cteh3 = 2. / coeff, mfact, Jline;
                                    ...
                                    math_Matrix&           H)
{
  ...
  occ::handle<TColStd_HArray2OfInteger> DepTab = DependenceTable();
