...
public:
  ...
  Standard_EXPORT FEmTool_Assembly(const NCollection_Array2<int>&        Dependence,
  ...
  Standard_EXPORT void AddVector(const int Element,
                                 const int Dimension,
  ...
  Standard_EXPORT void GetAssemblyTable(occ::handle<FEmTool_HAssemblyTable>& AssTable) const;

private:
  NCollection_Array2<int>        myDepTable;
  occ::handle<FEmTool_HAssemblyTable> myRefTable;
  bool               IsSolved;
  occ::handle<FEmTool_ProfileMatrix>  H;
  math_Vector                    B;
  occ::handle<FEmTool_ProfileMatrix>  GHGt;
  NCollection_Sequence<NCollection_List<occ::handle<TColStd_HArray1OfReal>>>         G;
