                                ...
                                AdvApp2Var_Node&                    NodeEnd)
{
  ...
  occ::handle<TColStd_HArray1OfReal> HCOURBE = new TColStd_HArray1OfReal(1, SZCRB * (IDERIV + 1));
  double*                COURBE = (double*)&HCOURBE->ChangeArray1()(HCOURBE->Lower());
  double*                CRBAPP = COURBE;
  int              SZTAB  = (1 + NBROOT / 2) * NDIMEN;
  occ::handle<TColStd_HArray1OfReal> HSOMTAB = new TColStd_HArray1OfReal(1, SZTAB * (IDERIV + 1));
  double*                SOMTAB = (double*)&HSOMTAB->ChangeArray1()(HSOMTAB->Lower());
  double*                SOMAPP = SOMTAB;
  occ::handle<TColStd_HArray1OfReal> HDIFTAB = new TColStd_HArray1OfReal(1, SZTAB * (IDERIV + 1));
  double*                DIFTAB = (double*)&HDIFTAB->ChangeArray1()(HDIFTAB->Lower());
  double*                DIFAPP = DIFTAB;
  occ::handle<TColStd_HArray1OfReal> HCONTR1 = new TColStd_HArray1OfReal(1, (IORDRE + 2) * NDIMEN);
  double*                CONTR1 = (double*)&HCONTR1->ChangeArray1()(HCONTR1->Lower());
  occ::handle<TColStd_HArray1OfReal> HCONTR2 = new TColStd_HArray1OfReal(1, (IORDRE + 2) * NDIMEN);
  double*                CONTR2 = (double*)&HCONTR2->ChangeArray1()(HCONTR2->Lower());
  occ::handle<TColStd_HArray2OfReal> HERRMAX = new TColStd_HArray2OfReal(1, NBSESP, 1, IDERIV + 1);
  double*                EMXAPP  = new double[NBSESP];
  occ::handle<TColStd_HArray2OfReal> HERRMOY = new TColStd_HArray2OfReal(1, NBSESP, 1, IDERIV + 1);
  // #ifdef OCCT_DEBUG
  // double *ERRMOY =
  // #endif
...
const occ::handle<TColStd_HArray1OfReal>& AdvApp2Var_Iso::Polynom() const
{
  return myEquation;
}

occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Iso::SomTab() const
{
  return mySomTab;
}

occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Iso::DifTab() const
{
  return myDifTab;
}

occ::handle<TColStd_HArray2OfReal> AdvApp2Var_Iso::MaxErrors() const
{
  return myMaxErrors;
}

occ::handle<TColStd_HArray2OfReal> AdvApp2Var_Iso::MoyErrors() const
{
  return myMoyErrors;
}
