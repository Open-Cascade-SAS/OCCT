...
AdvApp2Var_ApproxAFunc2Var::AdvApp2Var_ApproxAFunc2Var(
  ...
  const occ::handle<TColStd_HArray2OfReal>& OneDTolFr,
  const occ::handle<TColStd_HArray2OfReal>& TwoDTolFr,
  const occ::handle<TColStd_HArray2OfReal>& ThreeDTolFr,
                                                    ...
                                                    const AdvApp2Var_EvaluatorFunc2Var& Func)
{
  ...
  for (occ::handle<AdvApp2Var_Iso> anIso = myConstraints.FirstNotApprox(ind1, ind2); !anIso.IsNull();
...
void AdvApp2Var_ApproxAFunc2Var::ConvertBS()
{
  ...
  occ::handle<TColStd_HArray1OfReal> Uint1 = new (TColStd_HArray1OfReal)(1, 2);
  Uint1->SetValue(1, -1);
  Uint1->SetValue(2, 1);
  occ::handle<TColStd_HArray1OfReal> Vint1 = new (TColStd_HArray1OfReal)(1, 2);
  Vint1->SetValue(1, -1);
  Vint1->SetValue(2, 1);

  occ::handle<TColStd_HArray1OfReal> Uint2 = new (TColStd_HArray1OfReal)(1, myResult.NbPatchInU() + 1);
  for (j = 1; j <= Uint2->Length(); j++)
  {
    Uint2->SetValue(j, myResult.UParameter(j));
  }
  occ::handle<TColStd_HArray1OfReal> Vint2 = new (TColStd_HArray1OfReal)(1, myResult.NbPatchInV() + 1);
  ...
  occ::handle<TColStd_HArray2OfInteger> NbCoeff = new (TColStd_HArray2OfInteger)(1, nmax, 1, 2);
  occ::handle<TColStd_HArray1OfReal>    Poly    = new (TColStd_HArray1OfReal)(1, nmax * Size_eq);
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_ApproxAFunc2Var::MaxError(
  const int Dimension) const
{
  occ::handle<TColStd_HArray1OfReal> EPtr;
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_ApproxAFunc2Var::AverageError(
  const int Dimension) const
{
  occ::handle<TColStd_HArray1OfReal> EPtr;
  if (Dimension < 1 || Dimension > 3)
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_ApproxAFunc2Var::UFrontError(
  const int Dimension) const
{
  occ::handle<TColStd_HArray1OfReal> EPtr;
  if (Dimension < 1 || Dimension > 3)
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_ApproxAFunc2Var::VFrontError(
  const int Dimension) const
{
  occ::handle<TColStd_HArray1OfReal> EPtr;
...
double AdvApp2Var_ApproxAFunc2Var::MaxError(const int Dimension,
                                                   const int SSPIndex) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> EPtr = MaxError(Dimension);
  return EPtr->Value(SSPIndex);
}

//=================================================================================================

double AdvApp2Var_ApproxAFunc2Var::AverageError(const int Dimension,
                                                       const int SSPIndex) const
{
  if (Dimension != 3 || SSPIndex != 1)
  {
  ...
  occ::handle<TColStd_HArray1OfReal> EPtr = AverageError(Dimension);
  return EPtr->Value(SSPIndex);
}

//=================================================================================================

double AdvApp2Var_ApproxAFunc2Var::UFrontError(const int Dimension,
                                                      const int SSPIndex) const
{
  if (Dimension != 3 || SSPIndex != 1)
  {
  ...
  occ::handle<TColStd_HArray1OfReal> EPtr = UFrontError(Dimension);
  return EPtr->Value(SSPIndex);
}

//=================================================================================================

double AdvApp2Var_ApproxAFunc2Var::VFrontError(const int Dimension,
                                                      const int SSPIndex) const
{
  if (Dimension != 3 || SSPIndex != 1)
  {
  ...
  occ::handle<TColStd_HArray1OfReal> EPtr = VFrontError(Dimension);
  return EPtr->Value(SSPIndex);
}

//=================================================================================================

double AdvApp2Var_ApproxAFunc2Var::CritError(const int Dimension,
                                                    const int SSPIndex) const
{
  if (Dimension != 3 || SSPIndex != 1)
  {
...
void AdvApp2Var_ApproxAFunc2Var::Dump(Standard_OStream& o) const
{
  ...
  else
  {
    ...
    o << "Degree of Bezier patches in U : " << myDegreeInU << "  in V : " << myDegreeInV
      << std::endl;
    o << std::endl;
    occ::handle<Geom_BSplineSurface> S = occ::down_cast<Geom_BSplineSurface>(mySurfaces->Value(iesp));
