                                  ...
                                  const AdvApp2Var_EvaluatorFunc2Var& Func)
{
  ...
  occ::handle<TColStd_HArray1OfReal> HUROOT = Conditions.URoots();
  occ::handle<TColStd_HArray1OfReal> HVROOT = Conditions.VRoots();
  double*                UROOT;
  ...
  occ::handle<TColStd_HArray1OfReal> HCOINS = new TColStd_HArray1OfReal(1, SIZE * 4);
  HCOINS->Init(0.);
  ...
  occ::handle<TColStd_HArray1OfReal> HSU0 = new TColStd_HArray1OfReal(1, SIZE * (IORDRU + 1));
  HSU0->ChangeArray1()               = ((Constraints.IsoU(myU0, myV0, myV1)).SomTab())->Array1();

  occ::handle<TColStd_HArray1OfReal> HDU0 = new TColStd_HArray1OfReal(1, SIZE * (IORDRU + 1));
  HDU0->ChangeArray1()               = ((Constraints.IsoU(myU0, myV0, myV1)).DifTab())->Array1();

  occ::handle<TColStd_HArray1OfReal> HSU1 = new TColStd_HArray1OfReal(1, SIZE * (IORDRU + 1));
  HSU1->ChangeArray1()               = ((Constraints.IsoU(myU1, myV0, myV1)).SomTab())->Array1();

  occ::handle<TColStd_HArray1OfReal> HDU1 = new TColStd_HArray1OfReal(1, SIZE * (IORDRU + 1));
  ...
  occ::handle<TColStd_HArray1OfReal> HSV0 = new TColStd_HArray1OfReal(1, SIZE * (IORDRV + 1));
  HSV0->ChangeArray1()               = ((Constraints.IsoV(myU0, myU1, myV0)).SomTab())->Array1();

  occ::handle<TColStd_HArray1OfReal> HDV0 = new TColStd_HArray1OfReal(1, SIZE * (IORDRV + 1));
  HDV0->ChangeArray1()               = ((Constraints.IsoV(myU0, myU1, myV0)).DifTab())->Array1();

  occ::handle<TColStd_HArray1OfReal> HSV1 = new TColStd_HArray1OfReal(1, SIZE * (IORDRV + 1));
  HSV1->ChangeArray1()               = ((Constraints.IsoV(myU0, myU1, myV1)).SomTab())->Array1();

  occ::handle<TColStd_HArray1OfReal> HDV1 = new TColStd_HArray1OfReal(1, SIZE * (IORDRV + 1));
  ...
  occ::handle<TColStd_HArray1OfReal> HSOSO  = new TColStd_HArray1OfReal(1, SIZE);
  double*                SOSOTB = (double*)&HSOSO->ChangeArray1()(HSOSO->Lower());
  HSOSO->Init(0.);
  occ::handle<TColStd_HArray1OfReal> HDIDI  = new TColStd_HArray1OfReal(1, SIZE);
  ...
  occ::handle<TColStd_HArray1OfReal> HSODI  = new TColStd_HArray1OfReal(1, SIZE);
  double*                SODITB = (double*)&HSODI->ChangeArray1()(HSODI->Lower());
  HSODI->Init(0.);
  occ::handle<TColStd_HArray1OfReal> HDISO  = new TColStd_HArray1OfReal(1, SIZE);
  ...
  occ::handle<TColStd_HArray1OfReal> HTABLE = new TColStd_HArray1OfReal(1, SIZE);
  double*                TAB    = (double*)&HTABLE->ChangeArray1()(HTABLE->Lower());

  occ::handle<TColStd_HArray1OfReal> HPOINTS = new TColStd_HArray1OfReal(1, SIZE * NDIMEN);
                                      ...
                                      const AdvApp2Var_Framework& Constraints)
{
  ...
  occ::handle<TColStd_HArray1OfReal> HHERMV =
  ...
  occ::handle<TColStd_HArray1OfReal> HHERMU =
  ...
  occ::handle<TColStd_HArray1OfReal> HEXTR  = new TColStd_HArray1OfReal(1, 2 * IORDMX + 2);
  double*                EXTR   = (double*)&HEXTR->ChangeArray1()(HEXTR->Lower());
  occ::handle<TColStd_HArray1OfReal> HFACT  = new TColStd_HArray1OfReal(1, IORDMX + 1);
...
void AdvApp2Var_Patch::AddErrors(const AdvApp2Var_Framework& Constraints)
{
  ...
  for (iesp = 1; iesp <= NBSESP; iesp++)
  {
    ...
    occ::handle<TColStd_HArray2OfReal> HERISO = new TColStd_HArray2OfReal(1, NBSESP, 1, 4);
                                  ...
                                  const int      NumDec)
{
  ...
  occ::handle<TColStd_HArray1OfReal> HEPSAPR = new TColStd_HArray1OfReal(1, NBSESP);
  occ::handle<TColStd_HArray1OfReal> HEPSFRO = new TColStd_HArray1OfReal(1, NBSESP * 8);
  int              iesp;
  for (iesp = 1; iesp <= NBSESP; iesp++)
  {
  ...
  occ::handle<TColStd_HArray1OfReal> HPJAC   = new TColStd_HArray1OfReal(1, SIZE);
  double*                PATJAC  = (double*)&HPJAC->ChangeArray1()(HPJAC->Lower());
  SIZE                                  = 2 * SIZE;
  occ::handle<TColStd_HArray1OfReal> HPAUX   = new TColStd_HArray1OfReal(1, SIZE);
  double*                PATAUX  = (double*)&HPAUX->ChangeArray1()(HPAUX->Lower());
  SIZE                                  = NCFLMU * NCFLMV * NDIMEN;
  occ::handle<TColStd_HArray1OfReal> HPCAN   = new TColStd_HArray1OfReal(1, SIZE);
  double*                PATCAN  = (double*)&HPCAN->ChangeArray1()(HPCAN->Lower());
  occ::handle<TColStd_HArray1OfReal> HERRMAX = new TColStd_HArray1OfReal(1, NBSESP);
  double*                ERRMAX = (double*)&HERRMAX->ChangeArray1()(HERRMAX->Lower());
  occ::handle<TColStd_HArray1OfReal> HERRMOY = new TColStd_HArray1OfReal(1, NBSESP);
...
void AdvApp2Var_Patch::ChangeDomain(const double a,
                                    const double b,
                                    const double c,
                                    const double d)
{
...
int AdvApp2Var_Patch::CutSense(const AdvApp2Var_Criterion& Crit,
...
void AdvApp2Var_Patch::ChangeNbCoeff(const int NbCoeffU,
                                     const int NbCoeffV)
{
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Patch::MaxErrors() const
{
  return myMaxErrors;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Patch::AverageErrors() const
{
  return myMoyErrors;
}
...
occ::handle<TColStd_HArray2OfReal> AdvApp2Var_Patch::IsoErrors() const
{
  return myIsoErrors;
}
...
occ::handle<TColgp_HArray2OfPnt> AdvApp2Var_Patch::Poles(const int    SSPIndex,
                                                    const AdvApp2Var_Context& Cond) const
{
  occ::handle<TColStd_HArray1OfReal> SousEquation;
  ...
  occ::handle<TColStd_HArray1OfReal> Intervalle = new (TColStd_HArray1OfReal)(1, 2);
  Intervalle->SetValue(1, -1);
  Intervalle->SetValue(2, 1);

  occ::handle<TColStd_HArray1OfInteger> NbCoeff = new (TColStd_HArray1OfInteger)(1, 2);
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Patch::Coefficients(const int    SSPIndex,
                                                             const AdvApp2Var_Context& Cond) const
{
  occ::handle<TColStd_HArray1OfReal> SousEquation;
  if (Cond.TotalNumberSSP() == 1 && SSPIndex == 1)
