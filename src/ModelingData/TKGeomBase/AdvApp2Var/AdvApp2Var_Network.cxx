...
{
  int anIndex = 1;
  for (NCollection_Sequence<occ::handle<AdvApp2Var_Patch>>::Iterator aPatchIter(myNet); aPatchIter.More();
                                    ...
                                    int&      ncfv)
{
  ...
  ncfu = 2 * iu + 2;
  ncfv = 2 * iv + 2;
  for (NCollection_Sequence<occ::handle<AdvApp2Var_Patch>>::Iterator aPatIter(myNet); aPatIter.More(); aPatIter.Next())
  {
