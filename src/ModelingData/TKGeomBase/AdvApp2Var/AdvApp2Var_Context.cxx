...
AdvApp2Var_Context::AdvApp2Var_Context(const int               ifav,
                                       ...
                                       const int               nb2Dss,
                                       const int               nb3Dss,
                                       const occ::handle<TColStd_HArray1OfReal>& tol1D,
                                       const occ::handle<TColStd_HArray1OfReal>& tol2D,
                                       const occ::handle<TColStd_HArray1OfReal>& tol3D,
                                       const occ::handle<TColStd_HArray2OfReal>& tof1D,
                                       const occ::handle<TColStd_HArray2OfReal>& tof2D,
                                       const occ::handle<TColStd_HArray2OfReal>& tof3D)
    : myFav(ifav),
      myOrdU(iu),
      myOrdV(iv),
      myLimU(nlimu),
      ...
      myNb3DSS(nb3Dss)
{
  ...
  occ::handle<TColStd_HArray1OfReal> JMaxU    = new TColStd_HArray1OfReal(1, size);
  ...
  // myJMaxV
  size                                   = JDegV - 2 * iv - 1;
  occ::handle<TColStd_HArray1OfReal> JMaxV    = new TColStd_HArray1OfReal(1, size);
  double*                JV_array = (double*)&JMaxV->ChangeArray1()(JMaxV->Lower());
  AdvApp2Var_ApproxF2var::mma2jmx_(&JDegV, (integer*)&iv, JV_array);
  myJMaxV = JMaxV;

  // myURoots, myVRoots
  occ::handle<TColStd_HArray1OfReal> URoots  = new TColStd_HArray1OfReal(1, myNbURoot);
  double*                U_array = (double*)&URoots->ChangeArray1()(URoots->Lower());
  occ::handle<TColStd_HArray1OfReal> VRoots  = new TColStd_HArray1OfReal(1, myNbVRoot);
  ...
  occ::handle<TColStd_HArray1OfReal> UGauss   = new TColStd_HArray1OfReal(1, size);
  ...
  occ::handle<TColStd_HArray1OfReal> VGauss   = new TColStd_HArray1OfReal(1, size);
  ...
  occ::handle<TColStd_HArray1OfReal> ITol = new TColStd_HArray1OfReal(1, nbss);
  for (i = 1; i <= nb1Dss; i++)
  {
  ...
  occ::handle<TColStd_HArray2OfReal> FTol = new TColStd_HArray2OfReal(1, nbss, 1, 4);
  occ::handle<TColStd_HArray2OfReal> CTol = new TColStd_HArray2OfReal(1, nbss, 1, 4);
  for (i = 1; i <= nb1Dss; i++)
  {
    for (j = 1; j <= 4; j++)
    {
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::UJacMax() const
{
  return myJMaxU;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::VJacMax() const
{
  return myJMaxV;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::URoots() const
{
  return myURoots;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::VRoots() const
{
  return myVRoots;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::UGauss() const
{
  return myUGauss;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::VGauss() const
{
  return myVGauss;
}
...
occ::handle<TColStd_HArray1OfReal> AdvApp2Var_Context::IToler() const
{
...
occ::handle<TColStd_HArray2OfReal> AdvApp2Var_Context::FToler() const
{
...
occ::handle<TColStd_HArray2OfReal> AdvApp2Var_Context::CToler() const
{
  return myCuttingTol;
}
