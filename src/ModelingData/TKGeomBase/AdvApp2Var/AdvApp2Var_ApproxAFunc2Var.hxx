...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> UFrontError(const int Dimension) const;

  //! returns the errors max on VFrontiers
  //! Warning:
  //! Dimension must be equal to 3.
  Standard_EXPORT occ::handle<TColStd_HArray1OfReal> VFrontError(const int Dimension) const;
...
private:
  ...
  occ::handle<TColStd_HArray2OfReal>     my1DTolOnFront;
  occ::handle<TColStd_HArray2OfReal>     my2DTolOnFront;
  occ::handle<TColStd_HArray2OfReal>     my3DTolOnFront;
  ...
  bool                  myDone;
  bool                  myHasResult;
  occ::handle<TColGeom_HArray1OfSurface> mySurfaces;
  int                  myDegreeInU;
  int                  myDegreeInV;
  occ::handle<TColStd_HArray1OfReal>     my1DMaxError;
  occ::handle<TColStd_HArray1OfReal>     my1DAverageError;
  occ::handle<TColStd_HArray1OfReal>     my1DUFrontError;
  occ::handle<TColStd_HArray1OfReal>     my1DVFrontError;
  occ::handle<TColStd_HArray1OfReal>     my2DMaxError;
  occ::handle<TColStd_HArray1OfReal>     my2DAverageError;
  occ::handle<TColStd_HArray1OfReal>     my2DUFrontError;
  occ::handle<TColStd_HArray1OfReal>     my2DVFrontError;
  occ::handle<TColStd_HArray1OfReal>     my3DMaxError;
  occ::handle<TColStd_HArray1OfReal>     my3DAverageError;
  occ::handle<TColStd_HArray1OfReal>     my3DUFrontError;
  occ::handle<TColStd_HArray1OfReal>     my3DVFrontError;
