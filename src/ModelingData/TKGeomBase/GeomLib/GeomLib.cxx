...
void GeomLib::RemovePointsFromArray(const int         NumPoints,
                                    ...
                                    occ::handle<TColStd_HArray1OfReal>& OutParameters)
{
...

{
  ...
  // Entree
  //
  occ::handle<TColStd_HArray1OfReal> Tolerance1DPtr, Tolerance2DPtr;
  occ::handle<TColStd_HArray1OfReal> Tolerance3DPtr = new TColStd_HArray1OfReal(1, 1);
                                 ...
                                 const bool       After)
{
  ...
  double*                Padr = NULL;
  bool              Ok;
  occ::handle<TColStd_HArray1OfReal> FKnots, Point, lambda, Tgte, Poles;
  ...
  double                 ww;
  bool              ExtOk = false;
  occ::handle<TColgp_HArray2OfPnt>   NewPoles;
  occ::handle<TColStd_HArray2OfReal> NewWeights;
...
static void BuildFlatKnot(const NCollection_Array1<double>&       surface_knots,
                          ...
                          occ::handle<TColStd_HArray1OfReal>&    ResultKnots,
                          occ::handle<TColStd_HArray1OfInteger>& ResultMults)
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          occ::handle<TColStd_HArray1OfReal>    IntermedKnots;
          occ::handle<TColStd_HArray1OfInteger> IntermedMults;
          AddAKnot(surface_knots,
                   surface_mults,
                   knotmin,
                   deltasurface_degree,
...

{
  ...
  occ::handle<TColStd_HArray1OfReal>    newuknots, newvknots;
  occ::handle<TColStd_HArray1OfInteger> newumults, newvmults;
