...
private:
  ...
  bool makeApproximation(Geom2dConvert_PPoint& theFirstParam,
                                     Geom2dConvert_PPoint& theLastParam);

  //! Method for calculation of a biarc.
  bool calculateBiArcs(Geom2dConvert_PPoint& theFirstParam,
                                   Geom2dConvert_PPoint& theLastParam);

  //! Method for calculation of a linear interpolation.
  bool calculateLines(Geom2dConvert_PPoint& theFirstParam,
                                  Geom2dConvert_PPoint& theLastParam);
