...
#ifndef _GC_MakeTranslation2d_HeaderFile
#define _GC_MakeTranslation2d_HeaderFile
...
public:
  ...
  Standard_EXPORT GC_MakeTranslation2d(const gp_Vec2d& theVect);
  ...
  Standard_EXPORT GC_MakeTranslation2d(const gp_Pnt2d& thePoint1, const gp_Pnt2d& thePoint2);
...
#endif // _GC_MakeTranslation2d_HeaderFile
