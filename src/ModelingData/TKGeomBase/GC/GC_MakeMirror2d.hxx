...
#ifndef _GC_MakeMirror2d_HeaderFile
#define _GC_MakeMirror2d_HeaderFile
...
public:
  ...
  Standard_EXPORT GC_MakeMirror2d(const gp_Pnt2d& thePoint);

  //! Constructs an axial symmetry about an axis.
  //! @param[in] theAxis symmetry axis
  Standard_EXPORT GC_MakeMirror2d(const gp_Ax2d& theAxis);

  //! Constructs an axial symmetry about a line.
  //! @param[in] theLine symmetry line
  Standard_EXPORT GC_MakeMirror2d(const gp_Lin2d& theLine);
  ...
  Standard_EXPORT GC_MakeMirror2d(const gp_Pnt2d& thePoint, const gp_Dir2d& theDirec);
...
#endif // _GC_MakeMirror2d_HeaderFile
