...
public:
  ...
  Standard_EXPORT AppParCurves_Constraint
    FirstConstraint(const occ::handle<AppParCurves_HArray1OfConstraintCouple>& TheConstraints,
                    const int                                FirstPoint) const;

  Standard_EXPORT AppParCurves_Constraint
    LastConstraint(const occ::handle<AppParCurves_HArray1OfConstraintCouple>& TheConstraints,
...
private:
  ...
  int                               Adeb;
  int                               Afin;
  occ::handle<TColStd_HArray1OfInteger>               tabdim;
  double                                  ERR3d;
  double                                  ERR2d;
  int                               FirstP;
  int                               LastP;
  occ::handle<AppParCurves_HArray1OfConstraintCouple> myConstraints;
};
