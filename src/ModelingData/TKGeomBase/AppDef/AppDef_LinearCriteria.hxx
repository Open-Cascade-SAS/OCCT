...
public:
  ...
  Standard_EXPORT void SetParameters(const occ::handle<TColStd_HArray1OfReal>& Parameters)
    override;
  ...
  Standard_EXPORT void SetEstimation(const double E1,
                                     const double E2,
                                     const double E3) override;

  Standard_EXPORT double& EstLength() override;

  Standard_EXPORT void GetEstimation(double& E1,
                                     double& E2,
                                     double& E3) const override;

  Standard_EXPORT occ::handle<FEmTool_HAssemblyTable> AssemblyTable() const override;

  Standard_EXPORT occ::handle<TColStd_HArray2OfInteger> DependenceTable() const override;
  ...
  Standard_EXPORT void Gradient(const int Element,
                                const int Dimension,
  ...
  Standard_EXPORT void GetWeight(double& QuadraticWeight,
                                 double& QualityWeight) const override;
...
private:
  ...
  occ::handle<TColStd_HArray1OfReal>       myCache;
