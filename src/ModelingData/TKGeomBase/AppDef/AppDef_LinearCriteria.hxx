...
public:
  ...
  Standard_EXPORT void SetParameters(const occ::handle<NCollection_HArray1<double>>& Parameters)
    override;
  ...
  Standard_EXPORT occ::handle<NCollection_HArray2<occ::handle<NCollection_HArray1<int>>>> AssemblyTable() const override;
