...
private:
  occ::handle<TColgp_HArray1OfVec>   tabTang;
  occ::handle<TColgp_HArray1OfVec>   tabCurv;
  occ::handle<TColgp_HArray1OfVec2d> tabTang2d;
  occ::handle<TColgp_HArray1OfVec2d> tabCurv2d;
};
