...
public:
  ...
  Standard_EXPORT const occ::handle<TColStd_HArray1OfReal>& Parameters() const;

  //! returns the knots uses to the approximations
  Standard_EXPORT const occ::handle<TColStd_HArray1OfReal>& Knots() const;
  ...
  Standard_EXPORT bool
    SetConstraints(const occ::handle<AppParCurves_HArray1OfConstraintCouple>& aConstrainst);

  //! Defines the parameters used by the approximations.
  Standard_EXPORT void SetParameters(const occ::handle<TColStd_HArray1OfReal>& param);

  //! Defines the knots used by the approximations
  //! If this value is incompatible with the others fields
  //! this method modify nothing and returns false
  Standard_EXPORT bool SetKnots(const occ::handle<TColStd_HArray1OfReal>& knots);
...
private:
  ...
  int                               myLastPoint;
  int                               myNbPoints;
  occ::handle<TColStd_HArray1OfReal>                  myTabPoints;
  occ::handle<AppParCurves_HArray1OfConstraintCouple> myConstraints;
  int                               myNbConstraints;
  occ::handle<TColStd_HArray1OfReal>                  myTabConstraints;
  int                               myNbPassPoints;
  int                               myNbTangPoints;
  int                               myNbCurvPoints;
  occ::handle<TColStd_HArray1OfInteger>               myTypConstraints;
  occ::handle<TColStd_HArray1OfReal>                  myTtheta;
  occ::handle<TColStd_HArray1OfReal>                  myTfthet;
  int                               myMaxDegree;
  int                               myMaxSegment;
  int                               myNbIterations;
  double                                  myTolerance;
