...
public:
  Standard_EXPORT virtual void SetParameters(const occ::handle<TColStd_HArray1OfReal>& Parameters) = 0;
  ...
  Standard_EXPORT virtual void SetEstimation(const double E1,
                                             const double E2,
                                             const double E3) = 0;

  Standard_EXPORT virtual double& EstLength() = 0;

  Standard_EXPORT virtual void GetEstimation(double& E1,
                                             double& E2,
                                             double& E3) const = 0;

  Standard_EXPORT virtual occ::handle<FEmTool_HAssemblyTable> AssemblyTable() const = 0;

  Standard_EXPORT virtual occ::handle<TColStd_HArray2OfInteger> DependenceTable() const = 0;
  ...
  Standard_EXPORT virtual void Gradient(const int Element,
                                        const int Dimension,
                                        math_Vector&           G) = 0;

  //! Convert the assembly Vector in an Curve;
  Standard_EXPORT virtual void InputVector(const math_Vector&                    X,
                                           const occ::handle<FEmTool_HAssemblyTable>& AssTable) = 0;
  ...
  Standard_EXPORT virtual void GetWeight(double& QuadraticWeight,
                                         double& QualityWeight) const = 0;
