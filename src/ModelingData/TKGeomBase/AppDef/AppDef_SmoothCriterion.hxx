...
public:
  Standard_EXPORT virtual void SetParameters(const occ::handle<NCollection_HArray1<double>>& Parameters) = 0;
  ...
  Standard_EXPORT virtual occ::handle<NCollection_HArray2<occ::handle<NCollection_HArray1<int>>>> AssemblyTable() const = 0;
