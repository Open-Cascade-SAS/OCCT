...
{
public:
  Approx_Curve2d_Eval(const occ::handle<Adaptor2d_Curve2d>& theFunc,
                      double                    First,
                      double                    Last)
      : fonct(theFunc)
  {
                               ...
                               const int           MaxSegments)
{
  ...
  occ::handle<TColStd_HArray1OfReal> TwoDTolNul, ThreeDTolNul;
  occ::handle<TColStd_HArray1OfReal> OneDTol = new TColStd_HArray1OfReal(1, Num1DSS);
