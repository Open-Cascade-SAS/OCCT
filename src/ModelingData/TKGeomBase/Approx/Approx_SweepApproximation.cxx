                                        ...
                                        const int Segmax)
{
  ...
  occ::handle<TColStd_HArray1OfReal> OneDTol, TwoDTol, ThreeDTol;
  Num3DSS = NbPolSect;
...
void Approx_SweepApproximation::Approximation(const occ::handle<TColStd_HArray1OfReal>& OneDTol,
  ...
  if (done)
  {
    ...
    if (Num2DSS > 0)
    {
      ...
      for (ii = 1; ii <= Num2DSS; ii++)
      {
        ...
        occ::handle<TColgp_HArray1OfPnt2d> P2d = new (TColgp_HArray1OfPnt2d)(1, Approx.NbPoles());
