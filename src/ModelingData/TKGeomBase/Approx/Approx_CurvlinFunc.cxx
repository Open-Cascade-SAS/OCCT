...
static void findfourpoints(const double,
                           int                     NInterval,
                           const occ::handle<TColStd_HArray1OfReal>& Si,
                           occ::handle<TColStd_HArray1OfReal>&       Ui,
                           const double                  prevS,
                           const double                  prevU,
                           double*                       Xi,
                           double*                       Yi)
...
void Approx_CurvlinFunc::Init(Adaptor3d_Curve&               C,
                              occ::handle<TColStd_HArray1OfReal>& Si,
                              occ::handle<TColStd_HArray1OfReal>& Ui) const
{
                                                ...
                                                const int NumberOfCurve) const
{
  ...
  occ::handle<TColStd_HArray1OfReal> InitUArray, InitSArray;
#ifdef OCCT_DEBUG_CHRONO
