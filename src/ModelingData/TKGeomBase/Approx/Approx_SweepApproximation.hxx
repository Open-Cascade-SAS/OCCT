...
private:
  Standard_EXPORT void Approximation(const occ::handle<TColStd_HArray1OfReal>& OneDTol,
  ...
  int                 vdeg;
  int                 deg2d;
  occ::handle<TColgp_HArray2OfPnt>      tabPoles;
  occ::handle<TColStd_HArray2OfReal>    tabWeights;
  occ::handle<TColStd_HArray1OfReal>    tabUKnots;
  occ::handle<TColStd_HArray1OfReal>    tabVKnots;
  occ::handle<TColStd_HArray1OfReal>    tab2dKnots;
  occ::handle<TColStd_HArray1OfInteger> tabUMults;
  occ::handle<TColStd_HArray1OfInteger> tabVMults;
  occ::handle<TColStd_HArray1OfInteger> tab2dMults;
  NCollection_Sequence<occ::handle<TColgp_HArray1OfPnt2d>>   seqPoles2d;
  occ::handle<TColStd_HArray1OfReal>    MError1d;
  occ::handle<TColStd_HArray1OfReal>    tab2dError;
  occ::handle<TColStd_HArray1OfReal>    MError3d;
  occ::handle<TColStd_HArray1OfReal>    AError1d;
  occ::handle<TColStd_HArray1OfReal>    Ave2dError;
  occ::handle<TColStd_HArray1OfReal>    AError3d;
  occ::handle<Approx_HArray1OfGTrsf2d>  AAffin;
  occ::handle<TColStd_HArray1OfReal>    COnSurfErr;
  gp_Vec                           Translation;
  occ::handle<TColgp_HArray1OfPnt>      myPoles;
  occ::handle<TColgp_HArray1OfPnt2d>    myPoles2d;
  occ::handle<TColStd_HArray1OfReal>    myWeigths;
  occ::handle<TColgp_HArray1OfVec>      myDPoles;
  occ::handle<TColgp_HArray1OfVec>      myD2Poles;
  occ::handle<TColgp_HArray1OfVec2d>    myDPoles2d;
  occ::handle<TColgp_HArray1OfVec2d>    myD2Poles2d;
  occ::handle<TColStd_HArray1OfReal>    myDWeigths;
  occ::handle<TColStd_HArray1OfReal>    myD2Weigths;
  int                 myOrder;
  double                    myParam;
  double                    first;
  double                    last;
