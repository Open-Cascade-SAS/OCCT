...
private:
  ...
  double                 myPrevS;
  double                 myPrevU;
  occ::handle<TColStd_HArray1OfReal> myUi_1;
  occ::handle<TColStd_HArray1OfReal> mySi_1;
  occ::handle<TColStd_HArray1OfReal> myUi_2;
  occ::handle<TColStd_HArray1OfReal> mySi_2;
};
