...
public:
    ...
    ExtremaSS::SearchMode theMode = ExtremaSS::SearchMode::MinMax) const
  {
    ...
    {
      const gp_Pnt aPt1(myCenter1X + myRadius1 * aDirX,
                        myCenter1Y + myRadius1 * aDirY,
                        myCenter1Z + myRadius1 * aDirZ);
      const gp_Pnt aPt2(myCenter2X - myRadius2 * aDirX,
                        myCenter2Y - myRadius2 * aDirY,
...
private:
                                     ...
                                     double& theV)
  {
    ...
    if (std::abs(aCosV) > theTol)
    {
      ...
      const double aCosU =
        (theDirX * theXDirX + theDirY * theXDirY + theDirZ * theXDirZ) * aInvCosV;
      const double aSinU =
        (theDirX * theYDirX + theDirY * theYDirY + theDirZ * theYDirZ) * aInvCosV;
  ...
  void checkPointAgainstSphere2(double                theU1,
                                double                theV1,
                                double                theTol,
  ...
  void checkPointAgainstSphere1(double                theU2,
                                double                theV2,
                                double                theTol,
                                ExtremaSS::SearchMode theMode) const
  {
