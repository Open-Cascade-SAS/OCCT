...
ExtremaPC::Result ExtremaPC_OffsetCurve::Perform(const gp_Pnt&              theP,
...
ExtremaPC::Result ExtremaPC_OffsetCurve::PerformWithEndpoints(const gp_Pnt&              theP,
                                                              const ExtremaPC::Domain1D& theDomain,
                                                              double                     theTol,
                                                              ExtremaPC::SearchMode      theMode) const
{
...
void ExtremaPC_OffsetCurve::updateCacheIfNeeded(const ExtremaPC::Domain1D& theDomain) const
{
...
ExtremaPC::Result ExtremaPC_OffsetCurve::performInterior(const gp_Pnt&              theP,
                                                         const ExtremaPC::Domain1D& theDomain,
                                                         double                     theTol,
                                                         ExtremaPC::SearchMode      theMode) const
{
