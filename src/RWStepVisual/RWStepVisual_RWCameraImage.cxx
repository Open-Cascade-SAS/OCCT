...
void RWStepVisual_RWCameraImage::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepVisual_RWCameraImage::Share(const Handle(StepVisual_CameraImage)& ent,
