...
//! @file StepBasic_Array1OfDocument.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<StepBasic_Document>> directly instead.

#ifndef _StepBasic_Array1OfDocument_hxx
#define _StepBasic_Array1OfDocument_hxx
