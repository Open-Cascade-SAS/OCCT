...
//!             Use NCollection_Sequence<opencascade::handle<Graphic3d_Structure>> directly instead.

#ifndef _Graphic3d_SequenceOfStructure_hxx
#define _Graphic3d_SequenceOfStructure_hxx
