...
Standard_HEADER_DEPRECATED("TColgp_Array2OfDir2d.hxx is deprecated since OCCT 8.0.0. Use "
                           "NCollection_Array2<gp_Dir2d> directly.")

  Standard_DEPRECATED(
    "TColgp_Array2OfDir2d is deprecated, use NCollection_Array2<gp_Dir2d> directly")
