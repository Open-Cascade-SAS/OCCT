...
//! @file Intrv_SequenceOfInterval.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<Intrv_Interval> directly instead.

#ifndef _Intrv_SequenceOfInterval_hxx
#define _Intrv_SequenceOfInterval_hxx
