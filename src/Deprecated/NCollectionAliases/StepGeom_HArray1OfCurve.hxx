...
//! @file StepGeom_HArray1OfCurve.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_HArray1<opencascade::handle<StepGeom_Curve>> directly instead.

#ifndef _StepGeom_HArray1OfCurve_hxx
#define _StepGeom_HArray1OfCurve_hxx
