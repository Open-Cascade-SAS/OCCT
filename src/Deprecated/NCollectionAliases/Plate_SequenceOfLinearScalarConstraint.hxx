...
//! @file Plate_SequenceOfLinearScalarConstraint.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<Plate_LinearScalarConstraint> directly instead.

#ifndef _Plate_SequenceOfLinearScalarConstraint_hxx
#define _Plate_SequenceOfLinearScalarConstraint_hxx
