...
//! @file StepShape_HArray1OfFaceBound.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_HArray1<opencascade::handle<StepShape_FaceBound>> directly instead.

#ifndef _StepShape_HArray1OfFaceBound_hxx
#define _StepShape_HArray1OfFaceBound_hxx
