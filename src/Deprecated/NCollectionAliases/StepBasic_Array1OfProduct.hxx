...
//! @file StepBasic_Array1OfProduct.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<StepBasic_Product>> directly instead.

#ifndef _StepBasic_Array1OfProduct_hxx
#define _StepBasic_Array1OfProduct_hxx
