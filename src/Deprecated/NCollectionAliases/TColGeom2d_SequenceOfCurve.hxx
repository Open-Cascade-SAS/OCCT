...
//! @file TColGeom2d_SequenceOfCurve.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<opencascade::handle<Geom2d_Curve>> directly instead.

#ifndef _TColGeom2d_SequenceOfCurve_hxx
#define _TColGeom2d_SequenceOfCurve_hxx
