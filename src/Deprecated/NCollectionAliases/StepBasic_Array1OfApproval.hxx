...
//! @file StepBasic_Array1OfApproval.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<StepBasic_Approval>> directly instead.

#ifndef _StepBasic_Array1OfApproval_hxx
#define _StepBasic_Array1OfApproval_hxx
