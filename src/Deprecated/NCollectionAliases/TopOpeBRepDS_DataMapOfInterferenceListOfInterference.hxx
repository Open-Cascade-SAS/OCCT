...
//! @file TopOpeBRepDS_DataMapOfInterferenceListOfInterference.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection types directly instead.

#ifndef _TopOpeBRepDS_DataMapOfInterferenceListOfInterference_hxx
#define _TopOpeBRepDS_DataMapOfInterferenceListOfInterference_hxx
