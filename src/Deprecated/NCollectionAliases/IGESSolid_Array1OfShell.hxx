...
//! @file IGESSolid_Array1OfShell.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<IGESSolid_Shell>> directly instead.

#ifndef _IGESSolid_Array1OfShell_hxx
#define _IGESSolid_Array1OfShell_hxx
