...
//! @file IntRes2d_SequenceOfIntersectionPoint.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<IntRes2d_IntersectionPoint> directly instead.

#ifndef _IntRes2d_SequenceOfIntersectionPoint_hxx
#define _IntRes2d_SequenceOfIntersectionPoint_hxx
