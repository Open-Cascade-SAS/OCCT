...
//! @file TColStd_IndexedMapOfInteger.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_IndexedMap<int> directly instead.

#ifndef _TColStd_IndexedMapOfInteger_hxx
#define _TColStd_IndexedMapOfInteger_hxx
