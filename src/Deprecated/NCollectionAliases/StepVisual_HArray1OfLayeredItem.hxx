...
//! @file StepVisual_HArray1OfLayeredItem.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_HArray1<StepVisual_LayeredItem> directly instead.

#ifndef _StepVisual_HArray1OfLayeredItem_hxx
#define _StepVisual_HArray1OfLayeredItem_hxx
