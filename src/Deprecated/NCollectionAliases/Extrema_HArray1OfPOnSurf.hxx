...
Standard_HEADER_DEPRECATED("Extrema_HArray1OfPOnSurf.hxx is deprecated since OCCT 8.0.0. Use NCollection_HArray1<Extrema_POnSurf> directly.")

Standard_DEPRECATED("Extrema_HArray1OfPOnSurf is deprecated, use NCollection_HArray1<Extrema_POnSurf> directly")
