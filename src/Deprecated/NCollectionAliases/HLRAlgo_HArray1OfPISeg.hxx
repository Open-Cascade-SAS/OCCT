...
//! @file HLRAlgo_HArray1OfPISeg.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_HArray1<HLRAlgo_PolyInternalSegment> directly instead.

#ifndef _HLRAlgo_HArray1OfPISeg_hxx
#define _HLRAlgo_HArray1OfPISeg_hxx
