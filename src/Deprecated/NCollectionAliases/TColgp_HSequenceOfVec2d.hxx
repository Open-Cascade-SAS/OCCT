...
//! @file TColgp_HSequenceOfVec2d.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_HSequence<gp_Vec2d> directly instead.

#ifndef _TColgp_HSequenceOfVec2d_hxx
#define _TColgp_HSequenceOfVec2d_hxx
