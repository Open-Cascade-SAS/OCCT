...
//! @file StepVisual_Array1OfTextOrCharacter.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<StepVisual_TextOrCharacter> directly instead.

#ifndef _StepVisual_Array1OfTextOrCharacter_hxx
#define _StepVisual_Array1OfTextOrCharacter_hxx
