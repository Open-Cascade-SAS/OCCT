...
Standard_HEADER_DEPRECATED("StepAP203_Array1OfChangeRequestItem.hxx is deprecated since OCCT "
                           "8.0.0. Use NCollection_Array1<StepAP203_ChangeRequestItem> directly.")

  Standard_DEPRECATED("StepAP203_Array1OfChangeRequestItem is deprecated, use "
                      "NCollection_Array1<StepAP203_ChangeRequestItem> directly")
