...
//!             Use NCollection_Sequence<opencascade::handle<MAT2d_Connexion>> directly instead.

#ifndef _MAT2d_SequenceOfConnexion_hxx
#define _MAT2d_SequenceOfConnexion_hxx
