...
//! @file IGESAppli_Array1OfNode.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<IGESAppli_Node>> directly instead.

#ifndef _IGESAppli_Array1OfNode_hxx
#define _IGESAppli_Array1OfNode_hxx
