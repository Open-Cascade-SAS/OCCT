...
Standard_HEADER_DEPRECATED("Units_TksSequence.hxx is deprecated since OCCT 8.0.0. Use "
                           "NCollection_Sequence<opencascade::handle<Units_Token>> directly.")

  Standard_DEPRECATED("Units_TksSequence is deprecated, use "
                      "NCollection_Sequence<opencascade::handle<Units_Token>> directly")
