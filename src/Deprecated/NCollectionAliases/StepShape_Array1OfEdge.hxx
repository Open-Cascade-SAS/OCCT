...
//! @file StepShape_Array1OfEdge.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<StepShape_Edge>> directly instead.

#ifndef _StepShape_Array1OfEdge_hxx
#define _StepShape_Array1OfEdge_hxx
