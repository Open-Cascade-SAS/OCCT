...
Standard_HEADER_DEPRECATED("TColStd_Array1OfCharacter.hxx is deprecated since OCCT 8.0.0. Use NCollection_Array1<char> directly.")

Standard_DEPRECATED("TColStd_Array1OfCharacter is deprecated, use NCollection_Array1<char> directly")
