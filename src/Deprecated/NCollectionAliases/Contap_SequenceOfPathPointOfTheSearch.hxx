...
//! @file Contap_SequenceOfPathPointOfTheSearch.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<Contap_ThePathPointOfTheSearch> directly instead.

#ifndef _Contap_SequenceOfPathPointOfTheSearch_hxx
#define _Contap_SequenceOfPathPointOfTheSearch_hxx
