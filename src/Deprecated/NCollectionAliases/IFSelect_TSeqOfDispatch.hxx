...
//! @file IFSelect_TSeqOfDispatch.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<opencascade::handle<IFSelect_Dispatch>> directly instead.

#ifndef _IFSelect_TSeqOfDispatch_hxx
#define _IFSelect_TSeqOfDispatch_hxx
