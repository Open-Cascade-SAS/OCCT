...
//! @file BRepFill_DataMapOfShapeDataMapOfShapeListOfShape.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection types directly instead.

#ifndef _BRepFill_DataMapOfShapeDataMapOfShapeListOfShape_hxx
#define _BRepFill_DataMapOfShapeDataMapOfShapeListOfShape_hxx
