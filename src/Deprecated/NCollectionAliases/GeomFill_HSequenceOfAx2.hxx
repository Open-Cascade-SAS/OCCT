...
//! @file GeomFill_HSequenceOfAx2.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_HSequence<gp_Ax2> directly instead.

#ifndef _GeomFill_HSequenceOfAx2_hxx
#define _GeomFill_HSequenceOfAx2_hxx
