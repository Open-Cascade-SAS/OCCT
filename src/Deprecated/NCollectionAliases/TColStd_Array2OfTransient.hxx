...
//! @file TColStd_Array2OfTransient.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array2<opencascade::handle<Standard_Transient>> directly instead.

#ifndef _TColStd_Array2OfTransient_hxx
#define _TColStd_Array2OfTransient_hxx
