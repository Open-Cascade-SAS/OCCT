...
//! @file ExprIntrp_SequenceOfNamedFunction.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<opencascade::handle<Expr_NamedFunction>> directly instead.

#ifndef _ExprIntrp_SequenceOfNamedFunction_hxx
#define _ExprIntrp_SequenceOfNamedFunction_hxx
