...
Standard_HEADER_DEPRECATED("Extrema_HArray2OfPOnCurv.hxx is deprecated since OCCT 8.0.0. Use NCollection_HArray2<Extrema_POnCurv> directly.")

Standard_DEPRECATED("Extrema_HArray2OfPOnCurv is deprecated, use NCollection_HArray2<Extrema_POnCurv> directly")
