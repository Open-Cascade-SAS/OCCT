...
//! @file TColStd_SequenceOfInteger.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Sequence<int> directly instead.

#ifndef _TColStd_SequenceOfInteger_hxx
#define _TColStd_SequenceOfInteger_hxx
