...
//! @file StepShape_Array1OfFace.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection_Array1<opencascade::handle<StepShape_Face>> directly instead.

#ifndef _StepShape_Array1OfFace_hxx
#define _StepShape_Array1OfFace_hxx
