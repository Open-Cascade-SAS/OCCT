...
//! @file STEPCAFControl_DataMapOfLabelExternFile.hxx
//! @brief Deprecated typedef for backward compatibility.
//! @deprecated This header is deprecated since OCCT 8.0.0.
//!             Use NCollection types directly instead.

#ifndef _STEPCAFControl_DataMapOfLabelExternFile_hxx
#define _STEPCAFControl_DataMapOfLabelExternFile_hxx
