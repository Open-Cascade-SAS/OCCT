...
public:
  ...
  Standard_EXPORT static double CurrentToLS(const double aData, const char* const aQuantity);
  ...
  //! is millimeter.
  Standard_EXPORT static double CurrentToSI(const double aData, const char* const aQuantity);
  ...
  //! is meter and LocalSystem is MDTV.
  Standard_EXPORT static double CurrentFromLS(const double aData, const char* const aQuantity);
  ...
  //! is millimeter.
  Standard_EXPORT static double CurrentFromSI(const double aData, const char* const aQuantity);
  ...
  Standard_EXPORT static double AnyToLS(const double aData, const char* const aUnit);
  ...
  Standard_EXPORT static double AnyToSI(const double aData, const char* const aUnit);
  ...
  Standard_EXPORT static double AnyFromLS(const double aData, const char* const aUnit);

  //! Converts the SI system units value to the local unit value.
  //! Example: AnyFromSI(0.0254,"in.") returns 0.001
  //! Note: aUnit is also used to identify the type of physical quantity to convert.
  Standard_EXPORT static double AnyFromSI(const double aData, const char* const aUnit);
  ...
  Standard_EXPORT static double LSToSI(const double aData, const char* const aQuantity);
  ...
  Standard_EXPORT static const char* CurrentUnit(const char* const aQuantity);
  ...
  Standard_EXPORT static occ::handle<Units_Dimensions> Dimensions(const char* const aQuantity);
  ...
  Standard_EXPORT static bool Check(const char* const aQuantity, const char* const aUnit);
