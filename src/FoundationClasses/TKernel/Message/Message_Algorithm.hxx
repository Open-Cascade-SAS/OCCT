...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfHExtendedString> GetMessageStrings(
    const Message_Status& theStatus) const;
...
private:
  occ::handle<TColStd_HArray1OfTransient> myReportIntegers;
  occ::handle<TColStd_HArray1OfTransient> myReportStrings;
