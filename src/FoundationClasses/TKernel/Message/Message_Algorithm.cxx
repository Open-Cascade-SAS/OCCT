                                  ...
                                  const bool                     noRepetitions)
{
  ...
  occ::handle<TColStd_HSequenceOfHExtendedString> aReportSeq =
    occ::down_cast<TColStd_HSequenceOfHExtendedString>(aData);
                                           ...
                                           const int    theMaxCount) const
{
       ...
       i++)
  {
    ...
    {
      occ::handle<TColStd_HSequenceOfHExtendedString> aReportSeq =
        occ::down_cast<TColStd_HSequenceOfHExtendedString>(myReportStrings->Value(i));
      if (!aReportSeq.IsNull())
      {
                                  ...
                                  const occ::handle<Message_Algorithm>& theOtherAlgo)
{
       ...
       i++)
  {
    ...
    // b) strings
    occ::handle<TColStd_HSequenceOfHExtendedString> aStrsOther = theOtherAlgo->GetMessageStrings(stat);
...
occ::handle<TColStd_HSequenceOfHExtendedString> Message_Algorithm::GetMessageStrings(
  const Message_Status& theStatus) const
{
  if (myReportStrings.IsNull())
    return 0;
  ...
  return occ::down_cast<TColStd_HSequenceOfHExtendedString>(myReportStrings->Value(aFlagIndex));
}
