...
protected:
  ...
  struct Block
  {
    ...
    void SetFreeSize(const size_t theSize) noexcept { allocStart = static_cast<uint8_t*>(address) + theSize; }

    size_t FreeSize() const noexcept { return (uint8_t*)allocStart - static_cast<uint8_t*>(address); }
