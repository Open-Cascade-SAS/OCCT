...
public:
  ...
  Standard_EXPORT occ::handle<Units_QuantitiesSequence> QuantitiesSequence() const;
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfInteger> ActiveUnitsSequence() const;
