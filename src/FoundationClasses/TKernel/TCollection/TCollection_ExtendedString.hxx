...
public:
  ...
  Standard_EXPORT TCollection_ExtendedString(const char* const astring,
                                             const bool isMultiByte = false);

  //! Creation by converting an ExtString to an extended string.
  Standard_EXPORT TCollection_ExtendedString(const char16_t* const astring);
  ...
  //! Note that this method is an alias of operator ==
  Standard_EXPORT bool IsEqual(const char16_t* const other) const;

  bool operator==(const char16_t* const other) const { return IsEqual(other); }
  ...
  //! Note that this method is an alias of operator !=.
  Standard_EXPORT bool IsDifferent(const char16_t* const other) const;

  bool operator!=(const char16_t* const other) const { return IsDifferent(other); }
  ...
  Standard_EXPORT bool IsLess(const char16_t* const other) const;

  bool operator<(const char16_t* const other) const { return IsLess(other); }
  ...
  Standard_EXPORT bool IsGreater(const char16_t* const other) const;

  bool operator>(const char16_t* const other) const { return IsGreater(other); }
  ...
  Standard_EXPORT TCollection_ExtendedString Token(const char16_t* const separators,
...
private:
  ...
  bool ConvertToUnicode(const char* const astring);
