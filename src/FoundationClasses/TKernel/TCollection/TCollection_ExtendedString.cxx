...
bool TCollection_ExtendedString::IsEqual(const char16_t* const other) const
{
...
bool TCollection_ExtendedString::IsDifferent(const char16_t* const other) const
{
  return ExtStrCmp(mystring, other) != 0;
}
...
bool TCollection_ExtendedString::IsLess(const char16_t* const other) const
{
  return ExtStrCmp(mystring, other) < 0;
}
...
bool TCollection_ExtendedString::IsGreater(const char16_t* const other) const
{
  return ExtStrCmp(mystring, other) > 0;
}
...
TCollection_ExtendedString TCollection_ExtendedString::Token(const char16_t* const separators,
...
bool TCollection_ExtendedString::ConvertToUnicode(const char* const theStringUtf)
{
