...
public:
  ...
  Standard_EXPORT void Initialize(const occ::handle<Bnd_HArray1OfBox>& theSetOfBoxes);
  ...
  Standard_EXPORT void Initialize(const Bnd_Box&                  theEnclosingBox,
                                  const occ::handle<Bnd_HArray1OfBox>& theSetOfBoxes);
...
private:
  ...
  occ::handle<Bnd_HArray1OfBox> myBoxes;  //!< The set of bounding boxes to be sorted.
