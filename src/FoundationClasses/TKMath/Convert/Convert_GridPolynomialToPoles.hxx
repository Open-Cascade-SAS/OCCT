...
public:
  ...
  Standard_EXPORT Convert_GridPolynomialToPoles(
    ...
    const occ::handle<TColStd_HArray1OfInteger>& NumCoeff,
    const occ::handle<TColStd_HArray1OfReal>&    Coefficients,
    const occ::handle<TColStd_HArray1OfReal>&    PolynomialUIntervals,
    const occ::handle<TColStd_HArray1OfReal>&    PolynomialVIntervals);
  ...
  Standard_EXPORT Convert_GridPolynomialToPoles(
    ...
    const int                  MaxUDegree,
    const int                  MaxVDegree,
    const occ::handle<TColStd_HArray2OfInteger>& NumCoeffPerSurface,
    const occ::handle<TColStd_HArray1OfReal>&    Coefficients,
    const occ::handle<TColStd_HArray1OfReal>&    PolynomialUIntervals,
    const occ::handle<TColStd_HArray1OfReal>&    PolynomialVIntervals,
    const occ::handle<TColStd_HArray1OfReal>&    TrueUIntervals,
    const occ::handle<TColStd_HArray1OfReal>&    TrueVIntervals);
  ...
  Standard_EXPORT const occ::handle<TColgp_HArray2OfPnt>& Poles() const;
  ...
  Standard_EXPORT const occ::handle<TColStd_HArray1OfReal>& UKnots() const;

  //! Knots in the V direction
  Standard_EXPORT const occ::handle<TColStd_HArray1OfReal>& VKnots() const;

  //! Multiplicities of the knots in the U direction
  Standard_EXPORT const occ::handle<TColStd_HArray1OfInteger>& UMultiplicities() const;

  //! Multiplicities of the knots in the V direction
  Standard_EXPORT const occ::handle<TColStd_HArray1OfInteger>& VMultiplicities() const;

  Standard_EXPORT bool IsDone() const;

private:
  Standard_EXPORT void BuildArray(const int               Degree,
                                  const occ::handle<TColStd_HArray1OfReal>& Knots,
                                  const int               Continuty,
                                  occ::handle<TColStd_HArray1OfReal>&       FlatKnots,
                                  occ::handle<TColStd_HArray1OfInteger>&    Mults,
                                  occ::handle<TColStd_HArray1OfReal>&       Parameters) const;

  occ::handle<TColStd_HArray1OfReal>    myUFlatKnots;
  occ::handle<TColStd_HArray1OfReal>    myVFlatKnots;
  occ::handle<TColStd_HArray1OfReal>    myUKnots;
  occ::handle<TColStd_HArray1OfReal>    myVKnots;
  occ::handle<TColStd_HArray1OfInteger> myUMults;
  occ::handle<TColStd_HArray1OfInteger> myVMults;
  occ::handle<TColgp_HArray2OfPnt>      myPoles;
  int                 myUDegree;
  int                 myVDegree;
  bool                 myDone;
};
