...
Convert_GridPolynomialToPoles::Convert_GridPolynomialToPoles(
  ...
  const occ::handle<TColStd_HArray1OfInteger>& NumCoeffPerSurface,
    ...
    : myDone(false)
{
  ...
  occ::handle<TColStd_HArray2OfInteger> NumCoeff = new (TColStd_HArray2OfInteger)(1, 1, 1, 2);
  ...
  const occ::handle<TColStd_HArray1OfReal>&    TrueVIntervals)
{
  ...
  occ::handle<TColStd_HArray1OfReal> UParameters, VParameters;
...
const occ::handle<TColgp_HArray2OfPnt>& Convert_GridPolynomialToPoles::Poles() const
{
  StdFail_NotDone_Raise_if(!myDone, "GridPolynomialToPoles");
  return myPoles;
}
...
const occ::handle<TColStd_HArray1OfReal>& Convert_GridPolynomialToPoles::UKnots() const
{
  StdFail_NotDone_Raise_if(!myDone, "GridPolynomialToPoles");
  return myUKnots;
}

const occ::handle<TColStd_HArray1OfReal>& Convert_GridPolynomialToPoles::VKnots() const
{
  StdFail_NotDone_Raise_if(!myDone, "GridPolynomialToPoles");
  return myVKnots;
}

const occ::handle<TColStd_HArray1OfInteger>& Convert_GridPolynomialToPoles::UMultiplicities() const
{
  StdFail_NotDone_Raise_if(!myDone, "GridPolynomialToPoles");
  return myUMults;
}

const occ::handle<TColStd_HArray1OfInteger>& Convert_GridPolynomialToPoles::VMultiplicities() const
{
  StdFail_NotDone_Raise_if(!myDone, "GridPolynomialToPoles");
  return myVMults;
}
