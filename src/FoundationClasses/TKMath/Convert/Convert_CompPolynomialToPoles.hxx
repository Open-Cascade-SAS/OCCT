...
public:
  ...
  Standard_EXPORT Convert_CompPolynomialToPoles(
    ...
    const int                  Dimension,
    const int                  MaxDegree,
    const occ::handle<TColStd_HArray1OfInteger>& NumCoeffPerCurve,
    const occ::handle<TColStd_HArray1OfReal>&    Coefficients,
    const occ::handle<TColStd_HArray2OfReal>&    PolynomialIntervals,
    const occ::handle<TColStd_HArray1OfReal>&    TrueIntervals);
  ...
  Standard_EXPORT void Poles(occ::handle<TColStd_HArray2OfReal>& Poles) const;
  ...
  Standard_EXPORT void Knots(occ::handle<TColStd_HArray1OfReal>& K) const;

  //! Multiplicities of the knots in the BSpline
  Standard_EXPORT void Multiplicities(occ::handle<TColStd_HArray1OfInteger>& M) const;
...
private:
  ...
  occ::handle<TColStd_HArray2OfReal>    myPoles;
  int                 myDegree;
  bool                 myDone;
};
