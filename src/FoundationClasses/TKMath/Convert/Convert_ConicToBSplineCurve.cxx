...
void Convert_ConicToBSplineCurve::BuildCosAndSin(
  ...
  const double                UFirst,
  const double                ULast,
  occ::handle<TColStd_HArray1OfReal>&     CosNumeratorPtr,
  occ::handle<TColStd_HArray1OfReal>&     SinNumeratorPtr,
  occ::handle<TColStd_HArray1OfReal>&     DenominatorPtr,
  int&                  Degree,
  occ::handle<TColStd_HArray1OfReal>&     KnotsPtr,
  occ::handle<TColStd_HArray1OfInteger>&  MultsPtr) const
{
  double delta = ULast - UFirst, direct, inverse, value1, value2, cos_beta, sin_beta,
                alpha = 0, alpha_2, alpha_4, tan_alpha_2, beta, p_param, q_param, param;

  int num_poles = 0, ii, jj, num_knots = 1, num_spans = 1, num_flat_knots,
  ...
  occ::handle<TColStd_HArray1OfInteger>&  MultsPtr) const
{
  ...
  occ::handle<TColStd_HArray1OfReal>    temp_cos_ptr, temp_sin_ptr, temp_denominator_ptr, temp_knots_ptr;
  occ::handle<TColStd_HArray1OfInteger> temp_mults_ptr;
