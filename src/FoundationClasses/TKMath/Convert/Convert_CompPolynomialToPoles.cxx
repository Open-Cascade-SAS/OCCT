...
void Convert_CompPolynomialToPoles::Poles(occ::handle<TColStd_HArray2OfReal>& P) const
{
  if (myDone)
  {
    P = myPoles;
...
void Convert_CompPolynomialToPoles::Knots(occ::handle<TColStd_HArray1OfReal>& K) const
{
  if (myDone)
  {
    K = myKnots;
...
void Convert_CompPolynomialToPoles::Multiplicities(occ::handle<TColStd_HArray1OfInteger>& M) const
{
  if (myDone)
  {
    M = myMults;
