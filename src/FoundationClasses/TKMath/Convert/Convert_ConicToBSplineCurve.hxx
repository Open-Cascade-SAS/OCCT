...
public:
  ...
  Standard_EXPORT void BuildCosAndSin(const Convert_ParameterisationType Parametrisation,
                                      occ::handle<TColStd_HArray1OfReal>&     CosNumerator,
                                      occ::handle<TColStd_HArray1OfReal>&     SinNumerator,
                                      occ::handle<TColStd_HArray1OfReal>&     Denominator,
                                      int&                  Degree,
                                      occ::handle<TColStd_HArray1OfReal>&     Knots,
                                      occ::handle<TColStd_HArray1OfInteger>&  Mults) const;
...
protected:
  ...
  occ::handle<TColgp_HArray1OfPnt2d>    poles;
  occ::handle<TColStd_HArray1OfReal>    weights;
  occ::handle<TColStd_HArray1OfReal>    knots;
