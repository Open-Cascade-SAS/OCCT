...
occ::handle<TColgp_HArray1OfPnt> Poly_Triangulation::MapNodeArray() const
{
  if (myNodes.IsEmpty())
  {
    return occ::handle<TColgp_HArray1OfPnt>();
  }
  ...
  if (myNodes.IsDoublePrecision())
  {
    ...
    occ::handle<TColgp_HArray1OfPnt> anHArray = new TColgp_HArray1OfPnt();
  ...
  // deep copy
  occ::handle<TColgp_HArray1OfPnt> anArray = new TColgp_HArray1OfPnt(1, NbNodes());
...
occ::handle<Poly_HArray1OfTriangle> Poly_Triangulation::MapTriangleArray() const
{
  if (myTriangles.IsEmpty())
  {
    return occ::handle<Poly_HArray1OfTriangle>();
  }

  occ::handle<Poly_HArray1OfTriangle> anHArray = new Poly_HArray1OfTriangle();
...
occ::handle<TColgp_HArray1OfPnt2d> Poly_Triangulation::MapUVNodeArray() const
{
  if (myUVNodes.IsEmpty())
  {
    return occ::handle<TColgp_HArray1OfPnt2d>();
  }
  ...
  if (myUVNodes.IsDoublePrecision())
  {
    ...
    occ::handle<TColgp_HArray1OfPnt2d> anHArray = new TColgp_HArray1OfPnt2d();
  ...
  // deep copy
  occ::handle<TColgp_HArray1OfPnt2d> anArray = new TColgp_HArray1OfPnt2d(1, NbNodes());
  for (int aNodeIter = 0; aNodeIter < NbNodes(); ++aNodeIter)
  {
...
occ::handle<TShort_HArray1OfShortReal> Poly_Triangulation::MapNormalArray() const
{
  if (myNormals.IsEmpty())
  {
    return occ::handle<TShort_HArray1OfShortReal>();
  }

  occ::handle<TShort_HArray1OfShortReal> anHArray = new TShort_HArray1OfShortReal();
...
void Poly_Triangulation::SetNormals(const occ::handle<TShort_HArray1OfShortReal>& theNormals)
{
...
void Poly_Triangulation::ComputeNormals()
{
  ...
  int anElem[3] = {0, 0, 0};
  for (NCollection_Array1<Poly_Triangle>::Iterator aTriIter(myTriangles); aTriIter.More(); aTriIter.Next())
  {
