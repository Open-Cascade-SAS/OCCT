...
public:
  ...
  Standard_EXPORT occ::handle<TColgp_HArray1OfPnt> MapNodeArray() const;
  ...
  //! Returned object should not be used after Poly_Triangulation destruction.
  Standard_EXPORT occ::handle<Poly_HArray1OfTriangle> MapTriangleArray() const;
  ...
  //! Returned object should not be used after Poly_Triangulation destruction.
  Standard_EXPORT occ::handle<TColgp_HArray1OfPnt2d> MapUVNodeArray() const;
  ...
  Standard_EXPORT occ::handle<TShort_HArray1OfShortReal> MapNormalArray() const;
...
public:
  ...
  Standard_EXPORT void SetNormals(const occ::handle<TShort_HArray1OfShortReal>& theNormals);
