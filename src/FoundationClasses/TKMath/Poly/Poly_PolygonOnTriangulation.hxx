...
public:
  ...
  Standard_EXPORT void SetParameters(const occ::handle<TColStd_HArray1OfReal>& theParameters);
...
public:
  ...
  //! in this polygon.
  const occ::handle<TColStd_HArray1OfReal>& Parameters() const { return myParameters; }
