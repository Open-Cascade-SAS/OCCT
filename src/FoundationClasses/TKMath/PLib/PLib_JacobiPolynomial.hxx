...
private:
  ...
  mutable Handle(TColStd_HArray1OfReal) myTNorm;
  mutable Handle(TColStd_HArray1OfReal) myCofA;
  mutable Handle(TColStd_HArray1OfReal) myCofB;
  mutable Handle(TColStd_HArray1OfReal) myDenom;
};
