...
public:
  ...
  //! symmetry.
  [[nodiscard]] Standard_EXPORT gp_Torus Mirrored(const gp_Pnt& theP) const;
  ...
  //! symmetry.
  [[nodiscard]] Standard_EXPORT gp_Torus Mirrored(const gp_Ax1& theA1) const;
  ...
  [[nodiscard]] Standard_EXPORT gp_Torus Mirrored(const gp_Ax2& theA2) const;

  void Rotate(const gp_Ax1& theA1, const Standard_Real theAng) { pos.Rotate(theA1, theAng); }

  //! Rotates a torus. theA1 is the axis of the rotation.
  //! theAng is the angular value of the rotation in radians.
  [[nodiscard]] gp_Torus Rotated(const gp_Ax1& theA1, const Standard_Real theAng) const
  {
    gp_Torus aC = *this;
  ...
  [[nodiscard]] gp_Torus Scaled(const gp_Pnt& theP, const Standard_Real theS) const;
  ...
  [[nodiscard]] gp_Torus Translated(const gp_Vec& theV) const
  {
    gp_Torus aC = *this;
  ...
  [[nodiscard]] gp_Torus Translated(const gp_Pnt& theP1, const gp_Pnt& theP2) const
  {
    gp_Torus aC = *this;
