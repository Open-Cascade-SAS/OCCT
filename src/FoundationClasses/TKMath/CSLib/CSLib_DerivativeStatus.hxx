...
enum CSLib_DerivativeStatus
{
  ...
  CSLib_D1IsNull,         //!< Both derivatives are null: ||D1U|| <= Resolution and ||D1V|| <= Resolution.
  CSLib_D1uD1vRatioIsNull, //!< D1U is negligible compared to D1V: ||D1U|| / ||D1V|| <= RealEpsilon.
  CSLib_D1vD1uRatioIsNull, //!< D1V is negligible compared to D1U: ||D1V|| / ||D1U|| <= RealEpsilon.
  CSLib_D1uIsParallelD1v   //!< D1U and D1V are parallel (angle between them is null within tolerance).
};
