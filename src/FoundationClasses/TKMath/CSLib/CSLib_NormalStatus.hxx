...
enum CSLib_NormalStatus
{
  ...
  CSLib_InfinityOfSolutions, //!< Infinite normals possible: ||DN/du|| > Resolution and ||DN/dv|| > Resolution.
  CSLib_D1NuIsNull,          //!< DN/du has null length: ||DN/du|| <= Resolution.
  CSLib_D1NvIsNull,          //!< DN/dv has null length: ||DN/dv|| <= Resolution.
  CSLib_D1NIsNull,           //!< Both normal derivatives are null: ||DN/du|| <= Resolution and ||DN/dv|| <= Resolution.
  CSLib_D1NuNvRatioIsNull,   //!< DN/du is negligible compared to DN/dv: ||DN/du|| / ||DN/dv|| <= RealEpsilon.
  CSLib_D1NvNuRatioIsNull,   //!< DN/dv is negligible compared to DN/du: ||DN/dv|| / ||DN/du|| <= RealEpsilon.
  CSLib_D1NuIsParallelD1Nv   //!< DN/du and DN/dv are parallel (angle between them is null).
};
