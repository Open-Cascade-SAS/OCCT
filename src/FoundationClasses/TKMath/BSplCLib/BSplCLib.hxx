...
public:
  ...
  Standard_EXPORT static int LastUKnotIndex(const int         Degree,
                                                         const NCollection_Array1<int>& Mults);
  ...
  Standard_EXPORT static int KnotsLength(
    const NCollection_Array1<double>& KnotSeq,
    const bool      Periodic = false);
  ...
  Standard_EXPORT static int BoorIndex(const int Index,
                                                    const int Length,
                                                    const int Depth);
  ...
  Standard_EXPORT static bool PrepareInsertKnots(
    const int         Degree,
    const bool         Periodic,
    const NCollection_Array1<double>&    Knots,
    const NCollection_Array1<int>& Mults,
  ...
  //! for more comments.
  Standard_EXPORT static int IncreaseDegreeCountKnots(
    const int         Degree,
    const int         NewDegree,
    const bool         Periodic,
    const NCollection_Array1<int>& Mults);
  ...
  Standard_EXPORT static int EvalBsplineBasis(
  ...
  Standard_EXPORT static void MergeBSplineKnots(const double               Tolerance,
                                                ...
                                                int&                 NumPoles,
                                                occ::handle<TColStd_HArray1OfReal>&    NewKnots,
                                                occ::handle<TColStd_HArray1OfInteger>& NewMults);
  ...
  //! properly.
  Standard_EXPORT static void TangExtendToConstraint(const NCollection_Array1<double>& FlatKnots,
