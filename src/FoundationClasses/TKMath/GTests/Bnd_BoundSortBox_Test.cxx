...
protected:
  ...
  Bnd_Box                  myGlobalBox;
  occ::handle<Bnd_HArray1OfBox> myBoxes;
};
...
{
  occ::handle<Bnd_HArray1OfBox> boxes = new Bnd_HArray1OfBox(1, 2);
...
TEST_F(Bnd_BoundSortBoxTest, DegenerateBoxes)
{
  ...
  occ::handle<Bnd_HArray1OfBox> boxes = new Bnd_HArray1OfBox(1, 3);
