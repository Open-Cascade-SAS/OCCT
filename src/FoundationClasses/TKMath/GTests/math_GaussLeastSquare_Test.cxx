...
TEST(math_GaussLeastSquare, OverdeterminedSystem)
{
  ...
  A(1, 1) = 1.0; A(1, 2) = 1.0;   // x + y = 3
  A(2, 1) = 2.0; A(2, 2) = -1.0;  // 2x - y = 1
  A(3, 1) = 1.0; A(3, 2) = 2.0;   // x + 2y = 5
...
TEST(math_GaussLeastSquare, LargeDiagonalValues)
{
  ...
  math_Matrix A(1, 2, 1, 2);
  A(1, 1) = 100.0; A(1, 2) = 1.0;
  A(2, 1) = 1.0;   A(2, 2) = 100.0;
...
TEST(math_GaussLeastSquare, ScaledSystem)
{
  ...
  math_Matrix A(1, 2, 1, 2);
  A(1, 1) = 0.001; A(1, 2) = 0.002;
  A(2, 1) = 0.003; A(2, 2) = 0.004;
...
TEST(math_GaussLeastSquare, PolynomialFitting)
{
  ...
  A(1, 1) = 1.0; A(1, 2) = 0.0; A(1, 3) = 0.0;   // x = 0
  A(2, 1) = 1.0; A(2, 2) = 1.0; A(2, 3) = 1.0;   // x = 1
  A(3, 1) = 1.0; A(3, 2) = 2.0; A(3, 3) = 4.0;   // x = 2
  A(4, 1) = 1.0; A(4, 2) = 3.0; A(4, 3) = 9.0;   // x = 3
...
TEST(math_GaussLeastSquare, LinearFitting)
{
  ...
  A(1, 1) = 1.0; A(1, 2) = 1.0;   // x = 1
  A(2, 1) = 1.0; A(2, 2) = 2.0;   // x = 2
  A(3, 1) = 1.0; A(3, 2) = 3.0;   // x = 3
...
TEST(math_GaussLeastSquare, NoisyData)
{
  ...
  A(2, 1) = 1.0; A(2, 2) = 2.0;   // x = 2
  A(3, 1) = 1.0; A(3, 2) = 3.0;   // x = 3
  A(4, 1) = 1.0; A(4, 2) = 4.0;   // x = 4
  A(5, 1) = 1.0; A(5, 2) = 5.0;   // x = 5
