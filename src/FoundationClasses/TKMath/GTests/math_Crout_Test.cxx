...
TEST(MathCroutTest, SimpleSymmetricMatrix)
{
  ...
  aMatrix(1, 1) = 4.0; aMatrix(1, 2) = 2.0; aMatrix(1, 3) = 1.0;
  aMatrix(2, 1) = 2.0; aMatrix(2, 2) = 3.0; aMatrix(2, 3) = 0.5;
  aMatrix(3, 1) = 1.0; aMatrix(3, 2) = 0.5; aMatrix(3, 3) = 2.0;
  ...
  math_Vector aB(1, 3);
  aB(1) = 7.0; aB(2) = 5.5; aB(3) = 3.5; // Expected solution: [1, 1, 1]
...
TEST(MathCroutTest, DiagonalMatrix)
{
  ...
  math_Vector aB(1, 3);
  aB(1) = 4.0; aB(2) = 9.0; aB(3) = 12.0; // Expected solution: [2, 3, 3]
...
TEST(MathCroutTest, LowerTriangularInput)
{
  ...
  aMatrix(1, 1) = 4.0; aMatrix(1, 2) = 0.0; aMatrix(1, 3) = 0.0;
  aMatrix(2, 1) = 2.0; aMatrix(2, 2) = 3.0; aMatrix(2, 3) = 0.0;
  aMatrix(3, 1) = 1.0; aMatrix(3, 2) = 0.5; aMatrix(3, 3) = 2.0;
...
TEST(MathCroutTest, CustomMinPivot)
{
  ...
  aMatrix(1, 1) = 1.0e-15; aMatrix(1, 2) = 1.0;
...
TEST(MathCroutTest, NotDoneExceptions)
{
  ...
  math_Matrix aMatrix(1, 3, 1, 3);
  aMatrix(1, 1) = 1.0; aMatrix(1, 2) = 2.0; aMatrix(1, 3) = 3.0;
  aMatrix(2, 1) = 2.0; aMatrix(2, 2) = 4.0; aMatrix(2, 3) = 6.0; // Singular
  aMatrix(3, 1) = 3.0; aMatrix(3, 2) = 6.0; aMatrix(3, 3) = 9.0;
...
TEST(MathCroutTest, LargerMatrix)
{
  ...
  aMatrix(1, 1) = 10.0; aMatrix(1, 2) = 1.0; aMatrix(1, 3) = 2.0; aMatrix(1, 4) = 3.0;
  aMatrix(2, 1) = 1.0; aMatrix(2, 2) = 10.0; aMatrix(2, 3) = 1.0; aMatrix(2, 4) = 4.0;
  aMatrix(3, 1) = 2.0; aMatrix(3, 2) = 1.0; aMatrix(3, 3) = 10.0; aMatrix(3, 4) = 1.0;
  aMatrix(4, 1) = 3.0; aMatrix(4, 2) = 4.0; aMatrix(4, 3) = 1.0; aMatrix(4, 4) = 10.0;
  ...
  // Test solving
  math_Vector aB(1, 4);
  aB(1) = 16.0; aB(2) = 16.0; aB(3) = 14.0; aB(4) = 18.0; // Should give solution ≈ [1, 1, 1, 1]
...
TEST(MathCroutTest, CustomBounds)
{
  ...
  aMatrix(2, 3) = 4.0; aMatrix(2, 4) = 2.0; aMatrix(2, 5) = 1.0;
  aMatrix(3, 3) = 2.0; aMatrix(3, 4) = 3.0; aMatrix(3, 5) = 0.5;
  aMatrix(4, 3) = 1.0; aMatrix(4, 4) = 0.5; aMatrix(4, 5) = 2.0;
