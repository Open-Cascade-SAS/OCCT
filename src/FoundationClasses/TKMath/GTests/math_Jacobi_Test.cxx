...
TEST(MathJacobiTest, DiagonalMatrix)
{
  ...
  math_Matrix aMatrix(1, 3, 1, 3);
  aMatrix(1, 1) = 5.0; aMatrix(1, 2) = 0.0; aMatrix(1, 3) = 0.0;
  aMatrix(2, 1) = 0.0; aMatrix(2, 2) = 3.0; aMatrix(2, 3) = 0.0;
  aMatrix(3, 1) = 0.0; aMatrix(3, 2) = 0.0; aMatrix(3, 3) = 7.0;
...
TEST(MathJacobiTest, SimpleSymmetricMatrix)
{
  ...
  aMatrix(1, 1) = 3.0; aMatrix(1, 2) = 1.0;
  aMatrix(2, 1) = 1.0; aMatrix(2, 2) = 3.0;
...
TEST(MathJacobiTest, EigenvectorVerification)
{
  ...
  math_Matrix aMatrix(1, 2, 1, 2);
  aMatrix(1, 1) = 4.0; aMatrix(1, 2) = 2.0;
  aMatrix(2, 1) = 2.0; aMatrix(2, 2) = 1.0;
...
TEST(MathJacobiTest, LargerSymmetricMatrix)
{
  ...
  aMatrix(1, 1) = 4.0; aMatrix(1, 2) = 1.0; aMatrix(1, 3) = 0.5; aMatrix(1, 4) = 0.2;
  aMatrix(2, 1) = 1.0; aMatrix(2, 2) = 5.0; aMatrix(2, 3) = 1.5; aMatrix(2, 4) = 0.3;
  aMatrix(3, 1) = 0.5; aMatrix(3, 2) = 1.5; aMatrix(3, 3) = 6.0; aMatrix(3, 4) = 2.0;
  aMatrix(4, 1) = 0.2; aMatrix(4, 2) = 0.3; aMatrix(4, 3) = 2.0; aMatrix(4, 4) = 3.0;
...
TEST(MathJacobiTest, NotDoneExceptions)
{
  ...
  math_Matrix aMatrix(1, 2, 1, 2);
  aMatrix(1, 1) = 1.0; aMatrix(1, 2) = 0.0;
  aMatrix(2, 1) = 0.0; aMatrix(2, 2) = 1.0;
...
TEST(MathJacobiTest, OrthogonalityOfEigenvectors)
{
  ...
  math_Matrix aMatrix(1, 3, 1, 3);
  aMatrix(1, 1) = 6.0; aMatrix(1, 2) = 2.0; aMatrix(1, 3) = 1.0;
  aMatrix(2, 1) = 2.0; aMatrix(2, 2) = 3.0; aMatrix(2, 3) = 1.0;
...
TEST(MathJacobiTest, CustomBounds)
{
  ...
  aMatrix(2, 2) = 5.0; aMatrix(2, 3) = 1.0;
  aMatrix(3, 2) = 1.0; aMatrix(3, 3) = 3.0;
