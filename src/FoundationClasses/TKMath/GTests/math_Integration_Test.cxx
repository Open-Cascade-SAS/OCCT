...
public:
  ConstantFunction(Standard_Real theValue) : myValue(theValue) {}
...
public:
  LinearFunction(Standard_Real theA, Standard_Real theB) : myA(theA), myB(theB) {}
...
public:
  PowerFunction(Standard_Integer thePower) : myPower(thePower) {}
...
TEST(MathIntegrationTest, KronrodQuadraticFunction)
{
  ...
  // Integral of 2x^2 - x + 3 from 0 to 1: [2x^3/3 - x^2/2 + 3x] from 0 to 1 = 2/3 - 1/2 + 3 = 2/3 - 3/6 + 18/6 = 4/6 + 18/6 - 3/6 = 19/6
