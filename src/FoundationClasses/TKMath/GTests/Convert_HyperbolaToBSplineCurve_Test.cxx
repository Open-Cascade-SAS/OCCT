...
TEST(Convert_HyperbolaToBSplineCurveTest, BasicConversion)
{
  ...
  const double aFirstX =
    aCenter.X() + aMajR * std::cosh(aU1) * aXDir.X() + aMinR * std::sinh(aU1) * aYDir.X();
  const double aFirstY =
    aCenter.Y() + aMajR * std::cosh(aU1) * aXDir.Y() + aMinR * std::sinh(aU1) * aYDir.Y();
  ...
  const double aLastX =
    aCenter.X() + aMajR * std::cosh(aU2) * aXDir.X() + aMinR * std::sinh(aU2) * aYDir.X();
  const double aLastY =
    aCenter.Y() + aMajR * std::cosh(aU2) * aXDir.Y() + aMinR * std::sinh(aU2) * aYDir.Y();
