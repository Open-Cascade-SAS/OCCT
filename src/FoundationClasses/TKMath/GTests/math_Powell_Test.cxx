...
public:
  MultiDimensionalQuadratic(Standard_Integer n) : myN(n) {}
...
TEST(MathPowellTest, SimpleQuadraticFunction)
{
  ...
  aStartPoint(1) = 5.0; aStartPoint(2) = 7.0;

  // Initial search directions (identity matrix)
  math_Matrix aDirections(1, 2, 1, 2);
  aDirections(1, 1) = 1.0; aDirections(1, 2) = 0.0;
  aDirections(2, 1) = 0.0; aDirections(2, 2) = 1.0;
...
TEST(MathPowellTest, RosenbrockFunction)
{
  ...
  math_Vector aStartPoint(1, 2);
  aStartPoint(1) = -1.0; aStartPoint(2) = 1.0; // Classic starting point
...
TEST(MathPowellTest, HigherDimensionalOptimization)
{
  ...
  aStartPoint(1) = 0.0; aStartPoint(2) = 0.0; aStartPoint(3) = 0.0; aStartPoint(4) = 0.0;
...
TEST(MathPowellTest, DifferentStartingDirections)
{
  ...
  math_Vector aStartPoint(1, 2);
  aStartPoint(1) = 3.0; aStartPoint(2) = 5.0;

  // Non-orthogonal starting directions
  math_Matrix aDirections(1, 2, 1, 2);
  aDirections(1, 1) = 1.0; aDirections(1, 2) = 1.0;  // [1, 1]
  aDirections(2, 1) = 1.0; aDirections(2, 2) = -1.0; // [1, -1]
...
TEST(MathPowellTest, IterationLimit)
{
  ...
  math_Vector aStartPoint(1, 2);
  aStartPoint(1) = -2.0; aStartPoint(2) = 3.0;
  ...
  EXPECT_FALSE(aPowell.IsDone()) << "Should fail to converge within 5 iterations for challenging function";
}
...
TEST(MathPowellTest, ToleranceSettings)
{
  ...
  EXPECT_GE(aIterationsTight, aIterationsLoose) << "Tighter tolerance should require more iterations";
}
...
TEST(MathPowellTest, LocationOutputMethod)
{
  ...
  math_Vector aStartPoint(1, 2);
  aStartPoint(1) = 4.0; aStartPoint(2) = 6.0;
...
TEST(MathPowellTest, AlreadyAtOptimum)
{
  ...
  math_Vector aStartPoint(1, 2);
  aStartPoint(1) = 1.0; aStartPoint(2) = 2.0;
