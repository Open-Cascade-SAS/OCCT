// File:	RWStepAP203_RWCcDesignContract.cxx
                                               ...
                                               const Handle(StepAP203_CcDesignContract) &ent) const
{
  ...
  if ( ! data->CheckNbParams(num,2,ach,"cc_design_contract") ) return;

  // Inherited fields of ContractAssignment

  Handle(StepBasic_Contract) aContractAssignment_AssignedContract;
  data->ReadEntity (num, 1, "contract_assignment.assigned_contract", ach, STANDARD_TYPE(StepBasic_Contract), aContractAssignment_AssignedContract);
  ...
  // Initialize entity
  ent->Init(aContractAssignment_AssignedContract,
            aItems);
}
