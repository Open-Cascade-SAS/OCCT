...
using Access = LProp_SurfaceUtils::ToolAccess<HLRBRep_SLPropsATool>;
...
HLRBRep_SLProps::HLRBRep_SLProps(const int N, const double Resolution)
    : mySurf(nullptr),
      ...
      myCurvatureStatus(LProp_Undecided)
{
  Standard_OutOfRange_Raise_if(N < 0 || N > 2, "HLRBRep_SLProps::HLRBRep_SLProps() bad level");
}
...
void HLRBRep_SLProps::CurvatureDirections(gp_Dir& Max, gp_Dir& Min)
{
