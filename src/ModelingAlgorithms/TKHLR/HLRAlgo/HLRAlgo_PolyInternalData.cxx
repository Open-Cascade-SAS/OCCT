                                        ...
                                        NCollection_Array1<HLRAlgo_TriangleData>*& TData2)
{
  if (myNbTData >= myMxTData)
  {
    ...
    occ::handle<HLRAlgo_HArray1OfTData> NwTData = new HLRAlgo_HArray1OfTData(0, k);
                                        ...
                                        NCollection_Array1<HLRAlgo_PolyInternalSegment>*& PISeg2)
{
  if (myNbPISeg >= myMxPISeg)
  {
    ...
    j                                      = myMxPISeg;
    k                                      = 2 * j;
    occ::handle<HLRAlgo_HArray1OfPISeg> NwPISeg = new HLRAlgo_HArray1OfPISeg(0, k);
                                        ...
                                        NCollection_Array1<occ::handle<HLRAlgo_PolyInternalNode>>*& PINod2)
{
  if (myNbPINod >= myMxPINod)
  {
    ...
    j                                         = myMxPINod;
    k                                         = 2 * j;
    occ::handle<HLRAlgo_HArray1OfPINod>    NwPINod = new HLRAlgo_HArray1OfPINod(0, k);
