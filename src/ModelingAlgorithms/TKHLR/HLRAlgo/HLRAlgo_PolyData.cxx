...
void HLRAlgo_PolyData::HNodes(const occ::handle<TColgp_HArray1OfXYZ>& HNodes)
{
  myHNodes = HNodes;
}
...
void HLRAlgo_PolyData::HTData(const occ::handle<HLRAlgo_HArray1OfTData>& HTData)
{
  myHTData = HTData;
}
...
void HLRAlgo_PolyData::HPHDat(const occ::handle<HLRAlgo_HArray1OfPHDat>& HPHDat)
{
  myHPHDat = HPHDat;
}
