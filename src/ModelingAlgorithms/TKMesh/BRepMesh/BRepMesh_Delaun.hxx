...
public:
  ...
  Standard_EXPORT void InitCirclesTool(const int theCellsCountU,
                                       const int theCellsCountV);
...
private:
  ...
  void createTriangles(const int          theVertexIndex,
  ...
  void deleteTriangle(const int          theIndex,
  ...
  bool isBoundToFrontier(const int theRefNodeId,
  ...
  void killLinkTriangles(const int&         theLinkId,
                         IMeshData::MapOfIntegerInteger& theLoopEdges);
