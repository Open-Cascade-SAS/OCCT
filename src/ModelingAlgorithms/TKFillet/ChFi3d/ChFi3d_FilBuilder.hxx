...
public:
  ...
  Standard_EXPORT void SetRadius(const occ::handle<Law_Function>& C,
                                 const int      IC,
                                 const int      IinC);
  ...
  Standard_EXPORT occ::handle<ChFiDS_SecHArray1> Sect(const int IC,
                                                 const int IS) const;
...
protected:
  ...
  Standard_EXPORT virtual void PerformSurf(NCollection_Sequence<occ::handle<ChFiDS_SurfData>>&         SeqData,
                                           const occ::handle<ChFiDS_ElSpine>&      Guide,
                                           const occ::handle<ChFiDS_Spine>&        Spine,
                                           const int             Choix,
                                           const occ::handle<BRepAdaptor_Surface>& S1,
