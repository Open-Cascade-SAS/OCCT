...
public:
  ...
  Standard_EXPORT int Contains(const TopoDS_Edge& E,
...
protected:
  ...
  Standard_EXPORT void PerformSetOfSurf(occ::handle<ChFiDS_Stripe>& S,
                                        const bool Simul = false);

  Standard_EXPORT void PerformSetOfKPart(occ::handle<ChFiDS_Stripe>& S,
                                         const bool Simul = false);

  Standard_EXPORT void PerformSetOfKGen(occ::handle<ChFiDS_Stripe>& S,
                                        const bool Simul = false);
  ...
  Standard_EXPORT void PerformMoreThreeCorner(const int Index,
                                              const int nbcourb);
  ...
  Standard_EXPORT virtual bool PerformFirstSection(
    const occ::handle<ChFiDS_Spine>&        S,
    const occ::handle<ChFiDS_ElSpine>&      HGuide,
    const int             Choix,
...
private:
  ...
  Standard_EXPORT void PerformOneCorner(const int Index,
                                        const bool PrepareOnSame = false);
