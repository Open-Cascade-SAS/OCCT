...
static bool ToricCorner(const TopoDS_Face&  F,
                                    const double rd,
                                    const double rf,
                                    const gp_Vec&       v)
{
...
void ChFi3d_FilBuilder::PerformThreeCorner(const int Jndex)
{
  ...
  // the border.
  occ::handle<GeomAdaptor_Surface> bidsurf = new GeomAdaptor_Surface(Fac->ChangeSurface().Surface());
