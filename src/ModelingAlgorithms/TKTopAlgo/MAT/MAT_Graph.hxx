...
public:
  ...
  Standard_EXPORT void ChangeBasicElts(const NCollection_DataMap<int, occ::handle<MAT_BasicElt>>& NewMap);
...
private:
  ...
  //! <Arc2> is eliminated.
  Standard_EXPORT void FusionOfArcs(const occ::handle<MAT_Arc>& Arc1, const occ::handle<MAT_Arc>& Arc2);
