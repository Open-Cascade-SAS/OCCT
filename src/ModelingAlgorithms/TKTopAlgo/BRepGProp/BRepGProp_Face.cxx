...
static void GetRealKnots(const double                  theMin,
                         const double                  theMax,
                         const occ::handle<TColStd_HArray1OfReal>& theKnots,
                         occ::handle<TColStd_HArray1OfReal>&       theRealKnots)
{
                          ...
                          occ::handle<TColStd_HArray1OfReal>& theKnots)
{
  ...
  if (isSBSpline)
  {
    ...
    int              aNbKnots;
    occ::handle<TColStd_HArray1OfReal> aCrvKnots;
                               ...
                               occ::handle<TColStd_HArray1OfReal>& theTKnots) const
{
  ...
  {
    // Using span decomposition for BSpline.
    occ::handle<TColStd_HArray1OfReal> aSurfKnots;
    int              aNbKnots;
    ...
    //     occ::handle<TColStd_HArray1OfReal> aCurveKnots;
