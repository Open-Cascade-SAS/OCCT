...
public:
  ...
  //! of ancestors.
  Standard_EXPORT BRepLib_FuseEdges(const TopoDS_Shape& theShape, const bool PerformNow = false);
  ...
  Standard_EXPORT void SetConcatBSpl(const bool theConcatBSpl = true);
