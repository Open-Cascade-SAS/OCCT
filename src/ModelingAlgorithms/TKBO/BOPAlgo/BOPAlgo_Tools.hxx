...
public:
  ...
  Standard_EXPORT static void FillMap(const occ::handle<BOPDS_PaveBlock>&                thePB1,
                                      const int                        theF,
  ...
  Standard_EXPORT static void PerformCommonBlocks(
    NCollection_IndexedDataMap<occ::handle<BOPDS_PaveBlock>, NCollection_List<occ::handle<BOPDS_PaveBlock>>>& theMBlocks,
    const occ::handle<NCollection_BaseAllocator>&        theAllocator,
    BOPDS_PDS&                                      theDS,
  ...
  Standard_EXPORT static void PerformCommonBlocks(
    const NCollection_IndexedDataMap<occ::handle<BOPDS_PaveBlock>, NCollection_List<int>>& theMBlocks,
    const occ::handle<NCollection_BaseAllocator>&            theAllocator,
    BOPDS_PDS&                                          pDS,
    const occ::handle<IntTools_Context>&                     theContext = occ::handle<IntTools_Context>());
  ...
  Standard_EXPORT static int EdgesToWires(
  ...
  Standard_EXPORT static void ClassifyFaces(
    ...
    const NCollection_DataMap<TopoDS_Shape, Bnd_Box, TopTools_ShapeMapHasher>&          theShapeBoxMap = NCollection_DataMap<TopoDS_Shape, Bnd_Box, TopTools_ShapeMapHasher>(),
    const NCollection_DataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>&  theSolidsIF = NCollection_DataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>(),
  ...
  Standard_EXPORT static void FillInternals(const NCollection_List<TopoDS_Shape>&               theSolids,
