...
protected:
  typedef NCollection_DataMap<occ::handle<BOPDS_PaveBlock>, Bnd_Box> BOPAlgo_DataMapOfPaveBlockBndBox;
  ...
  Standard_EXPORT void IntersectVE(const NCollection_IndexedDataMap<occ::handle<BOPDS_PaveBlock>, NCollection_List<int>>& theVEPairs,
  ...
  Standard_EXPORT void MakeSDVerticesFF(const NCollection_DataMap<int, NCollection_List<int>>& aDMVLV,
  ...
  Standard_EXPORT void PerformNewVertices(
    NCollection_IndexedDataMap<TopoDS_Shape, BOPDS_CoupleOfPaveBlocks, TopTools_ShapeMapHasher>& theMVCPB,
  ...
  Standard_EXPORT void PostTreatFF(NCollection_IndexedDataMap<TopoDS_Shape, BOPDS_CoupleOfPaveBlocks, TopTools_ShapeMapHasher>& theMSCPB,
                                   NCollection_DataMap<occ::handle<BOPDS_PaveBlock>, NCollection_List<occ::handle<BOPDS_PaveBlock>>>&       theDMExEdges,
                                   NCollection_DataMap<int, int>&               theDMNewSD,
  ...
  Standard_EXPORT void TreatNewVertices(
    ...
    NCollection_IndexedDataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>&           theImages);
  ...
  Standard_EXPORT void PreparePostTreatFF(const int                         aInt,
                                          const int                         aCur,
  ...
  Standard_EXPORT void UpdateFaceInfo(NCollection_DataMap<occ::handle<BOPDS_PaveBlock>, NCollection_List<occ::handle<BOPDS_PaveBlock>>>&       theDME,
  ...
  Standard_EXPORT bool ForceInterfVF(const int nV,
                                                 const int nF);

  //! Checks if there are any common or intersecting sub shapes
  //! between two planar faces.
  Standard_EXPORT bool CheckPlanes(const int nF1,
                                               const int nF2) const;
  ...
  Standard_EXPORT int UpdateVertex(const int nV,
  ...
  Standard_EXPORT void ForceInterfEF(const NCollection_IndexedMap<occ::handle<BOPDS_PaveBlock>>& theMPB,
                                     const Message_ProgressRange&       theRange,
