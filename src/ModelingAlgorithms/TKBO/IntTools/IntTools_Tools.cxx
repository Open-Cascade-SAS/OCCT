...
int IntTools_Tools::SplitCurve(const IntTools_Curve&      IC,
                                            NCollection_Sequence<IntTools_Curve>& aCvs)
{
...
bool IntTools_Tools::IsVertex(const TopoDS_Edge&   aE,
                                          const TopoDS_Vertex& aV,
                                          const double  t)
{
...
double IntTools_Tools::CurveTolerance(const occ::handle<Geom_Curve>& aC3D,
