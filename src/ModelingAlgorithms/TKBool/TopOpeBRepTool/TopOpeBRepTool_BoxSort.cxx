...
const occ::handle<Bnd_HArray1OfBox>& TopOpeBRepTool_BoxSort::HAB() const
{
  return myHAB;
}
...
void TopOpeBRepTool_BoxSort::MakeHABCOB(const occ::handle<Bnd_HArray1OfBox>& HAB, Bnd_Box& COB)
{
  COB.SetVoid();
  int       n  = HAB->Upper();
