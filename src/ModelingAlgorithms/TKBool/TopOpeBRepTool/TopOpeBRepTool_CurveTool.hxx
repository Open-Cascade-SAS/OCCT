...
public:
  ...
  Standard_EXPORT static occ::handle<Geom_Curve> MakeBSpline1fromPnt(const NCollection_Array1<gp_Pnt>& P);

  Standard_EXPORT static occ::handle<Geom2d_Curve> MakeBSpline1fromPnt2d(const NCollection_Array1<gp_Pnt2d>& P);

  Standard_EXPORT static bool IsProjectable(const TopoDS_Shape&       S,
                                                        const occ::handle<Geom_Curve>& C);

  Standard_EXPORT static occ::handle<Geom2d_Curve> MakePCurveOnFace(const TopoDS_Shape&       S,
                                                               const occ::handle<Geom_Curve>& C,
                                                               double&      TolReached2d,
