                                    ...
                                    const occ::handle<TopOpeBRepDS_HDataStructure>& HDS)
{
  ...
  NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& EIL1 = myPDS->ChangeShapeInterferences(E1);
  ...
  for (; myPEI->MorePoint(); myPEI->NextPoint())
  {
    ...
    NCollection_List<occ::handle<TopOpeBRepDS_Interference>>::Iterator itloI1(myPDS->ShapeInterferences(E1));
    int                              G;
    TopOpeBRepDS_Kind                             K;
    ...
    if (isvertex && foundpoint)
    {
      ...
      for (; is <= ns; is++)
      {
        ...
        NCollection_List<occ::handle<TopOpeBRepDS_Interference>>&              li = myPDS->ChangeShapeInterferences(e);
...
occ::handle<TopOpeBRepDS_Interference> TopOpeBRep_EdgesFiller::StorePI(const TopOpeBRep_Point2d& P2D,
...
occ::handle<TopOpeBRepDS_Interference> TopOpeBRep_EdgesFiller::StoreVI(const TopOpeBRep_Point2d& P2D,
                                                                  const TopOpeBRepDS_Transition& T,
                                                                  const int         EI,
                                                                  const int         VI,
                                                                  const bool    VisB,
