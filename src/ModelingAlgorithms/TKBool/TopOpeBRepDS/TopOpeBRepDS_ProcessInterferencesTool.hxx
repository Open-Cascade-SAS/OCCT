...
Standard_EXPORT int FUN_selectTRASHAinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                              const TopAbs_ShapeEnum           sha,
                                                              NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectITRASHAinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                               const int Index,
                                                               NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectTRAUNKinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                              NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectTRAORIinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                              const TopAbs_Orientation         O,
                                                              NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectGKinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                          const TopOpeBRepDS_Kind          GK,
                                                          NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectSKinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                          const TopOpeBRepDS_Kind          SK,
                                                          NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectGIinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                          const int           GI,
                                                          NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
Standard_EXPORT int FUN_selectSIinterference(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L1,
                                                          const int           SI,
                                                          NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& L2);
...
Standard_EXPORT bool FUN_transitionINDEXEQUAL(const TopOpeBRepDS_Transition&,
                                                          const TopOpeBRepDS_Transition&);
Standard_EXPORT void             FUN_reducedoublons(NCollection_List<occ::handle<TopOpeBRepDS_Interference>>&  LI,
...
Standard_EXPORT int FUN_selectpure2dI(const NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& lF,
...
Standard_EXPORT void             FUN_select3dinterference(const int           SIX,
                                                          TopOpeBRepDS_DataStructure&      BDS,
