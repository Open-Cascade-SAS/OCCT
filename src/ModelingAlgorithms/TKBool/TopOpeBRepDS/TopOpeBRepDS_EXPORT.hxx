...
Standard_EXPORT void             FUN_scanloi(const NCollection_List<occ::handle<TopOpeBRepDS_Interference>>& lII,
...
Standard_EXPORT bool FUN_ds_GetTr(const TopOpeBRepDS_DataStructure&      BDS,
                                              const int                 ISE,
                                              const int                 G,
...
Standard_EXPORT void FDS_data(const occ::handle<TopOpeBRepDS_Interference>& I,
                              ...
                              int&                        S1);
Standard_EXPORT bool FDS_data(const NCollection_List<occ::handle<TopOpeBRepDS_Interference>>::Iterator& it,
...
Standard_EXPORT int FUN_ds_hasI2d(const int                 EIX,
