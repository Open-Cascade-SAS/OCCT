...
static bool SplitUEdges(const occ::handle<TopTools_HArray2OfShape>& theUEdges,
                                    const BOPDS_PDS&                       theDS,
                                    const gp_Vec&                          theCrossDirection,
                                    NCollection_DataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>&    theHistMap);

static void StoreVedgeInHistMap(const occ::handle<TopTools_HArray1OfShape>& theVEdges,
                                const int                 theIndex,
...
static bool GetUEdges(const int                 theIndex,
                                  const int                 theRank,
                                  const occ::handle<TopTools_HArray2OfShape>& theUEdges,
                                  const TopoDS_Edge&                     theBoundEdge,
                                  const TopoDS_Face&                     theFace,
...
BRepFill_TrimShellCorner::BRepFill_TrimShellCorner(const occ::handle<TopTools_HArray2OfShape>& theFaces,
...
void BRepFill_TrimShellCorner::AddBounds(const occ::handle<TopTools_HArray2OfShape>& theBounds)
{
...
void BRepFill_TrimShellCorner::AddUEdges(const occ::handle<TopTools_HArray2OfShape>& theUEdges)
{
...
void BRepFill_TrimShellCorner::AddVEdges(const occ::handle<TopTools_HArray2OfShape>& theVEdges,
                                         const int                 theIndex)
{
...
// purpose:
// ------------------------------------------------------------------------------------------
bool SplitUEdges(const occ::handle<TopTools_HArray2OfShape>& theUEdges,
                             const BOPDS_PDS&                       theDS,
                             const gp_Vec&                          theCrossDirection,
                             NCollection_DataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>&    theHistMap)
{
...
// purpose:
// ------------------------------------------------------------------------------------------
void StoreVedgeInHistMap(const occ::handle<TopTools_HArray1OfShape>& theVEdges,
                         const int                 theIndex,
