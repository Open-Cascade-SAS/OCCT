...
//=======================================================================
static void Translate(const occ::handle<TopTools_HArray2OfShape>& ArrayIn,
                      const int                 In,
                      occ::handle<TopTools_HArray2OfShape>&       ArrayOut,
                      const int                 Out)
{
  int ii, Nb;
...
//=======================================================================
static bool CheckSameParameterExact(
...
//=======================================================================
static void BuildFace(const occ::handle<Geom_Surface>&   S,
...
//=======================================================================
static void KeepEdge(const TopoDS_Shape& Face, const TopoDS_Shape& Edge, NCollection_List<TopoDS_Shape>& List)
{
  List.Clear();
  // Class BRep_Tool without fields and without Constructor :
  //  BRep_Tool BT;
...
static void ReverseModifiedEdges(TopoDS_Wire& theWire, const NCollection_Map<TopoDS_Shape, TopTools_ShapeMapHasher>& theEmap)
{
  if (theEmap.IsEmpty())
    return;
...
bool BRepFill_Sweep::BuildShell(const BRepFill_TransitionStyle /*Transition*/,
                                            ...
                                            NCollection_DataMap<TopoDS_Shape, occ::handle<TopTools_HArray2OfShape>, TopTools_ShapeMapHasher>& Tapes,
                                            NCollection_DataMap<TopoDS_Shape, occ::handle<TopTools_HArray2OfShape>, TopTools_ShapeMapHasher>& Rails,
                                            ...
                                            const double                    ExtendLast)
{
  ...
  if (!FirstShape.IsNull() && (IFirst == 1))
  {
    ...
    for (isec = 1; isec <= NbLaw; isec++)
    {
      ...
      {
        occ::handle<TopTools_HArray2OfShape> EmptyArray =
  ...
  if (IFirst == 1 && !Tapes.IsEmpty()) // works only in case of single shell
  {
    for (isec = 1; isec <= NbLaw; isec++)
    {
      ...
      if (!Rails.IsBound(Vfirst))
      {
        occ::handle<TopTools_HArray2OfShape> anArray = new TopTools_HArray2OfShape(1, 2, 1, NbPath + 1);
        for (j = 1; j <= NbPath; j++)
                           ...
                           const int                 Segmax)
{
  ...
  { // Shell
    int NbTrous = myLoc->NbHoles(myTol3d), NbPath = myLoc->NbLaw(),
    ...
    occ::handle<TopTools_HArray2OfShape> Bounds = new (TopTools_HArray2OfShape)(1, NbLaw, 1, 2);

    occ::handle<TColStd_HArray1OfInteger> Trous;
    ...
    */
    NCollection_DataMap<TopoDS_Shape, TopoDS_Shape, TopTools_ShapeMapHasher>::Iterator mapit(myVEdgesModified);
    ...
    if (myLoc->IsClosed() && mySec->IsUClosed())
    {
      ...
      bool                          closed = true;
      int                          iedge;
      NCollection_IndexedDataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher> EFmap;
...
//=======================================================================
occ::handle<TopTools_HArray2OfShape> BRepFill_Sweep::SubShape() const
{
  return myFaces;
}
...
//=======================================================================
occ::handle<TopTools_HArray2OfShape> BRepFill_Sweep::InterFaces() const
{
  return myUEdges;
}
...
//=======================================================================
occ::handle<TopTools_HArray2OfShape> BRepFill_Sweep::Sections() const
{
  return myVEdges;
}
...
bool BRepFill_Sweep::PerformCorner(const int                 Index,
                                               const BRepFill_TransitionStyle         Transition,
                                               const occ::handle<TopTools_HArray2OfShape>& Bounds)
{
  ...
  //  gp_Mat M;
  // occ::handle<TopTools_HArray1OfShape> TheShape =
  ...
  occ::handle<TopTools_HArray2OfShape> UEdges =
  ...
  occ::handle<TopTools_HArray2OfShape> aFaces =
  ...
  occ::handle<TopTools_HArray2OfShape> aUEdges =
