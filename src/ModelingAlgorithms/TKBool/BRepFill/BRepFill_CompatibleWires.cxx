...
void BRepFill_CompatibleWires::SameNumberByPolarMethod(const bool WithRotation)
{
  ...
  gp_Pln                      P;
  occ::handle<TColgp_HArray1OfPnt> Pos = new (TColgp_HArray1OfPnt)(1, NbSects);
  occ::handle<TColgp_HArray1OfVec> Axe = new (TColgp_HArray1OfVec)(1, NbSects);
  for (i = ideb; i <= ifin; i++)
  {
...
void BRepFill_CompatibleWires::ComputeOrigin(const bool /*polar*/)
{
  ...
  */
  ...
  /*
    ...
    // construction of tables of planes of wires
    gp_Pln P;
    occ::handle<TColgp_HArray1OfPnt> Pos
      = new (TColgp_HArray1OfPnt) (1,NbSects);
    occ::handle<TColgp_HArray1OfVec> Axe
