...
public:
  ...
  Standard_EXPORT void SetAngularControl(const double AngleMin = 0.01,
  ...
  Standard_EXPORT occ::handle<TopTools_HArray2OfShape> SubShape() const;

  Standard_EXPORT occ::handle<TopTools_HArray2OfShape> InterFaces() const;

  Standard_EXPORT occ::handle<TopTools_HArray2OfShape> Sections() const;
...
protected:
  ...
  Standard_EXPORT bool BuildShell(const BRepFill_TransitionStyle         Transition,
                                              const int                 Vf,
                                              const int                 Vl,
...
private:
  ...
  occ::handle<TopTools_HArray2OfShape> myVEdges;
  ...
  occ::handle<TopTools_HArray1OfShape> myTapes;
  double                   Error;
