...
protected:
  ...
  TopoDS_Wire                           myPath;
  double                         myTol;
  occ::handle<GeomFill_HArray1OfLocationLaw> myLaws;
  occ::handle<TColStd_HArray1OfReal>         myLength;
  occ::handle<TopTools_HArray1OfShape>       myEdges;
  occ::handle<TColStd_HArray1OfInteger>      myDisc;
