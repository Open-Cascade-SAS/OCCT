...
private:
  ...
  Standard_EXPORT int FindEdge(const TopoDS_Shape& S,
                                            const TopoDS_Edge&  E,
                                            int&   Init) const;

  Standard_EXPORT int FindVertex(const TopoDS_Shape&  S,
  ...
  occ::handle<TopTools_HArray2OfShape>       mySections;
  occ::handle<TopTools_HArray2OfShape>       myFaces;
  occ::handle<TopTools_HArray2OfShape>       myEdges;
  NCollection_Map<TopoDS_Shape, TopTools_ShapeMapHasher>                   myReversedEdges;
  NCollection_DataMap<TopoDS_Shape, occ::handle<TopTools_HArray2OfShape>, TopTools_ShapeMapHasher> myTapes;
  NCollection_DataMap<TopoDS_Shape, occ::handle<TopTools_HArray2OfShape>, TopTools_ShapeMapHasher> myRails;
