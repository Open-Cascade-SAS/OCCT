...
protected:
  gp_Ax3                           myAxis3;
  occ::handle<TColStd_HArray1OfReal>    myDiams;
  occ::handle<TColStd_HArray1OfReal>    myHeights;
  occ::handle<TColStd_HArray1OfReal>    myPitches;
  occ::handle<TColStd_HArray1OfBoolean> myIsPitches;
  double                    myTolerance;
  double                    myTolReached;
