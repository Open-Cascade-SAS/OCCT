...
void ShapeAnalysis_WireOrder::Perform(const bool /*closed*/)
{
  ...
  occ::handle<TColStd_HSequenceOfInteger> anEdgeSeq = new TColStd_HSequenceOfInteger;
  NCollection_Sequence<occ::handle<TColStd_HSequenceOfInteger>> aLoops;
  ...
  occ::handle<TColStd_HSequenceOfInteger> aMainLoop;
  if (myKeepLoops)
  {
    ...
    {
      const occ::handle<TColStd_HSequenceOfInteger>& aCurLoop = aLoops(i);
  ...
  else
  {
    ...
    while (aLoops.Length())
    {
      ...
      {
        const occ::handle<TColStd_HSequenceOfInteger>& aCurLoop = aLoops.Value(aLoopIt);
      ...
      occ::handle<TColStd_HSequenceOfInteger> aLoop   = aLoops.Value(aLoopNum1);
