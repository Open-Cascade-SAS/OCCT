...
occ::handle<TColStd_HSequenceOfReal> ShapeAnalysis_TransferParametersProj::Perform(
  const occ::handle<TColStd_HSequenceOfReal>& Knots,
  const bool                 To2d)
{
  // pdn
  if (!myInitOK
  ...
  occ::handle<TColStd_HSequenceOfReal> resKnots = new TColStd_HSequenceOfReal;
