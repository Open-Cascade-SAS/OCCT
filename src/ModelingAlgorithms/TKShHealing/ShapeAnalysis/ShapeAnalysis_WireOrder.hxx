...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger> myOrd;
  occ::handle<TColStd_HArray1OfInteger> myChains;
  occ::handle<TColStd_HArray1OfInteger> myCouples;
  occ::handle<TColgp_HSequenceOfXYZ>    myXYZ;
  occ::handle<TColgp_HSequenceOfXY>     myXY;
  double                    myTol;
  double                    myGap;
  int                 myStat;
  bool                 myKeepLoops;
