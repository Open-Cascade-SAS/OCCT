      ...
      mySplitOpen(splitopen)
{
  ...
  occ::handle<TopTools_HSequenceOfShape> edges  = new TopTools_HSequenceOfShape;
      ...
      mySplitOpen(splitopen)
{
  ...
  if (sas.HasFreeEdges())
  {
    ...
    occ::handle<TopTools_HSequenceOfShape> edges = see.SeqFromCompound(sas.FreeEdges(), false);
...
void ShapeAnalysis_FreeBounds::ConnectEdgesToWires(occ::handle<TopTools_HSequenceOfShape>& edges,
                                                   const double                toler,
                                                   const bool             shared,
                                                   occ::handle<TopTools_HSequenceOfShape>& wires)
{
  occ::handle<TopTools_HSequenceOfShape> iwires = new TopTools_HSequenceOfShape;
  BRep_Builder                      B;
...
void ShapeAnalysis_FreeBounds::ConnectWiresToWires(occ::handle<TopTools_HSequenceOfShape>& iwires,
                                                   const double                toler,
                                                   const bool             shared,
                                                   occ::handle<TopTools_HSequenceOfShape>& owires)
{
                                                   ...
                                                   NCollection_DataMap<TopoDS_Shape, TopoDS_Shape, TopTools_ShapeMapHasher>&      vertices)
{
  if (iwires.IsNull() || !iwires->Length())
    return;
  occ::handle<TopTools_HArray1OfShape> arrwires = new TopTools_HArray1OfShape(1, iwires->Length());
  // amv
  int i;
...
static void SplitWire(const TopoDS_Wire&                 wire,
                      const double                toler,
                      const bool             shared,
                      occ::handle<TopTools_HSequenceOfShape>& closed,
                      occ::handle<TopTools_HSequenceOfShape>& open)
{
...
void ShapeAnalysis_FreeBounds::SplitWires(const occ::handle<TopTools_HSequenceOfShape>& wires,
                                          const double                      toler,
                                          const bool                   shared,
                                          occ::handle<TopTools_HSequenceOfShape>&       closed,
                                          occ::handle<TopTools_HSequenceOfShape>&       open)
{
  ...
  {
    occ::handle<TopTools_HSequenceOfShape> tmpclosed, tmpopen;
...
void ShapeAnalysis_FreeBounds::DispatchWires(const occ::handle<TopTools_HSequenceOfShape>& wires,
...
void ShapeAnalysis_FreeBounds::SplitWires()
{
  ...
  ShapeExtend_Explorer              see;
  occ::handle<TopTools_HSequenceOfShape> closedwires, cw1, cw2, openwires, ow1, ow2;
