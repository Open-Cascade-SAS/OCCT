...
public:
  ...
  const occ::handle<TopTools_HSequenceOfShape>& BigSplineSec() const { return myBigSplineSec; }

  const occ::handle<TopTools_HSequenceOfShape>& IndirectSec() const { return myIndirectSec; }

  const occ::handle<TopTools_HSequenceOfShape>& OffsetSurfaceSec() const { return myOffsetSurfaceSec; }

  const occ::handle<TopTools_HSequenceOfShape>& Trimmed3dSec() const { return myTrimmed3dSec; }

  const occ::handle<TopTools_HSequenceOfShape>& OffsetCurveSec() const { return myOffsetCurveSec; }

  const occ::handle<TopTools_HSequenceOfShape>& Trimmed2dSec() const { return myTrimmed2dSec; }
...
private:
  ...
  occ::handle<TopTools_HSequenceOfShape> myBigSplineSec;
  occ::handle<TopTools_HSequenceOfShape> myIndirectSec;
  occ::handle<TopTools_HSequenceOfShape> myOffsetSurfaceSec;
  occ::handle<TopTools_HSequenceOfShape> myTrimmed3dSec;
  occ::handle<TopTools_HSequenceOfShape> myOffsetCurveSec;
  occ::handle<TopTools_HSequenceOfShape> myTrimmed2dSec;
};
