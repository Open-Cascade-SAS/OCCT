...
occ::handle<TColStd_HSequenceOfReal> ShapeAnalysis_TransferParameters::Perform(
  const occ::handle<TColStd_HSequenceOfReal>& Params,
  const bool                 To2d)
{
  occ::handle<TColStd_HSequenceOfReal> res = new TColStd_HSequenceOfReal;
