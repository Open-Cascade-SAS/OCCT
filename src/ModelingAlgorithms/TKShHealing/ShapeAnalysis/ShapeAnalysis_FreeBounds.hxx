...
public:
  ...
  Standard_EXPORT static void ConnectEdgesToWires(occ::handle<TopTools_HSequenceOfShape>& edges,
                                                  const double                toler,
                                                  const bool             shared,
                                                  occ::handle<TopTools_HSequenceOfShape>& wires);

  Standard_EXPORT static void ConnectWiresToWires(occ::handle<TopTools_HSequenceOfShape>& iwires,
                                                  const double                toler,
                                                  const bool             shared,
  ...
  Standard_EXPORT static void SplitWires(const occ::handle<TopTools_HSequenceOfShape>& wires,
                                         const double                      toler,
                                         const bool                   shared,
  ...
  Standard_EXPORT static void DispatchWires(const occ::handle<TopTools_HSequenceOfShape>& wires,
