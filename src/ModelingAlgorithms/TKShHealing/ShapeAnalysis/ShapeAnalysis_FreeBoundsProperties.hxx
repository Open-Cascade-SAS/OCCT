...
public:
  ...
  occ::handle<ShapeAnalysis_HSequenceOfFreeBounds> ClosedFreeBounds() const;

  //! Returns all open free bounds
  occ::handle<ShapeAnalysis_HSequenceOfFreeBounds> OpenFreeBounds() const;
...
private:
  ...
  bool                            mySplitClosed;
  bool                            mySplitOpen;
  occ::handle<ShapeAnalysis_HSequenceOfFreeBounds> myClosedFreeBounds;
  occ::handle<ShapeAnalysis_HSequenceOfFreeBounds> myOpenFreeBounds;
};
