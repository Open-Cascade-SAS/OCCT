...
private:
  ...
  occ::handle<TColStd_HArray1OfInteger> myStat;
  occ::handle<TColgp_HArray1OfXYZ>      myPos;
  occ::handle<TColStd_HArray1OfReal>    myUPre;
  occ::handle<TColStd_HArray1OfReal>    myUFol;
  double                    myPreci;
  bool                 myDone;
};
