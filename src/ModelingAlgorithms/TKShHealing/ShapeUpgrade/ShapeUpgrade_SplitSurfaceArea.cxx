...
void ShapeUpgrade_SplitSurfaceArea::Compute(const bool /*Segment*/)
{
  ...
  occ::handle<TColStd_HSequenceOfReal> aFirstSplit  = (aNbUV < 1. ? myVSplitValues : myUSplitValues);
  occ::handle<TColStd_HSequenceOfReal> aSecondSplit = (aNbUV < 1. ? myUSplitValues : myVSplitValues);
