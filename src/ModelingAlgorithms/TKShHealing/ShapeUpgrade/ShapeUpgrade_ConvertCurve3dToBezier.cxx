...
occ::handle<TColGeom_HSequenceOfCurve> ShapeUpgrade_ConvertCurve3dToBezier::Segments() const
{
  return mySegments;
}
...
occ::handle<TColStd_HSequenceOfReal> ShapeUpgrade_ConvertCurve3dToBezier::SplitParams() const
{
