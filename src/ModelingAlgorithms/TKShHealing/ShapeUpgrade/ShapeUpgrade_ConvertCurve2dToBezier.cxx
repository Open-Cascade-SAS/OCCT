...
occ::handle<TColGeom2d_HSequenceOfCurve> ShapeUpgrade_ConvertCurve2dToBezier::Segments() const
{
  return mySegments;
}
...
occ::handle<TColStd_HSequenceOfReal> ShapeUpgrade_ConvertCurve2dToBezier::SplitParams() const
{
