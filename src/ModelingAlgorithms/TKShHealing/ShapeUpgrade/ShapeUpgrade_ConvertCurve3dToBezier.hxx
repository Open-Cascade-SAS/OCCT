...
public:
  ...
  Standard_EXPORT occ::handle<TColStd_HSequenceOfReal> SplitParams() const;
...
private:
  ...
  //! curve.
  Standard_EXPORT occ::handle<TColGeom_HSequenceOfCurve> Segments() const;

  occ::handle<TColGeom_HSequenceOfCurve> mySegments;
  occ::handle<TColStd_HSequenceOfReal>   mySplitParams;
  bool                  myLineMode;
  bool                  myCircleMode;
  bool                  myConicMode;
};
