...
public:
  ...
  Standard_EXPORT void SetUSplitValues(const occ::handle<TColStd_HSequenceOfReal>& UValues);

  //! Sets V parameters where splitting has to be done
  Standard_EXPORT void SetVSplitValues(const occ::handle<TColStd_HSequenceOfReal>& VValues);
  ...
  Standard_EXPORT const occ::handle<TColStd_HSequenceOfReal>& USplitValues() const;

  //! returns all the splitting V values including the
  //! First and Last parameters of the input surface
  Standard_EXPORT const occ::handle<TColStd_HSequenceOfReal>& VSplitValues() const;
...
protected:
  occ::handle<TColStd_HSequenceOfReal>      myUSplitValues;
  occ::handle<TColStd_HSequenceOfReal>      myVSplitValues;
