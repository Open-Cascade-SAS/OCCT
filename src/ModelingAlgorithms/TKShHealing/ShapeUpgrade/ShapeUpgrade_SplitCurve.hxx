...
public:
  ...
  Standard_EXPORT void SetSplitValues(const occ::handle<TColStd_HSequenceOfReal>& SplitValues);
  ...
  Standard_EXPORT const occ::handle<TColStd_HSequenceOfReal>& SplitValues() const;
...
protected:
  occ::handle<TColStd_HSequenceOfReal> mySplitValues;
  int                myNbCurves;
  int                myStatus;
