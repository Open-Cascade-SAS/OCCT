...
public:
  ...
  occ::handle<TColStd_HSequenceOfReal> Knots2d() const;

  occ::handle<TColStd_HSequenceOfReal> Knots3d() const;
...
protected:
  ...
  bool                myHasCurve2d;
  bool                myHasCurve3d;
  occ::handle<TColStd_HSequenceOfReal> myKnots2d;
  occ::handle<TColStd_HSequenceOfReal> myKnots3d;
