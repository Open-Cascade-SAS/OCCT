...
public:
  ...
  Standard_EXPORT occ::handle<TopTools_HSequenceOfShape> NonmanifoldEdges() const;
...
private:
  occ::handle<TopTools_HSequenceOfShape>  myEdges;
  occ::handle<TopTools_HSequenceOfShape>  myNonmanifoldEdges;
  occ::handle<TColStd_HSequenceOfInteger> mySeams;
  int                   mySeamF;
  int                   mySeamR;
  bool                   myManifoldMode;
};
