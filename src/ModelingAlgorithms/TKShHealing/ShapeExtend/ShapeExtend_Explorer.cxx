...
TopoDS_Shape ShapeExtend_Explorer::CompoundFromSeq(
  const occ::handle<TopTools_HSequenceOfShape>& seqval) const
{
  BRep_Builder    B;
  TopoDS_Compound C;
  B.MakeCompound(C);
...
static void FillList(const occ::handle<TopTools_HSequenceOfShape>& list,
...
occ::handle<TopTools_HSequenceOfShape> ShapeExtend_Explorer::SeqFromCompound(
  const TopoDS_Shape&    comp,
  const bool expcomp) const
{
  occ::handle<TopTools_HSequenceOfShape> list = new TopTools_HSequenceOfShape();
  if (comp.IsNull())
    return list;
...
void ShapeExtend_Explorer::ListFromSeq(const occ::handle<TopTools_HSequenceOfShape>& seqval,
...
occ::handle<TopTools_HSequenceOfShape> ShapeExtend_Explorer::SeqFromList(
  const NCollection_List<TopoDS_Shape>& lisval) const
{
  occ::handle<TopTools_HSequenceOfShape>  seqval = new TopTools_HSequenceOfShape();
...
void ShapeExtend_Explorer::DispatchList(const occ::handle<TopTools_HSequenceOfShape>& list,
