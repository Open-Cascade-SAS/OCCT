...
const occ::handle<TColGeom_HArray2OfSurface>& ShapeExtend_CompositeSurface::Patches() const
{
  return myPatches;
}
...
occ::handle<TColStd_HArray1OfReal> ShapeExtend_CompositeSurface::UJointValues() const
{
...
occ::handle<TColStd_HArray1OfReal> ShapeExtend_CompositeSurface::VJointValues() const
{
...
bool ShapeExtend_CompositeSurface::SetUJointValues(const NCollection_Array1<double>& UJoints)
{
  ...
  occ::handle<TColStd_HArray1OfReal> UJointValues = new TColStd_HArray1OfReal(1, NbU + 1);
...
bool ShapeExtend_CompositeSurface::SetVJointValues(const NCollection_Array1<double>& VJoints)
{
  ...
  occ::handle<TColStd_HArray1OfReal> VJointValues = new TColStd_HArray1OfReal(1, NbV + 1);
