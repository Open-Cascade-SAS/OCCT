  ...
  const int      MaxDegree)
{
  ...
  {
    occ::handle<Geom_SurfaceOfLinearExtrusion> extr = occ::down_cast<Geom_SurfaceOfLinearExtrusion>(S);
...
bool ShapeConstruct::JoinPCurves(const occ::handle<TopTools_HSequenceOfShape>& edges,
