  ...
  const ArrayOfReal&     theParams) const
{
  ...
  try
  {
    ...
    occ::handle<TColgp_HArray1OfPnt2d> aPnts2d = new TColgp_HArray1OfPnt2d(1, theNbPnt);
    occ::handle<TColStd_HArray1OfReal> aParams = new TColStd_HArray1OfReal(1, theNbPnt);
