...
static double AdjustByPeriod(const double Val,
                                    const double ToVal,
                                    const double Period)
{
...
void ShapeBuild_Edge::RemovePCurve(const TopoDS_Edge& edge, const occ::handle<Geom_Surface>& surf) const
{
