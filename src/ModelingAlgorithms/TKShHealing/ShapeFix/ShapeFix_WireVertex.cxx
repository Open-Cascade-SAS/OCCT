...
int ShapeFix_WireVertex::Fix()
{
  ...
  occ::handle<TopTools_HArray1OfShape> VI = new TopTools_HArray1OfShape(1, nb);
  occ::handle<TopTools_HArray1OfShape> VJ = new TopTools_HArray1OfShape(1, nb);
  occ::handle<TopTools_HArray1OfShape> EF = new TopTools_HArray1OfShape(1, nb);
  occ::handle<TColStd_HArray1OfReal>   UI = new TColStd_HArray1OfReal(1, nb);
  occ::handle<TColStd_HArray1OfReal>   UJ = new TColStd_HArray1OfReal(1, nb);
