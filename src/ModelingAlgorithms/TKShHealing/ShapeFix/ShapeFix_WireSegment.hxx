...
private:
  ...
  occ::handle<TColStd_HSequenceOfInteger> myIUMin;
  occ::handle<TColStd_HSequenceOfInteger> myIUMax;
  occ::handle<TColStd_HSequenceOfInteger> myIVMin;
  occ::handle<TColStd_HSequenceOfInteger> myIVMax;
};
