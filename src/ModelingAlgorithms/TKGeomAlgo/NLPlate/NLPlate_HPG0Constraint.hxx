...
public:
  ...
  Standard_EXPORT virtual void SetUVFreeSliding(const Standard_Boolean UVFree) override;

  Standard_EXPORT virtual void SetIncrementalLoadAllowed(const Standard_Boolean ILA)
    override;

  Standard_EXPORT virtual Standard_Boolean UVFreeSliding() const override;

  Standard_EXPORT virtual Standard_Boolean IncrementalLoadAllowed() const override;

  Standard_EXPORT virtual Standard_Integer ActiveOrder() const override;

  Standard_EXPORT virtual Standard_Boolean IsG0() const override;
