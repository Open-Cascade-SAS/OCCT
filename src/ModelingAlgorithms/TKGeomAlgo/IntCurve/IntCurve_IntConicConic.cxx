...
static inline bool BOUNDED_DOMAIN(const IntRes2d_Domain& domain)
{
                             ...
                             const double             LIMITE)
{
  ...
  if (theIntAna2d.IsDone())
  {
    ...
    {
      for (int p = 1; p <= theIntAna2d.NbPoints(); p++)
      {
        double param = theIntAna2d.Point(p).ParamOnFirst();
