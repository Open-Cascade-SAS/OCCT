...
occ::handle<Law_BSpFunc> Law::MixBnd(const occ::handle<Law_Linear>& Lin)
{
  ...
  Mults(1) = Mults(4) = 4;
  Mults(2) = Mults(3)               = 1;
  occ::handle<TColStd_HArray1OfReal> pol = Law::MixBnd(3, Knots, Mults, Lin);
...
occ::handle<TColStd_HArray1OfReal> Law::MixBnd(const int         Degree,
                                          ...
                                          const occ::handle<Law_Linear>&      Lin)
{
  ...
  occ::handle<TColStd_HArray1OfReal> res = new TColStd_HArray1OfReal(1, nbpol);
...
occ::handle<TColStd_HArray1OfReal> Law::MixTgt(const int         Degree,
                                          const NCollection_Array1<double>&    Knots,
                                          const NCollection_Array1<int>& Mults,
                                       ...
                                       const int NbPoints)
{
  ...
  occ::handle<TColStd_HArray1OfReal> point = new TColStd_HArray1OfReal(1, NbPoints);
  occ::handle<TColStd_HArray1OfReal> param = new TColStd_HArray1OfReal(1, NbPoints);
  ...
  if (HasDF || HasDL)
  {
    ...
    occ::handle<TColStd_HArray1OfBoolean> flag = new TColStd_HArray1OfBoolean(1, NbPoints);
