...
void Law_BSpline::IncreaseDegree(const int Degree)
{
  ...
  occ::handle<TColStd_HArray1OfReal> npoles =
                              ...
                              const bool         Add)
{
  ...
  occ::handle<TColStd_HArray1OfReal>    npoles = new TColStd_HArray1OfReal(1, nbpoles);
                                         ...
                                         const double    Tolerance)
{
  ...
  occ::handle<TColStd_HArray1OfReal> npoles = new TColStd_HArray1OfReal(1, oldpoles.Length() - step);
  ...
  if (IsRational())
  {
    occ::handle<TColStd_HArray1OfReal> nweights = new TColStd_HArray1OfReal(1, npoles->Length());
    NCollection_Array1<double>          adimpol(1, 2 * poles->Upper());
    SetPoles(poles->Array1(), weights->Array1(), adimpol);
    NCollection_Array1<double> adimnpol(1, 2 * npoles->Upper());
...
void Law_BSpline::SetPeriodic()
{
  ...
  occ::handle<TColStd_HArray1OfReal> tp = poles;
