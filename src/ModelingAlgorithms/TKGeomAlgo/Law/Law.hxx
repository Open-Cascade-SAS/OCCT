...
public:
  ...
  Standard_EXPORT static occ::handle<TColStd_HArray1OfReal> MixBnd(const int         Degree,
  ...
  Standard_EXPORT static occ::handle<TColStd_HArray1OfReal> MixTgt(const int         Degree,
                                                              const NCollection_Array1<double>&    Knots,
                                                              const NCollection_Array1<int>& Mults,
