      ...
      Degree(9)
{
  ...
  //
  occ::handle<TColStd_HArray1OfReal>    Iknots = new TColStd_HArray1OfReal(1, 2);
  occ::handle<TColStd_HArray1OfInteger> Imults = new TColStd_HArray1OfInteger(1, 2);
  occ::handle<TColgp_HArray1OfPnt2d>    Ipoles = new TColgp_HArray1OfPnt2d(1, 2);
  ...
  occ::handle<TColgp_HArray1OfPnt2d>    Npoles  = new TColgp_HArray1OfPnt2d(1, Degree + 1);
  occ::handle<TColStd_HArray1OfReal>    Nweight = new TColStd_HArray1OfReal(1, 2);
  occ::handle<TColStd_HArray1OfReal>    Nknots  = new TColStd_HArray1OfReal(1, 2);
  occ::handle<TColStd_HArray1OfInteger> Nmults  = new TColStd_HArray1OfInteger(1, 2);
...
// =============================================================================
{
  ...
  occ::handle<TColgp_HArray1OfPnt2d> NPoles = new TColgp_HArray1OfPnt2d(1, Poles->Length());
  ...
  if (NewKnots)
  {
    ...
    occ::handle<TColgp_HArray1OfPnt2d> NewNPoles = new TColgp_HArray1OfPnt2d(1, NewBS->NbPoles());
    NewBS->Poles(NewNPoles->ChangeArray1());
    NewBS->Multiplicities(NMults->ChangeArray1());
    NewBS->Knots(NKnots->ChangeArray1());
    occ::handle<TColStd_HArray1OfReal> FKnots =
