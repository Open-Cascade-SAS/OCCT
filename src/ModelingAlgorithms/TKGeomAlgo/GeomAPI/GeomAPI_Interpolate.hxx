...
public:
  ...
  Standard_EXPORT GeomAPI_Interpolate(const occ::handle<TColgp_HArray1OfPnt>& Points,
...
private:
  ...
  double                    myTolerance;
  occ::handle<TColgp_HArray1OfPnt>      myPoints;
  bool                 myIsDone;
  occ::handle<Geom_BSplineCurve>        myCurve;
  occ::handle<TColgp_HArray1OfVec>      myTangents;
