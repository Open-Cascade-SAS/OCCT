...
void IntCurveSurface_ThePolygonToolOfHInter::Dump(
  const IntCurveSurface_ThePolygonOfHInter& L)
{
  ...
  std::cout << "Deflection "
            << IntCurveSurface_ThePolygonToolOfHInter::DeflectionOverEstimation(L) << std::endl;
