...
private:
  ...
  bool                 appdone;
  int                 degree[2];
  occ::handle<TColgp_HArray1OfPnt>      curvpol[4];
  occ::handle<TColgp_HArray1OfPnt>      tgtepol[4];
  occ::handle<TColStd_HArray1OfInteger> mults[2];
  occ::handle<TColStd_HArray1OfReal>    knots[2];
  occ::handle<TColStd_HArray1OfReal>    ab[4];
  occ::handle<TColStd_HArray1OfReal>    pq[4];
  double                    dom[4];
  occ::handle<TColgp_HArray1OfPnt>      ncpol[4];
  occ::handle<TColgp_HArray1OfPnt>      ntpol[4];
  occ::handle<TColStd_HArray1OfInteger> nm[2];
  occ::handle<TColStd_HArray1OfReal>    nk[2];
  int                 ibound[2];
  int                 ctr[2];
  int                 nbd3;
  occ::handle<TColgp_HArray2OfPnt>      S0;
  occ::handle<TColgp_HArray2OfPnt>      S1;
