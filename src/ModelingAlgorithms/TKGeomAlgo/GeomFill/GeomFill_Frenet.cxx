...
void GeomFill_Frenet::Init()
{
  ...
  occ::handle<TColStd_HArray1OfReal>    myC2Disc = new TColStd_HArray1OfReal(1, NbIntC2 + 1);
  occ::handle<TColStd_HArray1OfBoolean> IsLin    = new TColStd_HArray1OfBoolean(1, NbIntC2);
  occ::handle<TColStd_HArray1OfBoolean> IsConst  = new TColStd_HArray1OfBoolean(1, NbIntC2);
