...
GeomFill_SectionGenerator::GeomFill_SectionGenerator()
{
  ...
  {
    occ::handle<TColStd_HArray1OfReal> HPar = new (TColStd_HArray1OfReal)(1, mySequence.Length());
...
void GeomFill_SectionGenerator::SetParam(const occ::handle<TColStd_HArray1OfReal>& Params)
{
