...
private:
  ...
  occ::handle<TColStd_HArray1OfReal> HArrPoles;
  occ::handle<TColStd_HArray1OfReal> HArrAngle;
  occ::handle<TColgp_HArray1OfVec>   HArrTangent;
  occ::handle<TColgp_HArray1OfVec>   HArrNormal;
};
