...
public:
  ...
  //! parameter W.
  Standard_EXPORT gp_Vec Value(const Standard_Real W) const override;

  //! Computes the  derivative of  the field of  tangency at
  //! parameter W.
  Standard_EXPORT gp_Vec D1(const Standard_Real W) const override;

  //! Computes the value and the  derivative of the field of
  //! tangency at parameter W.
  Standard_EXPORT void D1(const Standard_Real W, gp_Vec& T, gp_Vec& DT) const override;
