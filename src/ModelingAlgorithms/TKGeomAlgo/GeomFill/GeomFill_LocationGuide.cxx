...
static void InGoodPeriod(const double Prec,
                         const double Period,
                         double&      Current)
{
...
GeomFill_LocationGuide::GeomFill_LocationGuide(const occ::handle<GeomFill_TrihedronWithGuide>& Triedre)
    : TolRes(1, 3),
      Inf(1, 3, 0.),
      Sup(1, 3, 0.),
      X(1, 3),
...
void GeomFill_LocationGuide::SetRotation(const double PrecAngle, double& LastAngle)
{
  ...
  occ::handle<TColStd_HArray1OfInteger>  Mult;
  occ::handle<TColStd_HArray1OfReal>     Knots, Weights;
  occ::handle<TColgp_HArray1OfPnt>       Poles;
...
//==================================================================
bool GeomFill_LocationGuide::D2(
  const double Param,
  gp_Mat&             M,
  gp_Vec&             V,
  gp_Mat&             DM,
...
GeomFill_PipeError GeomFill_LocationGuide::ComputeAutomaticLaw(
  occ::handle<TColgp_HArray1OfPnt2d>& ParAndRad) const
{
  gp_Pnt           P;
  gp_Vec           T, N, B;
  int ii;
