...
public:
  ...
  Standard_EXPORT virtual const Handle(Adaptor3d_Curve)& GetCurve() const override;

  //! Set a transformation Matrix like   the law M(t) become
  //! Mat * M(t)
  Standard_EXPORT virtual void SetTrsf(const gp_Mat& Transfo) override;

  Standard_EXPORT virtual Handle(GeomFill_LocationLaw) Copy() const override;
  ...
  Standard_EXPORT virtual Standard_Boolean D0(const Standard_Real   Param,
                                              gp_Mat&               M,
                                              gp_Vec&               V,
                                              TColgp_Array1OfPnt2d& Poles2d) override;
  ...
  Standard_EXPORT virtual Standard_Boolean D1(const Standard_Real   Param,
                                              ...
                                              TColgp_Array1OfVec2d& DPoles2d) override;
  ...
  Standard_EXPORT virtual Standard_Boolean D2(const Standard_Real   Param,
                                              ...
                                              TColgp_Array1OfVec2d& D2Poles2d) override;
  ...
  Standard_EXPORT virtual Standard_Real GetMaximalNorm() override;
  ...
  //! The default implementation is " returns False ".
  Standard_EXPORT virtual Standard_Boolean IsRotation(Standard_Real& Error) const override;
