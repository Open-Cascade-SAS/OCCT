...
public:
  ...
  Standard_EXPORT void CoefPol(occ::handle<TColgp_HArray2OfXYZ>& Coefs) const;

  Standard_EXPORT void SetPolynomialPartOnly(const bool PPOnly = true);

  Standard_EXPORT int Continuity() const;

  Standard_EXPORT void UVBox(double& UMin,
                             double& UMax,
                             double& VMin,
                             double& VMax) const;
...
private:
  Standard_EXPORT double SolEm(const gp_XY&           point2d,
                                      const int iu,
                                      const int iv) const;

  double Polm(const gp_XY&           point2d,
                     const int iu,
                     const int iv,
                     const int idu,
                     const int idv) const;
