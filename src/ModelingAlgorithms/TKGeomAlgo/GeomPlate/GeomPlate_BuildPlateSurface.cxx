...
GeomPlate_BuildPlateSurface::GeomPlate_BuildPlateSurface(
  const occ::handle<TColStd_HArray1OfInteger>&  NPoints,
  const occ::handle<GeomPlate_HArray1OfHCurve>& TabCurve,
  const occ::handle<TColStd_HArray1OfInteger>&  Tang,
  const int                   Degree,
  const int                   NbIter,
  const double                      Tol2d,
  const double                      Tol3d,
...
//-------------------------------------------------------------------------
static void TrierTab(occ::handle<TColStd_HArray1OfInteger>& Tab)
{
...
//---------------------------------------------------------
occ::handle<Geom2d_Curve> GeomPlate_BuildPlateSurface::ProjectCurve(const occ::handle<Adaptor3d_Curve>& Curv)
{
...
//---------------------------------------------------------
occ::handle<Adaptor2d_Curve2d> GeomPlate_BuildPlateSurface::ProjectedCurve(occ::handle<Adaptor3d_Curve>& Curv)
{
...
void GeomPlate_BuildPlateSurface::Perform(const Message_ProgressRange& theProgress)
{
  ...
  //======================================================================
  occ::handle<GeomPlate_HArray1OfSequenceOfReal> PntInter;
  occ::handle<GeomPlate_HArray1OfSequenceOfReal> PntG1G1;
  if (NTLinCont != 0)
  {
...
//---------------------------------------------------------
void GeomPlate_BuildPlateSurface::EcartContraintesMil(const int         c,
                                                      occ::handle<TColStd_HArray1OfReal>& d,
                                                      occ::handle<TColStd_HArray1OfReal>& an,
                                                      occ::handle<TColStd_HArray1OfReal>& courb)
{
...
// Function : Sense
//---------------------------------------------------------
occ::handle<TColStd_HArray1OfInteger> GeomPlate_BuildPlateSurface::Sense() const
{
  int                 NTCurve = myLinCont->Length();
  occ::handle<TColStd_HArray1OfInteger> Sens    = new TColStd_HArray1OfInteger(1, NTCurve);
...
// Function : Curve2d
//---------------------------------------------------------
occ::handle<TColGeom2d_HArray1OfCurve> GeomPlate_BuildPlateSurface::Curves2d() const
{
  int                  NTCurve = myLinCont->Length();
  occ::handle<TColGeom2d_HArray1OfCurve> C2dfin  = new TColGeom2d_HArray1OfCurve(1, NTCurve);
...
// Function : Order
//---------------------------------------------------------
occ::handle<TColStd_HArray1OfInteger> GeomPlate_BuildPlateSurface::Order() const
{
  occ::handle<TColStd_HArray1OfInteger> result = new TColStd_HArray1OfInteger(1, myLinCont->Length());
...
{
  occ::handle<TColStd_HArray1OfReal> tdistance  = new TColStd_HArray1OfReal(1, myNbPtsOnCur);
  occ::handle<TColStd_HArray1OfReal> tangle     = new TColStd_HArray1OfReal(1, myNbPtsOnCur);
  occ::handle<TColStd_HArray1OfReal> tcurvature = new TColStd_HArray1OfReal(1, myNbPtsOnCur);
...
void GeomPlate_BuildPlateSurface::ComputeSurfInit(const Message_ProgressRange& theProgress)
{
  ...
  if (CourbeJoint && IsOrderG1())
  {
    ...
    occ::handle<TColgp_HArray1OfPnt> Pts =
  ...
  if (nopt != 3)
  {
    ...
    occ::handle<TColgp_HArray1OfPnt> Pts     = new TColgp_HArray1OfPnt(1, 20 * NTLinCont + NTPntCont);
    int            NbPoint = 20;
    double               Uinit, Ufinal, Uif;
    for (i = 1; i <= NTLinCont; i++)
    {
...
//---------------------------------------------------------
void GeomPlate_BuildPlateSurface::Intersect(occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntInter,
                                            occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntG1G1)
{
...
void GeomPlate_BuildPlateSurface::Discretise(
  const occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntInter,
  const occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntG1G1)
{
  int     NTLinCont = myLinCont->Length();
  bool     ACR;
...
//---------------------------------------------------------
void GeomPlate_BuildPlateSurface::LoadCurve(const int NbBoucle,
                                            const int OrderMax)
{
  gp_Pnt           P3d, Pdif, PP;
  gp_Pnt2d         P2d;
...
bool GeomPlate_BuildPlateSurface::VerifSurface(const int NbBoucle)
{
  ...
  for (int i = 1; i <= NTLinCont; i++)
  {
    ...
    if (LinCont->Order() != -1)
    {
      ...
      if (NbPts_i < 3)
        NbPts_i = 4;
      occ::handle<TColStd_HArray1OfReal> tdist  = new TColStd_HArray1OfReal(1, NbPts_i - 1);
      occ::handle<TColStd_HArray1OfReal> tang   = new TColStd_HArray1OfReal(1, NbPts_i - 1);
      occ::handle<TColStd_HArray1OfReal> tcourb = new TColStd_HArray1OfReal(1, NbPts_i - 1);
...
// Function : VerifPoint
//---------------------------------------------------------
void GeomPlate_BuildPlateSurface::VerifPoints(double& Dist,
                                              double& Ang,
                                              double& Curv) const
{
  int NTPntCont = myPntCont->Length();
