...
public:
  ...
  Standard_EXPORT GeomPlate_BuildPlateSurface(const occ::handle<TColStd_HArray1OfInteger>&  NPoints,
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> Sense() const;

  //! Extracts the array of curves on the plate surface which
  //! correspond to the curve constraints set in Add.
  Standard_EXPORT occ::handle<TColGeom2d_HArray1OfCurve> Curves2d() const;
  ...
  Standard_EXPORT occ::handle<TColStd_HArray1OfInteger> Order() const;
...
private:
  ...
  Standard_EXPORT void Intersect(occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntInter,
                                 occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntG1G1);

  Standard_EXPORT void Discretise(const occ::handle<GeomPlate_HArray1OfSequenceOfReal>& PntInter,
  ...
  occ::handle<GeomPlate_HSequenceOfCurveConstraint> myLinCont;
  occ::handle<GeomPlate_HArray1OfSequenceOfReal>    myParCont;
  occ::handle<GeomPlate_HArray1OfSequenceOfReal>    myPlateCont;
  occ::handle<GeomPlate_HSequenceOfPointConstraint> myPntCont;
  ...
  bool                             myAnisotropie;
  occ::handle<TColStd_HArray1OfInteger>             mySense;
  int                             myDegree;
  occ::handle<TColStd_HArray1OfInteger>             myInitOrder;
  double                                myG0Error;
  double                                myG1Error;
  double                                myG2Error;
  int                             myNbPtsOnCur;
