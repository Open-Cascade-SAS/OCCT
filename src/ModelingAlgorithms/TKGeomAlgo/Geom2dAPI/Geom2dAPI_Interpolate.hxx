...
public:
  ...
  Standard_EXPORT Geom2dAPI_Interpolate(const occ::handle<TColgp_HArray1OfPnt2d>& Points,
  ...
  Standard_EXPORT Geom2dAPI_Interpolate(const occ::handle<TColgp_HArray1OfPnt2d>& Points,
                                        const occ::handle<TColStd_HArray1OfReal>& Parameters,
                                        const bool               PeriodicFlag,
                                        const double                  Tolerance);
  ...
  Standard_EXPORT void Load(const NCollection_Array1<gp_Vec2d>&             Tangents,
                            const occ::handle<TColStd_HArray1OfBoolean>& TangentFlags,
                            const bool                  Scale = true);
...
private:
  ...
  double                    myTolerance;
  occ::handle<TColgp_HArray1OfPnt2d>    myPoints;
  bool                 myIsDone;
  occ::handle<Geom2d_BSplineCurve>      myCurve;
  occ::handle<TColgp_HArray1OfVec2d>    myTangents;
  occ::handle<TColStd_HArray1OfBoolean> myTangentFlags;
  occ::handle<TColStd_HArray1OfReal>    myParameters;
  bool                 myPeriodic;
