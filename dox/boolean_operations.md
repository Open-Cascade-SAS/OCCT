...
<img src="images/operations_image005.svg" alt="Edge/edge interference: common parts" width="420">
...
<img src="images/operations_image006.svg" alt="Edge/edge interference: common points" width="420">
...
<img src="images/operations_image007.svg" alt="Edge/face interference: common parts" width="420">
...
<img src="images/operations_image008.svg" alt="Edge/face interference: common points" width="420">
...
<img src="images/operations_image009.svg" alt="Face/face interference: common curves" width="418">
...
Two paves *PV1* and *PV2* on the same curve *C* can be compared using the parameter value ``` PV1 > PV2 if t1 > t2 ```
...
<img src="images/operations_image013.svg" alt="Shrunk Range" width="340">
...
<img src="images/operations_image016.svg" alt="Face Info" width="420">
...
<img src="images/operations_image017.svg" alt="BOPDS_Interf classes" width="420">
...
<img src="images/operations_image019.png" alt="Coinciding chains of pave blocks" width="420">
...
<img src="images/operations_image033.svg" alt="Chains of same domain faces" width="420">
...
<tr>
  ...
  <td><img src="images/bsplit_image002.png" alt="Result" width="160"></td>
</tr>
</table>
...
<table align="center">
<tr>
  <td><img src="images/bsplit_image003.png" alt="Arguments" width="160"></td>
...
<tr>
  ...
  <td><img src="images/bsplit_image006.png" alt="Results" width="160"></td>
</tr>
</table>
...
<img src="images/boolean_image009.png" alt="" width="230">
...
<img src="images/boolean_image043.png" alt="" width="230">
...
<img src="images/boolean_image143.png" alt="" width="230">
...
<img src="images/boolean_image084.png" alt="" width="230">

The result of *Section* operation is the compound that contains vertex *V1*.

<img src="images/boolean_image085.png" alt="" width="230">
...
<img src="images/boolean_image086.png" alt="" width="230">
...
<img src="images/boolean_image095.png" alt="" width="230">

The result of *Section* operation is the compound that contains a new vertex *Vnew*. 

<img src="images/boolean_image096.png" alt="" width="230">
...
<img src="images/boolean_image097.png" alt="" width="230">
 
The result of *Section* operation is the compound that contains a new edge *Enew*. 

<img src="images/boolean_image098.png" alt="" width="230">
 
<h4><a id="specification__boolean_10a_3_11">Case 11: Two intersecting faces</a></h4>

Let us consider two intersecting faces *F1* and *F2*:
 
<img src="images/boolean_image099.png" alt="" width="230">

The result of *Section* operation is the compound that contains a new edge *Enew*. 

<img src="images/boolean_image100.png" alt="" width="230">
 
<h4><a id="specification__boolean_10a_3_12">Case 12: Two faces that have a common part</a></h4>

Let us consider two faces *F1* and *F2* that have a common part:

<img src="images/boolean_image133.png" alt="" width="230">
 
The result of *Section* operation is the compound that contains 4 new edges.

<img src="images/boolean_image134.png" alt="" width="230">
...
<img src="images/boolean_image101.png" alt="" width="230">

The result of *Section* operation is the compound that contains a new edge *Enew*.

<img src="images/boolean_image102.png" alt="" width="230">
...
<img src="images/boolean_image103.png" alt="" width="230">
 
The result of *Section* operation is the compound that contains a new vertex *Vnew*. 
 
<img src="images/boolean_image104.png" alt="" width="230">
...
<img src="images/boolean_image105.png" alt="" width="230">
 
The result of *Section* operation is the compound that contains new edges.

<img src="images/boolean_image106.png" alt="" width="230">
...
<img src="images/boolean_image107.png" alt="" width="230">
 
The result of *Section* operation is the compound that contains new edges
 
<img src="images/boolean_image108.png" alt="" width="230">
...
<img src="images/boolean_image109.png" alt="" width="230">

The result of *Section* operation is the compound that contains a new edge *Enew*.

<img src="images/boolean_image110.png" alt="" width="230">
...
<img src="images/boolean_image111.png" alt="" width="230">
  
The result of *Section* operation is the compound that contains a new vertex *Vnew*.
 
<img src="images/boolean_image112.png" alt="" width="230">
...
<table align="center">
<tr>
  <td><img src="images/mkvolume_image001.png" alt="Arguments" width="200"></td>
  <td><img src="images/mkvolume_image002.png" alt="Results" width="200"></td>
</tr>
</table>
...
<table align="center">
<tr>
  <td><img src="images/mkvolume_image003.png" alt="Arguments" width="200"></td>
  <td><img src="images/mkvolume_image004.png" alt="Results" width="200"></td>
</tr>
</table>
...
<img src="images/cells_algorithm_001.png" alt="Arguments" width="160">
...
<img src="images/cells_algorithm_002.png" alt="The result of COMMON operation" width="126"> 
...
<img src="images/cells_algorithm_003.png" alt="The result of COMMON operation between cylinder and face" width="90"> 
...
<img src="images/cells_algorithm_004.png" alt="The result of COMMON operation between cylinder and sphere" width="120"> 
...
<img src="images/cells_algorithm_005.png" alt="The result of FUSE operation between cylinder and sphere" width="160"> 
...
<img src="images/cells_algorithm_006_1.png" alt="Parts of the face inside solids" width="160">

~~~~{.php}
bcremoveint res
~~~~

<img src="images/cells_algorithm_006_2.png" alt="Unified parts of the face inside solids" width="160"> 
...
<img src="images/cells_algorithm_007.png" alt="Part of the face outside solids" width="160"> 
...
<img src="images/cells_algorithm_008.png" alt="Fuse operation" width="160"> 
...
<img src="images/operations_image036.svg" alt="Compound of two edges" width="230">

#### Example 2: Self-interfered Edge
The edge *E* is a self-interfered shape and cannot be used as an argument of the Algorithms.

<img src="images/operations_image037.svg" alt="Self-interfered Edge" width="140">
 
#### Example 3: Self-interfered Face
The face *F* is a self-interfered shape and cannot be used as an argument of the Algorithms.

<img src="images/operations_image038.svg" alt="Self-interfered Face" width="230">
 
####	Example 4: Face of Revolution
The face *F* has been obtained by revolution of edge *E* around line *L*.

<img src="images/operations_image039a.png" alt="Face of Revolution: Arguments" width="230">
<img src="images/operations_image039b.png" alt="Face of Revolution: Result" width="230">
...
Let us consider edge *E* based on a non-closed circle. <img src="images/operations_image040.png" alt="Edge based on a non-closed circle" width="230">

The distance between the vertices of *E* is *D=0.69799*. The values of the tolerances *Tol(V1)=Tol(V2)=0.5*.
<img src="images/operations_image041.png" alt="Distance and Tolerances" width="230">
...
Let us consider solid *S* containing vertex V. <img src="images/operations_image042.png" alt="Solid containing an interfered vertex" width="230">

The value of  tolerance Tol(V)= 50.000075982061.

<img src="images/operations_image043.png" alt="Tolerance" width="230">
...
<img src="images/boolean_image135.png" alt="" width="230">
...
<img src="images/operations_image044.png" alt="Face 1" width="230">

<img src="images/operations_image045.png" alt="P-Curves for Face 1" width="230">
...
<img src="images/operations_image046.png" alt="Face 2" width="230">

<img src="images/operations_image047.png" alt="P-Curves for Face 2" width="230">
...
<img src="images/operations_image048.png" alt="Example" width="230">
...
<img src="images/operations_image049.png" alt="Intersecting Edges" width="320">
...
<img src="images/operations_image050.svg" alt="Intersecting Faces" width="320">
...
<img src="images/operations_image051.svg" alt="Intersecting Edges" width="420">
...
<img src="images/operations_image052.svg" alt="Result of Intersection" width="420">
...
<img src="images/operations_image053.svg" alt="Intersecting Faces" width="420">
...
<img src="images/operations_image054.svg" alt="Vertex and Edge" width="171">
...
<img src="images/operations_image055.svg" alt="Vertex and Wire" width="200">
...
<img src="images/boolean_image121.png" alt="" width="240">
  
The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 5e<sup>-5</sup>:

<img src="images/boolean_image122.png" alt="Result of CUT operation obtained with Basic Operations" width="240">

<img src="images/boolean_image123.png" alt="Result of CUT operation obtained with Fuzzy Option" width="240">
...
<img src="images/boolean_image124.png" alt="" width="240">

The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 1e<sup>-6</sup>: 

<img src="images/boolean_image125.png" alt="Result of CUT operation obtained with Basic Operations" width="240">

<img src="images/boolean_image126.png" alt="Result of CUT operation obtained with Fuzzy Option" width="240">
...
<img src="images/boolean_image127.png" alt="" width="240">

The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 1e<sup>-5</sup>: 

<img src="images/boolean_image128.png" alt="Result of CUT operation obtained with Basic Operations" width="240">

<img src="images/boolean_image129.png" alt="Result of CUT operation obtained with Fuzzy Option" width="240">
...
<img src="images/boolean_image130.png" alt="" width="240">

The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 6e<sup>-5</sup>: 

<img src="images/boolean_image131.png" alt="Result of CUT operation obtained with Basic Operations" width="240">

<img src="images/boolean_image132.png" alt="Result of CUT operation obtained with Fuzzy Option" width="240">
...
<img src="images/glue_options_image002.png" alt="Intersecting faces" width="240">
...
<img src="images/glue_options_image001.png" alt="Partially coinciding faces" width="240">
...
<img src="images/glue_options_image003.png" alt="Full coinciding faces of the boxes" width="240">
...
<img src="images/glue_options_image004.png" alt="BSpline Boxes with partial coincidence" width="240">
...
<img src="images/glue_options_image005.png" alt="Faces with coinciding but not shared edges" width="240">
...
Since Oriented Bounding Boxes are usually much tighter than Axes Aligned Bounding Boxes (for more information on OBB see the [Bounding boxes](modeling_data#occt_modat_6) chapter of Modeling data User guide) its usage can significantly speed-up the intersection stage of the operation by reducing the number of interfering objects.
...
All operations in Boolean Component support [History information](modeling_algos#occt_modalg_hist). This chapter describes how the History is filled for these operations.
...
For controlling this possibility in DRAW the command **bsimplify** has been implemented. See the [Boolean Operations options](draw_test_harness#occt_draw_bop_options) chapter in draw user guide.
...
<table align="center">
  <tr>
    <td><img src="images/bop_simple_001.png" alt="Not simplified result" width="420"></td>
    <td><img src="images/bop_simple_002.png" alt="Simplified result" width="420"></td>
  </tr>
</table>
...
<img src="images/operations_image065.png" alt="Diagram of BRepAlgoAPI package" width="420">
