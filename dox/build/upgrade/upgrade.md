...
The recommended method for building OCCT 7.x is CMake, see [Link](#build_occt_win_cmake).
The alternative solution is to use project files generated by OCCT legacy tool **genproj**, see [Link](#build_occt_genproj).
