...
The recommended method for building OCCT 7.x is CMake, see [Link](../build_occt/building_occt.md#build_occt_win_cmake).
The alternative solution is to use project files generated by OCCT legacy tool **genproj**, see [Link](../build_occt/building_occt.md#build_occt_genproj).
...
11. Removes uses of obsolete macros *IMPLEMENT_DOWNCAST* and *IMPLEMENT_STANDARD_*..., except *IMPLEMENT_STANDARD_RTTIEXT*.
    ...
    @note If you plan to keep compatibility of your code with older versions of OCCT, add option <i>-compat</i> to avoid this change. See also [Link](#upgrade_occt700_cdl_compat).
...
Since the new version, these unclassified faces are no longer added into the resulting solids. Instead, the [warning](../../specification/boolean_operations/boolean_operations.md#specification__boolean_ers) with a list of these faces appears.
