...
public class ZCueingDlg extends JDialog
...
// Construction
//=======================================================================//
  public ZCueingDlg(Frame frame, SamplePanel aDoc, V3d_View aView)
  {
    super(frame, "ZCueing", false);
    myDocument = aDoc;
    myView = aView;
  ...
  void jbInit() throws Exception
  {
    ...
    chkOnOff = new JCheckBox("Cueing ON/OFF", false);
    chkOnOff.addItemListener(this);
    mainPanel.add(chkOnOff, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0,
            GridBagConstraints.WEST, GridBagConstraints.NONE,
  ...
  private void initValues()
  {
    ...
    boolean isOn = myView.ZCueing(depth, width);

    chkOnOff.setSelected(isOn);
...
//=======================================================================//
  private void onDepthChanged()
  {
    ...
    SampleViewer3DPackage.ChangeZCueingDepth(myView, value.doubleValue(), message);

    myDocument.traceMessage(message.ToCString().GetValue(), "SetZCueingDepth");
  }
...
//=======================================================================//
  private void onWidthChanged()
  {
    ...
    TCollection_AsciiString message = new TCollection_AsciiString();
    SampleViewer3DPackage.ChangeZCueingWidth(myView, value.doubleValue(), message);

    myDocument.traceMessage(message.ToCString().GetValue(), "SetZCueingWidth");
  }

//=======================================================================//
  private void onCueingOnOff()
  {
    TCollection_AsciiString message = new TCollection_AsciiString();
    SampleViewer3DPackage.ChangeZCueingOnOff(myView, chkOnOff.isSelected(), message);

    myDocument.traceMessage(message.ToCString().GetValue(), "SetZCueingOn/SetZCueingOff");
  }
